...
for test in `find ${baseDir}/tests/ -name "*.js" | xargs`
do
    printf "\n"
    echo "RUN TEST: ${test}"
    # Run our analysis using the test file
    ...
    echo " Run analysis "
    out=`node ${ABS_JALANGI}/src/js/commands/direct.js --smemory --analysis ${ABS_AN_HOME}/WrappedPrimitivesFlowAnalysis.js "${TEST_FILE_ABS}.js"`
