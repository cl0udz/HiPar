...
PerMessageDeflate.prototype.normalizeParams = function(paramsList) {
    var self = this; // TODO added by CAS to avoid the change of "this" introduced by jalangi
  return paramsList.map(function(params) {
    Object.keys(params).forEach(function(key) {
      ...
      case 'client_max_window_bits':
        ...
        if (!self._isServer && value === true) {//TODO changed by CAS from this._isServer to self._isServer
