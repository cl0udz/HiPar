...
function (_FindAndModifyOperati) {
  ...
  function FindOneAndUpdateOperation(collection, filter, update, options) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(FindOneAndUpdateOperation).call(this, collection, filter, finalOptions.sort, update, finalOptions));
  }
