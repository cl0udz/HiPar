...
var ReadPreference = require('./core/topologies/read_preference'); // Operations


var ConnectOperation = require('./operations/connect');

var CloseOperation = require('./operations/close');
/**
...
function MongoClient(url, options) {
  ...
  var promiseLibrary = this.s.options.promiseLibrary || Promise; // Add the promise to the internal state
...
MongoClient.prototype.close = function (force, callback) {
  ...
  var operation = new CloseOperation(this, force);
  return executeOperation(this, operation, callback);
};
/**
...
MongoClient.prototype.db = function (dbName, options) {
  ...
  var finalOptions = Object.assign({}, this.s.options, options); // Do we have the db in the cache already
  ...
  var db = new Db(dbName, this.topology, finalOptions); // Add the db to the cache
...
MongoClient.prototype.withSession = function (options, operation) {
  ...
  try {
    ...
    return Promise.resolve(result).then(function (result) {
      return _cleanupHandler(null, result);
    })["catch"](function (err) {
