...
function (_OperationBase) {
  _inherits(NextOperation, _OperationBase);

  function NextOperation(cursor) {
    var _this;

    _classCallCheck(this, NextOperation);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(NextOperation).call(this));
    _this.cursor = cursor;
    return _this;
  }

  _createClass(NextOperation, [{
    key: "execute",
    value: function execute(callback) {
      var cursor = this.cursor; // Return the currentDoc if someone called hasNext first
