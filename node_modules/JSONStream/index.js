...
function check(x, y) {
  if ('string' === typeof x) return y == x;else if (x && 'function' === typeof x.exec) return x.exec(y);else if ('boolean' === typeof x || 'object' === _typeof(x)) return x;else if ('function' === typeof x) return x(y);
  return false;
}
