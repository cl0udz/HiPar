...
d3.behavior.zoom = function () {
  ...
  event = d3_eventDispatch(zoom, "zoomstart", "zoom", "zoomend"),
      ...
      x1,
      y0,
      y1; // Lazily determine the DOM’s support for Wheel events.
  ...
  function touchstarted() {
    var that = this,
        dispatch = event.of(that, arguments),
        locations0 = {},
        // touchstart locations
    distance0 = 0,
        // distance² between initial touches
    scale0,
    ...
    zoomName = ".zoom-" + d3.event.changedTouches[0].identifier,
        ...
        dragRestore = d3_event_dragSuppress(that);
    started();
    zoomstarted(dispatch); // Workaround for Chrome issue 412723: the touchstart listener must be set
    ...
    function started() {
      ...
      targets.push(target); // Only track touches started on the same subject element.
