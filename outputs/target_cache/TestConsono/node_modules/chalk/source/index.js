...
var _require2 = require('./util'),
    ...
    stringEncaseCRLFWithFirstIndex = _require2.stringEncaseCRLFWithFirstIndex; // `supportsColor.level` → `ansiStyles.color[name]` mapping
...
var _loop2 = function _loop2() {
  ...
  styles[model] = {
    get() {
      ...
      return function () {
        var styler = createStyler(ansiStyles.color[levelMapping[level]][model](...arguments), ansiStyles.color.close, this._styler);
...
var _loop3 = function _loop3() {
  ...
  styles[bgModel] = {
    get() {
      var level = this.level;
      return function () {
        var styler = createStyler(ansiStyles.bgColor[levelMapping[level]][model](...arguments), ansiStyles.bgColor.close, this._styler);
        return createBuilder(this, styler, this._isEmpty);
      };
    }
