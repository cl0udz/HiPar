...
//                if (isNative(Constructor)) {
            ...
            function invokeFun(iid, base, f, args, isConstructor, isMethod) {
                ...
                //TODO decide on this
                if (sandbox.analysis && sandbox.analysis.getFunction) {
                    g = sandbox.analysis.getFunction(g, base, isConstructor)
                }
...
//                }
            ...
            function H(iid, val) {
                ...
                return getConcrete(val); //TODO added by CAS to avoid traversing wrapped objects
            }
            ...
            //TODO added by CAS
            function evalInvoked(code, iid) {
                if (sandbox.analysis && sandbox.analysis.evalInvoked) {
                    sandbox.analysis.evalInvoked(code, iid);
                }
            }
            ...
            //TODO added by CAS
            sandbox.evalInvoked = evalInvoked;
        }
    }
