...
var authedClient = new CoinbasePro.AuthenticatedClient(key, secret, passphrase, apiURI);
var buyParams = {
  after: 3000,
  status: 'open'
};
...
function test(input) {
  ...
  var websocket = new CoinbasePro.WebsocketClient(['BTC-USD', 'ETH-USD'], 'wss://ws-feed-public.sandbox.pro.coinbase.com', input['wsh'], input['wsb']);
}
...
var input_para = {
  getorder: buyParams,
  margintransfer: params4,
  closeposition: params2,
  convert: params3,
  withdraw: withdrawAddressParams,
  wsh: header,
  wsb: chnnel
};
