...
var checkState = function checkState(state, exp) {
...
suite('Orderbook', function () {
  test('.add()', function () {
    ...
    var orderbook = new CoinbasePro.Orderbook();
  ...
  test('.remove()', function () {
    var apiState = {
      bids: [[201, 10, 'super-duper-id-2'], [201, 10, 'super-duper-id-3'], [200, 10, 'super-duper-id']],
      asks: []
    };
    var state = {
      bids: [{
  ...
  test('.change() market order', function () {
    var apiState = {
