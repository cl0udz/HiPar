...
function checkAuth(auth) {
  if (auth && !(auth.key && auth.secret && auth.passphrase)) {
    throw new Error('Invalid or incomplete authentication credentials. Please provide all of the key, secret, and passphrase fields.');
  }
...
module.exports = {
  determineProductIDs: determineProductIDs,
  checkAuth: checkAuth
};