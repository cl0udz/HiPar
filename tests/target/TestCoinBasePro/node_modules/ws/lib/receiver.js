  ...
  _createClass(Receiver, [{
    ...
    value: function getInfo() {
      ...
      if (this._opcode === 0x00) {
        ...
        if (this._fragmented) {
          this.error(new RangeError("Invalid WebSocket frame: invalid opcode ".concat(this._opcode)), 1002);
          return;
        }
        ...
        if (this._payloadLength > 0x7d) {
          this.error(new RangeError("Invalid WebSocket frame: invalid payload length " + "".concat(this._payloadLength)), 1002);
          return;
        }
      } else {
        this.error(new RangeError("Invalid WebSocket frame: invalid opcode ".concat(this._opcode)), 1002);
      ...
      if (this._opcode === 0x08) {
        if (data.length === 0) {
          ...
          if (!validation.isValidStatusCode(code)) {
            this.error(new RangeError("Invalid WebSocket frame: invalid status code ".concat(code)), 1002);
            return;
          }
