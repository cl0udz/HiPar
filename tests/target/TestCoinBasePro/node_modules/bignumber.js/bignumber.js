  ...
  function BigNumber(n, b) {
    ...
    if (b == null) {
      ...
      if (isNum) {
        ...
        x.s = str.charCodeAt(0) === 45 ? (str = str.slice(1), -1) : 1; // Allow e.g. hexadecimal 'FF' as well as 'ff'.
    ...
    if (str) {
      len = str.length; // '[BigNumber Error] Number primitive has more than 15 significant digits: {n}'
