...
var levelMethods = {
  fatal: function fatal() {
    ...
    logFatal.call.apply(logFatal, [this].concat(args));
...
function genLsCache(instance) {
  ...
  instance[lsCacheSym] = Object.keys(instance.levels.labels).reduce(function (o, k) {
    o[k] = instance[useLevelLabelsSym] ? "{\"".concat(levelName, "\":\"").concat(instance.levels.labels[k], "\"") : flatstr("{\"".concat(levelName, "\":") + Number(k));
    return o;
...
function assertDefaultLevelFound(defaultLevel, customLevels, useOnlyCustomLevels) {
  if (typeof defaultLevel === 'number') {
    ...
    if (!values.includes(defaultLevel)) {
      throw Error("default level:".concat(defaultLevel, " must be included in custom levels"));
    }
...
module.exports = {
  initialLsCache: initialLsCache,
  genLsCache: genLsCache,
  levelMethods: levelMethods,
  getLevel: getLevel,
  setLevel: setLevel,
  isLevelEnabled: isLevelEnabled,
  mappings: mappings,
  assertNoLevelCollisions: assertNoLevelCollisions,
  assertDefaultLevelFound: assertDefaultLevelFound
};