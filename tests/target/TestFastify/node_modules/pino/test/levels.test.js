...
test('throws when creating a default label that does not exist in logger levels', function _callee26(_ref27) {
  var is, throws, defaultLevel, message;
  return regeneratorRuntime.async(function _callee26$(_context26) {
    while (1) {
      switch (_context26.prev = _context26.next) {
        case 0:
          is = _ref27.is, throws = _ref27.throws;
          defaultLevel = 'foo';
          throws(function () {
            pino({
              customLevels: {
  ...
  return regeneratorRuntime.async(function _callee27$(_context27) {
    while (1) {
      switch (_context27.prev = _context27.next) {
        case 0:
          is = _ref29.is, throws = _ref29.throws;
          defaultLevel = 15;
          throws(function () {
            pino({
              customLevels: {
  ...
  return regeneratorRuntime.async(function _callee28$(_context28) {
    while (1) {
      switch (_context28.prev = _context28.next) {
        case 0:
          is = _ref31.is, throws = _ref31.throws;
          throws(function () {
            pino({
              customLevels: {
                foo: 5
  ...
  return regeneratorRuntime.async(function _callee29$(_context29) {
    while (1) {
      switch (_context29.prev = _context29.next) {
        case 0:
          is = _ref33.is, throws = _ref33.throws;
          pino({
            level: 30
          });
