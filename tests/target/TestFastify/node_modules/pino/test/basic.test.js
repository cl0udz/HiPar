...
function levelTest(name, level) {
  test(`${name} logs as ${level}`, function _callee6(_ref6) {
  ...
  test(`passing objects at level ${name}`, function _callee7(_ref7) {
  ...
  test(`passing an object and a string at level ${name}`, function _callee8(_ref8) {
    var is, same, stream, instance, obj, result;
  ...
  test(`overriding object key by string at level ${name}`, function _callee9(_ref9) {
  ...
  test(`formatting logs as ${name}`, function _callee10(_ref10) {
  ...
  test(`formatting a symbol at level ${name}`, function _callee11(_ref11) {
  ...
  test(`passing error with a serializer at level ${name}`, function _callee12(_ref12) {
  ...
  test(`child logger for level ${name}`, function _callee13(_ref13) {
    ...
    while (1) {
      switch (_context14.prev = _context14.next) {
        case 0:
          ...
          _context14.t2 = {
            serializers: _context14.t1
          };
          _context14.t3 = stream;
          instance = (0, _context14.t0)(_context14.t2, _context14.t3);
          instance.info({
            test: 'sensitive info'
          });
          _context14.next = 10;
      ...
      switch (_context22.prev = _context22.next) {
        case 0:
          ...
          instance = pino({
            base: null,
            serializers: {
              [Symbol.for('pino.*')]: function (input) {
...
test('throw if creating child without bindings', function _callee23(_ref24) {
  var throws, stream, instance;
  return regeneratorRuntime.async(function _callee23$(_context23) {
    while (1) {
      switch (_context23.prev = _context23.next) {
        case 0:
          throws = _ref24.throws;
          stream = sink();
          instance = pino(stream);
          throws(function () {
    ...
    while (1) {
      switch (_context28.prev = _context28.next) {
        case 0:
          ...
          _context28.t0.fatal.call(_context28.t0, _context28.t2);
