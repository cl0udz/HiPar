...
test('throws when specifying pre-existing parent labels via child bindings', function _callee9(_ref15) {
  var is, throws, stream, message;
  return regeneratorRuntime.async(function _callee9$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        case 0:
          is = _ref15.is, throws = _ref15.throws;
          stream = sink();
          throws(function () {
            return pino({
              customLevels: {
  ...
  return regeneratorRuntime.async(function _callee10$(_context10) {
    while (1) {
      switch (_context10.prev = _context10.next) {
        case 0:
          is = _ref17.is, throws = _ref17.throws;
          stream = sink();
          throws(function () {
            return pino({
              customLevels: {
  ...
  return regeneratorRuntime.async(function _callee11$(_context11) {
    while (1) {
      switch (_context11.prev = _context11.next) {
        case 0:
          is = _ref19.is, throws = _ref19.throws;
          stream = sink();
          throws(function () {
  ...
  return regeneratorRuntime.async(function _callee12$(_context12) {
    while (1) {
      switch (_context12.prev = _context12.next) {
        case 0:
          is = _ref21.is, throws = _ref21.throws;
          stream = sink();
          throws(function () {
            return pino({
              useOnlyCustomLevels: true
