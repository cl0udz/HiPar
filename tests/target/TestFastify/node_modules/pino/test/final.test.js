...
test('throws if not supplied logger with pino.extreme instance', function _callee4(_ref4) {
  var _throws4, doesNotThrow;

  return regeneratorRuntime.async(function _callee4$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          _throws4 = _ref4["throws"], doesNotThrow = _ref4.doesNotThrow;
  ...
  return regeneratorRuntime.async(function _callee5$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          is = _ref5.is;
          is(_typeof(pino["final"](pino(pino.extreme()), function () {})), 'function');
      ...
      switch (_context11.prev = _context11.next) {
        case 0:
          ...
          pino["final"](logger, function (err, finalLogger) {
            error(err);
            is(_typeof(finalLogger.trace), 'function');
            is(_typeof(finalLogger.debug), 'function');
            is(_typeof(finalLogger.info), 'function');
            is(_typeof(finalLogger.warn), 'function');
            is(_typeof(finalLogger.error), 'function');
            is(_typeof(finalLogger.fatal), 'function');
