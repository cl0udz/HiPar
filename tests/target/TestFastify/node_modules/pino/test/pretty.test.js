...
test('throws when prettyPrint is true but pino-pretty module is not installed', function _callee5(_ref5) {
  var _throws, is, prettyFactory, message;

  return regeneratorRuntime.async(function _callee5$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          _throws = _ref5["throws"], is = _ref5.is; // pino pretty *is* installed, and probably also cached, so rather than
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          ...
          dest = new Writable({
            objectMode: true,
            write: function write(formatted, enc) {
              is(/^INFO.*foo\n$/.test(formatted), true);
            }
          });
          log = pino({
