...
var _require = require('./symbols'),
    kDefaultJsonParse = _require.kDefaultJsonParse,
...
var _require2 = require('./errors'),
    ...
    FST_ERR_CTP_INVALID_TYPE = _require2$codes.FST_ERR_CTP_INVALID_TYPE,
    FST_ERR_CTP_EMPTY_TYPE = _require2$codes.FST_ERR_CTP_EMPTY_TYPE,
    FST_ERR_CTP_ALREADY_PRESENT = _require2$codes.FST_ERR_CTP_ALREADY_PRESENT,
    FST_ERR_CTP_INVALID_HANDLER = _require2$codes.FST_ERR_CTP_INVALID_HANDLER,
    FST_ERR_CTP_INVALID_PARSE_TYPE = _require2$codes.FST_ERR_CTP_INVALID_PARSE_TYPE,
    FST_ERR_CTP_BODY_TOO_LARGE = _require2$codes.FST_ERR_CTP_BODY_TOO_LARGE,
    FST_ERR_CTP_INVALID_MEDIA_TYPE = _require2$codes.FST_ERR_CTP_INVALID_MEDIA_TYPE,
    FST_ERR_CTP_INVALID_CONTENT_LENGTH = _require2$codes.FST_ERR_CTP_INVALID_CONTENT_LENGTH,
    FST_ERR_CTP_EMPTY_JSON_BODY = _require2$codes.FST_ERR_CTP_EMPTY_JSON_BODY;
