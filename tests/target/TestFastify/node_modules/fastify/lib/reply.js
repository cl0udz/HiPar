...
var _require = require('./symbols.js'),
    ...
    kReplyErrorHandlerCalled = _require.kReplyErrorHandlerCalled,
    kReplySent = _require.kReplySent,
    kReplySentOverwritten = _require.kReplySentOverwritten,
    kReplyStartTime = _require.kReplyStartTime,
    kReplySerializer = _require.kReplySerializer,
    kReplySerializerDefault = _require.kReplySerializerDefault,
    kReplyIsError = _require.kReplyIsError,
    kReplyHeaders = _require.kReplyHeaders,
    kReplyHasStatusCode = _require.kReplyHasStatusCode,
    kReplyIsRunningOnErrorHook = _require.kReplyIsRunningOnErrorHook,
    kDisableRequestLogging = _require.kDisableRequestLogging;

var _require2 = require('./hooks'),
    hookRunner = _require2.hookRunner,
    onSendHookRunner = _require2.onSendHookRunner;
...
var _require3 = require('./errors'),
    ...
    FST_ERR_REP_INVALID_PAYLOAD_TYPE = _require3$codes.FST_ERR_REP_INVALID_PAYLOAD_TYPE,
    FST_ERR_REP_ALREADY_SENT = _require3$codes.FST_ERR_REP_ALREADY_SENT,
    FST_ERR_REP_SENT_VALUE = _require3$codes.FST_ERR_REP_SENT_VALUE,
    FST_ERR_SEND_INSIDE_ONERR = _require3$codes.FST_ERR_SEND_INSIDE_ONERR;
...
function setupResponseListeners(reply) {
  ...
  var onResFinished = function onResFinished(err) {
