...
function checkDependencies(fn) {
  ...
  dependencies.forEach(function (dependency) {
    assert(_this[registeredPlugins].indexOf(dependency) > -1, `The dependency '${dependency}' of plugin '${meta.name}' is not registered`);
  });
}
...
function _checkDecorators(instance, decorators) {
  ...
  decorators.forEach(function (decorator) {
    assert(instance === 'Fastify' ? decorator in _this2 : decorator in _this2.prototype, `The decorator '${decorator}' is not present in ${instance}`);
  });
}
