...
module.exports.payloadMethod = function (method, t) {
  ...
  fastify.listen(0, function (err) {
    ...
    test("".concat(upMethod, " - 400 on bad parameters"), function (t) {
      t.plan(3);
      sget({
        method: upMethod,
        url: 'http://localhost:' + fastify.server.address().port,
    ...
    test("".concat(upMethod, " - input-validation coerce"), function (t) {
      t.plan(3);
      sget({
        method: upMethod,
        url: 'http://localhost:' + fastify.server.address().port,
    ...
    test("".concat(upMethod, " - input-validation custom schema compiler"), function (t) {
      t.plan(3);
      sget({
        method: upMethod,
    ...
    test("".concat(upMethod, " - input-validation joi schema compiler ok"), function (t) {
      t.plan(3);
      sget({
        method: upMethod,
    ...
    test("".concat(upMethod, " - input-validation joi schema compiler ko"), function (t) {
      t.plan(3);
      sget({
        method: upMethod,
        url: 'http://localhost:' + fastify.server.address().port + '/joi',
    ...
    test("".concat(upMethod, " - input-validation instance custom schema compiler encapsulated"), function (t) {
      t.plan(3);
      sget({
        method: upMethod,
    ...
    test("".concat(upMethod, " - input-validation custom schema compiler encapsulated"), function (t) {
      t.plan(3);
      sget({
        method: upMethod,
