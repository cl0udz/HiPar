...
test('should work with valid payload', function (t) {
  t.plan(3);
  var fastify = Fastify();
  fastify.post('/', {
    schema: schema
...
test('should fail immediately with invalid payload', function (t) {
  t.plan(3);
  var fastify = Fastify();
  fastify.post('/', {
    schema: schema
...
test('should be able to use setErrorHandler specify custom validation error', function (t) {
  t.plan(3);
  var fastify = Fastify();
  fastify.post('/', {
    schema: schema
...
test('should be able to attach validation to request', function (t) {
  t.plan(3);
  var fastify = Fastify();
  fastify.post('/', {
    schema: schema,
...
test('should respect when attachValidation is explicitly set to false', function (t) {
  t.plan(3);
  var fastify = Fastify();
  fastify.post('/', {
    schema: schema,
...
test('Attached validation error should take precendence over setErrorHandler', function (t) {
  t.plan(3);
  var fastify = Fastify();
  fastify.post('/', {
    schema: schema,
...
test('should handle response validation error', function (t) {
  t.plan(2);
  var response = {
    200: {
      type: 'object',
...
test('should handle response validation error with promises', function (t) {
  t.plan(2);
  var response = {
    200: {
      type: 'object',
...
test('should return a defined output message parsing AJV errors', function (t) {
  t.plan(2);
  var body = {
    type: 'object',
    required: ['name', 'work'],
...
test('should return a defined output message parsing JOI errors', function (t) {
  t.plan(2);
...
test('should return a defined output message parsing JOI error details', function (t) {
  t.plan(2);
  var body = Joi.object().keys({
    name: Joi.string().required(),
    work: Joi.string().required()
