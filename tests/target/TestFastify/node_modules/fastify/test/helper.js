...
module.exports.payloadMethod = function (method, t) {
  ...
  test(`${upMethod} without schema can be created`, function (t) {
    t.plan(1);
  ...
  test(`${upMethod} with body and querystring`, function (t) {
    t.plan(1);
  ...
  test(`${upMethod} with bodyLimit option`, function (t) {
    t.plan(1);
  ...
  fastify.listen(0, function (err) {
    ...
    test(`${upMethod} - correctly replies with very large body`, function (t) {
      t.plan(3);
    ...
    test(`${upMethod} - correctly replies if the content type has the charset`, function (t) {
      t.plan(3);
      sget({
        method: upMethod,
        url: 'http://localhost:' + fastify.server.address().port,
    ...
    test(`${upMethod} without schema - correctly replies`, function (t) {
      t.plan(3);
      sget({
        method: upMethod,
    ...
    test(`${upMethod} with body and querystring - correctly replies`, function (t) {
      t.plan(3);
      sget({
        method: upMethod,
    ...
    test(`${upMethod} with no body - correctly replies`, function (t) {
      t.plan(6);
      sget({
        method: upMethod,
        url: 'http://localhost:' + fastify.server.address().port + '/missing',
    ...
    test(`${upMethod} returns 415 - incorrect media type if body is not json`, function (t) {
      t.plan(2);
      sget({
        method: upMethod,
        url: 'http://localhost:' + fastify.server.address().port + '/missing',
    ...
    test(`${upMethod} returns 400 - Bad Request`, function (t) {
      t.plan(4);
      sget({
        method: upMethod,
        url: 'http://localhost:' + fastify.server.address().port,
    ...
    test(`${upMethod} returns 413 - Payload Too Large`, function (t) {
    ...
    test(`${upMethod} should fail with empty body and application/json content-type`, function (t) {
