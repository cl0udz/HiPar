...
function testExecutionHook(hook) {
  ...
  test(`${hook} option should be called after ${hook} hook`, function (t) {
    t.plan(3);
    var fastify = Fastify();
  ...
  test(`${hook} option could accept an array of functions`, function (t) {
    t.plan(3);
    var fastify = Fastify();
    var checker = Object.defineProperty({
      calledTimes: 0
  ...
  test(`${hook} option does not interfere with ${hook} hook`, function (t) {
    t.plan(7);
    var fastify = Fastify();
    var checker = Object.defineProperty({
      calledTimes: 0
...
function testBeforeHandlerHook(hook) {
  test(`${hook} option should be unique per route`, function (t) {
    t.plan(4);
    var fastify = Fastify();
    fastify.post('/', {
      [hook]: function (req, reply, done) {
  ...
  test(`${hook} option should handle errors`, function (t) {
    t.plan(3);
    var fastify = Fastify();
    fastify.post('/', {
      [hook]: function (req, reply, done) {
  ...
  test(`${hook} option should handle errors with custom status code`, function (t) {
    t.plan(3);
    var fastify = Fastify();
    fastify.post('/', {
      [hook]: function (req, reply, done) {
  ...
  test(`${hook} option should keep the context`, function (t) {
    t.plan(3);
    var fastify = Fastify();
  ...
  test(`${hook} option should keep the context (array)`, function (t) {
    t.plan(3);
    var fastify = Fastify();
    fastify.decorate('foo', 42);
    fastify.post('/', {
