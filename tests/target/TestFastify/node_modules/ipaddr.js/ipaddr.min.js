...
(function () {
  var r, t, n, e, i, o, a, s;
  t = {}, s = this, "undefined" != typeof module && null !== module && module.exports ? module.exports = t : s.ipaddr = t, a = function a(r, t, n, e) {
    var i, o;
    ...
    function r(r, t) {
      var n, e, i, o, a, s;
      if (16 === r.length) for (this.parts = [], n = e = 0; e <= 14; n = e += 2) {
    ...
    return r.prototype.kind = function () {
      ...
      for (e = /((^|:)(0(:|$)){2,})/g, i = this.toNormalizedString(), r = 0, t = -1; n = e.exec(i);) {
    ...
    var n, e, i, a, s, p;
    if (_r.indexOf("::") !== _r.lastIndexOf("::")) return null;

    for ((p = (_r.match(o.zoneIndex) || [])[0]) && (p = p.substring(1), _r = _r.replace(/%.+$/, "")), n = 0, e = -1; (e = _r.indexOf(":", e + 1)) >= 0;) {
      n++;
    }

    if ("::" === _r.substr(0, 2) && n--, "::" === _r.substr(-2, 2) && n--, n > t) return null;

    for (s = t - n, a = ":"; s--;) {
      a += "0:";
    }

    return ":" === (_r = _r.replace("::", a))[0] && (_r = _r.slice(1)), ":" === _r[_r.length - 1] && (_r = _r.slice(0, -1)), t = function () {
      var t, n, e, o;

      for (o = [], t = 0, n = (e = _r.split(":")).length; t < n; t++) {
    ...
    try {
      for (e = (t = this.parseCIDR(r))[0].toByteArray(), o = this.subnetMaskFromPrefixLength(t[1]).toByteArray(), i = [], n = 0; n < 4;) {
