"use strict"; // This file is autogenerated by build-schema-validator.js, do not edit
...
var validate = function () {
        ...
        if (data.length < 1) {
          ...
          for (var i0 = 0; i0 < data.length; i0++) {
            ...
            if (!nop(data[i0], (dataPath || '') + '[' + i0 + ']', data, i0, rootData)) {
              if (vErrors === null) vErrors = nop.errors;else vErrors = vErrors.concat(nop.errors);
  ...
  return function validate(data, dataPath, parentData, parentDataProperty, rootData) {
    ...
    if ((!data || _typeof(data) !== "object" || Array.isArray(data)) && typeof data !== "boolean") {
      validate.errors = [{
        keyword: 'type',
        dataPath: (dataPath || '') + "",
        schemaPath: '#/type',
                                      ...
                                      if (valid1) {
                                        if (data.additionalItems === undefined) {
                                          ...
                                          if (!validate(data.additionalItems, (dataPath || '') + '.additionalItems', data, 'additionalItems', rootData)) {
                                            if (vErrors === null) vErrors = validate.errors;else vErrors = vErrors.concat(validate.errors);
                                            errors = vErrors.length;
                                          }
                                                                                      ...
                                                                                      if (valid1) {
                                                                                        if (data.allOf === undefined) {
                                                                                          ...
                                                                                          if (!refVal[3](data.allOf, (dataPath || '') + '.allOf', data, 'allOf', rootData)) {
                                                                                            if (vErrors === null) vErrors = refVal[3].errors;else vErrors = vErrors.concat(refVal[3].errors);
                                                                                            errors = vErrors.length;
                                                                                          }
