...
class Consono {
  ...
  toPrintable(t) {
    ...
    switch (_l) {
      case "array":
        var _n = t.length;
        r = _n > this.arrayMaxElements ? `${this.cli.keyword("array")}${s.length ? ` ${this.cli.keyword(s)}` : ""} ${this.cli.plain("(")}${this.cli.argument("elements")}${this.cli.plain("=")}${this.cli.number(_n)}${this.cli.plain(",")} ${this.cli.argument("shown")}=${this.cli.number(this.arrayMaxElements)}${this.cli.plain(")")} ${this.cli.plain("[")}\n` : `${this.cli.keyword("array")}${s.length ? ` ${this.cli.keyword(s)}` : ""} ${this.cli.plain("(")}${this.cli.argument("elements")}${this.cli.plain("=")}${this.cli.number(_n)}${this.cli.plain(")")} ${this.cli.plain("[")}\n`, a = `${i}${this.cli.plain("]")}`, o = this.arrayMaxElements;
        break;
      ...
      case "object":
        ...
        if (t = deCycle(t), !0 === e) {
          ...
          var _s = "";
          _s = _e > this.objectMaxProps ? `${this.cli.plain("(")}${this.cli.argument("props")}${this.cli.plain("=")}${this.cli.number(_e)}${this.cli.plain(",")} ${this.cli.argument("shown")}${this.cli.plain("=")}${this.cli.number(this.objectMaxProps)}${this.cli.plain(")")}` : `${this.cli.plain("(")}${this.cli.argument("props")}${this.cli.plain("=")}${this.cli.number(_e)}${this.cli.plain(")")}`, r = `${this.cli.keyword("object")} ${this.cli.keyword(getClass(_l))} ${_s} ${this.cli.plain("{")}\n`, a = `${i}${this.cli.plain("}")}`;
      ...
      case "arguments":
        var _c = t.length;
        r = _c > this.arrayMaxElements ? `${this.cli.keyword("arguments")} ${this.cli.plain("(")}${this.cli.argument("arity")}${this.cli.plain("=")}${this.cli.number(_c)}, ${this.cli.argument("shown")}${this.cli.plain("=")}${this.cli.number(this.arrayMaxElements)}${this.cli.plain(")")} ${this.cli.plain("[")}\n` : `${this.cli.keyword("arguments")} ${this.cli.plain("(")}${this.cli.argument("arity")}${this.cli.plain("=")}${this.cli.number(_c)}${this.cli.plain(")")} ${this.cli.plain("[")}\n`, a = `${i}${this.cli.plain("]")}`, o = this.arrayMaxElements;
        break;

      case "set":
        var h = t.size;
        r = h > this.setMaxValues ? `${this.cli.keyword("set")} ${this.cli.plain("(")}${this.cli.argument("size")}${this.cli.plain("=")}${this.cli.number(h)}${this.cli.plain(",")} ${this.cli.argument("shown")}${this.cli.plain("=")}${this.cli.number(this.setMaxValues)}${this.cli.plain(")")} ${this.cli.plain("{")}\n` : `${this.cli.keyword("set")} ${this.cli.plain("(")}${this.cli.argument("size")}${this.cli.plain("=")}${this.cli.number(h)}${this.cli.plain(")")} ${this.cli.plain("{")}\n`, a = `${i}}`, o = this.setMaxValues;
        break;

      case "map":
        var m = t.size;
        r = m > this.mapMaxEntries ? `${this.cli.keyword("map")} ${this.cli.plain("(")}${this.cli.argument("size")}${this.cli.plain("=")}${this.cli.number(m)}${this.cli.plain(",")} ${this.cli.argument("shown")}${this.cli.plain("=")}${this.cli.number(this.mapMaxEntries)}${this.cli.plain(")")} ${this.cli.plain("{")}\n` : `${this.cli.keyword("map")} ${this.cli.plain("(")}${this.cli.argument("size")}${this.cli.plain("=")}${this.cli.number(m)}${this.cli.plain(")")} ${this.cli.plain("{")}\n`, a = `${i}${this.cli.plain("}")}`, o = this.mapMaxEntries;
        break;
    ...
    switch (l) {
      case "set":
        var _e2 = Array.from(t);

        for (var _t in _e2) {
          var _s3 = _e2[_t],
              _r = this.formatValue(i, _s3);

          if (n += this.formatAssign("set", i, _t, _r), (c += 1) >= o) break;
        }
      ...
      case "map":
        ...
        try {
          for (var _iterator = t.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (n += this.formatAssign("map", i, _t2, _r2), (c += 1) >= o) break;
          }
        } catch (err) {
      ...
      default:
        var _s2 = Object.keys(t).sort(function (t, i) {
        ...
        for (var _e5 in _s2) {
          if (!Object.prototype.hasOwnProperty.call(t, _e5)) continue;

          var _s5 = t[_e5],
              _r3 = getType(_s5),
              _a = this.formatValue(i, _s5);

          if (n += this.formatAssign(_r3, i, _e5, _a), (c += 1) >= o) break;
        }
  ...
  formatValue(t, i) {
    ...
    switch (a) {
      ...
      case TAG_PROMISE:
        var _this$formatPromise = this.formatPromise(i);
      ...
      case TAG_GENERATOR:
        var _this$formatGenerator = this.formatGenerator(i);
      ...
      case TAG_WEAK_SET:
      case TAG_WEAK_MAP:
        var _this$formatWeak = this.formatWeak(a, i);
      ...
      default:
        if (a.includes("Array")) n = "array", r = getClass(i).toLowerCase(), i = Array.from(i);else if (a.includes("Iterator]")) {
          var _s6 = a.split(" ")[1];
          if ("Set" === _s6) return this.toPrintable(new Set(Array.from(i).map(function (t) {
            return t[1];
          })), t, e);
          if ("Map" === _s6) return this.toPrintable(new Map(Array.from(i)), t, e);
          if ("String" === _s6) return this.toPrintable(Array.from(i).map(function (t) {
            return t[1];
          }).join(""), t, e);
          if ("Array" === _s6) return this.toPrintable(Array.from(i).map(function (t) {
            return t[1];
          }), t, e);
        }
    }
    ...
    return `${this.cli.keyword(n)}${n.length ? this.cli.plain(" • ") : ""}${s}`;
  }
  ...
  formatDate(t) {
    return ["date", this.cli.name(t.toISOString() + " • " + t.toString())];
  }
