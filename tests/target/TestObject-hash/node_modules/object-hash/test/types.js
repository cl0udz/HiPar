...
describe('hash()ing different types', function () {
  it('hashes non-object types', function () {
    ...
    try {
      ...
      if (err.name === 'SyntaxError') asyncFunc = func;else throw err;
    }
  ...
  if (typeof Uint8Array !== 'undefined') {
    it("Typed arrays can be hashed", function () {
      ...
      if (typeof Float64Array !== 'undefined') assert.ok(validSha1.test(hash(new Float64Array([1, 2, 3, 4]))), 'hashes Float64Array');
      if (typeof Uint8ClampedArray !== 'undefined') assert.ok(validSha1.test(hash(new Uint8ClampedArray([1, 2, 3, 4]))), 'hashes Uint8ClampedArray');
  ...
  it("Builtin types themselves can be hashed", function () {
    var hashcount = {};
    var types = [Object, Date, Number, String, Function, RegExp, Error, 0, null, NaN];
    ...
    if (typeof Uint8Array !== 'undefined') types.push(Uint8Array); // Hash each type
  ...
  it("Functions with identical bodies and different names result in identical hashes with respectFunctionNames = false", function () {
    ...
    var toStringDummy = function toStringDummy() {
      return '...';
    };
