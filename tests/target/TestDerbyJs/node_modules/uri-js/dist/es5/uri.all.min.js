...
!function (e, r) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? r(exports) : "function" == typeof define && define.amd ? define(["exports"], r) : r(e.URI = e.URI || {});
}(void 0, function (e) {
  "use strict";
  ...
  function r() {
    ...
    if (r.length > 1) {
      ...
      for (var t = r.length - 1, o = 1; o < t; ++o) {
        r[o] = r[o].slice(1, -1);
      }
  ...
  function m(e, r) {
    ...
    if (o) {
      for (var i = o.toLowerCase().split("::").reverse(), u = R(i, 2), s = u[0], f = u[1], c = f ? f.split(":").map(g) : [], p = s.split(":").map(g), h = r.IPV4ADDRESS.test(p[p.length - 1]), d = h ? 7 : 8, l = p.length - d, m = Array(d), E = 0; E < d; ++E) {
        m[E] = c[E] || p[l + E] || "";
      }
  ...
  function y(e) {
    for (var r = []; e.length;) {
      if (e.match(W)) e = e.replace(W, "");else if (e.match(X)) e = e.replace(X, "/");else if (e.match(ee)) e = e.replace(ee, "/"), r.pop();else if ("." === e || ".." === e) e = "";else {
        var n = e.match(re);
  ...
  var F = u(!1),
    ...
    for (e = n ? H(e / 700) : e >> 1, e += H(e / r); e > 455; t += 36) {
      e = H(e / 35);
    }
    ...
    for (var u = 0; u < i; ++u) {
      e.charCodeAt(u) >= 128 && s("not-basic"), r.push(e.charCodeAt(u));
    }
    ...
    parse: function parse(e, r) {
      ...
      if (n.path = undefined, n.query) {
        for (var o = !1, a = {}, i = n.query.split("&"), u = 0, s = i.length; u < s; ++u) {
          ...
          switch (f[0]) {
            case "to":
              for (var c = f[1].split(","), p = 0, h = c.length; p < h; ++p) {
                t.push(c[p]);
              }
    ...
    serialize: function serialize(e, r) {
      ...
      for (var g in d) {
        d[g] !== oe[g] && l.push(g.replace(ce, I).replace(ce, o).replace(he, h) + "=" + d[g].replace(ce, I).replace(ce, o).replace(de, h));
      }
