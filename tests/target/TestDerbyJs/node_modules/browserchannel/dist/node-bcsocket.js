...
(function () {
  ...
  function ba(a) {
    ...
    for (var b = l, c; c = a.shift();) {
      if (null != b[c]) b = b[c];else return null;
    }
  ...
  a: {
    var Ea = "",
        Fa;
    if (Aa && l.opera) var Ga = l.opera.version,
        Ea = "function" == typeof Ga ? Ga() : Ga;else if (Ba ? Fa = /rv\:([^\);]+)(\)|;)/ : y ? Fa = /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/ : z && (Fa = /WebKit\/(\S+)/), Fa) var Ha = Fa.exec(xa()),
        Ea = Ha ? Ha[1] : "";
    ...
    if (!(b = Ja[a])) {
      ...
      for (var c = String(Da).replace(/^[\s\xa0]+|[\s\xa0]+$/g, "").split("."), d = String(a).replace(/^[\s\xa0]+|[\s\xa0]+$/g, "").split("."), e = Math.max(c.length, d.length), g = 0; 0 == b && g < e; g++) {
        ...
        do {
          var v = u.exec(h) || ["", "", ""],
              r = K.exec(k) || ["", "", ""];
          if (0 == v[0].length && 0 == r[0].length) break;
  ...
  var Ka = l.document,
      Ma = Ka && y ? Ca() || ("CSS1Compat" == Ka.compatMode ? parseInt(Da, 10) : 5) : void 0;
  ...
  function Ra(a) {
    if (Sa) {
      ...
      if (b) {
        var c = b.href;
        if (c && (c = (c = Ra(c)[3] || null) && decodeURIComponent(c)) && c != b.hostname) throw Sa = !0, Error();
      }
    }
  ...
  function eb(a) {
    if ("function" == typeof a.N) return a.N();
  ...
  function D(a, b, c) {
    if ("function" == typeof a.forEach) a.forEach(b, c);else if (ea(a) || n(a)) Ya(a, b, c);else {
      var d;
      if ("function" == typeof a.ca) d = a.ca();else if ("function" != typeof a.N) {
        if (ea(a) || n(a)) {
          d = [];
  ...
  function E(a, b) {
    var c;
    if (a instanceof E) this.D = void 0 !== b ? b : a.D, fb(this, a.oa), c = a.fb, F(this), this.fb = c, gb(this, a.ja), hb(this, a.Ca), ib(this, a.I), jb(this, a.R.n()), c = a.Oa, F(this), this.Oa = c;else if (a && (c = Ra(String(a)))) {
      this.D = !!b;
      fb(this, c[1] || "", !0);
      var d = c[2] || "";
      F(this);
    ...
    } else this.D = !!b, this.R = new kb(null, 0, this.D);
  }
  ...
  f.toString = function () {
    ...
    if (b = this.I) this.ja && "/" != b.charAt(0) && a.push("/"), a.push(lb(b, "/" == b.charAt(0) ? nb : ob));
  ...
  function F(a) {
    if (a.pc) throw Error("Tried to modify a read-only Uri");
  }
  ...
  function I(a) {
    if (!a.h && (a.h = new cb(), a.o = 0, a.C)) for (var b = a.C.split("&"), c = 0; c < b.length; c++) {
      var d = b[c].indexOf("="),
          e = null,
          g = null;
  ...
  f.N = function (a) {
    I(this);
    var b = [];
    if (n(a)) this.wa(a) && (b = ab(b, this.h.get(J(this, a))));else {
      a = this.h.N();
  ...
  function Fb(a, b) {
    var c = [];
    if (0 <= Xa(b, a)) c.push("[...circular reference...]");else if (a && 50 > b.length) {
      c.push(Gb(a) + "(");
  ...
  var Lb = new Kb("SEVERE", 1E3),
      Mb = new Kb("WARNING", 900),
      Nb = new Kb("INFO", 800),
      Ob = new Kb("CONFIG", 700),
      Pb = new Kb("FINE", 500);
  f = L.prototype;
  ...
  function Qb(a) {
    if (a.Aa) return a.Aa;
    if (a.Ta) return Qb(a.Ta);
    Pa("Root logger has no level set.");
    return null;
  }

  f.log = function (a, b, c) {
    if (a.value >= Qb(this).value) for (fa(b) && (b = b()), a = this.nc(a, b, c), b = "log:" + a.rc, l.console && (l.console.timeStamp ? l.console.timeStamp(b) : l.console.markTimeline && l.console.markTimeline(b)), l.msWriteProfilerMark && l.msWriteProfilerMark(b), b = this; b;) {
      c = b;
      var d = a;
      if (c.Kb) for (var e = 0, g = void 0; g = c.Kb[e]; e++) {
        g(d);
      }
      b = b.getParent();
    }
    ...
    if (c) {
      ...
      try {
        ...
        if (n(c)) h = {
          ...
          h = !v && c.lineNumber && c.fileName && c.stack && c.message && c.name ? c : {
      ...
      if (c) for (var d = 0; d < c.length; d++) {
        if (m(c[d])) {
          ...
          if (!(2 > e.length)) {
            ...
            if (m(g) && !(1 > g.length)) {
              var h = g[0];
              if ("noop" != h && "stop" != h) for (var k = 1; k < g.length; k++) {
                g[k] = "";
              }
            }
          }
  ...
  function fc(a, b, c, d) {
    for (var e = 0; e < a.length; ++e) {
      var g = a[e];
      if (!g.na && g.fa == b && g.capture == !!c && g.Pa == d) return e;
    }
  ...
  function tc(a, b, c, d, e) {
    if (m(b)) for (var g = 0; g < b.length; g++) {
      tc(a, b[g], c, d, e);
    } else c = pc(c), bc(a) ? a.vb(b, c, d, e) : a && (a = qc(a)) && (b = a.ya(b, c, !!d, e)) && uc(b);
  }

  function uc(a) {
    if ("number" == typeof a || !a || a.na) return !1;
    var b = a.src;
    if (bc(b)) return gc(b.W, a);
    var c = a.type,
        d = a.Va;
  ...
  function vc(a, b, c, d) {
    var e = 1;
    if (a = qc(a)) if (b = a.s[b]) for (b = bb(b), a = 0; a < b.length; a++) {
      var g = b[a];
  ...
  f.dispatchEvent = function (a) {
    ...
    var c = this.gc,
        d = a.type || a;
    if (n(a)) a = new Q(a, c);else if (a instanceof Q) a.target = a.target || c;else {
      var e = a;
      a = new Q(d, c);
      Wa(a, e);
    }
  ...
  function Cc(a, b, c) {
    if (fa(a)) c && (a = p(a, c));else if (a && "function" == typeof a.handleEvent) a = p(a.handleEvent, a);else throw Error("Invalid listener argument");
  ...
  f.send = function (a, b, c, d) {
    if (this.f) throw Error("[goog.net.XhrIo] Object is active with another request=" + this.Ra + "; newUri=" + a);
  ...
  function Sc(a) {
    if (a.T && "undefined" != typeof aa) if (a.gb[1] && 4 == T(a) && 2 == Tc(a)) M(a.r, S(a, "Local request error detected and ignored"));else if (a.Qa && 4 == T(a)) Cc(a.Rb, 0, a);else if (a.dispatchEvent("readystatechange"), 4 == T(a)) {
  ...
  f.vb = function (a, b, c, d, e) {
    if (m(b)) for (var g = 0; g < b.length; g++) {
      this.vb(a, b[g], c, d, e);
    } else c = c || this.handleEvent, e = e || this.e || this, c = pc(c), d = !!d, b = bc(a) ? a.ya(b, c, d, e) : a ? (a = qc(a)) ? a.ya(b, c, d, e) : null : null, b && (uc(b), delete this.j[b.key]);
    return this;
  };
  ...
  function hd(a, b) {
    ...
    a.b.H(kd);
    if (d = a.X) for (c = "", d = d.split("&"), e = 0; e < d.length; e++) {
      var g = d[e].split("=");
  ...
  f.fc = function (a) {
    try {
      if (a == this.k) a: {
        ...
        if (!fd() || z && !A("420+")) {
          if (4 > b) break a;
        } else if (3 > b || 3 == b && !Aa && !Uc(this.k)) break a;
      ...
      } else this.a.Z("Called back with an unexpected xmlhttp");
    } catch (h) {
  ...
  function rd(a, b) {
    ...
    if (isNaN(c)) return cd;
    d += 1;
    if (d + c > b.length) return ed;
    var e = b.substr(d, c);
    a.Ha = d + c;
    return e;
  }
  ...
  function ud(a, b) {
    if (null != a.ua) throw Error("WatchDog timer not null");
    a.ua = Y(p(a.Ac, a), b);
  }
  ...
  function Ad(a) {
    ...
    var b = a.b.Ec;
    if (null != b) a.a.debug("TestConnection: skipping stage 2, precomputed result is " + b ? "Buffered" : "Unbuffered"), W(), b ? (W(), Cd(a.b, a, !1)) : (W(), Cd(a.b, a, !0));else if (a.A = new U(a, a.a, void 0, void 0, void 0), a.A.S(a.v), b = Dd(a.b, a.L, a.I), W(), fd()) rb(b, "TYPE", "xmlhttp"), id(a.A, b, !1, a.L, !1);else {
      rb(b, "TYPE", "html");
      var c = a.A;
      a = Boolean(a.L);
      c.sa = 3;
  ...
  f.Sb = function (a, b) {
    ...
    if (0 == this.c) {
      if (this.a.debug("TestConnection: Got data for stage 1"), b) {
        ...
        this.va = c[1];
      } else this.a.debug("TestConnection: Null responseText"), Ed(this.b, this);
    } else if (2 == this.c) if (this.Xa) W(), this.rb = q();else if ("11111" == b) {
      if (W(), this.Xa = !0, this.Ma = q(), c = this.Ma - this.dc, fd() || 500 > c) this.g = 200, this.A.cancel(), this.a.debug("Test connection succeeded; using streaming connection"), W(), Cd(this.b, this, !0);
    } else W(), this.Ma = this.rb = q(), this.Xa = !1;
  };

  f.la = function () {
    this.g = this.A.g;
    if (!this.A.F) this.a.debug("TestConnection: request failed, in state " + this.c), 0 == this.c ? W() : 2 == this.c && W(), Ed(this.b, this);else if (0 == this.c) this.a.debug("TestConnection: request complete for initial check"), this.va ? (this.c = 1, zd(this)) : (this.c = 2, Ad(this));else if (2 == this.c) {
  ...
  f.Ub = function (a) {
    ...
    if (Md(this)) if (this.c == Gd) {
      if (a) this.a.J("Not supposed to retry the open");else {
        this.a.debug("open_()");
    ...
    } else 3 == this.c && (a ? Td(this, a) : 0 == this.t.length ? this.a.debug("startForwardChannel_ returned: nothing to send") : this.p ? this.a.J("startForwardChannel_ returned: connection already in progress") : (Td(this), this.a.debug("startForwardChannel_ finished, sent request")));
  };
  ...
  function Vd(a) {
    if (a.i || a.M) return a.a.J("Request already in progress"), !1;
    if (3 <= a.ha) return !1;
  ...
  f.Tb = function () {
    ...
    if (Md(this)) {
      ...
      G(a, "AID", this.za);
      Od(this, a);
      if (fd()) G(a, "TYPE", "xmlhttp"), id(this.i, a, !0, this.L, !1);else {
        G(a, "TYPE", "html");
        var b = this.i,
            c = Boolean(this.L);
        b.sa = 3;
  ...
  function Md(a) {
    if (a.e) {
      ...
      if (0 != b) return a.a.debug("Handler returned error code from okToMakeRequest"), Z(a, b), !1;
    }
  ...
  f.Sb = function (a, b) {
    if (0 != this.c && (this.i == a || this.p == a)) if (this.g = a.g, this.p == a && 3 == this.c) {
      if (7 < this.ia) {
        var c;
        ...
        if (m(c) && 3 == c.length) {
          ...
          if (0 == e[0]) {
            a: if (this.a.debug("Server claims our backchannel is missing."), this.M) this.a.debug("But we are currently starting the request.");else {
              if (this.i) {
                if (this.i.Da + 3E3 < this.p.Da) Qd(this), this.i.cancel(), this.i = null;else break a;
              } else this.a.Z("We do not have a BackChannel established");

              Vd(this);
              W();
            }
          } else this.Ob = e[1], c = this.Ob - this.za, 0 < c && (e = e[2], this.a.debug(e + " bytes (in " + c + " arrays) are outstanding on the BackChannel"), 37500 > e && this.wb && 0 == this.ha && !this.aa && (this.aa = Y(p(this.uc, this), 6E3)));
        } else this.a.debug("Bad POST response data returned"), Z(this, 11);
      } else b != Xb && (this.a.debug("Bad data returned - missing/invald magic cookie"), Z(this, 11));
    } else if (this.i == a && Qd(this), !/^[\s\xa0]*$/.test(b)) {
      c = this.P.parse(b);
  ...
  f.la = function (a) {
    ...
    var b;
    if (this.i == a) Qd(this), this.i = null, b = 2;else if (this.p == a) this.p = null, b = 1;else return;
    this.g = a.g;
    if (0 != this.c) if (a.F) 1 == b ? (q(), Id.dispatchEvent(new Kd(Id, a.X ? a.X.length : 0)), Rd(this), this.Q.length = 0) : Ud(this);else {
      var c = a.Jb();
      if (3 == c || 7 == c || 0 == c && 0 < this.g) this.a.debug("Not retrying due to error type");else {
        this.a.debug("Maybe retrying, last error: " + bd(c, this.g));
        var d;
        if (d = 1 == b) this.p || this.G ? (this.a.J("Request already in progress"), d = !1) : this.c == Gd || this.ba >= (this.La ? 0 : this.pb) ? d = !1 : (this.a.debug("Going to retry POST"), this.G = Y(p(this.Ub, this, a), Wd(this, this.ba)), this.ba++, d = !0);
        if (d || 2 == b && Vd(this)) return;
  ...
  f.mc = function (a) {
    if (!(0 <= Xa(arguments, this.c))) throw Error("Unexpected channel state: " + this.c);
  };
  ...
  function Pd(a) {
    a.c = 0;
    a.g = -1;
    if (a.e) if (0 == a.Q.length && 0 == a.t.length) a.e.channelClosed(a);else {
  ...
  function Bd(a, b, c) {
    var d = tb(c);
    if ("" != d.ja) b && gb(d, b + "." + d.ja), hb(d, d.Ca);else var e = window.location,
        d = ub(e.protocol, b ? b + "." + e.hostname : e.hostname, e.port, c);
  ...
  f.Ja = function (a) {
    if (a && !this.bb) throw Error("Can't create secondary domain capable XhrIo object.");
    a = new Jc();
    a.ec = this.bb;
    return a;
  };
  ...
  function Y(a, b) {
    if (!fa(a)) throw Error("Fn must not be null and must be a function");
  ...
  Zd = {
    0: "Ok",
    4: "User is logging out",
    6: "Unknown session ID",
    7: "Stopped by server",
    8: "General network error",
    2: "Request failed",
    9: "Blocked by a network administrator",
    5: "No data from server",
    10: "Got bad data from the server",
    11: "Got a bad response from the server"
  };
  ...
  _$ = function $(a, b) {
    ...
    e = function e(a, b, c, d, _e) {
      try {
        return "function" === typeof r[a] ? r[a](c, d, _e) : void 0;
      } catch (g) {
    ...
    g.channelClosed = function (a, c, d) {
      var g;
      if (r.readyState !== _$.CLOSED) return w = null, a = h ? Zd[h] : "Closed", X(_$.CLOSED), b.reconnect && 7 !== h && 0 !== h && (g = 6 === h ? 0 : K, clearTimeout(v), v = setTimeout(u, g)), e("onclose", 0, a, c, d), h = null;
    };

    g.channelHandleArray = function (a, b) {
      return e("onmessage", 0, {
        type: "message",
        data: b
      });
    };
    ...
    u = function u() {
      if (w) throw Error("Reconnect() called from invalid state");
      X(_$.CONNECTING);
      e("onconnecting");
      clearTimeout(v);
    ...
    this.open = function () {
      if (r.readyState !== r.CLOSED) throw Error("Already open");
      return u();
    };
    ...
    this.close = function () {
      clearTimeout(v);
      h = 0;
      if (r.readyState !== _$.CLOSED) return X(_$.ib), w.disconnect();
    };

    this.sendMap = La = function La(a) {
      var b;

      if ((b = r.readyState) !== _$.ib && b !== _$.CLOSED) {
        b = w;
  ...
  _$.prototype.canSendWhileConnecting = _$.canSendWhileConnecting = !0;
  _$.prototype.canSendJSON = _$.canSendJSON = !0;
  _$.prototype.CONNECTING = _$.CONNECTING = _$.CONNECTING = 0;
  _$.prototype.OPEN = _$.OPEN = _$.OPEN = 1;
  _$.prototype.CLOSING = _$.CLOSING = _$.ib = 2;
  _$.prototype.CLOSED = _$.CLOSED = _$.CLOSED = 3;
  ("undefined" !== typeof exports && null !== exports ? exports : window).BCSocket = _$;
