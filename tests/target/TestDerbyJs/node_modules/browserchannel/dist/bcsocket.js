...
(function () {
  ...
  var La = l.document,
      Ma = La && y ? Ca() || ("CSS1Compat" == La.compatMode ? parseInt(Da, 10) : 5) : void 0;
  ...
  function E(a, b) {
    var c;
    if (a instanceof E) this.D = void 0 !== b ? b : a.D, fb(this, a.oa), c = a.eb, F(this), this.eb = c, gb(this, a.ja), hb(this, a.Ca), ib(this, a.I), jb(this, a.R.n()), c = a.Na, F(this), this.Na = c;else if (a && (c = Ra(String(a)))) {
      this.D = !!b;
      fb(this, c[1] || "", !0);
      var d = c[2] || "";
      F(this);
  ...
  function F(a) {
    if (a.oc) throw Error("Tried to modify a read-only Uri");
  }
  ...
  function Qb(a) {
    if (a.Aa) return a.Aa;
    if (a.Sa) return Qb(a.Sa);
    Pa("Root logger has no level set.");
    return null;
  }

  f.log = function (a, b, c) {
    if (a.value >= Qb(this).value) for (fa(b) && (b = b()), a = this.mc(a, b, c), b = "log:" + a.qc, l.console && (l.console.timeStamp ? l.console.timeStamp(b) : l.console.markTimeline && l.console.markTimeline(b)), l.msWriteProfilerMark && l.msWriteProfilerMark(b), b = this; b;) {
      c = b;
      var d = a;
      if (c.Jb) for (var e = 0, g = void 0; g = c.Jb[e]; e++) {
        g(d);
      }
      b = b.getParent();
    }
  ...
  function fc(a, b, c, d) {
    for (var e = 0; e < a.length; ++e) {
      var g = a[e];
      if (!g.na && g.fa == b && g.capture == !!c && g.Oa == d) return e;
    }
  ...
  f.send = function (a, b, c, d) {
    if (this.f) throw Error("[goog.net.XhrIo] Object is active with another request=" + this.Qa + "; newUri=" + a);
  ...
  function Rc(a) {
    if (a.T && "undefined" != typeof aa) if (a.fb[1] && 4 == T(a) && 2 == Sc(a)) M(a.r, S(a, "Local request error detected and ignored"));else if (a.Pa && 4 == T(a)) Bc(a.Qb, 0, a);else if (a.dispatchEvent("readystatechange"), 4 == T(a)) {
  ...
  f.ec = function (a) {
    try {
      if (a == this.k) a: {
        ...
        if (!ed() || z && !A("420+")) {
          if (4 > b) break a;
        } else if (3 > b || 3 == b && !Aa && !Tc(this.k)) break a;
  ...
  function qd(a, b) {
    ...
    if (isNaN(c)) return bd;
    d += 1;
    if (d + c > b.length) return dd;
    var e = b.substr(d, c);
    a.Ha = d + c;
    return e;
  }
  ...
  function zd(a) {
    ...
    var b = a.b.Dc;
    if (null != b) a.a.debug("TestConnection: skipping stage 2, precomputed result is " + b ? "Buffered" : "Unbuffered"), W(), b ? (W(), Bd(a.b, a, !1)) : (W(), Bd(a.b, a, !0));else if (a.A = new U(a, a.a, void 0, void 0, void 0), a.A.S(a.v), b = Cd(a.b, a.L, a.I), W(), ed()) rb(b, "TYPE", "xmlhttp"), hd(a.A, b, !1, a.L, !1);else {
      rb(b, "TYPE", "html");
      var c = a.A;
      a = Boolean(a.L);
      c.sa = 3;
  ...
  f.Rb = function (a, b) {
    ...
    if (0 == this.c) {
      if (this.a.debug("TestConnection: Got data for stage 1"), b) {
        ...
        this.va = c[1];
      } else this.a.debug("TestConnection: Null responseText"), Dd(this.b, this);
    } else if (2 == this.c) if (this.Wa) W(), this.rb = q();else if ("11111" == b) {
      if (W(), this.Wa = !0, this.La = q(), c = this.La - this.cc, ed() || 500 > c) this.g = 200, this.A.cancel(), this.a.debug("Test connection succeeded; using streaming connection"), W(), Bd(this.b, this, !0);
    } else W(), this.La = this.rb = q(), this.Wa = !1;
  };

  f.la = function () {
    this.g = this.A.g;
    if (!this.A.F) this.a.debug("TestConnection: request failed, in state " + this.c), 0 == this.c ? W() : 2 == this.c && W(), Dd(this.b, this);else if (0 == this.c) this.a.debug("TestConnection: request complete for initial check"), this.va ? (this.c = 1, yd(this)) : (this.c = 2, zd(this));else if (2 == this.c) {
  ...
  f.Tb = function (a) {
    ...
    } else 3 == this.c && (a ? Sd(this, a) : 0 == this.t.length ? this.a.debug("startForwardChannel_ returned: nothing to send") : this.p ? this.a.J("startForwardChannel_ returned: connection already in progress") : (Sd(this), this.a.debug("startForwardChannel_ finished, sent request")));
  };
  ...
  f.Sb = function () {
    ...
    if (Ld(this)) {
      ...
      G(a, "AID", this.za);
      Nd(this, a);
      if (ed()) G(a, "TYPE", "xmlhttp"), hd(this.i, a, !0, this.L, !1);else {
        G(a, "TYPE", "html");
        var b = this.i,
            c = Boolean(this.L);
        b.sa = 3;
  ...
  f.Rb = function (a, b) {
        ...
        if (m(c) && 3 == c.length) {
          ...
          if (0 == e[0]) {
            a: if (this.a.debug("Server claims our backchannel is missing."), this.M) this.a.debug("But we are currently starting the request.");else {
              if (this.i) {
                if (this.i.Da + 3E3 < this.p.Da) Pd(this), this.i.cancel(), this.i = null;else break a;
              } else this.a.Z("We do not have a BackChannel established");

              Ud(this);
              W();
            }
          } else this.Nb = e[1], c = this.Nb - this.za, 0 < c && (e = e[2], this.a.debug(e + " bytes (in " + c + " arrays) are outstanding on the BackChannel"), 37500 > e && this.wb && 0 == this.ha && !this.aa && (this.aa = Y(p(this.tc, this), 6E3)));
    ...
    } else if (this.i == a && Pd(this), !/^[\s\xa0]*$/.test(b)) {
      c = this.P.parse(b);
  ...
  f.la = function (a) {
    ...
    var b;
    if (this.i == a) Pd(this), this.i = null, b = 2;else if (this.p == a) this.p = null, b = 1;else return;
    this.g = a.g;
    if (0 != this.c) if (a.F) 1 == b ? (q(), Hd.dispatchEvent(new Jd(Hd, a.X ? a.X.length : 0)), Qd(this), this.Q.length = 0) : Td(this);else {
      var c = a.Ib();
      if (3 == c || 7 == c || 0 == c && 0 < this.g) this.a.debug("Not retrying due to error type");else {
        ...
        var d;
        if (d = 1 == b) this.p || this.G ? (this.a.J("Request already in progress"), d = !1) : this.c == Fd || this.ba >= (this.Ka ? 0 : this.pb) ? d = !1 : (this.a.debug("Going to retry POST"), this.G = Y(p(this.Tb, this, a), Vd(this, this.ba)), this.ba++, d = !0);
        if (d || 2 == b && Ud(this)) return;
  ...
  f.lb = function (a) {
    if (a && !this.ab) throw Error("Can't create secondary domain capable XhrIo object.");
    a = new Ic();
    a.dc = this.ab;
    return a;
  };
  ...
  _$ = function $(a, b) {
    ...
    g.channelClosed = function (a, c, d) {
      var g;
      if (r.readyState !== _$.CLOSED) return w = null, a = h ? Yd[h] : "Closed", X(_$.CLOSED), b.reconnect && 7 !== h && 0 !== h && (g = 6 === h ? 0 : K, clearTimeout(v), v = setTimeout(u, g)), e("onclose", 0, a, c, d), h = null;
    };
    ...
    this.close = function () {
      clearTimeout(v);
      h = 0;
      if (r.readyState !== _$.CLOSED) return X(_$.hb), w.disconnect();
    };

    this.sendMap = Ka = function Ka(a) {
      var b;

      if ((b = r.readyState) !== _$.hb && b !== _$.CLOSED) {
        b = w;
  ...
  _$.prototype.CLOSING = _$.CLOSING = _$.hb = 2;
