...
require("core-js/modules/es.regexp.to-string"); //// Example framework-specific classes ////
...
Context.prototype._get = function (property) {
  return this.data && this.data.hasOwnProperty(property) ? this.data[property] : this.parent && this.parent._get(property);
};
