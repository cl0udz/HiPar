...
var serveStatic = require('serve-static'); // Default port is 5555. Override it with `PORT=____`,
...
var bindHost = process.env.HOST || '127.0.0.1'; // Serve files under Saddle's base directory, since test.html
