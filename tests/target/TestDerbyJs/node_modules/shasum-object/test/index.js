...
tape('buffers', function (t) {
  t.plan(2);
  t.strictEqual(shasum(Buffer.from('abc')), 'a9993e364706816aba3e25717850c26c9cd0d89d');
  t.strictEqual(shasum(Buffer.from('ab\xff').toString()), 'ba5142a8207bd61baddf325088732e71cbfe8eb6');
});
