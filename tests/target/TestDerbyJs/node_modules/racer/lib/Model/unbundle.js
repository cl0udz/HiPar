...
Model.prototype.unbundle = function (data) {
  if (this.connection) this.connection.startBulk(); // Re-create and subscribe queries; re-create documents associated with queries
  ...
  for (var contextId in data.contexts) {
    ...
    var contextModel = this.context(contextId); // Re-init fetchedDocs counts
  ...
  if (this.connection) this.connection.endBulk(); // Re-create refs
