...
LocalDoc.prototype.increment = function (segments, byNumber, cb) {
  ...
  function validate(value) {
    ...
    return new TypeError(self._errorMessage('increment on non-number', segments, value));
  }
...
LocalDoc.prototype.stringInsert = function (segments, index, value, cb) {
  ...
  function validate(value) {
    ...
    return new TypeError(self._errorMessage('stringInsert on non-string', segments, value));
  }
...
LocalDoc.prototype.stringRemove = function (segments, index, howMany, cb) {
  ...
  function validate(value) {
    if (typeof value === 'string' || value == null) return;
    return new TypeError(self._errorMessage('stringRemove on non-string', segments, value));
  }
