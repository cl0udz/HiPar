...
describe('ref', function () {
  ...
  describe('event emission', function () {
    ...
    it('re-emits on multiple reffed paths', function (done) {
      ...
      expectEvents('_page.favorites**', model, done, [function (capture, method, value) {
  ...
  describe('event/add ordering', function () {
    ...
    it('removing ref on same toPath in event callback is ok', function () {
      ...
      expect(model.get('_page.ref1')).to.eql('green'); // ref2 was removed while processing ref, but it should still be updated
      // for this current change.

      expect(model.get('_page.ref2')).to.eql('green'); // ref2 is now removed, so it should no longer be updated.
