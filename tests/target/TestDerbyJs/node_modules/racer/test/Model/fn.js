...
describe('fn', function () {
  ...
  describe('start with async option', function () {
    it('sets the output immediately on start', function () {
      ...
      model.set('_nums.a', 2);
      model.set('_nums.b', 4);
      var value = model.start('_nums.sum', '_nums.a', '_nums.b', {
        async: true
      }, 'sum');
      expect(value).to.equal(6);
      expect(model.get('_nums.sum')).to.equal(6);
    ...
    it('async sets the output when an input changes', function (done) {
      ...
      model.set('_nums.a', 2);
      model.set('_nums.b', 4);
      model.start('_nums.sum', '_nums.a', '_nums.b', {
        async: true
      }, 'sum');
      expect(model.get('_nums.sum')).to.equal(6);
      model.set('_nums.a', 5); // Synchronously, there should be no change

      expect(model.get('_nums.sum')).to.equal(6); // Async, the value should be updated
    ...
    it('no async sets the output multiple times when an input changes multiple times', function () {
      ...
      model.set('_nums.b', 4);
      model.start('_nums.sum', '_nums.a', '_nums.b', 'sum');
      expect(model.get('_nums.sum')).to.equal(6); // Synchronously, the value should change
    ...
    it('async sets the output when an input changes multiple times', function (done) {
      ...
      expect(model.get('_nums.sum')).to.equal(6); // Synchronously, there should be no change
      ...
      expect(model.get('_nums.sum')).to.equal(6);
      model.set('_nums.b', 4);
      expect(model.get('_nums.sum')).to.equal(6); // Async, the value should be updated once
