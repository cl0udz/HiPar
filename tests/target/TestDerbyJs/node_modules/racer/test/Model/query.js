...
describe('query', function () {
  ...
  describe('idMap', function () {
    ...
    it('handles insert and remove of a duplicate id', function () {
      var query = this.model.query('myCollection', {
        key: 'myVal'
      });
      query.subscribe();
      query.shareQuery.emit('insert', [{
        ...
        id: 'c'
      }], 0); // Add and immediately remove a duplicate id.
      ...
      query.shareQuery.emit('remove', [{
        id: 'a'
      }], 3); // 'a' is still present once in the results, should still be in the map.
