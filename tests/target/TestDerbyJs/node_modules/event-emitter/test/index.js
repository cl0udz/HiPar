...
module.exports = function (t, a) {
  ...
  test = "On & Once: ";
  count = 0;
  x.on('foo', listener1 = function listener1(a1, a2, a3) {
    a(this, x, test + "Context");
    a.deep([a1, a2, a3], ['foo', x, 15], test + "Arguments");
    ++count;
  });
  count2 = 0;
  x.once('foo', listener2 = function listener2(a1, a2, a3) {
    a(this, x, test + "Context");
    a.deep([a1, a2, a3], ['foo', x, 15], test + "Arguments");
    ++count2;
  });
  ...
  count = 0;
  x.once('foo', listener1 = function listener1() {
    ++count;
  });
  x.off('foo', listener1);
  x.emit('foo');
  ...
  count = 0;
  x.on('foo', listener2 = function listener2() {});
  x.once('foo', listener1 = function listener1() {
    ++count;
  });
  x.off('foo', listener1);
