...
module.exports = function (options) {
  ...
  var matchAllQuery = getQuery({
    query: {}
  });
  describe('client projections', function () {
    beforeEach(function (done) {
      this.backend.addProjection('dogs_summary', 'dogs', {
        age: true,
        owner: true
      });
    ...
    function queryUpdateTests(test) {
      it('doc create', function (done) {
        test.call(this, function (connection, callback) {
          var data = {
            age: 5,
            color: 'spotted',
            owner: {
    ...
    describe('subscribe query', function () {
      ...
      it('query subscribe on projection will update based on fields not in projection', function (done) {
        ...
        var query = connection2.createSubscribeQuery('dogs_summary', dbQuery, null, function (err, results) {
          if (err) return done(err);
          expect(results).to.have.length(0); // Submit an op on a field not in the projection, where the op should
          ...
          fido.submitOp({
            ...
            setTimeout(function () {
              ...
              expect(query.results[0].data).to.eql({
                age: 3,
                owner: {
                  name: 'jim'
                }
