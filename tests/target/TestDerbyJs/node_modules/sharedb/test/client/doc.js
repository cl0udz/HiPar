...
describe('Doc', function () {
  ...
  describe('applyStack', function () {
    ...
    it('single component ops emit an `op` event', function (done) {
      ...
      var doc2 = this.doc2;
      var doc3 = this.doc3;
      var handlers = [function (op, source) {
  ...
  describe('submitting ops in callbacks', function () {
    ...
    it('succeeds with valid op', function (done) {
      ...
      doc.create({
        ...
        expect(error).to.not.exist; // Build valid op that deletes a substring at index 0 of name.

        var textOpComponents = [{
          p: 0,
          d: 'Scooby '
        }];
        var op = [{
    ...
    it('fails with invalid op', function (done) {
      ...
      doc.create({
        ...
        expect(error).to.not.exist; // Build op that tries to delete an invalid substring at index 0 of name.
  ...
  describe('submitting an invalid op', function () {
    ...
    it('rescues an irreversible op collision', function (done) {
      ...
      this.backend.use('submit', function (request, callback) {
        if (pauseSubmit) {
          fireSubmit = function fireSubmit() {
            pauseSubmit = false;
            callback();
          };
        } else {
