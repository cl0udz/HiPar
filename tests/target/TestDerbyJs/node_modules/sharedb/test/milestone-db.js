...
describe('NoOpMilestoneDB', function () {
  ...
  it('does not error when trying to save and fetch a snapshot', function (done) {
    var snapshot = new Snapshot('catcher-in-the-rye', 2, 'http://sharejs.org/types/JSONv0', {
...
module.exports = function (options) {
  ...
  describe('Milestone Database', function () {
    ...
    it('fetches the most recent snapshot before the requested version', function (done) {
      var snapshot1 = new Snapshot('catcher-in-the-rye', 1, 'http://sharejs.org/types/JSONv0', {
        title: 'Catcher in the Rye'
      }, null);
      var snapshot2 = new Snapshot('catcher-in-the-rye', 2, 'http://sharejs.org/types/JSONv0', {
        title: 'Catcher in the Rye',
        author: 'J.D. Salinger'
      }, null);
      var snapshot10 = new Snapshot('catcher-in-the-rye', 10, 'http://sharejs.org/types/JSONv0', {
        title: 'Catcher in the Rye',
        author: 'J.D. Salinger',
    ...
    it('errors when saving a null collection', function (done) {
      var snapshot = new Snapshot('catcher-in-the-rye', 1, 'http://sharejs.org/types/JSONv0', {
        title: 'Catcher in the Rye'
      }, null);
    ...
    describe('snapshots with timestamps', function () {
      ...
      var snapshot3 = new Snapshot('catcher-in-the-rye', 3, 'http://sharejs.org/types/JSONv0', {
        title: 'Catcher in the Rye',
        author: 'J.D. Salinger'
      }, {
        ctime: 1000,
