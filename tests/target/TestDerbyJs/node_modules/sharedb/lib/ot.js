...
exports.checkOp = function (op) {
  ...
  if (op.m != null && _typeof(op.m) !== 'object') {
...
exports.transform = function (type, op, appliedOp) {
  ...
  } else if (appliedOp.create && (op.op || op.create || op.del) || appliedOp.op && op.create) {
