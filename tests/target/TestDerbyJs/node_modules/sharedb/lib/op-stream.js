...
var util = require('./util'); // Stream of operations. Subscribe returns one of these
...
inherits(OpStream, Readable); // This function is for notifying us that the stream is empty and needs data.
...
OpStream.prototype.pushData = function (data) {
  ...
  if (!this.open) return; // This data gets consumed in Agent#_subscribeToStream
