...
function ReadSnapshotsRequest(collection, snapshots, snapshotType) {
  ...
  this.snapshotType = snapshotType; // Added by Backend#trigger
...
ReadSnapshotsRequest.prototype.getReadSnapshotsError = function () {
  ...
  var idToError = this._idToError; // If there are 0 snapshots, there can't be any snapshot-specific errors.
