...
function MilestoneDB(options) {
  emitter.EventEmitter.call(this); // The interval at which milestone snapshots should be saved
...
MilestoneDB.prototype.getMilestoneSnapshot = function (collection, id, version, callback) {
  var error = new ShareDBError(ERROR_CODE.ERR_DATABASE_METHOD_NOT_IMPLEMENTED, 'getMilestoneSnapshot MilestoneDB method unimplemented');
...
MilestoneDB.prototype.saveMilestoneSnapshot = function (collection, snapshot, callback) {
  var error = new ShareDBError(ERROR_CODE.ERR_DATABASE_METHOD_NOT_IMPLEMENTED, 'saveMilestoneSnapshot MilestoneDB method unimplemented');

  this._callBackOrEmitError(error, callback);
};

MilestoneDB.prototype.getMilestoneSnapshotAtOrBeforeTime = function (collection, id, timestamp, callback) {
  var error = new ShareDBError(ERROR_CODE.ERR_DATABASE_METHOD_NOT_IMPLEMENTED, 'getMilestoneSnapshotAtOrBeforeTime MilestoneDB method unimplemented');

  this._callBackOrEmitError(error, callback);
};

MilestoneDB.prototype.getMilestoneSnapshotAtOrAfterTime = function (collection, id, timestamp, callback) {
  var error = new ShareDBError(ERROR_CODE.ERR_DATABASE_METHOD_NOT_IMPLEMENTED, 'getMilestoneSnapshotAtOrAfterTime MilestoneDB method unimplemented');
