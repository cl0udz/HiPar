...
module.exports = _PrimitiveMap = function PrimitiveMap()
/*iterable, serialize*/
{
  var iterable = arguments[0],
      serialize = arguments[1],
      self;
  if (!(this instanceof _PrimitiveMap)) throw new TypeError('Constructor requires \'new\'');
...
if (setPrototypeOf) setPrototypeOf(_PrimitiveMap, MapPolyfill);
_PrimitiveMap.prototype = create(MapPolyfill.prototype, {
  constructor: d(_PrimitiveMap),
  ...
  /*, thisArg*/
    ...
    while (result !== undefined) {
      ...
      call.call(cb, thisArg, this.__mapValuesData__[sKey], this.__mapKeysData__[sKey], this);
      result = iterator._next();
    }
  }),
  get: d(function (key) {
