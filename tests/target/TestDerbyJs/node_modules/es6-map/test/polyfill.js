...
module.exports = function (T, a) {
  ...
  map.forEach(function () {
    a.deep(aFrom(arguments), [arr[i][1], arr[i][0], map], "ForEach: Arguments:  #" + i);
  ...
  arr.splice(0, 1);
  a.deep(toArray(map.entries()), [['dwa', x], ['trzy', 'three'], [x, y], ['cztery', 'four']], "Entries");
  a.deep(toArray(map.keys()), ['dwa', 'trzy', x, 'cztery'], "Keys");
  a.deep(toArray(map.values()), [x, 'three', y, 'four'], "Values");
  a.deep(toArray(map), [['dwa', x], ['trzy', 'three'], [x, y], ['cztery', 'four']], "Iterator");
  map.clear();
