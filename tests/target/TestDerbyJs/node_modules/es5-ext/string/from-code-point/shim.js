...
var floor = Math.floor,
    fromCharCode = String.fromCharCode; // eslint-disable-next-line no-unused-vars

module.exports = function (codePoint1
/*, …codePoints*/
) {
  var chars = [],
  ...
  for (i = 0; i < length; ++i) {
    ...
    if (codePoint < 0x10000) {
      ...
      codePoint -= 0x10000; // eslint-disable-next-line no-bitwise
