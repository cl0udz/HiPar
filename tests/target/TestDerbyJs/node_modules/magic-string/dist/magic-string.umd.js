...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global.MagicString = factory();
})(void 0, function () {
  'use strict';
  ...
  function Mappings(hires) {
    ...
    this.addEdit = function (sourceIndex, content, loc, nameIndex) {
      if (content.length) {
        var segment = [generatedCodeColumn, sourceIndex, loc.line, loc.column];
  ...
  MagicString$1.prototype = {
    addSourcemapLocation: function addSourcemapLocation(_char) {
    ...
    indent: function indent(indentStr, options) {
      ...
      while (chunk) {
        ...
        if (chunk.edited) {
          ...
          while (charIndex < end) {
            if (!isExcluded[charIndex]) {
              var _char2 = this$1.original[charIndex];
