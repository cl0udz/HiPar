...
test('stringify()', function (t) {
  ...
  t.test('stringifies bigints', {
    ...
    var encodeWithN = function encodeWithN(value, defaultEncoder, charset) {
  ...
  t.test('supports custom representations when filter=function', function (st) {
    ...
    var filterFunc = function filterFunc(prefix, value) {
      calls += 1;
  ...
  t.test('receives the default encoder as a second argument', function (st) {
    ...
    qs.stringify({
      ...
      encoder: function encoder(str, defaultEncoder) {
  ...
  t.test('can use custom encoder for a buffer object', {
    ...
    st.equal(qs.stringify({
      ...
      encoder: function encoder(buffer) {
  ...
  t.test('strictNullHandling works with custom filter', function (st) {
    var filter = function filter(prefix, value) {
      return value;
    };
  ...
  t.test('strictNullHandling works with null serializeDate', function (st) {
    var serializeDate = function serializeDate() {
      return null;
    };
  ...
  t.test('allows for encoding keys and values differently', function (st) {
    var encoder = function encoder(str, defaultEncoder, charset, type) {
      if (type === 'key') {
