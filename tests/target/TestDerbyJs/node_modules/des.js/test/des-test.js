...
describe('DES', function () {
  ...
  describe('encryption/decryption', function () {
    var vectors = [{
      ...
      input: '0102030405060708090a0102030405060708090a0102030405060708090a' + '0102030405060708090a0102030405060607080a0102030405060708090a'
    }];
    ...
    it('should buffer during encryption/decryption', function () {
      ...
      var count = 257;
      var expected = new Buffer(new Array(count + 1).join('01020304050607'), 'hex');
      var enc = des.DES.create({
        type: 'encrypt',
        key: key
      });
