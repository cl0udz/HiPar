...
!function (e, n) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) ? module.exports = n() : "function" == typeof define && define.amd ? define([], n) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? exports.sourceMap = n() : e.sourceMap = n();
}(void 0, function () {
  return function (e) {
    function n(t) {
    ...
    var o = r(2),
        ...
        s = r(5).ArraySet,
        a = r(6).MappingList;
    t.prototype._version = 3, t.fromSourceMap = function (e) {
      var n = e.sourceRoot,
          r = new t({
        file: e.file,
        sourceRoot: n
      ...
      return e.eachMapping(function (e) {
        ...
        null != e.source && (t.source = e.source, null != n && (t.source = i.relative(n, t.source)), t.original = {
          line: e.originalLine,
          column: e.originalColumn
        }, null != e.name && (t.name = e.name)), r.addMapping(t);
      }), e.sources.forEach(function (t) {
        var o = t;
        null !== n && (o = i.relative(n, t)), r._sources.has(o) || r._sources.add(o);
      ...
      this._skipValidation || this._validateMapping(n, r, t, o), null != t && (t = String(t), this._sources.has(t) || this._sources.add(t)), null != o && (o = String(o), this._names.has(o) || this._names.add(o)), this._mappings.add({
      ...
      var r = e;
      null != this._sourceRoot && (r = i.relative(this._sourceRoot, r)), null != n ? (this._sourcesContents || (this._sourcesContents = Object.create(null)), this._sourcesContents[i.toSetString(r)] = n) : this._sourcesContents && (delete this._sourcesContents[i.toSetString(r)], 0 === Object.keys(this._sourcesContents).length && (this._sourcesContents = null));
      ...
      this._mappings.unsortedForEach(function (n) {
        if (n.source === t && null != n.originalLine) {
          ...
          null != s.source && (n.source = s.source, null != r && (n.source = i.join(r, n.source)), null != o && (n.source = i.relative(o, n.source)), n.originalLine = s.line, n.originalColumn = s.column, null != s.name && (n.name = s.name));
        }
        ...
        null != t && (null != r && (n = i.join(r, n)), null != o && (n = i.relative(o, n)), this.setSourceContent(n, t));
      }, this);
      ...
      if ((!(e && "line" in e && "column" in e && e.line > 0 && e.column >= 0) || n || r || t) && !(e && "line" in e && "column" in e && n && "line" in n && "column" in n && e.line > 0 && e.column >= 0 && n.line > 0 && n.column >= 0 && r)) throw new Error("Invalid mapping: " + JSON.stringify({
        generated: e,
        source: r,
        original: n,
        name: t
      ...
      for (var e, n, r, t, s = 0, a = 1, u = 0, l = 0, c = 0, g = 0, p = "", h = this._mappings.toArray(), f = 0, d = h.length; f < d; f++) {
        if (n = h[f], e = "", n.generatedLine !== a) for (s = 0; n.generatedLine !== a;) {
          e += ";", a++;
        } else if (f > 0) {
    ...
    n.encode = function (e) {
      ...
      do {
        n = o & u, o >>>= s, o > 0 && (n |= l), r += i.encode(n);
      } while (o > 0);
      ...
      do {
        if (n >= c) throw new Error("Expected more digits in base 64 VLQ value.");
        if (a = i.decode(e.charCodeAt(n++)), a === -1) throw new Error("Invalid base64 digit: " + e.charAt(n - 1));
        t = !!(a & l), a &= u, g += a << p, p += s;
      } while (t);
    ...
    n.encode = function (e) {
      ...
      var n = 65,
          ...
          l = 26,
          c = 52;
      return n <= e && e <= r ? e - n : t <= e && e <= o ? e - t + l : i <= e && e <= s ? e - i + c : e == a ? 62 : e == u ? 63 : -1;
    };
  }, function (e, n) {
    function r(e, n, r) {
    ...
    function i(e) {
      ...
      for (var s, a = n.isAbsolute(r), u = r.split(/\/+/), l = 0, c = u.length - 1; c >= 0; c--) {
        s = u[c], "." === s ? u.splice(c, 1) : ".." === s ? l++ : l > 0 && ("" === s ? (u.splice(c + 1, l), l = 0) : (u.splice(c, 2), l--));
      }

      return r = u.join("/"), "" === r && (r = a ? "/" : "."), i ? (i.path = r, o(i)) : r;
    }
    ...
    function p(e, n, r) {
      ...
      return 0 !== t ? t : (t = e.originalLine - n.originalLine, 0 !== t ? t : (t = e.originalColumn - n.originalColumn, 0 !== t || r ? t : (t = e.generatedColumn - n.generatedColumn, 0 !== t ? t : (t = e.generatedLine - n.generatedLine, 0 !== t ? t : f(e.name, n.name)))));
    }

    function h(e, n, r) {
      var t = e.generatedLine - n.generatedLine;
      return 0 !== t ? t : (t = e.generatedColumn - n.generatedColumn, 0 !== t || r ? t : (t = f(e.source, n.source), 0 !== t ? t : (t = e.originalLine - n.originalLine, 0 !== t ? t : (t = e.originalColumn - n.originalColumn, 0 !== t ? t : f(e.name, n.name)))));
    }
    ...
    function d(e, n) {
      ...
      return 0 !== r ? r : (r = e.generatedColumn - n.generatedColumn, 0 !== r ? r : (r = f(e.source, n.source), 0 !== r ? r : (r = e.originalLine - n.originalLine, 0 !== r ? r : (r = e.originalColumn - n.originalColumn, 0 !== r ? r : f(e.name, n.name)))));
    }
    ...
    var v = /^(?:([\w+\-.]+):)?\/\/(?:(\w+:\w+)@)?([\w.-]*)(?::(\d+))?(.*)$/,
        y = /^data:.+\,.+$/;
    n.urlParse = t, n.urlGenerate = o, n.normalize = i, n.join = s, n.isAbsolute = function (e) {
    ...
    n.toSetString = C ? u : l, n.fromSetString = C ? u : c, n.compareByOriginalPositions = p, n.compareByGeneratedPositionsDeflated = h, n.compareByGeneratedPositionsInflated = d, n.parseSourceMapInput = m, n.computeSourceURL = _;
  }, function (e, n, r) {
    function t() {
    ...
    t.fromArray = function (e, n) {
      for (var r = new t(), o = 0, i = e.length; o < i; o++) {
        r.add(e[o], n);
      }
      ...
      t && !n || this._array.push(e), t || (s ? this._set.set(e, a) : this._set[r] = a);
    ...
    function t(e, n) {
      var r = e.generatedLine,
          ...
          o = e.generatedColumn,
          s = n.generatedColumn;
      return t > r || t == r && s >= o || i.compareByGeneratedPositionsInflated(e, n) <= 0;
    }
    ...
    function t(e, n) {
      var r = e;
      return "string" == typeof e && (r = a.parseSourceMapInput(e)), null != r.sections ? new s(r, n) : new o(r, n);
    }
    ...
    function o(e, n) {
      ...
      s && (s = a.normalize(s)), o = o.map(String).map(a.normalize).map(function (e) {
        return s && a.isAbsolute(s) && a.isAbsolute(e) ? a.relative(s, e) : e;
      }), this._names = l.fromArray(i.map(String), !0), this._sources = l.fromArray(o, !0), this._absoluteSources = this._sources.toArray().map(function (e) {
        return a.computeSourceURL(s, e, n);
      }), this.sourceRoot = s, this.sourcesContent = u, this._mappings = c, this._sourceMapURL = n, this.file = g;
    }
    ...
    t.fromSourceMap = function (e, n) {
      ...
      o.map(function (e) {
        ...
        return n = a.computeSourceURL(u, n, this._sourceMapURL), {
          source: n,
      ...
      if (o >= 0) {
        ...
        if (void 0 === e.column) for (var s = i.originalLine; i && i.originalLine === s;) {
          t.push({
        ...
        } else for (var l = i.originalColumn; i && i.originalLine === n && i.originalColumn == l;) {
          t.push({
            line: a.getArg(i, "generatedLine", null),
            column: a.getArg(i, "generatedColumn", null),
            lastColumn: a.getArg(i, "lastGeneratedColumn", null)
      ...
      return t;
    }, n.SourceMapConsumer = t, o.prototype = Object.create(t.prototype), o.prototype.consumer = t, o.prototype._findSourceIndex = function (e) {
      var n = e;
      if (null != this.sourceRoot && (n = a.relative(this.sourceRoot, n)), this._sources.has(n)) return this._sources.indexOf(n);
      var r;
      ...
      for (var u = e._mappings.toArray().slice(), c = r.__generatedMappings = [], p = r.__originalMappings = [], h = 0, f = u.length; h < f; h++) {
        var d = u[h],
            m = new i();
        m.generatedLine = d.generatedLine, m.generatedColumn = d.generatedColumn, d.source && (m.source = s.indexOf(d.source), m.originalLine = d.originalLine, m.originalColumn = d.originalColumn, d.name && (m.name = t.indexOf(d.name)), p.push(m)), c.push(m);
      }
      ...
      for (var r, t, o, s, u, l = 1, p = 0, h = 0, f = 0, d = 0, m = 0, _ = e.length, v = 0, y = {}, C = {}, S = [], A = []; v < _;) {
        if (";" === e.charAt(v)) l++, v++, p = 0;else if ("," === e.charAt(v)) v++;else {
          for (r = new i(), r.generatedLine = l, s = v; s < _ && !this._charIsMappingSeparator(e, s); s++) {
            ;
          }

          if (t = e.slice(v, s), o = y[t]) v += t.length;else {
            for (o = []; v < s;) {
          ...
          r.generatedColumn = p + o[0], p = r.generatedColumn, o.length > 1 && (r.source = d + o[1], d += o[1], r.originalLine = h + o[2], h = r.originalLine, r.originalLine += 1, r.originalColumn = f + o[3], f = r.originalColumn, o.length > 4 && (r.name = m + o[4], m += o[4])), A.push(r), "number" == typeof r.originalLine && S.push(r);
        }
      }

      g(A, a.compareByGeneratedPositionsDeflated), this.__generatedMappings = A, g(S, a.compareByOriginalPositions), this.__originalMappings = S;
      ...
      var n = {
        ...
        generatedColumn: a.getArg(e, "column")
          ...
          r = this._findMapping(n, this._generatedMappings, "generatedLine", "generatedColumn", a.compareByGeneratedPositionsDeflated, a.getArg(e, "bias", t.GREATEST_LOWER_BOUND));
      ...
      if (r >= 0) {
        ...
        if (o.generatedLine === n.generatedLine) {
          ...
          null !== i && (i = this._sources.at(i), i = a.computeSourceURL(this.sourceRoot, i, this._sourceMapURL));
      ...
      if (null != this.sourceRoot && (o = a.urlParse(this.sourceRoot))) {
        ...
        if ("file" == o.scheme && this._sources.has(i)) return this.sourcesContent[this._sources.indexOf(i)];
        if ((!o.path || "/" == o.path) && this._sources.has("/" + t)) return this.sourcesContent[this._sources.indexOf("/" + t)];
      }
      ...
      var r = {
        ...
        originalColumn: a.getArg(e, "column")
          ...
          o = this._findMapping(r, this._originalMappings, "originalLine", "originalColumn", a.compareByOriginalPositions, a.getArg(e, "bias", t.GREATEST_LOWER_BOUND));
    ...
    }, n.BasicSourceMapConsumer = o, s.prototype = Object.create(t.prototype), s.prototype.constructor = t, s.prototype._version = 3, Object.defineProperty(s.prototype, "sources", {
      get: function get() {
      ...
      for (var r = 0; r < this._sections.length; r++) {
        for (var t = this._sections[r], o = t.consumer._generatedMappings, i = 0; i < o.length; i++) {
          var s = o[i],
              u = t.consumer._sources.at(s.source);

          u = a.computeSourceURL(t.consumer.sourceRoot, u, this._sourceMapURL), this._sources.add(u), u = this._sources.indexOf(u);
          var l = null;
          s.name && (l = t.consumer._names.at(s.name), this._names.add(l), l = this._names.indexOf(l));
          var c = {
            source: u,
            generatedLine: s.generatedLine + (t.generatedOffset.generatedLine - 1),
            generatedColumn: s.generatedColumn + (t.generatedOffset.generatedLine === s.generatedLine ? t.generatedOffset.generatedColumn - 1 : 0),
    ...
    function r(e, t, o, i, s, a) {
      var u = Math.floor((t - e) / 2) + e,
          l = s(o, i[u], !0);
      return 0 === l ? u : l > 0 ? t - u > 1 ? r(u, t, o, i, s, a) : a == n.LEAST_UPPER_BOUND ? t < i.length ? t : -1 : u : u - e > 1 ? r(e, u, o, i, s, a) : a == n.LEAST_UPPER_BOUND ? u : e < 0 ? -1 : e;
    }
    ...
    t.fromStringWithSourceMap = function (e, n, r) {
      ...
      return n.eachMapping(function (e) {
        if (null !== h) {
          if (!(g < e.generatedLine)) {
            ...
            return u[l] = n.substr(e.generatedColumn - p), p = e.generatedColumn, o(h, r), void (h = e);
          }

          o(h, c()), g++, p = 0;
        }

        for (; g < e.generatedLine;) {
          a.add(c()), g++;
        }

        if (p < e.generatedColumn) {
          var n = u[l] || "";
          a.add(n.substr(0, e.generatedColumn)), u[l] = n.substr(e.generatedColumn), p = e.generatedColumn;
        }

        h = e;
      }, this), l < u.length && (h && o(h, c()), a.add(u.splice(l).join(""))), n.sources.forEach(function (e) {
        var t = n.sourceContentFor(e);
        null != t && (null != r && (e = i.join(r, e)), a.setSourceContent(e, t));
      }), a;
      ...
      if (Array.isArray(e)) for (var n = e.length - 1; n >= 0; n--) {
        this.prepend(e[n]);
      } else {
        if (!e[u] && "string" != typeof e) throw new TypeError("Expected a SourceNode, string, or an array of SourceNodes and strings. Got " + e);
      ...
      for (var n, r = 0, t = this.children.length; r < t; r++) {
        n = this.children[r], n[u] ? n.walk(e) : "" !== n && e(n, {
          source: this.source,
          line: this.line,
          column: this.column,
          name: this.name
      ...
      return r[u] ? r.replaceRight(e, n) : "string" == typeof r ? this.children[this.children.length - 1] = r.replace(e, n) : this.children.push("".replace(e, n)), this;
    }, t.prototype.setSourceContent = function (e, n) {
      ...
      for (var t = Object.keys(this.sourceContents), n = 0, r = t.length; n < r; n++) {
      ...
      return this.walk(function (e, o) {
        n.code += e, null !== o.source && null !== o.line && null !== o.column ? (i === o.source && s === o.line && u === o.column && l === o.name || r.addMapping({
          source: o.source,
          original: {
            line: o.line,
            column: o.column
          ...
          name: o.name
        }), i = o.source, s = o.line, u = o.column, l = o.name, t = !0) : t && (r.addMapping({
          generated: {
            line: n.line,
            column: n.column
          }
        ...
        for (var c = 0, g = e.length; c < g; c++) {
          e.charCodeAt(c) === a ? (n.line++, n.column = 0, c + 1 === g ? (i = null, t = !1) : t && r.addMapping({
            source: o.source,
            original: {
              line: o.line,
              column: o.column
