...
((void 0).define || function (G, J) {
  ...
  (function b(p, u, m) {
    ...
    for (var g = "function" == typeof require && require, h = 0; h < m.length; h++) {
      e(m[h]);
    }
    ...
    5: [function (p, u, m) {
      function b(f, n, a) {
        ...
        if ("number" === c) var d = 0 < f ? f >>> 0 : 0;else if ("string" === c) {
          if ("base64" === n) for (f = (f.trim ? f.trim() : f.replace(/^\s+|\s+$/g, "")).replace(H, ""); 0 !== f.length % 4;) {
            f += "=";
          }
          d = b.byteLength(f, n);
        ...
        if (b.TYPED_ARRAY_SUPPORT && "number" === typeof f.byteLength) k._set(f);else {
          ...
          if (F(C) || b.isBuffer(C) || C && "object" === _typeof(C) && "number" === typeof C.length) {
            if (b.isBuffer(f)) for (n = 0; n < d; n++) {
              k[n] = f.readUInt8(n);
            } else for (n = 0; n < d; n++) {
              k[n] = (f[n] % 256 + 256) % 256;
            }
          } else if ("string" === c) k.write(f, 0, n);else if ("number" === c && !b.TYPED_ARRAY_SUPPORT && !a) for (n = 0; n < d; n++) {
            k[n] = 0;
          }
        }
        return k;
      ...
      function e(f, n, b) {
        ...
        for (b = Math.min(f.length, b); n < b; n++) {
      ...
      function d(f, n, b, a) {
        ...
        for (var c = 0, d = Math.min(f.length - b, 2); c < d; c++) {
          f[b + c] = (n & 255 << 8 * (a ? c : 1 - c)) >>> 8 * (a ? c : 1 - c);
        }
      }
      ...
      function a(f, n, b, a) {
        ...
        for (var c = 0, d = Math.min(f.length - b, 4); c < d; c++) {
          f[b + c] = n >>> 8 * (a ? c : 3 - c) & 255;
        }
      }
      ...
      b.concat = function (f, a) {
        ...
        var c;
        if (void 0 === a) for (c = a = 0; c < f.length; c++) {
          a += f[c].length;
        }
        var n = new b(a),
            d = 0;
      ...
      b.prototype.slice = function (f, a) {
        ...
        for (var d = new b(c, void 0, !0), n = 0; n < c; n++) {
          d[n] = this[n + f];
        }
      ...
      b.prototype.copy = function (a, c, d, k) {
        ...
        if (k !== d && 0 !== a.length && 0 !== this.length) {
          ...
          k -= d;
          if (1E3 > k || !b.TYPED_ARRAY_SUPPORT) for (var f = 0; f < k; f++) {
            a[f + c] = this[f + d];
          } else a._set(this.subarray(d, d + k), c);
        }
      };
    ...
    8: [function (p, u, m) {
      (function (b) {
        ...
        m.relative = function (a, b) {
          ...
          for (var l = d(a.split("/")), w = d(b.split("/")), e = Math.min(l.length, w.length), c = e, k = 0; k < e; k++) {
            if (l[k] !== w[k]) {
              c = k;
              break;
            }
    ...
    10: [function (p, u, m) {
      ...
      b.fromArray = function (d, a) {
        for (var e = new b(), g = 0, h = d.length; g < h; g++) {
          e.add(d[g], a);
        }
    ...
    16: [function (p, u, m) {
      ...
      b.prototype.allGeneratedPositionsFor = function (b) {
        ...
        if (0 <= c) {
          ...
          if (void 0 === b.column) for (e = g.originalLine; g && g.originalLine === e;) {
            k.push({
          ...
          } else for (b = g.originalColumn; g && g.originalLine === e && g.originalColumn == b;) {
            k.push({
              line: d.getArg(g, "generatedLine", null),
              column: d.getArg(g, "generatedColumn", null),
              lastColumn: d.getArg(g, "lastGeneratedColumn", null)
      ...
      e.prototype._parseMappings = function (a, b) {
        for (var c = 1, k = 0, e = 0, l = 0, w = 0, h = 0, m = a.length, v = 0, f = {}, n = {}, p = [], u = [], y, B, A, E, I; v < m;) {
          if (";" === a.charAt(v)) c++, v++, k = 0;else if ("," === a.charAt(v)) v++;else {
            y = new g();
            y.generatedLine = c;
            ...
            if (A = f[B]) v += B.length;else {
              for (A = []; v < E;) {
                r.decode(a, v, n), I = n.value, v = n.rest, A.push(I);
              }
      ...
      e.prototype.sourceContentFor = function (a, b) {
        ...
        for (e = 0; e < k.length; ++e) {
          if (k[e] == a) return this.sourcesContent[e];
        }
      ...
      h.prototype._parseMappings = function (a, b) {
        ...
        for (var c = 0; c < this._sections.length; c++) {
          for (var k = this._sections[c], e = k.consumer._generatedMappings, g = 0; g < e.length; g++) {
            var l = e[g],
    ...
    17: [function (p, u, m) {
      ...
      b.prototype._serializeMappings = function () {
        for (var a = 0, b = 1, d = 0, h = 0, m = 0, p = 0, c = "", k, x, z, F = this._mappings.toArray(), D = 0, t = F.length; D < t; D++) {
          x = F[D];
          k = "";
          if (x.generatedLine !== b) for (a = 0; x.generatedLine !== b;) {
            k += ";", b++;
          } else if (0 < D) {
    ...
    18: [function (p, u, m) {
      ...
      b.prototype.prepend = function (b) {
        if (Array.isArray(b)) for (var a = b.length - 1; 0 <= a; a--) {
          this.prepend(b[a]);
        } else if (b.$$$isSourceNode$$$ || "string" === typeof b) this.children.unshift(b);else throw new TypeError("Expected a SourceNode, string, or an array of SourceNodes and strings. Got " + b);
        return this;
      };
      ...
      b.prototype.toStringWithSourceMap = function (b) {
        ...
        this.walk(function (b, e) {
          ...
          for (var l = 0, z = b.length; l < z; l++) {
            10 === b.charCodeAt(l) ? (d++, g = 0, l + 1 === z ? (p = null, m = !1) : m && h.addMapping({
              source: e.source,
              original: {
                line: e.line,
                column: e.column
    ...
    19: [function (p, u, m) {
      ...
      function g(a) {
        ...
        for (var g, h = 0, l = c.length - 1; 0 <= l; l--) {
    ...
    21: [function (p, u, m) {
      (function (b) {
        ...
        m.install = function (a) {
          ...
          !t && ("handleUncaughtExceptions" in a ? a.handleUncaughtExceptions : 1) && "object" === _typeof(b) && null !== b && "function" === typeof b.on && (t = !0, c());
        };
