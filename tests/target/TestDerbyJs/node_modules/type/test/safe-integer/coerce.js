...
describe("safe-integer/coerce", function () {
  ...
  it("Should coerce string", function () {
    assert.equal(coerceToSafeInteger("12.123"), 12);
  });
  it("Should coerce booleans", function () {
    assert.equal(coerceToSafeInteger(true), 1);
  });
  ...
  it("Should coerce objects", function () {
    assert.equal(coerceToSafeInteger({
  ...
  it("Should reject NaN", function () {
    assert.equal(coerceToSafeInteger(NaN), null);
  });
  ...
  it("Should not coerce null", function () {
    assert.equal(coerceToSafeInteger(null), null);
  });
