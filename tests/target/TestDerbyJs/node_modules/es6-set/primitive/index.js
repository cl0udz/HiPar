...
module.exports = _PrimitiveSet = function PrimitiveSet()
/*iterable, serialize*/
{
  var iterable = arguments[0],
      serialize = arguments[1],
      self;
  if (!(this instanceof _PrimitiveSet)) throw new TypeError('Constructor requires \'new\'');
  if (isNative && setPrototypeOf) self = setPrototypeOf(new Set(), getPrototypeOf(this));else self = this;
...
if (setPrototypeOf) setPrototypeOf(_PrimitiveSet, Set);
_PrimitiveSet.prototype = create(Set.prototype, {
  constructor: d(_PrimitiveSet),
