...
module.exports = function (T, a) {
  ...
  a.deep(toArray(set.entries()).sort(), [['dwa', 'dwa'], ['trzy', 'trzy'], [x, x], ['raz', 'raz']].sort(), "Entries");
  a.deep(toArray(set.keys()).sort(), ['dwa', 'trzy', x, 'raz'].sort(), "Keys");
  a.deep(toArray(set.values()).sort(), ['dwa', 'trzy', x, 'raz'].sort(), "Values");
  a.deep(toArray(getIterator(set)).sort(), ['dwa', 'trzy', x, 'raz'].sort(), "Iterator");
  set.clear();
