...
var _es6WeakMap = _interopRequireDefault(require("es6-weak-map"));

var _scope = _interopRequireWildcard(require("./scope"));
...
function () {
  function ScopeManager(options) {
    ...
    this.__nodeToScope = new _es6WeakMap["default"]();
    this.__currentScope = null;
    this.__options = options;
    this.__declaredVariables = new _es6WeakMap["default"]();
  }
