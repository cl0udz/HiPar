...
exports.ClassScope = exports.ForScope = exports.FunctionScope = exports.SwitchScope = exports.BlockScope = exports.TDZScope = exports.WithScope = exports.CatchScope = exports.FunctionExpressionNameScope = exports.ModuleScope = exports.GlobalScope = exports["default"] = void 0;
...
function () {
  function Scope(scopeManager, type, upperScope, block, isMethodDefinition) {
    ...
    */
    ...
    this.set = new _es6Map["default"]();
    /**
     * The tainted variables of this scope, as <code>{ Variable.name :
     * boolean }</code>.
     * @member {Map} Scope#taints */

    this.taints = new _es6Map["default"]();
    /**
...
function (_Scope) {
  ...
  function GlobalScope(scopeManager, block) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(GlobalScope).call(this, scopeManager, 'global', null, block, false));
    _this.implicit = {
      set: new _es6Map["default"](),
      variables: [],
...
function (_Scope2) {
  ...
  function ModuleScope(scopeManager, upperScope, block) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ModuleScope).call(this, scopeManager, 'module', upperScope, block, false));
  }
...
function (_Scope3) {
  ...
  function FunctionExpressionNameScope(scopeManager, upperScope, block) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(FunctionExpressionNameScope).call(this, scopeManager, 'function-expression-name', upperScope, block, false));
...
function (_Scope4) {
  ...
  function CatchScope(scopeManager, upperScope, block) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(CatchScope).call(this, scopeManager, 'catch', upperScope, block, false));
  }
...
function (_Scope5) {
  ...
  function WithScope(scopeManager, upperScope, block) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(WithScope).call(this, scopeManager, 'with', upperScope, block, false));
  }
...
function (_Scope6) {
  ...
  function TDZScope(scopeManager, upperScope, block) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(TDZScope).call(this, scopeManager, 'TDZ', upperScope, block, false));
  }
...
function (_Scope7) {
  ...
  function BlockScope(scopeManager, upperScope, block) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(BlockScope).call(this, scopeManager, 'block', upperScope, block, false));
  }
...
function (_Scope8) {
  ...
  function SwitchScope(scopeManager, upperScope, block) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(SwitchScope).call(this, scopeManager, 'switch', upperScope, block, false));
  }
...
function (_Scope9) {
  ...
  function FunctionScope(scopeManager, upperScope, block, isMethodDefinition) {
    ...
    _this3 = _possibleConstructorReturn(this, _getPrototypeOf(FunctionScope).call(this, scopeManager, 'function', upperScope, block, isMethodDefinition)); // section 9.2.13, FunctionDeclarationInstantiation.
...
function (_Scope10) {
  ...
  function ForScope(scopeManager, upperScope, block) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ForScope).call(this, scopeManager, 'for', upperScope, block, false));
  }
...
function (_Scope11) {
  ...
  function ClassScope(scopeManager, upperScope, block) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ClassScope).call(this, scopeManager, 'class', upperScope, block, false));
  }
