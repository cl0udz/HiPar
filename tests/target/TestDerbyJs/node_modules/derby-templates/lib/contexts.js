...
Context.prototype.addBinding = function (binding) {
  ...
  var expression = binding.template.expression; // Don't rerender in unbound sections
...
Context.prototype.child = function (expression) {
  ...
  var unbound = blockType === 'unbound' ? true : blockType === 'bound' ? false : this.unbound;
...
Context.prototype.forAttribute = function (attribute) {
  ...
  while (context) {
    ...
    if (context.view) {
      ...
      if (attributes.hasOwnProperty(attribute)) return context; // If the attribute isn't found, but the attributes inherit, continue
...
Context.prototype.get = function () {
  var value = this.expression ? this.expression.get(this) : this.controller.model.data;
