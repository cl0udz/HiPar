...
function () {
  ...
  _createClass(TextareaInput, [{
    ...
    value: function init(display) {
      ...
      (0, _event.on)(te, "input", function () {
        if (_browser.ie && _browser.ie_version >= 9 && _this.hasSelection) _this.hasSelection = null;
        input.poll();
      });
      (0, _event.on)(te, "paste", function (e) {
      ...
      (0, _event.on)(display.scroller, "paste", function (e) {
      ...
      (0, _event.on)(display.lineSpace, "selectstart", function (e) {
        if (!(0, _widgets.eventInWidget)(display, e)) (0, _event.e_preventDefault)(e);
      });
      (0, _event.on)(te, "compositionstart", function () {
      ...
      (0, _event.on)(te, "compositionend", function () {
        if (input.composing) {
          input.poll();
    ...
    key: "createField",
    value: function createField(_display) {
    ...
    value: function prepareSelection() {
      ...
      var cm = this.cm,
          display = cm.display,
          doc = cm.doc;
      var result = (0, _selection.prepareSelection)(cm); // Move the hidden textarea near the cursor to prevent scrolling artifacts

      if (cm.options.moveInputWithCursor) {
        var headPos = (0, _position_measurement.cursorCoords)(cm, doc.sel.primary().head, "div");
    ...
    key: "showSelection",
    value: function showSelection(drawn) {
      var cm = this.cm,
          display = cm.display;
    ...
    value: function slowPoll() {
      ...
      this.polling.set(this.cm.options.pollInterval, function () {
        ...
        if (_this2.cm.state.focused) _this2.slowPoll();
      });
    ...
    value: function poll() {
      ...
      (0, _operations.runInOp)(cm, function () {
        (0, _input.applyTextInput)(cm, text.slice(same), prevInput.length - same, null, _this3.composing ? "*compose" : null); // Don't leave long text in the textarea, since it makes further polling slow

        if (text.length > 1000 || text.indexOf("\n") > -1) input.value = _this3.prevInput = "";else _this3.prevInput = text;

        if (_this3.composing) {
          _this3.composing.range.clear();

          _this3.composing.range = cm.markText(_this3.composing.start, cm.getCursor("to"), {
            className: "CodeMirror-composing"
          });
        }
      });
    ...
    value: function onContextMenu(e) {
      ...
      te.style.cssText = "position: absolute; width: 30px; height: 30px;\n      top: ".concat(e.clientY - wrapperBox.top - 5, "px; left: ").concat(e.clientX - wrapperBox.left - 5, "px;\n      z-index: 1000; background: ").concat(_browser.ie ? "rgba(255, 255, 255, .05)" : "transparent", ";\n      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);");
      var oldScrollY;
