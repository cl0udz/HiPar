...
function normalizeKeyMap(keymap) {
  ...
  for (var keyname in keymap) {
    if (keymap.hasOwnProperty(keyname)) {
      ...
      var keys = (0, _misc.map)(keyname.split(" "), normalizeKeyName);
...
function isModifierKey(value) {
  var name = typeof value == "string" ? value : _keynames.keyNames[value.keyCode];
...
function addModifierNames(name, event, noShift) {
  ...
  if ((_browser.flipCtrlCmd ? event.ctrlKey : event.metaKey) && base != "Cmd") name = "Cmd-" + name;
...
function keyName(event, noShift) {
  ...
  var name = _keynames.keyNames[event.keyCode];
