...
function lookupKeyForEditor(cm, name, handle) {
  for (var i = 0; i < cm.state.keyMaps.length; i++) {
    var result = (0, _keymap.lookupKey)(name, cm.state.keyMaps[i], handle, cm);
...
function dispatchKey(cm, name, e, handle) {
  ...
  if (seq) {
    ...
    if (/\'$/.test(name)) cm.state.keySeq = null;else stopSeq.set(50, function () {
...
function handleKeyBinding(cm, e) {
  var name = (0, _keymap.keyName)(e, true);
