...
function onDrop(e) {
  ...
  var pos = (0, _position_measurement.posFromMouse)(cm, e, true),
  ...
  if (files && files.length && window.FileReader && window.File) {
    ...
    var markAsReadAndPasteIfAllFilesAreRead = function markAsReadAndPasteIfAllFilesAreRead() {
      if (++read == n) {
        (0, _operations.operation)(cm, function () {
          ...
          (0, _selection_updates.setSelectionReplaceHistory)(cm.doc, (0, _selection2.simpleSelection)(pos, (0, _change_measurement.changeEnd)(change)));
        })();
      }
    };
    ...
    try {
      var _text = e.dataTransfer.getData("Text");
      ...
      if (_text) {
        ...
        if (selected) for (var _i = 0; _i < selected.length; ++_i) {
          (0, _changes.replaceRange)(cm.doc, "", selected[_i].anchor, selected[_i].head, "drag");
        }
        cm.replaceSelection(_text, "around", "paste");
...
function onDragStart(cm, e) {
  ...
  if (e.dataTransfer.setDragImage && !_browser.safari) {
    var img = (0, _dom.elt)("img", null, null, "position: fixed; left: 0; top: 0;");
