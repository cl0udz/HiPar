...
function CodeMirror(place, options) {
  ...
  var display = this.display = new _Display.Display(place, doc, input, options);
  ...
  if (_browser.ie && _browser.ie_version < 11) setTimeout(function () {
    return _this.display.input.reset(true);
  }, 20);
  ...
  if (options.autofocus && !_browser.mobile || this.hasFocus()) setTimeout((0, _misc.bind)(_focus.onFocus, this), 20);else (0, _focus.onBlur)(this);

  for (var opt in _options.optionHandlers) {
    if (_options.optionHandlers.hasOwnProperty(opt)) _options.optionHandlers[opt](this, options[opt], _options.Init);
  }
...
function registerEventHandlers(cm) {
  ...
  if (_browser.ie && _browser.ie_version < 11) (0, _event.on)(d.scroller, "dblclick", (0, _operations.operation)(cm, function (e) {
  ...
  }));else (0, _event.on)(d.scroller, "dblclick", function (e) {
    return (0, _event.signalDOMEvent)(cm, e) || (0, _event.e_preventDefault)(e);
  }); // Some browsers fire contextmenu *after* opening the menu, at
  // which point we can't mess with it anymore. Context menu is
  // handled in onMouseDown for these browsers.

  (0, _event.on)(d.scroller, "contextmenu", function (e) {
    return (0, _mouse_events.onContextMenu)(cm, e);
  });
  (0, _event.on)(d.input.getField(), "contextmenu", function (e) {
  ...
  (0, _event.on)(d.scroller, "touchstart", function (e) {
  ...
  (0, _event.on)(d.scroller, "touchmove", function () {
    if (d.activeTouch) d.activeTouch.moved = true;
  });
  (0, _event.on)(d.scroller, "touchend", function (e) {
  ...
  (0, _event.on)(d.scroller, "scroll", function () {
  ...
  (0, _event.on)(d.scroller, "mousewheel", function (e) {
    return (0, _scroll_events.onScrollWheel)(cm, e);
  });
  (0, _event.on)(d.scroller, "DOMMouseScroll", function (e) {
    return (0, _scroll_events.onScrollWheel)(cm, e);
  }); // Prevent wrapper from ever scrolling

  (0, _event.on)(d.wrapper, "scroll", function () {
  ...
  d.dragFunctions = {
    ...
    start: function start(e) {
      return (0, _drop_events.onDragStart)(cm, e);
    },
  ...
  (0, _event.on)(inp, "keyup", function (e) {
    return _key_events.onKeyUp.call(cm, e);
  });
  ...
  (0, _event.on)(inp, "focus", function (e) {
    return (0, _focus.onFocus)(cm, e);
  });
  (0, _event.on)(inp, "blur", function (e) {
    return (0, _focus.onBlur)(cm, e);
  });
}
