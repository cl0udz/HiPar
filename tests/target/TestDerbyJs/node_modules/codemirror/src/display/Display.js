...
function Display(place, doc, input, options) {
  ...
  var lines = (0, _dom.eltP)("div", [d.lineSpace], "CodeMirror-lines"); // Moved around its parent to cover visible view.
  ...
  d.wrapper = (0, _dom.elt)("div", [d.scrollbarFiller, d.gutterFiller, d.scroller], "CodeMirror"); // Work around IE7 z-index bug (not perfect, hence IE7 not really being supported)
