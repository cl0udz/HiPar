...
function endOperation(cm) {
  var op = cm.curOp;
  if (op) (0, _operation_group.finishOperation)(op, function (group) {
...
function endOperations(group) {
  ...
  for (var _i = 0; _i < ops.length; _i++) {
    // Write DOM (maybe)
    endOperation_W1(ops[_i]);
  }

  for (var _i2 = 0; _i2 < ops.length; _i2++) {
    // Read DOM
    endOperation_R2(ops[_i2]);
  }

  for (var _i3 = 0; _i3 < ops.length; _i3++) {
    // Write DOM (maybe)
    endOperation_W2(ops[_i3]);
  }

  for (var _i4 = 0; _i4 < ops.length; _i4++) {
    // Read DOM
    endOperation_finish(ops[_i4]);
  }
}
...
function endOperation_W2(op) {
  ...
  var takeFocus = op.focus && op.focus == (0, _dom.activeElt)();
...
function endOperation_finish(op) {
  ...
  if (op.scrollToPos) {
    var rect = (0, _scrolling.scrollPosIntoView)(cm, (0, _pos.clipPos)(doc, op.scrollToPos.from), (0, _pos.clipPos)(doc, op.scrollToPos.to), op.scrollToPos.margin);
  ...
  if (hidden) for (var i = 0; i < hidden.length; ++i) {
    if (!hidden[i].lines.length) (0, _event.signal)(hidden[i], "hide");
  }
  if (unhidden) for (var _i5 = 0; _i5 < unhidden.length; ++_i5) {
    if (unhidden[_i5].lines.length) (0, _event.signal)(unhidden[_i5], "unhide");
  }
