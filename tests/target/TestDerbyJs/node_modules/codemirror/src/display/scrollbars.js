...
function measureForScrollbars(cm) {
  ...
  var docH = Math.round(cm.doc.height + (0, _position_measurement.paddingVert)(cm.display));
  return {
...
var NativeScrollbars =
/*#__PURE__*/
function () {
  function NativeScrollbars(place, scroll, cm) {
    _classCallCheck(this, NativeScrollbars);

    this.cm = cm;
    var vert = this.vert = (0, _dom.elt)("div", [(0, _dom.elt)("div", null, null, "min-width: 1px")], "CodeMirror-vscrollbar");
    var horiz = this.horiz = (0, _dom.elt)("div", [(0, _dom.elt)("div", null, null, "height: 100%; min-height: 1px")], "CodeMirror-hscrollbar");
    vert.tabIndex = horiz.tabIndex = -1;
    place(vert);
    place(horiz);
    (0, _event.on)(vert, "scroll", function () {
      if (vert.clientHeight) scroll(vert.scrollTop, "vertical");
    });
    (0, _event.on)(horiz, "scroll", function () {
  ...
  _createClass(NativeScrollbars, [{
    key: "update",
    value: function update(measure) {
    ...
    key: "setScrollLeft",
    value: function setScrollLeft(pos) {
      if (this.horiz.scrollLeft != pos) this.horiz.scrollLeft = pos;
      if (this.disableHoriz) this.enableZeroWidthBar(this.horiz, this.disableHoriz, "horiz");
    }
  }, {
    key: "setScrollTop",
    value: function setScrollTop(pos) {
      if (this.vert.scrollTop != pos) this.vert.scrollTop = pos;
      if (this.disableVert) this.enableZeroWidthBar(this.vert, this.disableVert, "vert");
    }
  }, {
    key: "zeroWidthHack",
    value: function zeroWidthHack() {
      var w = _browser.mac && !_browser.mac_geMountainLion ? "12px" : "18px";
    ...
    key: "enableZeroWidthBar",
    value: function enableZeroWidthBar(bar, delay, type) {
...
function () {
  function NullScrollbars() {
    _classCallCheck(this, NullScrollbars);
  }

  _createClass(NullScrollbars, [{
    key: "update",
...
function initScrollbars(cm) {
  ...
  cm.display.scrollbars = new scrollbarModel[cm.options.scrollbarStyle](function (node) {
    ...
    (0, _event.on)(node, "mousedown", function () {
