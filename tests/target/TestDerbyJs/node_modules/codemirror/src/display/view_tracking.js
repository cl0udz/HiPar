...
function regChange(cm, from, to, lendiff) {
  ...
  if (from >= display.viewTo) {
    ...
    // Bottom overlap
    var _cut = viewCuttingPoint(cm, from, from, -1);

    if (_cut) {
      display.view = display.view.slice(0, _cut.index);
      display.viewTo = _cut.lineN;
    } else {
      resetView(cm);
    }
  } else {
...
function regLineChange(cm, line, type) {
  ...
  var lineView = display.view[(0, _position_measurement.findViewIndex)(cm, line)];
...
function viewCuttingPoint(cm, oldN, newN, dir) {
  var index = (0, _position_measurement.findViewIndex)(cm, oldN),
      diff,
