...
var Doc = function Doc(text, mode, firstLine, lineSep, direction) {
  ...
  var start = (0, _pos.Pos)(firstLine, 0);
...
Doc.prototype = (0, _misc.createObj)(_chunk.BranchChunk.prototype, {
  ...
  getValue: function getValue(lineSep) {
    var lines = (0, _utils_line.getLines)(this, this.first, this.first + this.size);
    if (lineSep === false) return lines;
    return lines.join(lineSep || this.lineSeparator());
  },
  setValue: (0, _operations.docMethodOp)(function (code) {
    var top = (0, _pos.Pos)(this.first, 0),
  ...
  getRange: function getRange(from, to, lineSep) {
    var lines = (0, _utils_line.getBetween)(this, (0, _pos.clipPos)(this, from), (0, _pos.clipPos)(this, to));
    if (lineSep === false) return lines;
    return lines.join(lineSep || this.lineSeparator());
  },
  ...
  extendSelectionsBy: (0, _operations.docMethodOp)(function (f, options) {
    var heads = (0, _misc.map)(this.sel.ranges, f);
    (0, _selection_updates.extendSelections)(this, (0, _pos.clipPosArray)(this, heads), options);
  }),
  setSelections: (0, _operations.docMethodOp)(function (ranges, primary, options) {
    ...
    for (var i = 0; i < ranges.length; i++) {
      out[i] = new _selection.Range((0, _pos.clipPos)(this, ranges[i].anchor), (0, _pos.clipPos)(this, ranges[i].head));
    }
  ...
  getSelection: function getSelection(lineSep) {
    ...
    for (var i = 0; i < ranges.length; i++) {
      var sel = (0, _utils_line.getBetween)(this, ranges[i].from(), ranges[i].to());
  ...
  replaceSelections: (0, _operations.docMethodOp)(function (code, collapse, origin) {
    ...
    var newSel = collapse && collapse != "end" && (0, _change_measurement.computeReplacedSel)(this, changes, collapse);

    for (var _i = changes.length - 1; _i >= 0; _i--) {
      (0, _changes.makeChange)(this, changes[_i]);
    }
  ...
  historySize: function historySize() {
    ...
    for (var _i2 = 0; _i2 < hist.undone.length; _i2++) {
      if (!hist.undone[_i2].ranges) ++undone;
    }
  ...
  clearHistory: function clearHistory() {
    ...
    this.history = new _history.History(this.history.maxGeneration);
    (0, _document_data.linkedDocs)(this, function (doc) {
      return doc.history = _this.history;
    }, true);
  },
  ...
  setHistory: function setHistory(histData) {
    var hist = this.history = new _history.History(this.history.maxGeneration);
  ...
  setGutterMarker: (0, _operations.docMethodOp)(function (line, gutterID, value) {
    return (0, _changes.changeLine)(this, line, "gutter", function (line) {
  ...
  clearGutter: (0, _operations.docMethodOp)(function (gutterID) {
    ...
    this.iter(function (line) {
      if (line.gutterMarkers && line.gutterMarkers[gutterID]) {
        (0, _changes.changeLine)(_this2, line, "gutter", function () {
  ...
  addLineClass: (0, _operations.docMethodOp)(function (handle, where, cls) {
    return (0, _changes.changeLine)(this, handle, where == "gutter" ? "gutter" : "class", function (line) {
  ...
  removeLineClass: (0, _operations.docMethodOp)(function (handle, where, cls) {
    return (0, _changes.changeLine)(this, handle, where == "gutter" ? "gutter" : "class", function (line) {
      ...
      if (!cur) return false;else if (cls == null) line[prop] = null;else {
        var found = cur.match((0, _dom.classTest)(cls));
  ...
  copy: function copy(copyHistory) {
    var doc = new Doc((0, _utils_line.getLines)(this, this.first, this.first + this.size), this.modeOption, this.first, this.lineSep, this.direction);
  ...
  linkedDoc: function linkedDoc(options) {
    ...
    var copy = new Doc((0, _utils_line.getLines)(this, from, to), options.mode || this.modeOption, from, this.lineSep, this.direction);
  ...
  unlinkDoc: function unlinkDoc(other) {
    ...
    if (other.history == this.history) {
      ...
      (0, _document_data.linkedDocs)(other, function (doc) {
