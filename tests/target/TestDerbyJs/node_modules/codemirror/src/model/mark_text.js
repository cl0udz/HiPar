  ...
  _createClass(TextMarker, [{
    ...
    value: function clear() {
      ...
      for (var i = 0; i < this.lines.length; ++i) {
        ...
        var span = (0, _spans.getMarkedSpanFor)(line.markedSpans, this);
      ...
      if (cm && this.collapsed && !cm.options.lineWrapping) for (var _i = 0; _i < this.lines.length; ++_i) {
        var visual = (0, _spans.visualLine)(this.lines[_i]),
    ...
    key: "find",
    value: function find(side, lineObj) {
    ...
    value: function changed() {
      ...
      (0, _operations.runInOp)(cm, function () {
        ...
        var view = (0, _position_measurement.findViewForLine)(cm, lineN);
        ...
        if (!(0, _spans.lineIsHidden)(widget.doc, line) && widget.height != null) {
          ...
          widget.height = null;
          var dHeight = (0, _widgets.widgetHeight)(widget) - oldHeight;
          if (dHeight) (0, _utils_line.updateLineHeight)(line, line.height + dHeight);
        }

        (0, _operation_group.signalLater)(cm, "markerChanged", cm, _this);
      });
    }
  }, {
    key: "attachLine",
    value: function attachLine(line) {
    ...
    key: "detachLine",
    value: function detachLine(line) {
...
function markText(doc, from, to, options, type) {
  ...
  doc.iter(curLine, to.line + 1, function (line) {
    ...
    (0, _spans.addMarkedSpan)(line, new _spans.MarkedSpan(marker, curLine == from.line ? from.ch : null, curLine == to.line ? to.ch : null));
    ++curLine;
  ...
  if (marker.clearOnEnter) (0, _event.on)(marker, "beforeCursorEnter", function () {
    return marker.clear();
  });
  ...
  if (cm) {
    ...
    if (marker.collapsed) (0, _view_tracking.regChange)(cm, from.line, to.line + 1);else if (marker.className || marker.startStyle || marker.endStyle || marker.css || marker.attributes || marker.title) for (var i = from.line; i <= to.line; i++) {
      (0, _view_tracking.regLineChange)(cm, i, "text");
    }
...
var SharedTextMarker =
/*#__PURE__*/
function () {
  function SharedTextMarker(markers, primary) {
    _classCallCheck(this, SharedTextMarker);
...
function markTextShared(doc, from, to, options, type) {
  ...
  (0, _document_data.linkedDocs)(doc, function (doc) {
...
function findSharedMarkers(doc) {
  return doc.findMarks((0, _pos.Pos)(doc.first, 0), doc.clipPos((0, _pos.Pos)(doc.lastLine())), function (m) {
    return m.parent;
  });
}
...
function detachSharedMarkers(markers) {
  var _loop = function _loop(i) {
    ...
    (0, _document_data.linkedDocs)(marker.primary.doc, function (d) {
