...
var styleMapfile = fixtures + '/to.css.map'; // This base path is baken into the source maps in the fixtures.
...
test('\nwhen piping a bundle generated with browserify through exorcist without adjusting properties', function (t) {
  t.on('end', cleanup);
  var data = '';
  fs.createReadStream(fixtures + '/bundle.js').pipe(exorcist(scriptMapfile)).pipe(through(onread, onflush));

  function onread(d, _, cb) {
    data += d;
    cb();
  }
...
test('\nwhen piping a bundle generated with browserify through exorcist and adjusting url', function (t) {
  t.on('end', cleanup);
  var data = '';
  fs.createReadStream(fixtures + '/bundle.js').pipe(exorcist(scriptMapfile, 'http://my.awseome.site/bundle.js.map')).pipe(through(onread, onflush));
...
test('\nwhen piping a bundle generated with browserify through exorcist and adjusting root and url', function (t) {
  t.on('end', cleanup);
  var data = '';
  fs.createReadStream(fixtures + '/bundle.js').pipe(exorcist(scriptMapfile, 'http://my.awseome.site/bundle.js.map', 'http://my.awesome.site/src')).pipe(through(onread, onflush));
...
test('\nwhen piping a bundle generated with browserify through exorcist and adjusting root, url, and base', function (t) {
  t.on('end', cleanup);
  var data = '';
  fs.createReadStream(fixtures + '/bundle.js').pipe(exorcist(scriptMapfile, 'http://my.awseome.site/bundle.js.map', 'http://my.awesome.site/src', base)).pipe(through(onread, onflush));
...
test('\nwhen piping a bundle generated with browserify to a map file in a directory that does not exist', function (t) {
  ...
  fs.createReadStream(fixtures + '/bundle.js').pipe(exorcist(badPathScriptMapfile)).on('error', t.end).on('end', function () {
...
test('\nwhen piping a bundle generated with browserify and the write fails', function (t) {
  ...
  var ex = proxyquire('../', {
    fs: {
      writeFile: function writeFile(file, content, enc, callback) {
        callback(expectedErr);
      }
    }
  });
  fs.createReadStream(fixtures + '/bundle.js').pipe(ex(scriptMapfile)).on('error', function (err) {
...
test('\nwhen piping a bundle generated with browserify thats missing a map through exorcist and errorOnMissing is truthy', function (t) {
  t.on('end', cleanup);
  var data = '';
  fs.createReadStream(fixtures + '/bundle.nomap.js').pipe(exorcist(scriptMapfile, undefined, undefined, undefined, true)).on('error', onerror);
...
test('\nwhen piping a bundle generated with browserify thats missing a map through exorcist and errorOnMissing is falsey', function (t) {
  ...
  fs.createReadStream(fixtures + '/bundle.nomap.js').pipe(exorcist(scriptMapfile)).on('missing-map', function () {
    missingMapEmitted = true;
...
test('\nwhen performing a stylish exorcism', function (t) {
  t.on('end', cleanup);
  var data = '';
  fs.createReadStream(fixtures + '/to.css').pipe(exorcist(styleMapfile)).pipe(through(onread, onflush));
...
test('\nwhen piping a bundle generated with browserify with preexisting source root', function (t) {
  t.on('end', cleanup);
  fs.createReadStream(fixtures + '/bundle.withroot.js').pipe(exorcist(scriptMapfile)).pipe(through(onread, onflush));

  function onread(_, __, cb) {
    cb();
  }
...
test('\nwhen piping a bundle generated with browserify through exorcist without adjusting properties and sending source map to stream', function (t) {
  ...
  var data = '';
  var map = '';
  fs.createReadStream(fixtures + '/bundle.js').pipe(exorcist(through(onreadMap, onflushMap), 'bundle.js.map')).pipe(through(onread, onflush));
...
test('\nwhen piping a browserify bundle thru exorcist sending source map to a stream with missing required url', function (t) {
  t.on('end', cleanup);
  var exorcistStream = exorcist(through(onread)) // this is missing the URL as second argument
