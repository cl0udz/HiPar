...
(function () {
  ...
  o = function o(patternString, action, options) {
    ...
    addLocationDataFn = function addLocationDataFn(first, last) {
      if (!last) {
  ...
  grammar = {
    ...
    Statement: [o('Return'), o('Comment'), o('STATEMENT', function () {
    ...
    YieldReturn: [o('YIELD RETURN Expression', function () {
    ...
    Index: [o('INDEX_START IndexValue INDEX_END', function () {
      return $2;
    ...
    Import: [o('IMPORT String', function () {
    ...
    ImportSpecifierList: [o('ImportSpecifier', function () {
      return [$1];
    ...
    ImportSpecifier: [o('Identifier', function () {
    ...
    ImportDefaultSpecifier: [o('Identifier', function () {
      return new ImportDefaultSpecifier($1);
    })],
    ImportNamespaceSpecifier: [o('IMPORT_ALL AS Identifier', function () {
      return new ImportNamespaceSpecifier(new Literal($1), $3);
    })],
    Export: [o('EXPORT { }', function () {
    ...
    ExportSpecifierList: [o('ExportSpecifier', function () {
      return [$1];
    ...
    ExportSpecifier: [o('Identifier', function () {
    ...
    Invocation: [o('Value OptFuncExist String', function () {
    ...
    ThisProperty: [o('@ Property', function () {
    ...
    Arg: [o('Expression'), o('Splat'), o('...', function () {
      return new Expansion();
    })],
    ...
    ForValue: [o('Identifier'), o('ThisProperty'), o('Array', function () {
      return new Value($1);
    }), o('Object', function () {
      return new Value($1);
    })],
    ...
    If: [o('IfBlock'), o('IfBlock ELSE Block', function () {
      return $1.addElse($3);
