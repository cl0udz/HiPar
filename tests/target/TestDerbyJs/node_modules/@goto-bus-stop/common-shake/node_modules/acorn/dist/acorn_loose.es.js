...
exports.pluginsLoose = exports.LooseParser = void 0;

var _acorn = require("./acorn.es");
...
var LooseParser = function LooseParser(input, options) {
  ...
  this.toks = (0, _acorn.tokenizer)(input, options);
...
lp.readToken = function () {
  ...
  for (;;) {
    try {
      ...
      if (this$1.toks.type === _acorn.tokTypes.dot && this$1.input.substr(this$1.toks.end, 1) === "." && this$1.options.ecmaVersion >= 6) {
        this$1.toks.end++;
        this$1.toks.type = _acorn.tokTypes.ellipsis;
      }

      return new _acorn.Token(this$1.toks);
    } catch (e) {
      ...
      if (replace) {
        if (this$1.options.locations) {
          replace.loc = new _acorn.SourceLocation(this$1.toks, (0, _acorn.getLineInfo)(this$1.input, replace.start), (0, _acorn.getLineInfo)(this$1.input, replace.end));
        }
  ...
  switch (starttype) {
    ...
    case _acorn.tokTypes._switch:
      ...
      while (!this.closes(_acorn.tokTypes.braceR, blockIndent, line, true)) {
        if (this$1.tok.type === _acorn.tokTypes._case || this$1.tok.type === _acorn.tokTypes._default) {
          var isCase = this$1.tok.type === _acorn.tokTypes._case;
          ...
          this$1.expect(_acorn.tokTypes.colon);
        } else {
          if (!cur) {
            node.cases.push(cur = this$1.startNode());
            cur.consequent = [];
...
lp$1.parseVar = function (noIn, kind) {
  ...
  do {
    ...
    decl.init = this$1.eat(_acorn.tokTypes.eq) ? this$1.parseMaybeAssign(noIn) : null;
...
lp$1.parseClass = function (isStatement) {
  ...
  while (!this.closes(_acorn.tokTypes.braceR, indent, line)) {
    ...
    if (this$1.options.ecmaVersion >= 6) {
      method["static"] = false;
      isGenerator = this$1.eat(_acorn.tokTypes.star);
    }
    ...
    if (isDummy(method.key)) {
      ...
      this$1.eat(_acorn.tokTypes.comma);
      continue;
    }

    if (method.key.type === "Identifier" && !method.computed && method.key.name === "static" && this$1.tok.type !== _acorn.tokTypes.parenL && this$1.tok.type !== _acorn.tokTypes.braceL) {
      method["static"] = true;
      isGenerator = this$1.eat(_acorn.tokTypes.star);
      this$1.parsePropertyName(method);
    } else {
    ...
    if (!method.computed && method.key.type === "Identifier" && method.key.name === "async" && this$1.tok.type !== _acorn.tokTypes.parenL && !this$1.canInsertSemicolon()) {
      isAsync = true;
      isGenerator = this$1.options.ecmaVersion >= 9 && this$1.eat(_acorn.tokTypes.star);
      this$1.parsePropertyName(method);
    } else {
      isAsync = false;
    }

    if (this$1.options.ecmaVersion >= 5 && method.key.type === "Identifier" && !method.computed && (method.key.name === "get" || method.key.name === "set") && this$1.tok.type !== _acorn.tokTypes.parenL && this$1.tok.type !== _acorn.tokTypes.braceL) {
...
lp$1.parseImportSpecifierList = function () {
  ...
  if (this.tok.type === _acorn.tokTypes.star) {
    ...
    while (!this.closes(_acorn.tokTypes.braceR, indent + (this.curLineStart <= continuedLine ? 1 : 0), line)) {
      ...
      if (this$1.eat(_acorn.tokTypes.star)) {
...
lp$2.parseSubscripts = function (base, start, noCalls, startIndent, line) {
  ...
  for (;;) {
    if (this$1.curLineStart !== line && this$1.curIndent <= startIndent && this$1.tokenStartsLine()) {
      if (this$1.tok.type === _acorn.tokTypes.dot && this$1.curIndent === startIndent) {
        --startIndent;
      } else {
        return base;
      }
    ...
    if (this$1.eat(_acorn.tokTypes.dot)) {
    ...
    } else if (this$1.tok.type === _acorn.tokTypes.bracketL) {
      this$1.pushCx();
      this$1.next();
      ...
      this$1.popCx();
      this$1.expect(_acorn.tokTypes.bracketR);
      base = this$1.finishNode(node$1, "MemberExpression");
    } else if (!noCalls && this$1.tok.type === _acorn.tokTypes.parenL) {
      var exprList = this$1.parseExprList(_acorn.tokTypes.parenR);

      if (maybeAsyncArrow && this$1.eat(_acorn.tokTypes.arrow)) {
    ...
    } else if (this$1.tok.type === _acorn.tokTypes.backQuote) {
...
lp$2.parseTemplate = function () {
  ...
  while (!curElt.tail) {
    ...
    if (this$1.expect(_acorn.tokTypes.braceR)) {
...
lp$2.parseObj = function () {
  ...
  while (!this.closes(_acorn.tokTypes.braceR, indent, line)) {
    ...
    if (this$1.options.ecmaVersion >= 9 && this$1.eat(_acorn.tokTypes.ellipsis)) {
    ...
    if (this$1.eat(_acorn.tokTypes.colon)) {
      prop.kind = "init";
      prop.value = this$1.parseMaybeAssign();
    } else if (this$1.options.ecmaVersion >= 6 && (this$1.tok.type === _acorn.tokTypes.parenL || this$1.tok.type === _acorn.tokTypes.braceL)) {
      prop.kind = "init";
      prop.method = true;
      prop.value = this$1.parseMethod(isGenerator, isAsync);
    } else if (this$1.options.ecmaVersion >= 5 && prop.key.type === "Identifier" && !prop.computed && (prop.key.name === "get" || prop.key.name === "set") && this$1.tok.type !== _acorn.tokTypes.comma && this$1.tok.type !== _acorn.tokTypes.braceR && this$1.tok.type !== _acorn.tokTypes.eq) {
      ...
      if (this$1.options.ecmaVersion >= 6) {
        if (this$1.eat(_acorn.tokTypes.eq)) {
...
lp$2.parseExprList = function (close, allowEmpty) {
  ...
  while (!this.closes(close, indent + 1, line)) {
    if (this$1.eat(_acorn.tokTypes.comma)) {
...
_acorn.defaultOptions.tabSize = 4; // eslint-disable-next-line camelcase

function parse_dammit(input, options) {
  return new LooseParser(input, options).parse();
}

(0, _acorn.addLooseExports)(parse_dammit, LooseParser, pluginsLoose);