...
require("core-js/modules/es.regexp.to-string"); // TODO: Refactor and include derby-parsing module in derby itself
...
exports.getImportNamespace = function (namespace, attrs, importFilename) {
  ...
  var relativeNamespace = attrs.ns == null ? path.basename(attrs.src, extension) : attrs.ns;
  return namespace && relativeNamespace ? namespace + ':' + relativeNamespace : namespace || relativeNamespace || '';
};
