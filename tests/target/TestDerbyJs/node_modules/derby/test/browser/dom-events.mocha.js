...
describe('DOM events', function () {
  it('HTML element markup custom `create` event', function () {
    ...
    app.views.register('Body', '<div on-create="createDiv($element)">' + '<span on-create="createSpan($element)"></span>' + '</div>');
  ...
  it('HTML element markup custom `destroy` event', function () {
    var app = derby.createApp();
    app.views.register('Body', '<div>' + '{{unless _page.hide}}' + '<span on-destroy="destroySpan($element)"></span>' + '{{/unless}}' + '</div>');
    var page = app.createPage();
    var span;
  ...
  it('dom.on custom `destroy` event', function () {
    var app = derby.createApp();
    app.views.register('Body', '<div>' + '{{unless _page.hide}}' + '<span as="span"></span>' + '{{/unless}}' + '</div>');
    var page = app.createPage();
    var fragment = page.getFragment('Body');
    var destroyed = false;
