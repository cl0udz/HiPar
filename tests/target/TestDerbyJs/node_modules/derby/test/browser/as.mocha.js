...
describe('as', function () {
  ...
  it('HTML element `as-object` property', function () {
    var app = derby.createApp();
    app.views.register('Body', '<ul>' + '{{each _page.items}}' + '<li as-object="nested.map, this.id">{{this.text}}</li>' + '{{/each}}' + '</ul>');
    var page = app.createPage();
    ...
    page.model.unshift('_page.items', {
      id: 'd',
      text: 'D'
    });
  ...
  it('Component `as-object` property', function () {
    var app = derby.createApp();
    app.views.register('Body', '<ul>' + '{{each _page.items}}' + '<view is="item" as-object="nested.map, this.id">' + '{{this.text}}' + '</view>' + '{{/each}}' + '</ul>');
  ...
  it('HTML element `as-array` property', function () {
    var app = derby.createApp();
    app.views.register('Body', '<ul>' + '{{each _page.items}}' + '<li as-array="nested.list">{{this.text}}</li>' + '{{/each}}' + '</ul>');
    var page = app.createPage();
    page.model.set('_page.items', [{
      id: 'a',
      text: 'A'
  ...
  it('Component `as-array` property', function () {
    var app = derby.createApp();
    app.views.register('Body', '<ul>' + '{{each _page.items}}' + '<view is="item" as-array="nested.list">' + '{{this.text}}' + '</view>' + '{{/each}}' + '</ul>');
    app.views.register('item', '<li>{{@content}}</li>');
