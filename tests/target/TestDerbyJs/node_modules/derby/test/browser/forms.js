...
describe('forms', function () {
  describe('textarea', function () {
    ...
    it('updates textarea value on model set', function () {
      ...
      text.set('Yo');
      var textarea = fragment.firstChild;
      expect(textarea.value).equal('Yo'); // Note that the contained textNode.data need not be updated. Browsers
    ...
    it('updates model after changing text and emitting change', function () {
      ...
      var fragment = page.getFragment('Body');
      var textarea = fragment.firstChild;
      var textNode = textarea.firstChild; // Insert the fragment in the document so that Derby captures events
