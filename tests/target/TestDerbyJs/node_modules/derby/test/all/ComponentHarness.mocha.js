...
describe('ComponentHarness', function () {
  describe('renderHtml', function () {
    ...
    it('renders view partials', function () {
      ...
      Box.view = {
        is: 'box',
        source: '<index:>' + '<div class="box">' + '<view is="peanuts" />' + '</div>' + '<peanuts:>' + '<div class="peanuts"></div>'
      };
      var html = new ComponentHarness('<view is="box" />', Box).renderHtml().html;
    ...
    it('renders child components', function () {
      ...
      Box.view = {
        is: 'box',
        source: '<index:>' + '<div class="box">' + '<view is="clown" />' + '</div>'
      };
      ...
      Clown.view = {
        is: 'clown',
        source: '<index:>' + '<div class="clown"></div>'
      };
    ...
    it('creates child component instances', function () {
      ...
      Box.view = {
        is: 'box',
        source: '<index:>' + '<div class="box">' + '<view on-init="initClown()" is="clown" />' + '</div>'
      };
  ...
  describe('dependencies', function () {
    ...
    it('can specify custom name for a dependency', function () {
      ...
      Box.view = {
        is: 'box',
        source: '<index:>' + '<div class="box">' + '<view is="my-precious" />' + '</div>',
        dependencies: [['my-precious', Clown]]
      };
      var html = new ComponentHarness('<view is="box" />', Box).renderHtml().html;
      expect(html).equal('<div class="box"><div class="clown"></div></div>');
    });
    ...
    it('supports view serializing', function () {
      ...
      Clown.view = {
        is: 'clown',
        source: '<index:>' + '<div class="{{getClass()}}"></div>'
      };
      ...
      Box.view = {
        is: 'box',
        source: '<index:>' + '<div class="{{getClass()}}">' + '<view is="clown" />' + '</div>',
        dependencies: [Clown]
      };
      ...
      var harness = new ComponentHarness('<view is="box" />', Box); // Serialize returns JavaScript source code that is written to and
      // required from a file. We simulate that by evaling the source

      var serializedSource = harness.app.views.serialize();
      var serialized = new Function('return ' + serializedSource)(); // This is similar to what would happen in the browser. Derby would inject
    ...
    it('gets overridden without error', function () {
      ...
      var html = new ComponentHarness('<view is="box" />', Box, ConflictingClown).renderHtml().html;
      expect(html).equal('<div class="box"></div>');
    });
    it('allows two components to share a dependency', function () {
      ...
      Car.view = {
        is: 'car',
        source: '<index:>' + '<div class="car">' + '<view is="clown" />' + '</div>',
        dependencies: [Clown]
      };
      var html = new ComponentHarness('<view is="box" /><view is="car" />', Box, Car).renderHtml().html;
      expect(html).equal('<div class="box"><div class="clown"></div></div>' + '<div class="car"><div class="clown"></div></div>');
    });
    it('handles circular dependencies', function () {
      ...
      Clown.view = {
        is: 'clown',
        source: '<index:>' + '<div class="clown"></div>' + '<view is="box" clownless />',
        dependencies: [Box]
      };
      ...
      Box.view = {
        is: 'box',
        source: '<index:>' + '<div class="box">' + '{{unless clownless}}<view is="clown" />{{/unless}}' + '</div>',
        dependencies: [Clown]
      };
      var html = new ComponentHarness('<view is="box" />', Box).renderHtml().html;
    ...
    it('overrides component dependency with custom mock', function () {
      ...
      ClownMock.view = {
        is: 'clown',
        source: '<index:>' + '<div class="clown mock"></div>'
      };
  ...
  describe('stub', function () {
    it('defines empty views by name', function () {
      ...
      Box.view = {
        is: 'box',
        source: '<index:>' + '<div class="box">' + '<view is="clown" />' + '<view is="ball" />' + '<view is="puppy" />' + '</div>'
      };
      var html = new ComponentHarness('<view is="box" />', Box).stub('clown', 'ball', 'puppy').renderHtml().html;
      expect(html).equal('<div class="box"></div>');
    });
    it('defines source of view when provided', function () {
      ...
      var html = new ComponentHarness('<view is="box" />', Box).stub('clown', {
        is: 'ball',
        source: '<span class="ball"></span>'
      }, 'puppy').renderHtml().html;
    ...
    it('overrides a component dependency with an empty view', function () {
      ...
      var html = new ComponentHarness('<view is="box" />', Box).stub('clown').renderHtml().html;
      expect(html).equal('<div class="box"></div>');
    });
  });
  describe('stubComponent', function () {
    it('defines an empty view and creates a property on page by name', function () {
      ...
      Box.view = {
        is: 'box',
        source: '<index:>' + '<div class="box">' + '<view is="clown" expression="happy" />' + '<view is="ball" type="bouncy" />' + '</div>'
      };
      var page = new ComponentHarness('<view is="box" />', Box).stubComponent('clown', 'ball').renderHtml();
    ...
    it('supports `as` option', function () {
      ...
      Box.view = {
        is: 'box',
        source: '<index:>' + '<div class="box">' + '<view is="clown" expression="happy" />' + '</div>'
      };
      var page = new ComponentHarness('<view is="box" />', Box).stubComponent({
        is: 'clown',
        as: 'myClown'
      }).renderHtml();
      expect(page.html).equal('<div class="box"></div>');
    ...
    it('supports `asArray` option', function () {
      ...
      Box.view = {
        is: 'box',
        source: '<index:>' + '<div class="box">' + '<view is="clown" expression="happy" />' + '<view is="clown" expression="sad" />' + '</div>'
      };
      var page = new ComponentHarness('<view is="box" />', Box).stubComponent({
        is: 'clown',
        asArray: 'clowns'
