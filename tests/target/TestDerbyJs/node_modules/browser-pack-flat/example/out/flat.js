...
(function () {
  ...
  var _$events_10 = [// attribute events (can be set with attributes)
  ...
  var TEXT_NODE = 3;
  var COMMENT_NODE = 8;
  var _$morph_11 = morph; // diff elements and apply the resulting patch to the old node
  // (obj, obj) -> null
  ...
  ;
  var __TEXT_NODE_9 = 3; // var DEBUG = false

  var _$nanomorph_9 = nanomorph; // Morph one tree into another tree
  //
  // no parent
  ...
  function nanomorph(oldTree, newTree) {
    ...
    // )
    // }
    _$assert_3.equal(_typeof(oldTree), 'object', 'nanomorph: oldTree should be an object');

    _$assert_3.equal(_typeof(newTree), 'object', 'nanomorph: newTree should be an object');

    var tree = walk(newTree, oldTree); // if (DEBUG) console.log('=> morphed\n  %s', tree.outerHTML)
  ...
  var _$hyperx_2 = function _$hyperx_2(h, opts) {
    if (!opts) opts = {};
  ...
  var _$svgTags_8 = ['svg', 'altGlyph', 'altGlyphDef', 'altGlyphItem', 'animate', 'animateColor', 'animateMotion', 'animateTransform', 'circle', 'clipPath', 'color-profile', 'cursor', 'defs', 'desc', 'ellipse', 'feBlend', 'feColorMatrix', 'feComponentTransfer', 'feComposite', 'feConvolveMatrix', 'feDiffuseLighting', 'feDisplacementMap', 'feDistantLight', 'feFlood', 'feFuncA', 'feFuncB', 'feFuncG', 'feFuncR', 'feGaussianBlur', 'feImage', 'feMerge', 'feMergeNode', 'feMorphology', 'feOffset', 'fePointLight', 'feSpecularLighting', 'feSpotLight', 'feTile', 'feTurbulence', 'filter', 'font', 'font-face', 'font-face-format', 'font-face-name', 'font-face-src', 'font-face-uri', 'foreignObject', 'g', 'glyph', 'glyphRef', 'hkern', 'image', 'line', 'linearGradient', 'marker', 'mask', 'metadata', 'missing-glyph', 'mpath', 'path', 'pattern', 'polygon', 'polyline', 'radialGradient', 'rect', 'set', 'stop', 'switch', 'symbol', 'text', 'textPath', 'title', 'tref', 'tspan', 'use', 'view', 'vkern'];
  var _$boolProps_5 = ['autofocus', 'checked', 'defaultchecked', 'disabled', 'formnovalidate', 'indeterminate', 'readonly', 'required', 'selected', 'willvalidate'];
  var _$directProps_7 = ['indeterminate'];
  var _$browser_6 = {};
  ...
  _$browser_6 = _$hyperx_2(nanoHtmlCreateElement, {
    comments: true
  });
  ...
  var _$render_13 = function render(props) {
    return _$browser_6(_templateObject(), props.counter, onclick);
