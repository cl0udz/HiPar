...
describe('Hmac', function () {
  describe('mixed test vector', function () {
    ...
    test({
      name: 'nist 4',
      key: '00' + '01020304 05060708 090A0B0C 0D0E0F10 11121314 15161718' + '191A1B1C 1D1E1F20 21222324 25262728 292A2B2C 2D2E2F30',
    ...
    function test(opt) {
      it('should not fail at ' + opt.name, function () {
        ...
        assert.equal(h.update(opt.msg.slice(0, 10), opt.msgEnc).update(opt.msg.slice(10), opt.msgEnc).digest('hex'), opt.res);
      });
    }
  });
});