...
var array = new Array(10).fill(0).map(function (_, i) {
  return i;
});
var obj = {
  foo: array
...
var circGetters = JSON.parse(JSON.stringify(obj));
...
var deepCircGetters = JSON.parse(JSON.stringify(deep));
...
var deepCircNonCongifurableGetters = JSON.parse(JSON.stringify(deep));
Object.defineProperty(deepCircNonCongifurableGetters.deep.deep.deep, 'circ', {
  get: function get() {
    return deepCircNonCongifurableGetters;
  },
  enumerable: true,
  configurable: false
});
