...
function () {
  ...
  _createClass(FsEventsHandler, [{
    ...
    key: "checkFd",
    value: function checkFd(path, fullPath, realPath, parent, watchedDir, item, info, opts) {
      var fd;
      return regeneratorRuntime.async(function checkFd$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return regeneratorRuntime.awrap(open(path, FS_MODE_READ));
