...
function () {
  ...
  _createClass(NodeFsHandler, [{
    ...
    value: function _handleFile(file, stats, initialAdd) {
      ...
      var closer = this._watchWithNodeFs(file, function _callee2(path, newStats) {
        ...
        return regeneratorRuntime.async(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 15:
                _context2.prev = 15;
                _context2.t0 = _context2["catch"](3); // Fix issues where mtime is null but file is still present
    ...
    value: function _handleRead(directory, initialAdd, wh, target, dir, depth, throttler) {
      var _this2 = this; // Normalize the directory name on Windows
      ...
      var stream = this.fsw._readdirp(directory, {
        ...
        depth: 0
      }).on(STR_DATA, function _callee3(entry) {
        var item, path;
