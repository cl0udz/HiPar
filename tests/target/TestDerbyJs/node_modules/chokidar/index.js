...
function (_EventEmitter) {
  _inherits(FSWatcher, _EventEmitter); // Not indenting methods for history sake; for now.
  ...
  _createClass(FSWatcher, [{
    ...
    */
    ...
    value: function close() {
      ...
      return closers.length ? Promise.all(closers).then(function () {
        return undefined;
      }) : Promise.resolve();
    }
    /**
    ...
    */
    ...
    value: function _remove(directory, item) {
      var _this10 = this; // if what is being deleted is a directory, get that directory's paths
