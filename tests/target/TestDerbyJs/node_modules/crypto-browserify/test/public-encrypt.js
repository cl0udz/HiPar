...
test('publicEncrypt/privateDecrypt', function (t) {
  t.test('can decrypt', function (t) {
    t.plan(2); // note encryption is ranomized so can't test to see if they encrypt the same
  ...
  t.test('can round trip', function (t) {
    t.plan(2);
    var msg = 'this is a message'; // note encryption is ranomized so can't test to see if they encrypt the same
