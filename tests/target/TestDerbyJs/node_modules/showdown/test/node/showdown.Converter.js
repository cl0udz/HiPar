...
describe('showdown.Converter', function () {
  ...
  describe('metadata methods', function () {
    ...
    it('_setMetadataPair() should set foo to bar', function () {
      ...
      converter.getMetadata().should.eql({
        foo: 'bar'
      });
    });
  ...
  describe('events', function () {
    var events = ['anchors', 'autoLinks', 'blockGamut', 'blockQuotes', 'codeBlocks', 'codeSpans', 'githubCodeBlocks', 'headers', 'images', 'italicsAndBold', 'lists', 'paragraph', 'spanGamut' //'strikeThrough',
    //'tables'
    ];
