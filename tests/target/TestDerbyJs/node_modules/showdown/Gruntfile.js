...
module.exports = function (grunt) {
  ...
  var config = {
    ...
    concat: {
      ...
      dist: {
        src: ['src/options.js', 'src/showdown.js', 'src/helpers.js', 'src/converter.js', 'src/subParsers/*.js', 'src/subParsers/makeMarkdown/*.js', 'src/loader.js'],
  ...
  grunt.registerTask('prep-release', ['build', 'generate-changelog']); // Default task(s).
