...
(function () {
  ...
  function r(e, r) {
    ...
    for (var s = 0; s < e.length; ++s) {
      var o = t + " sub-extension " + s + ": ",
          i = e[s];
      if ("object" != _typeof(i)) return n.valid = !1, n.error = o + "must be an object, but " + _typeof(i) + " given", n;
      if (!a.helper.isString(i.type)) return n.valid = !1, n.error = o + 'property "type" must be a string, but ' + _typeof(i.type) + " given", n;
      ...
      if (i.listeners) {
        if ("object" != _typeof(i.listeners)) return n.valid = !1, n.error = o + '"listeners" property must be an object but ' + _typeof(i.listeners) + " given", n;
      ...
      if (i.filter) {
        ...
        if (a.helper.isString(i.regex) && (i.regex = new RegExp(i.regex, "g")), !(i.regex instanceof RegExp)) return n.valid = !1, n.error = o + '"regex" property must either be a string or a RegExp object, but ' + _typeof(i.regex) + " given", n;
  ...
  a.helper = {}, a.extensions = {}, a.setOption = function (e, r) {
    ...
    if ("function" == typeof e.forEach) e.forEach(r);else if (a.helper.isArray(e)) for (var t = 0; t < e.length; t++) {
      r(e[t], t, e);
    } else {
      if ("object" != _typeof(e)) throw new Error("obj does not seem to be an array or an iterable object");
  ...
  a.helper.matchRecursiveRegExp = function (e, r, t, a) {
    ...
    function t(e, t) {
      ...
      for (var i = 0; i < e.length; ++i) {
        ...
        if (e[i].hasOwnProperty("listeners")) for (var l in e[i].listeners) {
    ...
    function n(e, r) {
      if (!a.helper.isString(e)) throw Error("Invalid argument in converter.listen() method: name must be a string, but " + _typeof(e) + " given");
      if ("function" != typeof r) throw Error("Invalid argument in converter.listen() method: callback must be a function, but " + _typeof(r) + " given");
    ...
    !function () {
      ...
      if ("object" != _typeof(e)) throw Error("Converter expects the passed parameter to be an object, but " + _typeof(e) + " was passed instead.");
      ...
      for (var o = n.childNodes, i = "", l = 0; l < o.length; l++) {
    ...
    var n = function n(e, _n, s, o, i, l, c) {
      ...
      return "" !== c && null !== c && (u += ' title="' + (c = (c = c.replace(/"/g, "&quot;")).replace(a.helper.regexes.asteriskDashAndColon, a.helper.escapeCharactersCallback)) + '"'), r.openLinksInNewWindow && !/^#/.test(o) && (u += ' rel="noopener noreferrer" target="¨E95Eblank"'), u += ">" + _n + "</a>";
    };
  ...
  a.subParser("autoLinks", function (e, r, t) {
    ...
    var n = function n(e, _n2, s, o, i, l, c) {
      return _n2 = _n2.toLowerCase(), s.match(/^data:.+?\/.+?;base64,/) ? t.gUrls[_n2] = s.replace(/\s/g, "") : t.gUrls[_n2] = a.subParser("encodeAmpsAndAngles")(s, r, t), l ? l + c : (c && (t.gTitles[_n2] = c.replace(/"|'/g, "&quot;")), r.parseImgDimensions && o && i && (t.gDimensions[_n2] = {
        width: o,
        height: i
      }), "");
    };
    ...
    function i(e) {
      ...
      for (l.shift(), l.shift(), i = 0; i < l.length; ++i) {
