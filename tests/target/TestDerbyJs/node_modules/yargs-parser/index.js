...
function parse(args, opts) {
  ...
  if (configuration['strip-aliased']) {
    ...
    (_ref = []).concat.apply(_ref, _toConsumableArray(Object.keys(aliases).map(function (k) {
      return aliases[k];
  ...
  function hasAnyFlag(key) {
    ...
    var toCheck = (_ref2 = []).concat.apply(_ref2, _toConsumableArray(Object.keys(flags).map(function (k) {
      return flags[k];
    })));
  ...
  function hasFlagsMatching(arg) {
    ...
    var toCheck = (_ref3 = []).concat.apply(_ref3, patterns);
