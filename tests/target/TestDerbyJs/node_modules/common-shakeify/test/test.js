...
function runTest(t, name) {
  ...
  var bundle = browserify({
    entries: entry
  }).plugin(commonShake, options).bundle().on('error', t.fail); // Write actual output to a file for easier inspection

  bundle.pipe(fs.createWriteStream(actual));
  bundle.pipe(concat(function (result) {
    t.is(result.toString('utf8').replace(/\r\n/g, '\n'), fs.readFileSync(expected, 'utf8').replace(/\r\n/g, '\n'), name);
    t.end();
  }));
}
...
test('source maps', function (t) {
  ...
  var bundle = b.bundle();
  bundle.on('error', t.fail); // Write actual output to a file for easier inspection

  bundle.pipe(fs.createWriteStream(path.join(__dirname, 'source-map/actual.js')));
  bundle.pipe(concat(function (result) {
    t.is(result.toString('utf8'), fs.readFileSync(path.join(__dirname, 'source-map/expected.js'), 'utf8'), 'source maps');
    t.end();
  }));
});
test('dash-r', function (t) {
  ...
  b.require(path.join(__dirname, 'dash-r/expose.js'), {
    expose: 'whatever'
  });
  ...
  bundle.pipe(fs.createWriteStream(path.join(__dirname, 'dash-r/actual.js')));
  bundle.pipe(concat(function (result) {
    t.is(result.toString('utf8'), fs.readFileSync(path.join(__dirname, 'dash-r/expected.js'), 'utf8'), 'dash-r');
    t.end();
  }));
});
test('dash-r node_modules', function (t) {
  ...
  var bundle = b.bundle();
  bundle.on('error', t.fail);
  bundle.pipe(fs.createWriteStream(path.join(__dirname, 'dash-r-node-modules/actual.js')));
  bundle.pipe(concat(function (result) {
    t.is(result.toString('utf8'), fs.readFileSync(path.join(__dirname, 'dash-r-node-modules/expected.js'), 'utf8'), 'dash-r');
    t.end();
  }));
}); // TODO fix this one

test('dash-r node_modules with full paths', {
  skip: true
}, function (t) {
  var b = browserify({
    fullPaths: true,
  ...
  var bundle = b.bundle();
  bundle.on('error', t.fail);
  bundle.pipe(fs.createWriteStream(path.join(__dirname, 'dash-r-node-modules/actual-fullpaths.js')));
  bundle.pipe(concat(function (result) {
    t.is(result.toString('utf8'), fs.readFileSync(path.join(__dirname, 'dash-r-node-modules/expected-fullpaths.js'), 'utf8'), 'dash-r');
    t.end();
  }));
});