...
var resolveReadPreference = require('./utils').resolveReadPreference; // Operations


var bulkWrite = require('./operations/collection_ops').bulkWrite;

var checkForAtomicOperators = require('./operations/collection_ops').checkForAtomicOperators;

var count = require('./operations/collection_ops').count;

var countDocuments = require('./operations/collection_ops').countDocuments;

var createIndex = require('./operations/collection_ops').createIndex;

var createIndexes = require('./operations/collection_ops').createIndexes;

var deleteMany = require('./operations/collection_ops').deleteMany;

var deleteOne = require('./operations/collection_ops').deleteOne;

var distinct = require('./operations/collection_ops').distinct;

var dropIndex = require('./operations/collection_ops').dropIndex;

var dropIndexes = require('./operations/collection_ops').dropIndexes;

var ensureIndex = require('./operations/collection_ops').ensureIndex;

var findAndModify = require('./operations/collection_ops').findAndModify;

var findAndRemove = require('./operations/collection_ops').findAndRemove;

var findOne = require('./operations/collection_ops').findOne;

var findOneAndDelete = require('./operations/collection_ops').findOneAndDelete;

var findOneAndReplace = require('./operations/collection_ops').findOneAndReplace;

var findOneAndUpdate = require('./operations/collection_ops').findOneAndUpdate;

var geoHaystackSearch = require('./operations/collection_ops').geoHaystackSearch;

var group = require('./operations/collection_ops').group;

var indexes = require('./operations/collection_ops').indexes;

var indexExists = require('./operations/collection_ops').indexExists;

var indexInformation = require('./operations/collection_ops').indexInformation;

var insertOne = require('./operations/collection_ops').insertOne;

var isCapped = require('./operations/collection_ops').isCapped;

var mapReduce = require('./operations/collection_ops').mapReduce;

var optionsOp = require('./operations/collection_ops').optionsOp;

var parallelCollectionScan = require('./operations/collection_ops').parallelCollectionScan;

var prepareDocs = require('./operations/collection_ops').prepareDocs;

var reIndex = require('./operations/collection_ops').reIndex;

var removeDocuments = require('./operations/collection_ops').removeDocuments;

var rename = require('./operations/collection_ops').rename;

var replaceOne = require('./operations/collection_ops').replaceOne;

var save = require('./operations/collection_ops').save;

var stats = require('./operations/collection_ops').stats;

var updateDocuments = require('./operations/collection_ops').updateDocuments;

var updateMany = require('./operations/collection_ops').updateMany;

var updateOne = require('./operations/collection_ops').updateOne;
/**
...
function Collection(db, topology, dbName, name, pkFactory, options) {
  ...
  var namespace = "".concat(dbName, ".").concat(name); // Get the promiseLibrary

  var promiseLibrary = options.promiseLibrary || Promise; // Assign the right collection level readPreference
...
Collection.prototype.find = deprecateOptions({
  ...
  var cursor = this.s.topology.cursor(this.s.namespace, findCommand, newOptions);
...
Collection.prototype.insertOne = function (doc, options, callback) {
  ...
  options = options || {}; // Add ignoreUndfined
...
Collection.prototype.insertMany = function (docs, options, callback) {
  ...
  docs = prepareDocs(this, docs, options); // Generate the bulk write operations
  ...
  return executeOperation(this.s.topology, bulkWrite, [this, operations, options, callback], {
    resultMutator: function resultMutator(result) {
      return mapInsertManyResults(docs, result);
    }
  });
};
/**
...
Collection.prototype.updateOne = function (filter, update, options, callback) {
  ...
  options = Object.assign({}, options); // Add ignoreUndfined
...
Collection.prototype.listIndexes = function (options) {
  ...
  var ns = "".concat(this.s.dbName, ".system.indexes"); // Get the query
...
Collection.prototype.findOneAndReplace = function (filter, replacement, options, callback) {
  ...
  if (filter == null || _typeof(filter) !== 'object') throw toError('filter parameter must be an object');
  if (replacement == null || _typeof(replacement) !== 'object') throw toError('replacement parameter must be an object');
...
Collection.prototype.aggregate = function (pipeline, options, callback) {
  ...
  if (pipeline.length > 0 && pipeline[pipeline.length - 1]['$out'] && this.s.topology.capabilities().commandsTakeWriteConcern) {
    applyWriteConcern(command, {
      db: this.s.db,
      collection: this
    }, options);
  ...
  if (typeof options.maxTimeMS === 'number') command.maxTimeMS = options.maxTimeMS; // If we are giving a hint
