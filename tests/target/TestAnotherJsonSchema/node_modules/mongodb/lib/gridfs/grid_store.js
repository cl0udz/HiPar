...
GridStore.prototype.puts = function (string, options, callback) {
  ...
  return executeOperation(this.db.s.topology, this.write.bind(this), [finalString, options, callback], {
    skipSessions: true
  });
};
/**
...
GridStore.prototype.seek = function (position, seekLocation, options, callback) {
  ...
  options = args.length ? args.shift() : {};
  return executeOperation(this.db.s.topology, seek, [this, position, seekLocation, options, callback], {
    skipSessions: true
  });
};
...
GridStore.exist = function (db, fileIdObject, rootCollection, options, callback) {
  ...
  options = args.length ? args.shift() : {};
  options = options || {};
  return executeOperation(db.s.topology, exists, [db, fileIdObject, rootCollection, options, callback], {
    skipSessions: true
  });
};
