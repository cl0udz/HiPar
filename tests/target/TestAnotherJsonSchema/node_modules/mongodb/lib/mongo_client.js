...
var MongoError = require('mongodb-core').MongoError; // Operations


var connectOp = require('./operations/mongo_client_ops').connectOp;

var logout = require('./operations/mongo_client_ops').logout;

var validOptions = require('./operations/mongo_client_ops').validOptions;
/**
...
MongoClient.prototype.close = function (force, callback) {
  if (typeof force === 'function') callback = force, force = false; // Close the topology connection
  ...
  this.emit('close', this); // Fire close event on any cached db instances
  ...
  this.removeAllListeners('close'); // Callback after next event loop tick
