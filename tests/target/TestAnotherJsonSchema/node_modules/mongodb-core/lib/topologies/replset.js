...
var ReplSet = function ReplSet(seedlist, options) {
  ...
  this.authProviders = options.authProviders || defaultAuthProviders(this.s.bson); // Add forwarding of events from state handler
...
ReplSet.prototype.command = function (ns, cmd, options, callback) {
  ...
  var cb = function cb(err, result) {
    ...
    if (_this2.s.replicaSetState.primary) {
      _this2.s.replicaSetState.remove(_this2.s.replicaSetState.primary, {
        force: true
      });
    }
