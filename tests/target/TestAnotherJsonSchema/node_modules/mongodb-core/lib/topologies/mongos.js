...
var BasicCursor = require('../cursor');
...
var Mongos = function Mongos(seedlist, options) {
  ...
  this.authProviders = options.authProviders || defaultAuthProviders(this.s.bson); // Disconnected state
...
Mongos.prototype.connect = function (options) {
  ...
  var servers = this.s.seedlist.map(function (x) {
    var server = new Server(Object.assign({}, self.s.options, x, {
...
function applyAuthenticationContexts(self, server, callback) {
  ...
  function applyAuth(authContexts, server, callback) {
    ...
    customAuthContext.push(function ()
    /* err */
    {
...
Mongos.prototype.destroy = function (options) {
  ...
  proxies.forEach(function (server) {
    ...
    destroyServer(server, options); // Move to list of disconnectedProxies
...
var executeWriteOperation = function executeWriteOperation(self, op, ns, ops, options, callback) {
  ...
  server[op](ns, ops, options, function (err, result) {
    ...
    server = pickProxy(self); // No server found error out with original error
...
Mongos.prototype.command = function (ns, cmd, options, callback) {
  ...
  var cb = function cb(err, result) {
    ...
    if (willRetryWrite) {
      ...
      return _this2.command(ns, cmd, newOptions, callback);
    }
