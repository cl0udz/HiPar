...
GSSAPI.prototype.auth = function (server, connections, db, username, password, options, callback) {
  ...
  var gssapiServiceName = options['gssapiservicename'] || options['gssapiServiceName'] || 'mongodb'; // Total connections
  ...
  while (connections.length > 0) {
    ...
    var execute = function execute(connection) {
      ...
      GSSAPIInitialize(self, kerberos.processes.MongoAuthProcess, db, username, password, db, gssapiServiceName, server, connection, options, function (err, r) {
        // Adjust count
...
var GSSAPIInitialize = function GSSAPIInitialize(self, MongoAuthProcess, db, username, password, authdb, gssapiServiceName, server, connection, options, callback) {
