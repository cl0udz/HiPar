...
function _require(path, parent, orig) {
  var resolved = _require.resolve(path); // lookup failed
  ...
  var module = _require.modules[resolved]; // perform real require()
...
_require.relative = function (parent) {
  ...
  localRequire.resolve = function (path) {
    ...
    if ('.' == c) return _require.normalize(p, path); // resolve deps by returning
...
_require.register("isarray/index.js", function (exports, require, module) {
  module.exports = Array.isArray || function (arr) {
    return Object.prototype.toString.call(arr) == '[object Array]';
  };
});

_require.alias("isarray/index.js", "isarray/index.js");