...
function findGlobals(source) {
  ...
  if (!(ast && _typeof(ast) === 'object' && ast.type === 'Program')) {
  ...
  function identifier(node, parents) {
    ...
    if (parents[parents.length - 2] && parents[parents.length - 2].type === 'TryStatement' && parents[parents.length - 2].handler && node === parents[parents.length - 2].handler.param) {
      return;
    }
