...
module.exports.isValid = function isValid(v) {
  return shorthandParser(v, shorthand_for) !== undefined || valueType(v) === TYPES.KEYWORD && static_fonts.indexOf(v.toLowerCase()) !== -1;
};

var setter = shorthandSetter('font', shorthand_for);
module.exports.definition = {
  set: function set(v) {
    var _short = shorthandParser(v, shorthand_for);
