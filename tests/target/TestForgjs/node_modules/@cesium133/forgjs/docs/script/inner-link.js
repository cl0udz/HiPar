...
require("core-js/modules/web.timers.js"); // inner link(#foo) can not correctly scroll, because page has fixed header,
...
(function () {
  ...
  function adjust() {
    ...
    if (el) el.classList.remove('inner-link-active'); // ``[ ] . ' " @`` are not valid in DOM id. so must escape these.
