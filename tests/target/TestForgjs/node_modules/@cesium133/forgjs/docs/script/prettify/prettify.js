  ...
  */
  ...
  (function () {
    function T(a) {
      ...
      function b(e) {
        ...
        for (a = 0; a < b.length; ++a) {
          h = b[a], c.push(f(h[0])), h[1] > h[0] && (h[1] + 1 > h[0] && c.push("-"), c.push(f(h[1])));
        }
      ...
      function v(e) {
        ...
        for (h = g = 0; g < c; ++g) {
          k = a[g], "(" === k ? (++h, d[h] || (a[g] = "(?:")) : "\\" === k.charAt(0) && (k = +k.substring(1)) && k <= h && (a[g] = "\\" + d[k]);
        }
        ...
        if (e.ignoreCase && n) for (g = 0; g < c; ++g) {
          k = a[g], e = k.charAt(0), 2 <= k.length && "[" === e ? a[g] = b(k) : "\\" !== e && (a[g] = k.replace(/[a-zA-Z]/g, function (a) {
            a = a.charCodeAt(0);
    ...
    function L(a, d, f) {
      function b(a) {
        ...
        if (1 == c && !A.test(a.className)) {
          if ("br" === a.nodeName) v(a), a.parentNode && a.parentNode.removeChild(a);else for (a = a.firstChild; a; a = a.nextSibling) {
            b(a);
          }
        } else if ((3 == c || 4 == c) && f) {
          var d = a.nodeValue,
              q = d.match(n);
          q && (c = d.substring(0, q.index), a.nodeValue = c, (d = d.substring(q.index + q[0].length)) && a.parentNode.insertBefore(l.createTextNode(d), a.nextSibling), v(a), c || a.parentNode.removeChild(a));
        }
      }
      ...
      for (var p = 0, r = c.length; p < r; ++p) {
        m = c[p], m.className = "L" + (p + d) % 10, m.firstChild || m.appendChild(l.createTextNode("\xA0")), w.appendChild(m);
      }
    ...
    var E = window,
        ...
        F = [[C, "auto,case,char,const,default,double,enum,extern,float,goto,inline,int,long,register,restrict,short,signed,sizeof,static,struct,switch,typedef,union,unsigned,void,volatile"], "catch,class,delete,false,import,new,operator,private,protected,public,this,throw,true,try,typeof"],
          ...
          for (var b = E.PR_SHOULD_USE_CONTINUATION ? c.now() + 250 : Infinity; p < t.length && c.now() < b; p++) {
            ...
            if ((l !== g || r.test(m)) && !e.test(m)) {
              ...
              if (!n) {
                ...
                if (y.test(d.tagName)) u = 1;else var u = d.currentStyle,
                    x = v.defaultView,
