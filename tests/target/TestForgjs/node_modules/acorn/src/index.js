...
var _whitespace = require("./whitespace"); // Acorn is a tiny, fast JavaScript parser written in JavaScript.
//
...
var version = "2.7.0"; // The main exported interface (under `self.acorn` when in the
