...
(function (f) {
  ...
  return function e(t, n, r) {
      ...
      pp.parseExprAtom = function (refDestructuringErrors) {
        ...
        switch (this.type) {
          ...
          case _tokentype.types.bracketL:
            node = this.startNode();
            this.next(); // check whether this is array comprehension or regular array
    ...
    3: [function (_dereq_, module, exports) {
      ...
      var version = "2.7.0";
      exports.version = version; // The main exported interface (under `self.acorn` when in the
    ...
    5: [function (_dereq_, module, exports) {
      ...
      var _whitespace = _dereq_("./whitespace"); // These are used when `options.locations` is on, for the
    ...
    8: [function (_dereq_, module, exports) {
      ...
      var _locutil = _dereq_("./locutil"); // A second optional argument can be given to further configure
    ...
    10: [function (_dereq_, module, exports) {
      ...
      var _options = _dereq_("./options"); // Registered plugins
    ...
    11: [function (_dereq_, module, exports) {
      ...
      pp.parseStatement = function (declaration, topLevel) {
        var starttype = this.type,
            node = this.startNode(); // Most types of statements are recognized by the keyword they
    ...
    13: [function (_dereq_, module, exports) {
      ...
      exports.Token = Token;
      var pp = _state.Parser.prototype; // Are we running under Rhino?
      ...
      pp.readRegexp = function () {
        ...
        if (!isRhino) {
          tryCreateRegexp(tmp, undefined, start, this); // Get a regular expression object for this pattern-flag pair, or `null` in
    ...
    14: [function (_dereq_, module, exports) {
      ...
      var keywords = {};
      exports.keywords = keywords; // Succinct definitions of keyword token types
