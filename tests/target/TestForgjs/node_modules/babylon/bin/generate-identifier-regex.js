"use strict"; // Which Unicode version should be used?
...
var start = require("unicode-" + version + "/Binary_Property/ID_Start/code-points.js").filter(function (ch) {
  return ch > 0x7f;
});

var last = -1;
var cont = [0x200c, 0x200d].concat(require("unicode-" + version + "/Binary_Property/ID_Continue/code-points.js").filter(function (ch) {
