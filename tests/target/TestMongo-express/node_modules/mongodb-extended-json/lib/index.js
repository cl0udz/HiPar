...
module.exports.reviver = require('./reviver'); // Backwards compat for 1.x

module.exports.deflate = deprecate(deserialize, 'mongodb-extended-json#deflate: Use deserialize(obj) instead');
module.exports.inflate = deprecate(serialize, 'mongodb-extended-json#inflate: Use serialize(obj) instead'); // JSONStream.stringify
