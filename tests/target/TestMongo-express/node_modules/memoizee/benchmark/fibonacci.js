...
"use strict"; // Simple benchmark for very simple memoization case (fibonacci series)
...
getFib = function getFib(memoize, opts) {
...
forEach(data, function (value, name, obj, currentIndex) {
