...
module.exports = function (memoize) {
  ...
  /*, options*/
    ...
    var map,
        ...
        resolve,
        normalizer;
    callable(fn); // Do not memoize already memoized function
    ...
    if (length === 1 && !normalizer && !options.async && !options.dispose && !options.maxAge && !options.max && !options.refCounter) {
