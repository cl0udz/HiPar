...
var memoize = require("../.."),
    ...
    _Promise = require("plain-promise");
                  ...
                  setTimeout(function () {
                    ...
                    mfn(3, 7, function (err, result) {
                      ...
                      mfn(5, 8, function (err, result) {
                        ...
                        a(i, 2, "Called: Wait B"); // Wait 200ms
                            ...
                            mfn(5, 8, function (err, result) {
                              ...
                              mfn(3, 7, function (err, result) {
                                ...
                                mfn(5, 8, function (err, result) {
                                  ...
                                  a(i, 4, "Called: Wait After B #2"); // Wait 200ms
                                  ...
                                  setTimeout(function () {
                                    ...
                                    mfn(3, 7, function (err, result) {
                                      ...
                                      mfn(5, 8, function (err, result) {
                                        ...
                                        a(i, 4, "Called: After Refetch B: After"); // Wait 250ms
                        ...
                        setTimeout(function () {
                          ...
                          delay(function (result) {
                            ...
                            delay(function (result) {
                              a(result, 13, "Result: Wait After B");
                              a(i, 4, "Called: Wait After B");
                              mfn(3, 7).done( // next tick
                              delay(function (result) {
                                a(result, 10, "Result: Wait After #2");
                                a(i, 4, "Called: Wait After #2");
                                mfn(5, 8).done(function (result) {
                                  a(result, 13, "Result: Wait After B #2");
                                  a(i, 4, "Called: Wait After B #2"); // 400
                                  ...
                                  setTimeout(function () {
                                    ...
                                    mfn(3, 7).done(function (result) {
                                      ...
                                      mfn(5, 8).done(function (result) {
                                        a(result, 13, "Result: After Refetch B");
                                        a(i, 4, "Called: After Refetch B: After"); // 400
