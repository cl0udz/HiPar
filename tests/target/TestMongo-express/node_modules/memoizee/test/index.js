...
module.exports = function (t, a) {
  return {
    ...
    "Normalizer function": function NormalizerFunction() {
      var i = 0,
          fn = function fn() {
        ++i;
    ...
    "Async": {
      Regular: {
        ...
        "Reference counter": function ReferenceCounter(a, d) {
          var mfn,
              fn,
              u = {},
              i = 0;
                            ...
                            a(mfn(5, 8, function (err, res) {
                              ...
                              a(mfn(12, 4, function (err, res) {
                                ...
                                a(mfn(3, 7, function (err, res) {
                                  ...
                                  a(i, 6, "Called #5");
                                  a(mfn(77, 11, function (err, res) {
                                    a.deep([err, res], [null, 88], "Result D #2");
                                    a(i, 7, "Called D #2");
                                    a(mfn(12, 4, function (err, res) {
                                      a.deep([err, res], [null, 16], "Result C #3");
                                      a(i, 7, "Called C #3");
                                      a(mfn(5, 8, function (err, res) {
                                        a.deep([err, res], [null, 13], "Result B #5");
                                        a(i, 8, "Called B #5");
                                        a(mfn(77, 11, function (err, res) {
                                          a.deep([err, res], [null, 88], "Result D #3");
                                          a(i, 8, "Called D #3");
                                          mfn["delete"](77, 11);
                                          a(mfn(77, 11, function (err, res) {
                                            a.deep([err, res], [null, 88], "Result D #4");
                                            a(i, 9, "Called D #4");
                                            mfn.clear();
                                            a(mfn(5, 8, function (err, res) {
                                              a.deep([err, res], [null, 13], "Result B #6");
                                              a(i, 10, "Called B #6");
                                              a(mfn(77, 11, function (err, res) {
                                                a.deep([err, res], [null, 88], "Result D #5");
                                                a(i, 11, "Called D #5");
                                                d();
                                              }), u, "Initial D #5");
                                            }), u, "Initial B #6");
    ...
    "Dispose": {
      Regular: {
        ...
        "Ref counter": function RefCounter(a) {
          var mfn,
              fn,
              value = [];
