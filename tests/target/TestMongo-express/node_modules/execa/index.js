...
module.exports = function (cmd, args, opts) {
  ...
  var promise = pFinally(Promise.all([processDone, getStream(spawned, 'stdout', encoding, maxBuffer), getStream(spawned, 'stderr', encoding, maxBuffer)]).then(function (arr) {
    var result = arr[0];
    var stdout = arr[1];
    var stderr = arr[2];
    var err = result.err;
