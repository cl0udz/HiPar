...
function transform(file) {
  ...
  var src = 'var sys = require("util");\nvar MOZ_SourceMap = require("source-map");\nvar UglifyJS = exports;\n' + uglify.FILES.map(function (path) {
    return fs.readFileSync(path, 'utf8');
  }).join('\n');
  var ast = uglify.parse(src);
  ast.figure_out_scope();
  var variables = ast.variables.map(function (node, name) {
    return name;
  });
  ...
  src += 'exports.describe_ast = ' + uglify.describe_ast.toString() + ';'; // TODO: remove once https://github.com/substack/node-browserify/issues/631 is resolved
