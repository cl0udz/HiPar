...
function normalizeArguments(url, opts) {
  if (typeof url !== 'string' && _typeof(url) !== 'object') {
    throw new Error("Parameter `url` must be a string or object, not ".concat(_typeof(url)));
  }
  ...
  if (body) {
    if (typeof body !== 'string' && !(body !== null && _typeof(body) === 'object')) {
    ...
    } else if (body !== null && _typeof(body) === 'object' && !Buffer.isBuffer(body) && !isStream(body)) {
