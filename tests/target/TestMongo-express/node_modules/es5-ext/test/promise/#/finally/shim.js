  ...
  return {
    Success: function Success(d) {
      ...
      t.call(Promise.resolve("foo"), function () {
        invoked = true;
        return "bar";
      }).then(microtaskDelay.call(function (result) {
        a(result, "foo");
        a(invoked, true);
        d();
    ...
    Failure: function Failure(d) {
      ...
      t.call(Promise.reject(error), function () {
        invoked = true;
        return "bar";
      }).then(microtaskDelay.call(function () {
        a.never();
        d();
    ...
    SuccessFinallyError: function SuccessFinallyError(d) {
      var invoked,
    ...
    FailureFinallyError: function FailureFinallyError(d) {
      var invoked,
          finallyError = new Error("Finally error");
