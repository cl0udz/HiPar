...
function Argv(processArgs, cwd) {
  ...
  self.option = self.options = function (key, opt) {
    if (_typeof(key) === 'object') {
      ...
      assert(_typeof(opt) === 'object', 'second argument to option must be an object');
  ...
  self.completion = function (cmd, desc, fn) {
    ...
    self.command(completionCommand, desc || 'generate bash completion script'); // a function can be provided
  ...
  function parseArgs(args) {
    ...
    argv.$0 = self.$0;
    self.parsed = parsed; // generate a completion script for adding to ~/.bashrc.
