...
var fs = require('fs'),
    path = require('path'); // add bash completions to your
...
module.exports = function (yargs, usage) {
  ...
  self.getCompletion = function (done) {
    var completions = [],
        ...
        argv = yargs.parse(previous); // a custom completion function can be provided
    // to completion().
  ...
  self.generateCompletionScript = function ($0) {
    var script = fs.readFileSync(path.resolve(__dirname, '../completion.sh.hbs'), 'utf-8'),
        name = path.basename($0); // add ./to applications not yet installed as bin.
