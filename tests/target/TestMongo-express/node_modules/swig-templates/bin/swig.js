...
}).alias('v', 'version').alias('o', 'output')["default"]('o', 'stdout').alias('h', 'help').alias('j', 'json').alias('c', 'context').alias('m', 'minify')["default"]('wrap-start', wrapstart)["default"]('wrap-end', ';')["default"]('method-name', 'tpl').check(function (argv) {
  if (argv.v) {
    return;
  }
...
switch (command) {
  case 'compile':
    fn = function fn(file, str) {
      var r = swig.precompile(str, {
        filename: file,
        locals: ctx
