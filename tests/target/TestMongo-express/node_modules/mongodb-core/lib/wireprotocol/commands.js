...
var Insert = function Insert(requestId, ismaster, bson, ns, documents, options) {
...
var Update = function Update(requestId, ismaster, bson, ns, update, options) {
  // Basic options needed to be passed in
...
var Remove = function Remove(requestId, ismaster, bson, ns, remove, options) {
  // Basic options needed to be passed in
  if (ns == null) throw new MongoError("ns must be specified for query"); // Ensure empty options
