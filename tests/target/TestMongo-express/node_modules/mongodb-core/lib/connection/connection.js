...
var Connection = function Connection(messageHandler, options) {
  ...
  this.socketTimeout = options.socketTimeout || 0; // If connection was destroyed
...
Connection.prototype.connect = function (_options) {
  ...
  self.connection = self.domainSocket ? net.createConnection(self.host) : net.createConnection(self.port, self.host); // Set the options for the connection
