...
var Mongos = function Mongos(seedlist, options) {
  ...
  this.ismaster = null; // Add event listener
...
function handleEvent(self) {
  return function () {
    ...
    moveServerFrom(self.connectedProxies, self.disconnectedProxies, this); // Emit the left signal
    ...
    return function () {
      ...
      if (event == 'connect' && !self.authenticating) {
        ...
        applyAuthenticationContexts(self, _self, function () {
          ...
          moveServerFrom(self.disconnectedProxies, self.connectedProxies, _self); // Emit joined event
