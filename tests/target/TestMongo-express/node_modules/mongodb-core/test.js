...
var ReplSet = require('./lib2/topologies/replset'),
    ReadPreference = require('./lib2/topologies/read_preference'); // Attempt to connect
...
server.on('connect', function (_server) {
  console.log("---------------------------------- 0"); // Attempt authentication

  _server.auth('scram-sha-1', 'admin', 'root', 'root', function (err, r) {
    console.log("---------------------------------- 1"); // console.dir(err)
    // console.dir(r)
    ...
    _server.insert('test.test', [{
      ...
      executeCursors(_server, function () {
        console.log("============== 0"); // Attempt to force a server reconnect
