...
var throwUnexpected = function throwUnexpected() {
...
describe("thenable_/finally", function () {
  describe("Successful on fulfilled", function () {
    ...
    it("Should invoke finally callback", function () {
  ...
  describe("Successful on rejected", function () {
    ...
    before(function () {
      ...
      return result["catch"](function (error) {
        if (error !== inputError) throw error;
      });
    });
    it("Should invoke finally callback", function () {
      assert(callback.calledOnce);
    ...
    it("Return promise should fulfill with original result", function () {
      return Promise.all([input["catch"](identity), result["catch"](identity)]).then(function (results) {
        assert.equal(results[0], results[1]);
      });
    });
  });
  describe("Failed on fulfilled", function () {
    ...
    before(function () {
      ...
      result = finallyMethod.call(input, callback);
      return result["catch"](function (error) {
        if (error !== finallyError) throw error;
      });
    });
    it("Should invoke finally callback", function () {
      assert(callback.calledOnce);
