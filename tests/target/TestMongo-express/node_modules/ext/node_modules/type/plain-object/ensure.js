...
/*, options*/
  ...
  var allowedKeys = ensureArray(options.allowedKeys, {
    isOptional: true
  });
  ...
  if (allowedKeys) {
    ...
    if (invalidKeys) {
      errorMessage = resolveErrorMessage(defaultErrorMessage, value, options) + ".\n           Following keys are unexpected: " + invalidKeys.join(", ");
  ...
  if (ensurePropertyValue) {
    ...
    if (invalidKeys) {
      errorMessage = resolveErrorMessage(defaultErrorMessage, value, options) + ".\n           Valuees for following keys are invalid: " + invalidKeys.join(", ");
      throw new TypeError(errorMessage);
    }
