  ...
  if (typeof borderStyle === 'string') {
    ...
    sides.forEach(function (key) {
      if (!borderStyle[key] || typeof borderStyle[key] !== 'string') {
        throw new TypeError("Invalid border style: ".concat(key));
      }
    });
    chars = borderStyle;
  }
...
module.exports = function (text, opts) {
  ...
  if (opts.borderColor && !chalk[opts.borderColor]) {
    throw new Error("".concat(opts.borderColor, " is not a valid borderColor"));
  }

  if (opts.backgroundColor && !chalk[opts.backgroundColor]) {
    throw new Error("".concat(opts.backgroundColor, " is not a valid backgroundColor"));
  }
