...
module.exports = function (t, a) {
  ...
  a(t("\x1b[0;0;A"), "", "Two Separated Commands"); // Base on index tests.
  ...
  a(t(clc.blue.bgYellow.red.bgMagenta("foo", "bar")), "foo bar", "Foreground & Background: Overriden");
  ...
  a(t(clc.blueBright.bgYellowBright.red.bgMagenta("foo", "bar")), "foo bar", "Foreground & Background: Bright: Overriden");
  ...
  a(t(clc.bgRed.blue.bgBlue.red("foo")), "foo", "Prioritize the Last Mixed Style: BG Blue and Red");
  a(t(clc.bgBlue.red.bgRed.blue("foo")), "foo", "Prioritize the Last Mixed Style: BG Red and Blue");
