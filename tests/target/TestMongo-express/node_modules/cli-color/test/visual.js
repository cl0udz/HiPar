...
var colors = ["black", "red", "green", "yellow", "blue", "magenta", "cyan", "white"]; // Write some message.

var w = function w(message) {
  process.stdout.write(message);
}; // Print colors.


var printColors = function printColors(title, style) {
  var j = colors.length,
      color,
      colorText,
      tint,
...
w(clc.move(1, 0));
w(clc.blueBright.bgYellowBright("O")); // Red nose.

w(clc.move.to(8, 5));
w(clc.redBright.bgYellowBright("\u25A0")); // Red mouth.

w(clc.move.down(2));
w(clc.move.left(2));
w(clc.red.bgYellowBright("\u2588\u2584\u2588")); // Move back.

w(clc.move.to(0, 9)); // Colors test.
...
printColors("BACKGROUNDS (BRIGHT) ", "backgroundBright"); // // Art test.
