...
test('short boolean', function (t) {
  ...
  t.same(_typeof(parse.b), 'boolean');
  t.end();
});
...
test('nums', function (t) {
  ...
  t.same(_typeof(argv.x), 'number');
  t.same(_typeof(argv.y), 'number');
  t.same(_typeof(argv.z), 'number');
  t.same(_typeof(argv.w), 'string');
  t.same(_typeof(argv.hex), 'number');
  t.same(_typeof(argv._[0]), 'number');
  t.end();
});
test('flag boolean', function (t) {
  ...
  t.same(_typeof(parse.t), 'boolean');
  t.end();
});
test('flag boolean value', function (t) {
  ...
  t.same(_typeof(parse.verbose), 'boolean');
  t.same(_typeof(parse.t), 'boolean');
  t.end();
});
...
test('boolean groups', function (t) {
  ...
  t.same(_typeof(parse.x), 'boolean');
  t.same(_typeof(parse.y), 'boolean');
  t.same(_typeof(parse.z), 'boolean');
  t.end();
});
...
test('strings', function (t) {
  ...
  t.same(s, '0001234');
  t.same(_typeof(s), 'string');
  var x = optimist(['-x', '56']).string('x').argv.x;
  t.same(x, '56');
  t.same(_typeof(x), 'string');
  t.end();
});
test('stringArgs', function (t) {
  ...
  t.same(s.length, 2);
  t.same(_typeof(s[0]), 'string');
  t.same(s[0], '  ');
  t.same(_typeof(s[1]), 'string');
  t.same(s[1], '  ');
  t.end();
});
