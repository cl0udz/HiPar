...
Mongos.prototype.connect = function (db, _options, callback) {
  ...
  var connectHandler = function connectHandler() {
    ...
    self.s.mongos.once('close', errorHandler('close')); // Set up SDAM listeners
    ...
    self.s.mongos.on('topologyDescriptionChanged', relay('topologyDescriptionChanged')); // Set up serverConfig listeners

    self.s.mongos.on('fullsetup', relay('fullsetup')); // Emit open event
