...
MongoClient.connect = function (url, options, callback) {
  ...
  options = options || {}; // Validate options object
...
var connect = function connect(url, options, callback) {
  options = options || {};
  ...
  var logger = Logger('MongoClient', options); // Parse the string
  ...
  if (_finalOptions.connectTimeoutMS == null) _finalOptions.connectTimeoutMS = 30000; // Failure modes
