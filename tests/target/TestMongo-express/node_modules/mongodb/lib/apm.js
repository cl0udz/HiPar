...
var Instrumentation = function Instrumentation(core, options, callback) {
  ...
  var instrumentPrototype = function instrumentPrototype(callback) {
  ...
  methods.forEach(function (x) {
    ...
    proto[x] = function () {
      var requestId = core.Query.nextRequestId(); // Get the aruments
