...
var UnorderedBulkOperation = function UnorderedBulkOperation(topology, collection, options) {
  options = options == null ? {} : options; // Get the namesspace for the write operations
...
var executeBatch = function executeBatch(self, batch, callback) {
  var finalOptions = {
    ordered: false
  };
...
var executeBatches = function executeBatches(self, callback) {
