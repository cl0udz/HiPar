...
Collection.prototype.find = function () {
  ...
  if (!options) options = {};
  var newOptions = {}; // Make a shallow copy of options
...
Collection.prototype.updateOne = function (filter, update, options, callback) {
  var self = this;
  if (typeof options == 'function') callback = options, options = {};
  options = shallowClone(options); // Add ignoreUndfined
...
var updateDocuments = function updateDocuments(self, selector, document, options, callback) {
  ...
  if (document == null || _typeof(document) != 'object') return callback(toError("document must be a valid JavaScript object")); // Get the write concern options
  ...
  op.multi = typeof options.multi == 'boolean' ? options.multi : false; // Have we specified collation
...
var findOne = function findOne(self, args, callback) {
...
var rename = function rename(self, newName, opt, callback) {
...
var options = function options(self, callback) {
...
var isCapped = function isCapped(self, callback) {
...
var createIndexes = function createIndexes(self, indexSpecs, callback) {
...
var reIndex = function reIndex(self, options, callback) {
  ...
  decorateWithWriteConcern(cmd, self, options); // Execute the command
...
var indexExists = function indexExists(self, indexes, callback) {
...
var indexes = function indexes(self, callback) {
...
Collection.prototype.findOneAndDelete = function (filter, options, callback) {
  ...
  if (filter == null || _typeof(filter) != 'object') throw toError('filter parameter must be an object'); // Execute using callback
...
Collection.prototype.findOneAndReplace = function (filter, replacement, options, callback) {
  ...
  if (replacement == null || _typeof(replacement) != 'object') throw toError('replacement parameter must be an object'); // Execute using callback
...
Collection.prototype.findOneAndUpdate = function (filter, update, options, callback) {
  ...
  if (filter == null || _typeof(filter) != 'object') throw toError('filter parameter must be an object');
  if (update == null || _typeof(update) != 'object') throw toError('update parameter must be an object'); // Execute using callback
...
Collection.prototype.aggregate = function (pipeline, options, callback) {
  ...
  this.s.db.command(command, options, function (err, result) {
    ...
    } else if (_typeof(result) == 'object' && result['serverPipeline']) {
      handleCallback(callback, null, result['serverPipeline']);
    } else if (_typeof(result) == 'object' && result['stages']) {
...
var geoNear = function geoNear(self, x, y, point, options, callback) {
  // Build command object
  var commandObject = {
    geoNear: self.s.name,
    near: point || [x, y]
...
var writeConcern = function writeConcern(target, db, col, options) {
