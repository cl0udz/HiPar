...
var GridStore = function GridStore(db, id, filename, mode, options) {
  ...
  var promiseLibrary = this.options.promiseLibrary; // No promise library selected fall back
...
GridStore.prototype.getc = function (callback) {
  ...
  if (typeof callback == 'function') return eof(self, callback); // Return promise
...
var eof = function eof(self, callback) {
  if (self.eof()) {
    callback(null, null);
...
GridStore.prototype.puts = function (string, callback) {
  var self = this;
  var finalString = string.match(/\n$/) == null ? string + "\n" : string; // We provided a callback leg

  if (typeof callback == 'function') return this.write(finalString, callback); // Return promise
...
GridStore.prototype.write = function write(data, close, callback) {
  ...
  if (typeof callback == 'function') return _writeNormal(this, data, close, callback); // Return promise
...
GridStore.prototype.writeFile = function (file, callback) {
  ...
  if (typeof callback == 'function') return writeFile(self, file, callback); // Return promise
...
var writeFile = function writeFile(self, file, callback) {
        ...
        fs.read(file, self.chunkSize, offset, 'binary', function (err, data, bytesRead) {
          ...
          chunk.write(data, function (err, chunk) {
            ...
            chunk.save({}, function (err) {
              if (err) return callback(err, self);
              self.position = self.position + data.length; // Point to current chunk
...
GridStore.prototype.close = function (callback) {
  ...
  if (typeof callback == 'function') return close(self, callback); // Return promise
...
var close = function close(self, callback) {
  if (self.mode[0] == "w") {
    // Set up options
...
GridStore.prototype.unlink = function (callback) {
  ...
  if (typeof callback == 'function') return unlink(self, callback); // Return promise
...
var unlink = function unlink(self, callback) {
...
GridStore.prototype.readlines = function (separator, callback) {
  ...
  if (typeof callback == 'function') return readlines(self, separator, callback); // Return promise
...
var readlines = function readlines(self, separator, callback) {
...
GridStore.prototype.rewind = function (callback) {
  ...
  if (typeof callback == 'function') return rewind(self, callback); // Return promise
...
var rewind = function rewind(self, callback) {
...
GridStore.prototype.read = function (length, buffer, callback) {
  ...
  buffer = args.length ? args.shift() : null; // We provided a callback leg

  if (typeof callback == 'function') return read(self, length, buffer, callback); // Return promise
...
var read = function read(self, length, buffer, callback) {
  // The data is a c-terminated string and thus the length - 1
  var finalLength = length == null ? self.length - self.position : length;
  var finalBuffer = buffer == null ? new Buffer(finalLength) : buffer; // Add a index to buffer to keep track of writing position or apply current index
...
GridStore.prototype.seek = function (position, seekLocation, callback) {
  ...
  callback = args.pop();
  if (typeof callback != 'function') args.push(callback);
  seekLocation = args.length ? args.shift() : null; // We provided a callback leg

  if (typeof callback == 'function') return seek(self, position, seekLocation, callback); // Return promise
...
var seek = function seek(self, position, seekLocation, callback) {
...
var _open = function _open(self, options, callback) {
  ...
  if (query != null) {
    collection.findOne(query, options, function (err, doc) {
      if (err) return error(err); // Check if the collection for the files exists otherwise prepare the new one
...
GridStore.exist = function (db, fileIdObject, rootCollection, options, callback) {
  ...
  options = options || {}; // Get the promiseLibrary
  ...
  if (typeof callback == 'function') return exists(db, fileIdObject, rootCollection, options, callback); // Return promise
...
GridStore.list = function (db, rootCollection, options, callback) {
  ...
  if (typeof callback == 'function') return list(db, rootCollection, options, callback); // Return promise
...
GridStore.read = function (db, name, length, offset, options, callback) {
  ...
  var promiseLibrary = options ? options.promiseLibrary : null; // No promise library selected fall back
  ...
  if (typeof callback == 'function') return readStatic(db, name, length, offset, options, callback); // Return promise
...
GridStore.readlines = function (db, name, separator, options, callback) {
  ...
  if (typeof callback == 'function') return readlinesStatic(db, name, separator, options, callback); // Return promise
...
GridStore.unlink = function (db, names, options, callback) {
  ...
  if (typeof callback == 'function') return unlinkStatic(self, db, names, options, callback); // Return promise
...
var _writeNormal = function _writeNormal(self, data, close, callback) {
