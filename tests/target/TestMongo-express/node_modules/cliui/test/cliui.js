...
describe('cliui', function () {
  describe('div', function () {
    ...
    it('evenly divides text across columns if multiple columns are given', function () {
      ...
      ui.div({
        text: 'i am a string that should be wrapped',
        width: 15
      }, 'i am a second string that should be wrapped', 'i am a third string that should be wrapped'); // total width of all columns is <=
      ...
      var expected = ['i am a string  i am a      i am a third', 'that should be second      string that', 'wrapped        string that should be', '               should be   wrapped', '               wrapped'];
      ui.toString().split('\n').should.eql(expected);
    });
    it('allows for a blank row to be appended', function () {
      ...
      ui.div(); // it should wrap each column appropriately.
  ...
  describe('alignment', function () {
    it('allows a column to be right aligned', function () {
      ...
      ui.div('i am a string', {
        text: 'i am a second string',
        align: 'right'
      }, 'i am a third string that should be wrapped'); // it should right-align the second column.

      var expected = ['i am a stringi am a secondi am a third', '                    stringstring that', '                          should be', '                          wrapped'];
      ui.toString().split('\n').should.eql(expected);
    });
    it('allows a column to be center aligned', function () {
      ...
      var expected = ['i am a string          i am a second       i am a third string', '                           string          that should be', '                                           wrapped'];
      ui.toString().split('\n').should.eql(expected);
    });
  });
  describe('padding', function () {
    it('handles left/right padding', function () {
      ...
      ui.div({
        text: 'i have padding on my left',
        padding: [0, 0, 0, 4]
      }, {
        text: 'i have padding on my right',
        padding: [0, 2, 0, 0],
        align: 'center'
      }, {
      ...
      var expected = ['    i have     i have      i have no', '    padding  padding on    padding', '    on my     my right', '    left'];
      ui.toString().split('\n').should.eql(expected);
    });
    it('handles top/bottom padding', function () {
      ...
      ui.div('i am a string', {
        ...
        text: 'i am a third string that should be wrapped',
        padding: [0, 0, 1, 0]
      }); // it should add top/bottom padding to second
      // and third columns.

      var expected = ['i am a string             i am a third', '                          string that', '             i am a secondshould be', '             string       wrapped', ''];
      ui.toString().split('\n').should.eql(expected);
    });
  });
  describe('wrap', function () {
    it('allows wordwrap to be disabled', function () {
      ...
      ui.div({
        ...
        text: 'i am a third string that should not be wrapped',
        padding: [0, 0, 0, 2]
      });
  ...
  describe('span', function () {
    it('appends the next row to the end of the prior row if it fits', function () {
      ...
      ui.span({
        text: 'i am a string that will be wrapped',
        width: 30
      });
      ui.div({
        text: ' [required] [default: 99]',
        align: 'right'
      });
      var expected = ['i am a string that will be', 'wrapped         [required] [default: 99]'];
      ui.toString().split('\n').should.eql(expected);
    });
    it('does not append the string if it does not fit on the prior row', function () {
      ...
      ui.div({
        text: 'i am a second row',
        align: 'left'
      });
      var expected = ['i am a string that will be', 'wrapped', 'i am a second row'];
      ui.toString().split('\n').should.eql(expected);
    });
    it('always appends text to prior span if wrap is disabled', function () {
      ...
      ui.div('a third line');
      var expected = ['i am a string that will be wrapped   i am a second row', 'a third line'];
      ui.toString().split('\n').should.eql(expected);
    });
  });
  describe('layoutDSL', function () {
    it('turns tab into multiple columns', function () {
      ...
      ui.div('  <regex>  \tmy awesome regex\n  <my second thing>  \tanother row\t  a third column');
      var expected = ['  <regex>            my awesome regex', '  <my second thing>  another row          a third column'];
      ui.toString().split('\n').should.eql(expected);
    });
    it('turns newline into multiple rows', function () {
      ...
      var expected = ['Usage: $0', '  <regex>  my awesome regex', '  <glob>   my awesome     [required]', '           glob'];
      ui.toString().split('\n').should.eql(expected);
    });
