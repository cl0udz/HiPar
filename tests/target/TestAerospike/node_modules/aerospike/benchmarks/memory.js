...
function report() {
  ...
  filtered.forEach(function (r, i) {
    ...
    if (l) {
      rtable.push([r[0], (r[0] - l[0]).toFixed(3), r[1], (r[1] - l[1]).toFixed(3), r[2], (r[1] - r[0]).toFixed(3), memoryBar(r[0], r[1])]);
    } else {
      rtable.push([r[0], 0.00, r[1], 0.00, r[2], (r[1] - r[0]).toFixed(3), memoryBar(r[0], r[1])]);
    }
...
function readline(line) {
  ...
  if (memMax === undefined || mem > memMax) {
    ...
    memRanges.push([memMin, memMax, memCnt]); // reset
