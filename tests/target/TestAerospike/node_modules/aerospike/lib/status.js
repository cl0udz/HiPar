...
exports.ERR_ENTERPRISE_ONLY = exports.AEROSPIKE_ERR_ENTERPRISE_ONLY = as.status.AEROSPIKE_ERR_ENTERPRISE_ONLY; // TODO: Remove ERR_FAIL_ENTERPRISE_ONLY - this is kept for backwards compatibility only.
...
exports.getMessage = function (code) {
  ...
  switch (code) {
    ...
    case exports.ERR_FAIL_ELEMENT_NOT_FOUND:
      return 'Map/list element not found in UPDATE_ONLY write mode.';

    case exports.ERR_FAIL_ELEMENT_EXISTS:
      return 'Map/list element exists in CREATE_ONLY write mode.';
    ...
    default:
      return "Unknown status message ".concat(code);
  }
};