...
function getSeparators(key) {
  var pattern = Object.keys(separators).find(function (p) {
    return minimatch(key, p);
  });
  var seps = separators[pattern] || defaultSeparators;
...
function deepSplitString(input, separators) {
  ...
  if (typeof input === 'string') {
    ...
    output = input.map(function (i) {
      return splitString(i, sep);
    });
...
var defaultSeparators = [smartParse];
/**********************************************************
