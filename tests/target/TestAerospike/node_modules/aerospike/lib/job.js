...
var DEFAULT_POLL_INTERVALL = 1000;
/**
 * @class Job
...
Job.pollUntilDone = function (statusFunction, pollInterval) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    var poll = function poll() {
      statusFunction().then(function (done) {
        if (done) {
...
Job.prototype.checkStatus = function () {
  ...
  return this.info().then(function (info) {
    return _this.hasCompleted(info);
  });
};
/**
 * @function Job#info
...
Job.prototype.info = function (policy, callback) {
  ...
  var cmd = new Commands.JobInfo(this.client, [this.jobID, this.module, policy], callback);
  return cmd.execute();
};
/**
 * @function Job#wait
...
Job.prototype.wait = function (pollInterval, callback) {
  ...
  if (typeof callback === 'function') {
    Job.pollUntilDone(checkStatus, pollInterval).then(function (result) {
