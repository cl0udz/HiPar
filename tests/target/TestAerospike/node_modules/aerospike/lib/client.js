...
var AerospikeError = require('./error');
...
var IndexJob = require('./index_job');

var Query = require('./query');

var Scan = require('./scan');

var UdfJob = require('./udf_job');

var operations = require('./operations');

var utils = require('./utils'); // number of client instances currently connected to any Aerospike cluster


var _connectedClients = 0; // callback function for cluster events (node added/removed, etc.)
...
Client.prototype.batchExists = function (keys, policy, callback) {
  ...
  var cmd = new Commands.BatchExists(this, [keys, policy], callback);
  return cmd.execute();
};
/**
...
Client.prototype.batchGet = function (keys, policy, callback) {
  ...
  var cmd = new Commands.BatchGet(this, [keys, policy], callback);
  return cmd.execute();
};
/**
...
Client.prototype.batchRead = function (records, policy, callback) {
  ...
  var cmd = new Commands.BatchRead(this, [records, policy], callback);
  return cmd.execute();
};
/**
...
Client.prototype.batchSelect = function (keys, bins, policy, callback) {
  ...
  var cmd = new Commands.BatchSelect(this, [keys, bins, policy], callback);
  return cmd.execute();
};
/**
...
Client.prototype.connect = function (callback) {
  ...
  var eventsCb = eventsCallback.bind(this);
  this.as_client.setupEventCb(eventsCb);
  var cmd = new Commands.Connect(this);
  return cmd.execute().then(function () {
    _this.connected = true;
    _connectedClients += 1;
    if (callback) callback(null, _this);else return _this;
  })["catch"](function (error) {
    _this.as_client.close();
...
Client.prototype.createIndex = function (options, policy, callback) {
  ...
  var args = [options.ns, options.set, options.bin, options.index, options.type || as.indexType.DEFAULT, options.datatype, policy];
  var cmd = new Commands.IndexCreate(this, args, callback);

  cmd.convertResult = function () {
    return new IndexJob(_this2, options.ns, options.index);
  };
...
Client.prototype.apply = function (key, udfArgs, policy, callback) {
  ...
  var cmd = new Commands.Apply(this, [key, udfArgs, policy], callback);
  return cmd.execute();
};
/**
...
Client.prototype.exists = function exists(key, policy, callback) {
  ...
  var cmd = new Commands.Exists(this, [key, policy], callback);
  return cmd.execute();
};
/**
 * @function Client#get
...
Client.prototype.get = function (key, policy, callback) {
  ...
  var cmd = new Commands.Get(this, key, [policy], callback);
  return cmd.execute();
};
/**
...
Client.prototype.indexRemove = function (namespace, index, policy, callback) {
  ...
  var cmd = new Commands.IndexRemove(this, [namespace, index, policy], callback);
  return cmd.execute();
};
/**
...
Client.prototype.info = function (request, host, policy, callback) {
  ...
  var cmd = new Commands.InfoHost(this, [request, host, policy], callback);
  return cmd.execute();
};
/**
...
Client.prototype.infoAny = function (request, policy, callback) {
  ...
  var cmd = new Commands.InfoAny(this, [request, policy], callback);
  return cmd.execute();
};
/**
...
Client.prototype.infoAll = function (request, policy, callback) {
  ...
  var cmd = new Commands.InfoForeach(this, [request, policy], callback);
  return cmd.execute();
};
/**
...
Client.prototype.infoNode = function (request, node, policy, callback) {
  ...
  var cmd = new Commands.InfoNode(this, [request, node.name, policy], callback);
  return cmd.execute();
};
/**
...
Client.prototype.operate = function (key, operations, metadata, policy, callback) {
  ...
  var cmd = new Commands.Operate(this, key, [operations, metadata, policy], callback);
  return cmd.execute();
}
/**
...
['append', 'prepend', 'add'].forEach(function (op) {
...
Client.prototype.put = function (key, bins, meta, policy, callback) {
  ...
  var cmd = new Commands.Put(this, key, [bins, meta, policy], callback);
  return cmd.execute();
};
/**
...
Client.prototype.remove = function (key, policy, callback) {
  ...
  var cmd = new Commands.Remove(this, key, [policy], callback);
  return cmd.execute();
};
/**
...
Client.prototype.select = function (key, bins, policy, callback) {
  ...
  var cmd = new Commands.Select(this, key, [bins, policy], callback);
  return cmd.execute();
};
/**
...
Client.prototype.truncate = function (ns, set, beforeNanos, policy, callback) {
  ...
  var cmd = new Commands.Truncate(this, [ns, set, beforeNanos, policy], callback);
  return cmd.execute();
};
/**
...
Client.prototype.udfRegister = function (udfPath, udfType, policy, callback) {
  ...
  if (_typeof(udfType) === 'object') {
    policy = udfType;
    udfType = null;
  }

  var cmd = new Commands.UdfRegister(this, [udfPath, udfType, policy], callback);

  cmd.convertResult = function () {
    var module = path.basename(udfPath);
    return new UdfJob(_this3, module, UdfJob.REGISTER);
  };
...
Client.prototype.udfRemove = function (udfModule, policy, callback) {
  ...
  var cmd = new Commands.UdfRemove(this, [udfModule, policy], callback);

  cmd.convertResult = function () {
    return new UdfJob(_this4, udfModule, UdfJob.UNREGISTER);
  };
