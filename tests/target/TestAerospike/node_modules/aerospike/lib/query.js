...
var RecordStream = require('./record_stream');

var filter = require('./filter');

var predexp = require('./predexp');
...
Query.prototype.foreach = function (policy, dataCb, errorCb, endCb) {
  ...
  var args = [this.ns, this.set, this, policy];
  var cmd;
...
Query.prototype.results = function (policy) {
  ...
  return new Promise(function (resolve, reject) {
    var stream = _this.foreach(policy);
...
Query.prototype.apply = function (udfModule, udfFunction, udfArgs, policy, callback) {
  ...
  var cmd = new Commands.QueryApply(this.client, [this.ns, this.set, this, policy], callback);
  return cmd.execute();
};
/**
...
Query.prototype.background = function (udfModule, udfFunction, udfArgs, policy, queryID, callback) {
  ...
  var cmd = new Commands.QueryBackground(this.client, [this.ns, this.set, this, policy, queryID], callback);

  cmd.convertResult = function () {
    var module = _this2.filters.length > 0 ? 'query' : 'scan';
    return new Job(_this2.client, queryID, module);
  };
