...
var ApplyPolicy = require('./policies/apply_policy');

var BatchPolicy = require('./policies/batch_policy');

var CommandQueuePolicy = require('./policies/command_queue_policy');

var InfoPolicy = require('./policies/info_policy');

var ListPolicy = require('./policies/list_policy');

var MapPolicy = require('./policies/map_policy');

var OperatePolicy = require('./policies/operate_policy');

var QueryPolicy = require('./policies/query_policy');

var ReadPolicy = require('./policies/read_policy');

var RemovePolicy = require('./policies/remove_policy');

var ScanPolicy = require('./policies/scan_policy');

var WritePolicy = require('./policies/write_policy');
/**
...
function policyClass(type) {
  switch (type) {
    ...
    default:
      throw new TypeError("Unknown policy type: \"".concat(type, "\""));
  }
}
/**
 * @private
