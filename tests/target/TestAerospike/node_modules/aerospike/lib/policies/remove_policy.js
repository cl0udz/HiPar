...
function (_BasePolicy) {
  _inherits(RemovePolicy, _BasePolicy);
   ...
   */
  function RemovePolicy(props) {
    var _this;

    _classCallCheck(this, RemovePolicy);

    props = props || {};
    _this = _possibleConstructorReturn(this, _getPrototypeOf(RemovePolicy).call(this, props));
    /**
    ...
    _this.generation = props.generation;
    /**
