...
function (_BasePolicy) {
  _inherits(WritePolicy, _BasePolicy);
  ...
  function WritePolicy(props) {
    ...
    _classCallCheck(this, WritePolicy);

    props = props || {};
    _this = _possibleConstructorReturn(this, _getPrototypeOf(WritePolicy).call(this, props));
    /**
    ...
    _this.compressionThreshold = props.compressionThreshold;
    /**
