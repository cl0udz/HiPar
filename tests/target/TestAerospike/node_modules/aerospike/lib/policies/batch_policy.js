...
function (_BasePolicy) {
  _inherits(BatchPolicy, _BasePolicy);
   ...
   */
  function BatchPolicy(props) {
    var _this;

    _classCallCheck(this, BatchPolicy);

    props = props || {};
    _this = _possibleConstructorReturn(this, _getPrototypeOf(BatchPolicy).call(this, props));
    /**
    ...
    _this.allowInline = props.allowInline;
    /**
    ...
    _this.sendSetName = props.sendSetName;
    /**
