...
function (_BasePolicy) {
  _inherits(ScanPolicy, _BasePolicy);
   ...
   */
  function ScanPolicy(props) {
    var _this;

    _classCallCheck(this, ScanPolicy);

    props = props || {};
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ScanPolicy).call(this, props));
    /**
     * Terminate the scan if the cluster is in migration state.
     *
     * @type boolean
     * @default <code>false</code>
     */

    _this.failOnClusterChange = props.failOnClusterChange;
    /**
