...
var maps = exports.maps = require('./maps'); // copy maps related enums into maps module
...
var policy = exports.policy = require('./policy'); // short-cuts to the policy classes defined under the policy module
