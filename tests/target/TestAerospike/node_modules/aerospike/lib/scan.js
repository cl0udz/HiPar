...
Scan.prototype.background = function (udfModule, udfFunction, udfArgs, policy, scanID, callback) {
  ...
  var cmd = new Commands.ScanBackground(this.client, [this.ns, this.set, this, policy, scanID], callback);

  cmd.convertResult = function () {
    return new Job(_this.client, scanID, 'scan');
  };
...
Scan.prototype.foreach = function (policy, dataCb, errorCb, endCb) {
  ...
  var args = [this.ns, this.set, this, policy, scanID];
  var cmd = new Commands.Scan(stream, args);
  cmd.execute();
