...
var opcodes = as.operations;

var Context = require('./cdt_context');
...
/*#__PURE__*/
function (_Operation) {
  _inherits(ListOperation, _Operation);

  function ListOperation() {
    _classCallCheck(this, ListOperation);

    return _possibleConstructorReturn(this, _getPrototypeOf(ListOperation).apply(this, arguments));
  }
  ...
  _createClass(ListOperation, [{
     ...
     * })
     */
    value: function andReturn(returnType) {
    ...
    key: "withContext",
    value: function withContext(contextOrFunction) {
    ...
    key: "invertSelection",
    value: function invertSelection() {
      throw new AerospikeError("List operation cannot be inverted [op ".concat(this.op, "]"));
    }
  }]);
...
var InvertibleListOp =
/*#__PURE__*/
function (_ListOperation) {
  _inherits(InvertibleListOp, _ListOperation);

  function InvertibleListOp(op, bin, props) {
    var _this;

    _classCallCheck(this, InvertibleListOp);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(InvertibleListOp).call(this, op, bin, props));
    _this.inverted = false;
    return _this;
  }

  _createClass(InvertibleListOp, [{
    key: "invertSelection",
    value: function invertSelection() {
      this.inverted = true;
      return this;
...
exports.set = function (bin, index, value, policy) {
  return new ListOperation(opcodes.LIST_SET, bin, {
    index: index,
    value: value,
    policy: policy
  });
