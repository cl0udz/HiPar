...
/*#__PURE__*/
function (_Operation) {
  _inherits(MapOperation, _Operation);

  function MapOperation() {
    _classCallCheck(this, MapOperation);

    return _possibleConstructorReturn(this, _getPrototypeOf(MapOperation).apply(this, arguments));
  }

  _createClass(MapOperation, [{
    key: "andReturn",
    ...
    value: function withContext(contextOrFunction) {
      if (_typeof(contextOrFunction) === 'object') {
