...
exports.streams = require('./streams'); // Check whether example has been executed directly or via the runner
...
exports.runner = function () {
  ...
  started = true;
  var example = process.argv[1];
  var runner = path.join(example, '../run.js');
  var cmd = path.basename(example, '.js');
