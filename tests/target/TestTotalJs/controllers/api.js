...
exports.install = function () {
  ...
  ROUTE('/api/orders/dependencies/', ['*Order --> dependencies']); // Account
  ...
  ROUTE('/api/account/password/', ['*UserPassword --> exec', 'post', 'unauthorize']); // Newsletter view
...
function unsubscribe() {
  var self = this;
  self.$workflow('unsubscribe', function () {
    return self.plain(TRANSLATOR(self.language, '@(You have been successfully unsubscribed.\nThank you)'));
  });
}