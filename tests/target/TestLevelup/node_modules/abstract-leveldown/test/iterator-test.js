...
exports.args = function (test, testCommon) {
  ...
  test('test argument-less iterator#next() throws', function (t) {
    var iterator = db.iterator();
    t.throws(iterator.next.bind(iterator), /Error: next\(\) requires a callback argument/, 'no-arg iterator#next() throws');
    iterator.end(t.end.bind(t));
  });
  test('test argument-less iterator#end() after next() throws', function (t) {
    var iterator = db.iterator();
    iterator.next(function () {
      t.throws(iterator.end.bind(iterator), /Error: end\(\) requires a callback argument/, 'no-arg iterator#end() throws');
      iterator.end(t.end.bind(t));
    });
  });
...
exports.iterator = function (test, testCommon) {
  test('test simple iterator()', function (t) {
    ...
    db.batch(data, function (err) {
      ...
      var fn = function fn(err, key, value) {
        t.error(err);
