...
exports.range = function (test, testCommon) {
  ...
  rangeTest('full range', {}, []); // Reversing has no effect without limit
  ...
  rangeTest('gt=50 and reverse=true', {
    gt: '50',
    reverse: true
  }, data.slice(0, 51)); // Starting key is actually '00' so it should avoid it

  rangeTest('lte=0', {
    lte: '0'
  }, data); // Starting key is actually '00' so it should avoid it
