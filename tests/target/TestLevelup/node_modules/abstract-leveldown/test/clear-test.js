...
exports.args = function (test, testCommon) {
  test('test argument-less clear() throws', function (t) {
    t.throws(db.clear.bind(db), /Error: clear\(\) requires a callback argument/, 'no-arg clear() throws');
    t.end();
  });
};
...
exports.clear = function (test, testCommon) {
  ...
  if (testCommon.bufferKeys) {
    ...
    makeTest('mixed', [Buffer.from('a'), 'b']); // These keys would be equal when compared as utf8 strings
