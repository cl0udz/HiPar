...
exports.args = function (test, testCommon) {
  test('test database open no-arg throws', function (t) {
    ...
    t.throws(db.open.bind(db), /Error: open\(\) requires a callback argument/, 'no-arg open() throws');
    t.end();
  });
  test('test callback-less, 1-arg, open() throws', function (t) {
    var db = testCommon.factory();
    t.throws(db.open.bind(db, {}), /Error: open\(\) requires a callback argument/, 'callback-less, 1-arg open() throws');
    t.end();
  });
};
...
exports.open = function (test, testCommon) {
  test('test database open, no options', function (t) {
    var db = testCommon.factory(); // default createIfMissing=true, errorIfExists=false
