...
class Query {
  ...
  find(query) {
    ...
    var data = this.data,
        length = this.length;
    var _options$lean = options.lean,
        lean = _options$lean === void 0 ? false : _options$lean;
    var _options$limit = options.limit,
        limit = _options$limit === void 0 ? length : _options$limit,
        skip = options.skip;
    var arr = [];

    for (var i = 0; limit && i < length; i++) {
      var item = data[i];
