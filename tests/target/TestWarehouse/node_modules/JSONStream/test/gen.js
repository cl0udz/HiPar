...
var tape = require('tape'); // if (process.title !== 'browser') {
...
tape('out of mem', function (t) {
  ...
  var randomString = function randomString(min, max) {
  ...
  var randomJsonDoc = function randomJsonDoc() {
    var doc = {
  ...
  var generateTestData = function generateTestData(cb) {
  ...
  var testJSONStreamParse_causesOutOfMem = function testJSONStreamParse_causesOutOfMem(done) {
    var items = 0;
  ...
  fs.stat(file, function (err, stat) {
    console.log(stat);
    if (err) generateTestData(testJSONStreamParse_causesOutOfMem);else testJSONStreamParse_causesOutOfMem();
  });
}); // }