...
var _ = require('underscore'); // check if object contains any of expected keys
...
exports.isSimpleValue = function (value) {
  return _.isString(value) || _.isNumber(value) || _.isBoolean(value) || _.isNull(value) || _.isUndefined(value) || _.isRegExp(value) || _.isDate(value);
};
