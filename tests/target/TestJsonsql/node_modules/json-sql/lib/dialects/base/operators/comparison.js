...
var buildComparisonOperator = function buildComparisonOperator(field, operator, value) {
  return [field, operator, value].join(' ');
};

var buildBooleanOperator = function buildBooleanOperator(field, operator, value) {
