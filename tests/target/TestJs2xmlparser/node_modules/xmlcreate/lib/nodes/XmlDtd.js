...
function validatePubId(str) {
  for (var i = 0; i < str.length; i++) {
    ...
    if (char === 0xA || char === 0xD || char === 0x20 || char === 0x21 || char >= 0x23 && char <= 0x25 || char >= 0x27 && char <= 0x2F || char >= 0x30 && char <= 0x39 || char === 0x3A || char === 0x3B || char === 0x3D || char === 0x3F || char >= 0x40 && char <= 0x5A || char === 0x5F || char >= 0x61 && char <= 0x7A) {
      continue;
    }
