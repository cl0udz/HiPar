  ...
  return function (t) {
    ...
    (function (t) {
      ...
      e.toCollectionName = function (t, e) {
        return "system.profile" === t ? t : "system.indexes" === t ? t : "function" == typeof e ? e(t) : t;
      },
      /*!
      ...
      e.deepEqual = function t(r, i) {
        ...
        if (b(r, "ObjectID") && b(i, "ObjectID") || b(r, "Decimal128") && b(i, "Decimal128")) return r.toString() === i.toString();
        if (r instanceof RegExp && i instanceof RegExp) return r.source === i.source && r.ignoreCase === i.ignoreCase && r.multiline === i.multiline && r.global === i.global;
        if ("object" !== (void 0 === r ? "undefined" : n(r)) && "object" !== (void 0 === i ? "undefined" : n(i))) return r == i;
        if (null === r || null === i || void 0 === r || void 0 === i) return !1;
        if (r.prototype !== i.prototype) return !1;
        if (r instanceof Number && i instanceof Number) return r.valueOf() === i.valueOf();
        if (d.isBuffer(r)) return e.buffer.areEqual(r, i);
        E(r) && (r = r.toObject()), E(i) && (i = i.toObject());
        var o = void 0,
            s = void 0,
            a = void 0,
            u = void 0;
        ...
        try {
          o = Object.keys(r), s = Object.keys(i);
        } catch (t) {
          return !1;
        }
        ...
        for (o.sort(), s.sort(), u = o.length - 1; u >= 0; u--) {
          if (o[u] !== s[u]) return !1;
        }

        for (u = o.length - 1; u >= 0; u--) {
          if (!t(r[a = o[u]], i[a])) return !1;
        }
       ...
       * @api private
       */
      e.clone = function (t, r, n) {
        if (null == t) return t;
        if (Array.isArray(t)) return S(t, r);
        if (E(t)) return r && r._skipSingleNestedGetters && t.$isSingleNested && (r = Object.assign({}, r, {
          getters: !1
        })), r && r.json && "function" == typeof t.toJSON ? t.toJSON(r) : t.toObject(r);
        if (t.constructor) switch (e.getFunctionName(t.constructor)) {
          case "Object":
            return O(t, r, n);
        ...
        return t instanceof o ? new o(t.id) : b(t, "Decimal128") ? r && r.flattenDecimals ? t.toJSON() : i.fromString(t.toString()) : !t.constructor && e.isObject(t) ? O(t, r, n) : t[p.schemaTypeSymbol] ? t.clone() : r && r.bson && "function" == typeof t.toBSON ? t : null != t.valueOf ? t.valueOf() : O(t, r, n);
      };
      var w = e.clone;
      /*!
       * ignore
      ...
      function O(t, e, r) {
        ...
        for (var s in t) {
          if (!g.has(s)) {
            var a = w(t[s], e);
            n && void 0 === a || (!1 === n && void 0 === a ? delete i[s] : (o || (o = !0), i[s] = a));
          }
        }
      ...
      e.promiseOrCallback = function (e, r, n) {
        return "function" == typeof e ? r(function (r) {
          if (null == r) e.apply(this, arguments);else {
            null != n && n.listeners("error").length > 0 && !r[y] && (r[y] = !0, n.emit("error", r));
        ...
        }) : new (a.get())(function (t, e) {
          r(function (r, i) {
            return null != r ? (null != n && n.listeners("error").length > 0 && !r[y] && (r[y] = !0, n.emit("error", r)), e(r)) : arguments.length > 2 ? t(Array.prototype.slice.call(arguments, 1)) : void t(i);
          });
        });
      },
      /*!
      ...
      e.merge = function t(r, n, i, s) {
        ...
        for (var f = i.omitNested || {}; u < c;) {
          if (l = a[u++], !(i.omit && i.omit[l] || f[s] || g.has(l))) if (null == r[l]) r[l] = n[l];else if (e.isObject(n[l])) {
            if (e.isObject(r[l]) || (r[l] = {}), null != n[l]) {
              if (n[l].instanceOfSchema) {
                r[l].instanceOfSchema ? r[l].add(n[l].clone()) : r[l] = n[l].clone();
                continue;
              }
      ...
      e.toObject = function t(n) {
        ...
        var i = void 0;
        if (null == n) return n;
        if (n instanceof m) return n.toObject();
      ...
      e.isObject = function (t) {
        return !!d.isBuffer(t) || "[object Object]" === Object.prototype.toString.call(t);
      },
      /*!
       ...
       */
      e.isPOJO = function (t) {
        if (null == t || "object" !== (void 0 === t ? "undefined" : n(t))) return !1;
      ...
      e.isEmptyObject = function (t) {
        return null != t && "object" === (void 0 === t ? "undefined" : n(t)) && 0 === Object.keys(t).length;
      },
      /*!
      ...
      e.hasKey = function (t, r) {
        ...
        try {
          for (var a, u = n[Symbol.iterator](); !(i = (a = u.next()).done); i = !0) {
            var c = a.value;
            if (c === r) return !0;
            if (e.isPOJO(t[c]) && e.hasKey(t[c], r)) return !0;
          }
        } catch (t) {
          o = !0, s = t;
        } finally {
      ...
      e.isMongooseType = function (t) {
        return t instanceof o || t instanceof i || t instanceof d;
      },
      /*!
       ...
       * @api private
       */
      e.isMongooseObject = function (t) {
        return m || (m = r(6)), v || (v = r(23).Array), _ || (_ = r(23).Buffer), null != t && (null != t.$__ || t.isMongooseArray || t.isMongooseBuffer || t.$isMongooseMap);
      };
      var E = e.isMongooseObject;
      /*!
      ...
      e.expires = function (t) {
        if (t && "Object" === t.constructor.name && "expires" in t) {
          var e = void 0;
          e = "string" != typeof t.expires ? t.expires : Math.round(h(t.expires) / 1e3), t.expireAfterSeconds = e, delete t.expires;
        }
      },
      /*!
       * populate helper
       */
      e.populate = function (t, r, i, o, a, u, c, l) {
        var f = null;

        if (1 === arguments.length) {
          if (t instanceof s) return [t];
          if (Array.isArray(t)) return function (t) {
            var e = [];
        ...
        } else f = "object" === (void 0 === i ? "undefined" : n(i)) ? {
          path: t,
          select: r,
          match: i,
          options: o
        ...
        if ("string" != typeof f.path) throw new TypeError("utils.populate: invalid path. Expected string. Got typeof `" + (void 0 === t ? "undefined" : n(t)) + "`");
        return function (t) {
          ...
          } else null != t.populate && "object" === n(t.populate) && (t.populate = e.populate(t.populate));
      ...
      e.hasUserDefinedProperty = function (t, r) {
        ...
        if (Array.isArray(r)) {
          ...
          try {
            for (var a, u = r[Symbol.iterator](); !(i = (a = u.next()).done); i = !0) {
              var c = a.value;
              if (e.hasUserDefinedProperty(t, c)) return !0;
            }
          } catch (t) {
            o = !0, s = t;
          } finally {
        ...
        if ("object" === (void 0 === t ? "undefined" : n(t)) && r in t) {
          var l = t[r];
          return l !== Object.prototype[r] && l !== Array.prototype[r];
        }
      ...
      var j = Math.pow(2, 32) - 1;
      e.isArrayIndex = function (t) {
        return "number" == typeof t ? t >= 0 && t <= j : "string" == typeof t && !!/^\d+$/.test(t) && (t = +t) >= 0 && t <= j;
      },
      /*!
      ...
      e.array.unique = function (t) {
        for (var e = {}, r = {}, n = [], i = t.length, s = 0; s < i; ++s) {
          if ("number" == typeof t[s] || "string" == typeof t[s] || null == t[s]) {
            if (e[t[s]]) continue;
            n.push(t[s]), e[t[s]] = !0;
          } else if (t[s] instanceof o) {
            if (r[t[s].toString()]) continue;
            n.push(t[s]), r[t[s].toString()] = !0;
          } else n.push(t[s]);
        }
      ...
      e.buffer = {}, e.buffer.areEqual = function (t, e) {
        if (!d.isBuffer(t)) return !1;
        if (!d.isBuffer(e)) return !1;
      ...
      e.decorate = function (t, e) {
        ...
        for (var n = Object.keys(r), i = n.length, o = 0, s = void 0; o < i;) {
          if (s = n[o++], !g.has(s)) if (void 0 === t[s]) t[s] = e.clone(r[s], {
            transform: !1,
            virtuals: !1,
            depopulate: !0,
            getters: !1,
            ...
            if (null == a || !a.valueOf || a instanceof Date || (a = a.valueOf()), e.isObject(a)) {
              var u = a;
              E(a) && !a.isMongooseBuffer && (u = u.toObject({
                transform: !1,
                virtuals: !1,
                depopulate: !0,
                getters: !1,
                flattenDecimals: !1
              })), a.isMongooseBuffer && (u = d.from(u)), e.mergeClone(t[s], u);
            } else t[s] = e.clone(a, {
              flattenDecimals: !1
            });
          }
    ...
    (function (t) {
      ...
      e.Buffer = u, e.SlowBuffer = function (t) {
        ...
        var t = 0 | this.length;
        return 0 === t ? "" : 0 === arguments.length ? A(this, 0, t) : function (t, e, r) {
          var n = !1;
      ...
      u.prototype.slice = function (t, e) {
        ...
        return t = +t, e |= 0, r || T(this, t, e, 2, 65535, 0), u.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : B(this, t, e, !0), e + 2;
      }, u.prototype.writeUInt16BE = function (t, e, r) {
        return t = +t, e |= 0, r || T(this, t, e, 2, 65535, 0), u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : B(this, t, e, !1), e + 2;
      }, u.prototype.writeUInt32LE = function (t, e, r) {
        return t = +t, e |= 0, r || T(this, t, e, 4, 4294967295, 0), u.TYPED_ARRAY_SUPPORT ? (this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t) : C(this, t, e, !0), e + 4;
      }, u.prototype.writeUInt32BE = function (t, e, r) {
        return t = +t, e |= 0, r || T(this, t, e, 4, 4294967295, 0), u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : C(this, t, e, !1), e + 4;
        ...
        return t = +t, e |= 0, r || T(this, t, e, 2, 32767, -32768), u.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : B(this, t, e, !0), e + 2;
      }, u.prototype.writeInt16BE = function (t, e, r) {
        return t = +t, e |= 0, r || T(this, t, e, 2, 32767, -32768), u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : B(this, t, e, !1), e + 2;
      }, u.prototype.writeInt32LE = function (t, e, r) {
        return t = +t, e |= 0, r || T(this, t, e, 4, 2147483647, -2147483648), u.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24) : C(this, t, e, !0), e + 4;
      }, u.prototype.writeInt32BE = function (t, e, r) {
        return t = +t, e |= 0, r || T(this, t, e, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : C(this, t, e, !1), e + 4;
        ...
        if (e >>>= 0, r = void 0 === r ? this.length : r >>> 0, t || (t = 0), "number" == typeof t) for (o = e; o < r; ++o) {
          ...
          var s = u.isBuffer(t) ? t : L(new u(t, n).toString()),
              a = s.length;
    ...
    (function (t) {
      ...
      function f(t, r, n) {
        ...
        var c,
            ...
            w = !1,
            A = ["{", "}"];
        (d(r) && (w = !0, A = ["[", "]"]), E(r)) && (l = " [Function" + (r.name ? ": " + r.name : "") + "]");
      ...
      function p(t, e, r, n, i, o) {
        ...
        if ((u = Object.getOwnPropertyDescriptor(e, i) || {
          value: e[i]
        }).get ? a = u.set ? t.stylize("[Getter/Setter]", "special") : t.stylize("[Getter]", "special") : u.set && (a = t.stylize("[Setter]", "special")), x(n, i) || (s = "[" + i + "]"), a || (t.seen.indexOf(u.value) < 0 ? (a = _(r) ? f(t, u.value, null) : f(t, u.value, r - 1)).indexOf("\n") > -1 && (a = o ? a.split("\n").map(function (t) {
          return "  " + t;
        }).join("\n").substr(2) : "\n" + a.split("\n").map(function (t) {
          return "   " + t;
      ...
      function O(t) {
        return w(t) && "[object Date]" === A(t);
      }

      function S(t) {
        return w(t) && ("[object Error]" === A(t) || t instanceof Error);
      }
      ...
      e.debuglog = function (r) {
        ...
        date: "magenta",
        regexp: "red"
      }, e.isArray = d, e.isBoolean = y, e.isNull = _, e.isNullOrUndefined = function (t) {
        return null == t;
      }, e.isNumber = v, e.isString = m, e.isSymbol = function (t) {
        return "symbol" === (void 0 === t ? "undefined" : n(t));
      }, e.isUndefined = g, e.isRegExp = b, e.isObject = w, e.isDate = O, e.isError = S, e.isFunction = E, e.isPrimitive = function (t) {
      ...
      }, e.inherits = r(92), e._extend = function (t, e) {
        if (!e || !w(e)) return t;
    ...
    t.exports = n, n.messages = r(116), n.Messages = n.messages, n.DocumentNotFoundError = r(117), n.CastError = r(12), n.ValidationError = r(27), n.ValidatorError = r(65), n.VersionError = r(118), n.ParallelSaveError = r(119), n.OverwriteModelError = r(120), n.MissingSchemaError = r(121), n.DivergentArrayError = r(122), n.StrictModeError = r(28);
  }, function (t, e, r) {
    "use strict";
    /*!
    ...
    (function (e, n) {
      ...
      var s = r(18).EventEmitter,
          ...
          $ = r(161),
          j = r(3).inspect,
          x = r(20).internalToObjectOptions,
          N = r(43),
          k = r(1),
          P = k.clone,
          T = k.deepEqual,
          B = k.isMongooseObject,
          C = r(0).arrayAtomicsSymbol,
          D = r(0).documentArrayParent,
          M = r(0).documentSchemaSymbol,
          R = r(0).getSymbol,
          F = r(0).populateModelSymbol,
          I = void 0,
          L = void 0,
          U = void 0,
          V = k.specialProperties;

      function q(t, e, r, n) {
        var o = this;

        if ("object" === (void 0 === r ? "undefined" : i(r)) && null != r && (r = (n = r).skipId), n = n || {}, null == this.schema) {
          var u = k.isObject(e) && !e.instanceOfSchema ? new p(e) : e;
        ...
        var c = this.schema;
        "boolean" == typeof e ? (this.$__.strictMode = e, e = void 0) : (this.$__.strictMode = c.options.strict, this.$__.selected = e);

        for (var l = c.requiredPaths(!0), h = 0; h < l.length; ++h) {
          this.$__.activePaths.require(l[h]);
        }
        ...
        function (t) {
          for (var e = {}, r = Object.keys(t), n = 0; n < r.length; ++n) {
            for (var i = r[n].split("."), o = [], s = 0; s < i.length; ++s) {
              o.push(i[s]), e[o.join(".")] = 1;
            }
          }
        ...
        if (null == this._doc && (this.$__buildDoc(t, e, r, d, y, !1), H(this, e, r, d, y, !0, {
          isNew: this.isNew
        })), t && (t instanceof q && (this.isNew = t.isNew), this.$__original_set ? this.$__original_set(t, void 0, !0) : this.$set(t, void 0, !0)), n.willInit ? s.prototype.once.call(this, "init", function () {
          H(o, e, r, d, y, !1, n.skipDefaults, o.isNew);
        }) : H(this, e, r, d, y, !1, n.skipDefaults, this.isNew), this.$__._id = this._id, this.$locals = {}, !c.options.strict && t) {
          var _ = this;

          Object.keys(this._doc).forEach(function (t) {
            t in c.tree || b(t, null, _);
          });
        }
        ...
        function (t) {
          ...
          for (var r = void 0, n = 0; n < e.length; ++n) {
            "pre" !== (r = e[n])[0] && "post" !== r[0] && "on" !== r[0] && t[r[0]].apply(t, r[1]);
          }
        }
        /*!
         * ignore
      ...
      for (var W in k.each(["on", "once", "emit", "listeners", "removeListener", "setMaxListeners", "removeAllListeners", "addListener"], function (t) {
        q.prototype[t] = function () {
          return this.$__.emitter[t].apply(this.$__.emitter, arguments);
        };
      }), q.prototype.constructor = q, s.prototype) {
        q[W] = s.prototype[W];
      }
      ...
      function H(t, e, r, n, i, o, s) {
        for (var a = Object.keys(t.schema.paths), u = a.length, c = 0; c < u; ++c) {
          var l = void 0,
              f = "",
              h = a[c];
          if ("_id" !== h || !r) for (var p = t.schema.paths[h], d = -1 === h.indexOf(".") ? [h] : h.split("."), y = d.length, _ = !1, v = t._doc, m = 0; m < y && null != v; ++m) {
            var g = d[m];

            if (f += (f.length ? "." : "") + g, !0 === n) {
              if (f in e) break;
            } else if (!1 === n && e && !_) if (f in e) _ = !0;else if (!i[f]) break;
            ...
            if (m === y - 1) {
              ...
              if (e && null !== n) {
                if (!0 === n) {
                  if (h in e) continue;
                  void 0 !== (l = p.getDefault(t, !1)) && (v[g] = l, t.$__.activePaths["default"](h));
                } else _ && void 0 !== (l = p.getDefault(t, !1)) && (v[g] = l, t.$__.activePaths["default"](h));
              } else void 0 !== (l = p.getDefault(t, !1)) && (v[g] = l, t.$__.activePaths["default"](h));
            } else v = v[g];
          }
        }
      }
      ...
      function Y(t) {
        ...
        function (t) {
          Object.keys(t.$__.activePaths.states.require).forEach(function (e) {
            var r = t.schema.path(e);
            null != r && "function" == typeof r.originalRequiredValue && (t.$__.cachedRequired[e] = r.originalRequiredValue.call(t));
          });
        }(t);
        var r = new Set(Object.keys(t.$__.activePaths.states.require).filter(function (e) {
          return !(!t.isSelected(e) && !t.isModified(e)) && (!(e in t.$__.cachedRequired) || t.$__.cachedRequired[e]);
        }));
        ...
        try {
          for (var c, l = i[Symbol.iterator](); !(s = (c = l.next()).done); s = !0) {
            var f = c.value;
            ...
            if (f.$basePath) {
              ...
              try {
                for (var y, _ = r[Symbol.iterator](); !(h = (y = _.next()).done); h = !0) {
                  var v = y.value;
                  (null === v || v.startsWith(f.$basePath + ".")) && r["delete"](v);
                }
              } catch (t) {
                p = !0, d = t;
              } finally {
              ...
              !t.isModified(f.$basePath, o) || t.isDirectModified(f.$basePath) || t.$isDefault(f.$basePath) || (r.add(f.$basePath), e[f.$basePath] = !0);
            }
          }
        } catch (t) {
          a = !0, u = t;
        ...
        try {
          for (var S, E = r[Symbol.iterator](); !(m = (S = E.next()).done); m = !0) {
            var A = S.value,
                $ = t.schema.path(A);
            if ($ && $.$isMongooseArray && (!$.$isMongooseDocumentArray || O($, "schemaOptions.required"))) j(t.$__getValue(A), r, A);
          }
        } catch (t) {
          g = !0, b = t;
        } finally {
        ...
        function j(t, e, r) {
          if (null != t) for (var n = t.length, i = 0; i < n; ++i) {
            Array.isArray(t[i]) ? j(t[i], e, r + "." + i) : e.add(r + "." + i);
          }
        }
        ...
        try {
          for (var T, C = r[Symbol.iterator](); !(N = (T = C.next()).done); N = !0) {
            var D = T.value;

            if (t.schema.nested[D]) {
              var M = t.$__getValue(D);
              B(M) && (M = M.toObject({
                transform: !1
              }));
              var R = w(M, D, x, t.schema);
        ...
        try {
          for (var U, V = r[Symbol.iterator](); !(F = (U = V.next()).done); F = !0) {
            var q = U.value;
            if (t.schema.singleNestedPaths.hasOwnProperty(q)) r["delete"](q);else {
              var W = t.schema.path(q);

              if (W && W.$isSchemaMap) {
                var H = t.$__getValue(q);
                ...
                if (null != H) {
                  ...
                  try {
                    for (var Q, J = H.keys()[Symbol.iterator](); !(Y = (Q = J.next()).done); Y = !0) {
                      var G = Q.value;
                      r.add(q + "." + G);
                    }
                  } catch (t) {
      ...
      function z(t, e, r, n) {
        ...
        for (r = r || {}, s = 0; s < a; ++s) {
          if (u = o[s], h || !i.aliases.hasOwnProperty(u)) {
            if (c = u, null != r.path) {
              if (!u.startsWith(r.path + ".")) continue;
              c = u.substr(r.path.length + 1);
            }

            var p = c.split(".");

            if (void 0 !== (f = P(t.get(u), r))) {
              var d = p.length;
              l = e;
      ...
      q.prototype.schema, Object.defineProperty(q.prototype, "$locals", {
        ...
        enumerable: !1,
        writable: !0
      }), q.prototype.isNew, q.prototype.id, q.prototype.errors, q.prototype.$__buildDoc = function (t, e, r, n, i) {
        for (var o = {}, s = Object.keys(this.schema.paths).filter(function (t) {
          return !t.includes("$*");
          ...
          for (var l = c.split("."), f = l.length, h = f - 1, p = "", d = o, y = !1, _ = 0; _ < f; ++_) {
            var v = l[_];

            if (p += (p.length ? "." : "") + v, !0 === n) {
              if (p in e) break;
            } else if (!1 === n && e && !y) if (p in e) y = !0;else if (!i[p]) break;
      ...
      q.prototype.$__init = function (t, e) {
        if (this.isNew = !1, this.$init = !0, e = e || {}, null != t._id && e.populated && e.populated.length) for (var r = String(t._id), n = 0; n < e.populated.length; ++n) {
          var i = e.populated[n];
          i.isVirtual ? this.populated(i.path, k.getValue(i.path, t), i) : this.populated(i.path, i._docs[r], i);
        }
        /*!
         * Init helper.
         *
        ...
        return function t(e, r, n, i, o) {
          ...
          function h(a) {
            if (l = s[a], c = o + l, u = e.schema.path(c), !e.schema.$isRootDiscriminator || e.isSelected(c)) if (!u && k.isPOJO(r[l])) n[l] || (n[l] = {}), t(e, r[l], n[l], i, c + ".");else if (u) {
              if (null === r[l]) n[l] = null;else if (void 0 !== r[l]) {
                var f = r[l].$__ || {},
                    h = f.wasPopulated || null;
                if (u && !h) try {
                  n[l] = u.cast(r[l], e, !0);
                } catch (t) {
                  e.invalidate(t.path, new _({
                    path: t.path,
                    message: t.message,
                    type: "cast",
                    value: t.value
              ...
              e.isModified(c) || e.$__.activePaths.init(c);
            } else n[l] = r[l];
          }
        }(this, t, this._doc, e),
        /*!
         ...
         */
        function (t, e) {
          if (null == t._id || null == e || 0 === e.length) return;
          var r = String(t._id),
              n = !0,
              i = !1,
              o = void 0;
          ...
          try {
            for (var s, a = e[Symbol.iterator](); !(n = (s = a.next()).done); n = !0) {
              var u = s.value;
              if (!u.isVirtual) for (var c = u.path, l = c.split("."), f = 0; f < l.length - 1; ++f) {
                var h = l.slice(0, f + 1).join("."),
                    p = l.slice(f + 1).join("."),
                    d = t.get(h);

                if (null != d && d.isMongooseDocumentArray) {
                  for (var y = 0; y < d.length; ++y) {
                    d[y].populated(p, u._docs[r][y], u);
                  }
        ...
        var e = Array.from(new Set(Object.keys(this._doc).concat(Object.keys(t)))),
            r = !0,
            n = !1,
            i = void 0;
        ...
        try {
          for (var o, s = e[Symbol.iterator](); !(r = (o = s.next()).done); r = !0) {
            var a = o.value;
            "_id" !== a && (this.schema.options.versionKey && a === this.schema.options.versionKey || this.$set(a, t[a]));
          }
        } catch (t) {
          n = !0, i = t;
        } finally {
        ...
        if (f && ((this.$__.adhocPaths || (this.$__.adhocPaths = {}))[t] = this.schema.interpretAsType(t, r, this.schema.options)), "string" != typeof t) {
          if (null !== t && void 0 !== t) {
            g = e ? e + "." : "", t instanceof q && (t = t.$__isNested ? t.toObject() : t._doc);
            var w = (p = Object.keys(t)).length;
            if (0 === w && !this.schema.options.minimize) return e && this.$set(e, {}), this;
        ...
        function E(e) {
          v = p[e];
          var o = g + v;
          if (_ = this.schema.pathType(o), !0 !== r || g || null == t[v] || "nested" !== _ || null == this._doc[v] || 0 !== Object.keys(this._doc[v]).length || delete this._doc[v], "object" !== i(t[v]) || k.isNativeObject(t[v]) || k.isMongooseType(t[v]) || null == t[v] || "virtual" === _ || "real" === _ || this.$__path(o) instanceof c || this.schema.paths[o] && this.schema.paths[o].options && this.schema.paths[o].options.ref) {
            if (b) {
              if (h && void 0 === t[v] && void 0 !== this.get(v)) return;

              if ("adhocOrUndefined" === _ && (_ = S(this, o, {
                typeOnly: !0
              })), "real" === _ || "virtual" === _) {
                var s = t[v];
                this.schema.paths[o] && this.schema.paths[o].$isSingleNested && t[v] instanceof q && (s = s.toObject({
                  virtuals: !1,
                  transform: !1
                })), this.$set(g + v, s, h, n);
              } else if ("nested" === _ && t[v] instanceof q) this.$set(g + v, t[v].toObject({
                transform: !1
              }), h, n);else if ("throw" === b) throw "nested" === _ ? new l(v, t[v]) : new d(v);
            } else void 0 !== t[v] && this.$set(g + v, t[v], h, n);
          } else this.$__.$setCalled.add(g + v), this.$set(t[v], g + v, h, n);
        }

        var A = this.schema.pathType(t);

        if ("adhocOrUndefined" === A && (A = S(this, t, {
          typeOnly: !0
        })), k.isPOJO(e) && null != e.$__ && null != e._doc && (e = e._doc), "nested" === A && e) {
          if ("object" === (void 0 === e ? "undefined" : i(e)) && null != e) {
            if (a) return this.$set(e, t, h);
            this.$__setValue(t, null), m(this, t);
            var $ = Object.keys(e);
            this.$__setValue(t, {});
            var j = !0,
                x = !1,
            ...
            try {
              for (var T, B = $[Symbol.iterator](); !(j = (T = B.next()).done); j = !0) {
                var C = T.value;
                this.$set(t + "." + C, e[C], h);
              }
            } catch (t) {
            ...
            return this.markModified(t), m(this, t, {
              skipDocArrays: !0
            }), this;
          }

          return this.invalidate(t, new u.CastError("Object", e, t)), this;
        }

        var D = void 0,
            M = -1 === t.indexOf(".") ? [t] : t.split(".");

        if ("string" == typeof this.schema.aliases[M[0]] && (M[0] = this.schema.aliases[M[0]]), "adhocOrUndefined" === A && b) {
          var R = void 0;

          for (y = 0; y < M.length; ++y) {
            var I = M.slice(0, y + 1).join(".");
            if (y + 1 < M.length && "virtual" === this.schema.pathType(I)) return N.set(t, e, this), this;

            if (null != (D = this.schema.path(I)) && D instanceof c) {
              R = !0;
              break;
            }
          }

          if (null == D && (D = S(this, t)), !R && !D) {
            if ("throw" === b) throw new d(t);
            return this;
          }
        } else {
          if ("virtual" === A) return (D = this.schema.virtualpath(t)).applySetters(e, this), this;
          D = this.$__path(t);
        }
        ...
        for (y = 0; y < M.length - 1; ++y) {
          L = L[M[y]], U += (U.length > 0 ? "." : "") + M[y], L || (this.$set(U, {}), this.isSelected(U) || this.unmarkModified(U), L = this.$__getValue(U));
        }

        var V = void 0;
        if (M.length <= 1) V = t;else {
          for (y = 0; y < M.length; ++y) {
            var W = M.slice(0, y + 1).join(".");

            if (null === this.get(W, null, {
              getters: !1
            })) {
              V = W;
              break;
        ...
        var H = null != s.$__.$options.priorDoc ? s.$__.$options.priorDoc.$__getValue(t) : h ? void 0 : s.$__getValue(t);
        if (!D) return this.$__set(V, t, h, M, D, e, H), this;

        if (D.$isSingleNested && null != e && a) {
          ...
          try {
            for (var J, G = Y[Symbol.iterator](); !(z = (J = G.next()).done); z = !0) {
              var X = J.value;
              this.$set(t + "." + X, e[X], h, n);
            }
          } catch (t) {
            K = !0, Q = t;
          } finally {
        ...
        try {
          ...
          tt && e instanceof q && (this.populated(t, e._id, o({}, F, e.constructor)), et = !0);
          var rt = void 0;

          if (D.options && Array.isArray(D.options[this.schema.options.typeKey]) && D.options[this.schema.options.typeKey].length && D.options[this.schema.options.typeKey][0].ref &&
          /*!
           * ignore
           */
          function (t, e) {
            ...
            try {
              for (var o, s = t[Symbol.iterator](); !(r = (o = s.next()).done); r = !0) {
                ...
                var u = a.constructor.modelName;
                if (null == u) return !1;
                if (a.constructor.modelName != e && a.constructor.baseModelName != e) return !1;
              }
            } catch (t) {
              n = !0, i = t;
            } finally {
            ...
            return !0;
          }(e, D.options[this.schema.options.typeKey][0].ref) && (this.ownerDocument ? (rt = o({}, F, e[0].constructor), this.ownerDocument().populated(this.$__fullPath(t), e.map(function (t) {
            return t._id;
          }), rt)) : (rt = o({}, F, e[0].constructor), this.populated(t, e.map(function (t) {
            return t._id;
          }), rt)), et = !0), null == this.schema.singleNestedPaths[t] && (e = D.applySetters(e, this, !1, H)), D.$isMongooseDocumentArray && Array.isArray(e) && e.length > 0 && null != e[0] && null != e[0].$__ && null != e[0].$__.populated) {
            var nt = Object.keys(e[0].$__.populated),
                it = !0,
                ot = !1,
                st = void 0;

            try {
              for (var at, ut = function ut() {
                var r = at.value;
                s.populated(t + "." + r, e.map(function (t) {
                  return t.populated(r);
                }), e[0].$__.populated[r].options);
              }, ct = nt[Symbol.iterator](); !(it = (at = ct.next()).done); it = !0) {
                ut();
              }
            } catch (t) {
              ot = !0, st = t;
          ...
          if (!et && this.$__.populated) {
            if (Array.isArray(e) && this.$__.populated[t]) for (var lt = 0; lt < e.length; ++lt) {
              e[lt] instanceof q && (e[lt] = e[lt]._id);
            }
          ...
          r instanceof u.StrictModeError && r.isImmutableError ? this.invalidate(t, r) : this.invalidate(t, new u.CastError(D.instance, e, t, r)), Z = !1;
        }

        return Z && this.$__set(V, t, h, M, D, e, H), D.$isSingleNested && (this.isDirectModified(t) || null == e) && m(this, t), this;
      }, q.prototype.set = q.prototype.$set, q.prototype.$__shouldModify = function (t, e, r, n, i, o, s) {
        return !!this.isNew || null == this.schema.singleNestedPaths[e] && (void 0 === o && !this.isSelected(e) || !(void 0 === o && e in this.$__.activePaths.states["default"]) && !(this.populated(e) && o instanceof q && T(o._id, s)) && (!T(o, s || this.get(e)) || !!(!r && null !== o && void 0 !== o && e in this.$__.activePaths.states["default"] && T(o, i.getDefault(this, r)))));
      }, q.prototype.$__set = function (t, e, n, i, o, s, a) {
        U = U || r(24);
        var u = this;
        this.$__shouldModify(t, e, n, i, o, s, a) && (this.markModified(t), L || (L = r(63)), s && s.isMongooseArray && (s._registerAtomic("$set", s), s.isMongooseDocumentArray && s.forEach(function (t) {
          t && t.__parentArray && (t.__parentArray = s);
        }), this.$__.activePaths.forEach(function (t) {
          t.startsWith(e + ".") && u.$__.activePaths.ignore(t);
        })));

        for (var c = this._doc, l = 0, f = i.length, h = ""; l < f; l++) {
          var p = l + 1 === f;
          if (h += h ? "." + i[l] : i[l], V.has(i[l])) return;
          p ? c instanceof Map ? c.set(i[l], s) : c[i[l]] = s : k.isPOJO(c[i[l]]) ? c = c[i[l]] : c[i[l]] && c[i[l]] instanceof U ? c = c[i[l]] : c[i[l]] && c[i[l]].$isSingleNested ? c = c[i[l]] : c[i[l]] && Array.isArray(c[i[l]]) ? c = c[i[l]] : (c[i[l]] = c[i[l]] || {}, c = c[i[l]]);
        }
      }, q.prototype.$__getValue = function (t) {
        return k.getValue(t, this._doc);
      }, q.prototype.$__setValue = function (t, e) {
        return k.setValue(t, e, this._doc), this;
      }, q.prototype.get = function (t, e, r) {
        var n = void 0;
        r = r || {}, e && (n = this.schema.interpretAsType(t, e, this.schema.options));
        var i = this.$__path(t);

        if (null == i && (i = this.schema.virtualpath(t)), i instanceof c) {
          var o = this.schema.virtualpath(t);
          null != o && (i = o);
        }
        ...
        if (i instanceof v) {
          if (0 === i.getters.length) return;
          return i.applyGetters(null, this);
        }

        "string" == typeof this.schema.aliases[s[0]] && (s[0] = this.schema.aliases[s[0]]);

        for (var u = 0, l = s.length; u < l; u++) {
          a && a._doc && (a = a._doc), a = null == a ? void 0 : a instanceof Map ? a.get(s[u]) : u === l - 1 ? k.getValue(s[u], a) : a[s[u]];
        }

        if (n && (a = n.cast(a)), null != i && !1 !== r.getters) a = i.applyGetters(a, this);else if (this.schema.nested[t] && r.virtuals) return z(this, k.clone(a) || {}, {
          path: t
        });
        return a;
      },
       ...
       * ignore
       */
      q.prototype[R] = q.prototype.get, q.prototype.$__path = function (t) {
        ...
        if (arguments.length > 0) {
          var r = this.get(t);
          return null == r || "object" === (void 0 === r ? "undefined" : i(r)) && (k.isPOJO(r) ? function t(e) {
            if (null == e) return !0;
            if ("object" !== (void 0 === e ? "undefined" : i(e)) || Array.isArray(e)) return !1;
            var r = !0;
            var n = !1;
            var o = void 0;

            try {
              for (var s, a = Object.keys(e)[Symbol.iterator](); !(r = (s = a.next()).done); r = !0) {
                var u = s.value;
                if (!t(e[u])) return !1;
              }
            } catch (t) {
            ...
            return !0;
          }(r) : 0 === Object.keys(r.toObject(e)).length);
        }
        ...
        t = t || {};
        var e = this;
        return Object.keys(this.$__.activePaths.states.modify).reduce(function (r, n) {
          var o = n.split(".");
          if (r = r.concat(o.reduce(function (t, e, r) {
            return t.concat(o.slice(0, r).concat(e).join("."));
          }, []).filter(function (t) {
            return -1 === r.indexOf(t);
          })), !t.includeChildren) return r;
          var s = e.get(n);
          if (null != s && "object" === (void 0 === s ? "undefined" : i(s))) if (s._doc && (s = s._doc), Array.isArray(s)) {
            for (var a = s.length, u = 0; u < a; ++u) {
              if (-1 === r.indexOf(n + "." + u) && (r.push(n + "." + u), null != s[u] && s[u].$__)) {
                var c = s[u].modifiedPaths(),
                    l = !0,
                    f = !1,
                    h = void 0;
          ...
          } else Object.keys(s).filter(function (t) {
            return -1 === r.indexOf(n + "." + t);
          }).forEach(function (t) {
            r.push(n + "." + t);
          });
          return r;
        ...
        if (this.$__.selected) {
          ...
          var e = Object.keys(this.$__.selected),
              r = e.length,
              n = null,
              i = void 0;
          if (1 === r && "_id" === e[0]) return 0 === this.$__.selected._id;

          for (; r--;) {
            if ("_id" !== (i = e[r]) && A(this.$__.selected[i])) {
              n = !!this.$__.selected[i];
              break;
            }
          }
          ...
          for (var o = t + "."; r--;) {
            if ("_id" !== (i = e[r])) {
              if (i.startsWith(o)) return n || i !== o;
              if (o.startsWith(i + ".")) return n;
            }
          }
        ...
        if (this.$__.selected) {
          ...
          return null === n || (t in this.$__.selected ? n : !n);
        }
        ...
        var n = this,
            i = void 0;
        return null != this.ownerDocument || (this.$__.validating ? i = new h(this, {
          parentStack: e && e.parentStack,
          conflictStack: this.$__.validating.stack
        }) : this.$__.validating = new h(this, {
          parentStack: e && e.parentStack
        })), "function" == typeof t ? (r = t, e = null, t = null) : "function" == typeof e && (r = e, e = t, t = null), k.promiseOrCallback(r, function (r) {
          if (null != i) return r(i);
          n.$__validate(t, e, function (t) {
            n.$__.validating = null, r(t);
          });
        }, this.constructor.events);
      }, q.prototype.$__validate = function (t, r, n) {
        var o = this;
        "function" == typeof t ? (n = t, r = null, t = null) : "function" == typeof r && (n = r, r = null);
        var s = r && "object" === (void 0 === r ? "undefined" : i(r)) && "validateModifiedOnly" in r,
            a = void 0;
        a = s ? !!r.validateModifiedOnly : this.schema.options.validateModifiedOnly;

        var c = this,
            l = function l() {
          var t = o.$__.validationError;

          if (o.$__.validationError = void 0, a && null != t) {
            ...
            try {
              for (var s, l = e[Symbol.iterator](); !(r = (s = l.next()).done); r = !0) {
                var f = s.value;
                o.isModified(f) || delete t.errors[f];
              }
            } catch (t) {
              n = !0, i = t;
            } finally {
          ...
          if (o.$__.cachedRequired = {}, o.emit("validate", c), o.constructor.emit("validate", c), t) {
            for (var h in t.errors) {
              !o[D] && t.errors[h] instanceof u.CastError && o.invalidate(h, t.errors[h]);
            }
        ...
        if (0 === h.length) return e.nextTick(function () {
          var t = l();
          if (t) return c.schema.s.hooks.execPost("validate:error", c, [c], {
            error: t
          }, function (t) {
            n(t);
          });
        ...
        for (var _ = {}, v = 0, m = function m() {
          ...
          null == t || _[t] || (_[t] = !0, v++, e.nextTick(function () {
            var e = c.schema.path(t);
            if (!e) return --v || m();

            if (c.$isValid(t)) {
              var r = c.$__getValue(t),
                  n = void 0;
              null == r && (n = c.populated(t)) && (r = n);
              var i = (t in c.$__.pathsToScopes) ? c.$__.pathsToScopes[t] : c,
                  o = {
                skipSchemaValidators: p[t],
                path: t
              };
              e.doValidate(r, function (r) {
                if (r && (!e.$isMongooseDocumentArray || r.$isArrayValidatorError)) {
                  if (e.$isSingleNested && r instanceof y && !1 === e.schema.options.storeSubdocValidationError) return --v || m();
        ...
        var r = this,
            n = this,
            o = void 0;
        o = e && "object" === (void 0 === e ? "undefined" : i(e)) && "validateModifiedOnly" in e ? !!e.validateModifiedOnly : this.schema.options.validateModifiedOnly, "string" == typeof t && (t = t.split(" "));
        var s = Y(this),
            a = o ? s[0].filter(function (t) {
        ...
        a.forEach(function (t) {
          if (!h[t]) {
            h[t] = !0;
            var e = n.schema.path(t);

            if (e && n.$isValid(t)) {
              var r = n.$__getValue(t),
                  i = e.doValidateSync(r, n, {
                skipSchemaValidators: c[t],
                path: t
              });

              if (i && (!e.$isMongooseDocumentArray || i.$isArrayValidatorError)) {
                if (e.$isSingleNested && i instanceof y && !1 === e.schema.options.storeSubdocValidationError) return;
                n.invalidate(t, i, void 0, !0);
              }
            }
          }
        });
        var p = n.$__.validationError;
        if (n.$__.validationError = void 0, n.emit("validate", n), n.constructor.emit("validate", n), p) for (var d in p.errors) {
          p.errors[d] instanceof u.CastError && n.invalidate(d, p.errors[d]);
        }
        return p;
      }, q.prototype.invalidate = function (t, e, r, n) {
        if (this.$__.validationError || (this.$__.validationError = new y(this)), !this.$__.validationError.errors[t]) return e && "string" != typeof e || (e = new _({
          path: t,
          message: e,
          type: n || "user defined",
          value: r
        })), this.$__.validationError === e ? this.$__.validationError : (this.$__.validationError.addError(t, e), this.$__.validationError);
        ...
        var t = this;
        return I || (I = r(16)), this.$__.activePaths.map("init", "modify", function (e) {
          ...
          t.$__.activePaths.init(e.$path()), e[C] = {};
        ...
        (e = e.concat(this.$__.activePaths.map("default", function (e) {
          ...
          return t.path < e.path ? -1 : t.path > e.path ? 1 : 0;
        });
        var r = [],
            n = void 0,
            i = void 0;
        return e.forEach(function (t) {
          t && (null == n || 0 !== t.path.indexOf(n) ? (n = t.path + ".", r.push(t), i = t) : null != i && null != i.value && null != i.value[C] && i.value.hasAtomics() && (i.value[C] = {}, i.value[C].$set = i.value));
        }), i = n = null, r;
      }, q.prototype.$__setSchema = function (t) {
        t.plugin(E, {
          deduplicate: !0
        }), g(t.tree, this, void 0, t.options);
        var e = !0,
            r = !1,
            n = void 0;

        try {
          for (var i, o = Object.keys(t.virtuals)[Symbol.iterator](); !(e = (i = o.next()).done); e = !0) {
            var s = i.value;

            t.virtuals[s]._applyDefaultGetters();
          }
        } catch (t) {
          r = !0, n = t;
        } finally {
        ...
        this.schema = t, this[M] = t;
      }, q.prototype.$__getArrayPathsToValidate = function () {
        return I || (I = r(16)), this.$__.activePaths.map("init", "modify", function (t) {
        ...
        return Object.keys(this._doc).reduce(function (e, r) {
          return function t(e, r, n) {
            var i = e;
            return n && (i = e instanceof q && e[M].paths[n] ? e._doc[n] : e[n]), i instanceof U ? r.push(i) : i instanceof Map ? r = Array.from(i.keys()).reduce(function (e, r) {
              return t(i.get(r), e, null);
            }, r) : i && i.$isSingleNested ? (r = Object.keys(i._doc).reduce(function (e, r) {
              return t(i._doc, e, r);
            }, r)).push(i) : i && i.isMongooseDocumentArray ? i.forEach(function (e) {
              e && e._doc && (r = Object.keys(e._doc).reduce(function (r, n) {
                return t(e._doc, r, n);
              }, r), e instanceof U && r.push(e));
            }) : i instanceof q && i.$__isNested && (r = Object.keys(i).reduce(function (e, r) {
              return t(i, e, r);
            }, r)), r;
          }(t, e, r);
        }, []);
      }, q.prototype.$__handleReject = function (t) {
        this.listeners("error").length ? this.emit("error", t) : this.constructor.listeners && this.constructor.listeners("error").length ? this.constructor.emit("error", t) : this.listeners && this.listeners("error").length && this.emit("error", t);
        ...
        var r = {
          ...
          flattenDecimals: !0
            ...
            i = e ? "toJSON" : "toObject",
            o = O(this, "constructor.base.options." + i, {}),
            s = O(this, "schema.options", {});
        r = k.options(r, P(o)), r = k.options(r, P(s[i] || {})), "flattenMaps" in (t = k.isPOJO(t) ? P(t) : {}) || (t.flattenMaps = r.flattenMaps);
        var a = void 0;
        a = null != t.minimize ? t.minimize : null != r.minimize ? r.minimize : s.minimize;
        var u = Object.assign(k.clone(t), {
          _isNested: !0,
          json: e,
          minimize: a
        });
        if (k.hasUserDefinedProperty(t, "getters") && (u.getters = t.getters), k.hasUserDefinedProperty(t, "virtuals") && (u.virtuals = t.virtuals), (t.depopulate || O(t, "_parentOptions.depopulate", !1)) && t._isNested && this.$__.wasPopulated) return P(this._id, u);
        (t = k.options(r, t))._isNested = !0, t.json = e, t.minimize = a, u._parentOptions = t, u._skipSingleNestedGetters = !0;
        ...
        t.getters && (!function (t, e, r) {
          ...
          for (; o--;) {
            var c = (s = i[o]).split("."),
                ...
                h = e,
                p = void 0;
            if (a = t._doc, t.isSelected(s)) for (var d = 0; d < l; ++d) {
              if (p = c[d], u = a[p], d === f) {
                var y = t.get(s);
                h[p] = P(y, r);
              } else {
        ...
        function t(e) {
          ...
          for (; i--;) {
            s = r[i], a = e[s], k.isObject(a) && !n.isBuffer(a) && (e[s] = t(a)), void 0 !== e[s] ? o = !0 : delete e[s];
          }

          return o ? e : void 0;
        }(f) || {})), (t.virtuals || t.getters && !1 !== t.virtuals) && z(this, f, c, t), !1 === t.versionKey && this.schema.options.versionKey && delete f[this.schema.options.versionKey];
        var h = t.transform;

        if (!0 === h || s.toObject && h) {
          var p = t.json ? s.toJSON : s.toObject;
          p && (h = "function" == typeof t.transform ? t.transform : p.transform);
        } else t.transform = l;
      ...
      /*!
        ...
        */
      q.prototype[j.custom] = q.prototype.inspect), q.prototype.toString = function () {
        var t = this.inspect();
        ...
        var e = this.get("_id"),
            r = t.get ? t.get("_id") : t;
        return e || r ? e && e.equals ? e.equals(r) : e === r : T(this, t);
      }, q.prototype.populate = function () {
        if (0 === arguments.length) return this;
        var t = this.$__.populate || (this.$__.populate = {}),
            e = k.args(arguments),
            r = void 0;
        if ("function" == typeof e[e.length - 1] && (r = e.pop()), e.length) for (var n = k.populate.apply(null, e), i = 0; i < n.length; ++i) {
          t[n[i].path] = n[i];
        }

        if (r) {
          var o = k.object.vals(t);
        ...
        var e = this;
        return k.promiseOrCallback(t, function (t) {
          e.populate(t);
        }, this.constructor.events);
        ...
        var e = void 0,
            ...
            n = O(this, "$__.populated", {});

        if (0 === arguments.length) {
          for (var i = 0; i < r.length; i++) {
            delete this.$$populatedVirtuals[r[i]], delete this._doc[r[i]], delete n[r[i]];
          }

          for (var o = Object.keys(n), s = 0; s < o.length; s++) {
            (e = this.populated(o[s])) && (delete n[o[s]], this.$set(o[s], e));
          }
        ...
        for (var a = 0; a < t.length; a++) {
          e = this.populated(t[a]), delete n[t[a]], -1 !== r.indexOf(t[a]) ? (delete this.$$populatedVirtuals[t[a]], delete this._doc[t[a]]) : e && this.$set(t[a], e);
        }
       ...
       * Module exports.
       */
      q.ValidationError = y, t.exports = q;
    ...
    (function (n) {
      ...
      function m(t, e, r) {
        this[h] = !0, this.path = t, this.instance = r, this.validators = [], this.getters = this.constructor.hasOwnProperty("getters") ? this.constructor.getters.slice() : [], this.setters = [];
        var n = this.OptionsConstructor || s;
        this.options = new n(e), this._index = null, this.selected, d.hasUserDefinedProperty(this.options, "immutable") && (this.$immutable = this.options.immutable, l(this));
        var o = Object.keys(this.options),
            a = !0,
            u = !1,
            c = void 0;
        ...
        try {
          for (var f, p = o[Symbol.iterator](); !(a = (f = p.next()).done); a = !0) {
            ...
            if ("cast" !== y && d.hasUserDefinedProperty(this.options, y) && "function" == typeof this[y]) {
              if ("index" === y && this._index) {
                if (!1 === e.index) {
                  var _ = this._index;

                  if ("object" === (void 0 === _ ? "undefined" : i(_)) && null != _) {
                    if (_.unique) throw new Error('Path "' + this.path + '" may not have `index` set to false and `unique` set to true');
                    if (_.sparse) throw new Error('Path "' + this.path + '" may not have `index` set to false and `sparse` set to true');
                  }
      ...
      m.prototype.OptionsConstructor = s, m.cast = function (t) {
        return 0 === arguments.length ? this._cast : (!1 === t && (t = function t(_t) {
          return _t;
        }), this._cast = t, this._cast);
      }, m.get = function (t) {
        this.getters = this.hasOwnProperty("getters") ? this.getters : [], this.getters.push(t);
      }, m.prototype["default"] = function (t) {
        return 1 === arguments.length ? void 0 === t ? void (this.defaultValue = void 0) : (this.defaultValue = t, this.defaultValue) : (arguments.length > 1 && (this.defaultValue = d.args(arguments)), this.defaultValue);
      }, m.prototype.index = function (t) {
        return this._index = t, d.expires(this._index), this;
      }, m.prototype.unique = function (t) {
        if (!1 === this._index) {
          if (!t) return;
        ...
        return null == this._index || !0 === this._index ? this._index = {} : "string" == typeof this._index && (this._index = {
          type: this._index
        }), this._index.unique = t, this;
      }, m.prototype.text = function (t) {
        if (!1 === this._index) {
          if (!t) return;
        ...
        return null === this._index || void 0 === this._index || "boolean" == typeof this._index ? this._index = {} : "string" == typeof this._index && (this._index = {
          type: this._index
        }), this._index.text = t, this;
      }, m.prototype.sparse = function (t) {
        if (!1 === this._index) {
          if (!t) return;
        ...
        return null == this._index || "boolean" == typeof this._index ? this._index = {} : "string" == typeof this._index && (this._index = {
          type: this._index
        }), this._index.sparse = t, this;
      }, m.prototype.immutable = function (t) {
        return this.$immutable = t, l(this), this;
      ...
      }, m.prototype.validate = function (t, e, r) {
        if ("function" == typeof t || t && "RegExp" === d.getFunctionName(t.constructor)) {
          var n = void 0;
          return "function" == typeof e ? (n = {
            validator: t,
            message: e
          }).type = r || "user defined" : e instanceof Object && !r ? ((n = d.clone(e)).message || (n.message = n.msg), n.validator = t, n.type = n.type || "user defined") : (null == e && (e = o.messages.general["default"]), r || (r = "user defined"), n = {
            message: e,
            type: r,
            validator: t
          }), n.isAsync && g(), this.validators.push(n), this;
        }
        ...
        for (a = 0, s = arguments.length; a < s; a++) {
          if (u = arguments[a], !d.isPOJO(u)) {
            var c = "Invalid validator. Received (" + (void 0 === u ? "undefined" : i(u)) + ") " + u + ". See http://mongoosejs.com/docs/api.html#schematype_SchemaType-validate";
            throw new Error(c);
          }
      ...
      m.prototype.required = function (t, e) {
        var r = {};
        ...
        if ("object" === (void 0 === t ? "undefined" : i(t)) && (e = (r = t).message || e, t = t.isRequired), !1 === t) return this.validators = this.validators.filter(function (t) {
          return t.validator !== this.requiredValidator;
        }, this), this.isRequired = !1, delete this.originalRequiredValue, this;
        var n = this;
        this.isRequired = !0, this.requiredValidator = function (e) {
          var r = c(this, "$__.cachedRequired");
          if (null != r && !this.isSelected(n.path) && !this.isModified(n.path)) return !0;
      ...
      }, m.prototype.ref = function (t) {
        return this.options.ref = t, this;
      }, m.prototype.getDefault = function (t, e) {
        var r = "function" == typeof this.defaultValue ? this.defaultValue.call(t) : this.defaultValue;

        if (null !== r && void 0 !== r) {
          "object" !== (void 0 === r ? "undefined" : i(r)) || this.options && this.options.shared || (r = d.clone(r));
          var n = this.applySetters(r, t, e);
          return n && n.$isSingleNested && (n.$parent = t), n;
        }
       ...
       * @api private
       */
      m.prototype._applySetters = function (t, e, r, n) {
        for (var i = t, o = this.setters, s = o.length, a = this.caster; s--;) {
          i = o[s].call(e, i, this);
        }

        if (Array.isArray(i) && a && a.setters) {
          for (var u = [], c = 0; c < i.length; c++) {
            u.push(a.applySetters(i[c], e, r, n));
          }
        ...
        return i;
      }, m.prototype.applySetters = function (t, e, r, n, i) {
        var o = this._applySetters(t, e, r, n, i);

        return null == o ? o : o = this.cast(o, e, r, n, i);
      }, m.prototype.applyGetters = function (t, e) {
        var r = t,
            n = this.getters,
            i = n.length;
        if (0 === i) return r;
        ...
        var c = function c(t, r) {
          if (!o) if (void 0 === t || t) --u <= 0 && f(function () {
            e(null);
          });else {
            var n = r.ErrorConstructor || v;
            (o = new n(r))[y] = !0, f(function () {
              e(o);
            });
          }
        },
        ...
        a.forEach(function (e) {
          if (!o) {
            var i = e.validator,
                a = void 0,
                u = d.clone(e);
            if (u.path = n && n.path ? n.path : s, u.value = t, i instanceof RegExp) c(i.test(t), u);else if ("function" == typeof i) {
              if (void 0 === t && i !== l.requiredValidator) return void c(!0, u);
              if (u.isAsync) !
              /*!
              ...
              function (t, e, r, n, i) {
                var o = !1,
                    s = t.call(e, r, function (t, e) {
                  o || (o = !0, e && (n.message = e), i(t, n));
                });
                "boolean" == typeof s ? (o = !0, i(s, n)) : s && "function" == typeof s.then && s.then(function (t) {
                  o || (o = !0, i(t, n));
                }, function (t) {
                  o || (o = !0, n.reason = t, n.message = t.message, i(!1, n));
                });
              }(i, r, t, u, c);else {
                try {
                  a = u.propsParameter ? i.call(r, t, u) : i.call(r, t);
                } catch (t) {
                  a = !1, u.reason = t, t.message && (u.message = t.message);
                }

                null != a && "function" == typeof a.then ? a.then(function (t) {
                  c(t, u);
                }, function (t) {
                  u.reason = t, u.message = t.message, c(a = !1, u);
                }) : c(a, u);
              }
            }
          }
        ...
        return a.forEach(function (a) {
          if (!n && null != a && "object" === (void 0 === a ? "undefined" : i(a))) {
            var u = a.validator,
                c = d.clone(a);
            c.path = r && r.path ? r.path : o, c.value = t;
            var l = void 0;
            if (!u.isAsync) if (u instanceof RegExp) s(u.test(t), c);else if ("function" == typeof u) {
              try {
                l = c.propsParameter ? u.call(e, t, c) : u.call(e, t);
              } catch (t) {
                l = !1, c.reason = t;
              }

              if (null != l && "function" == typeof l.then) return;
              s(l, c);
            }
          }
        }), n;
      }, m._isRef = function (t, e, r, i) {
        var o = i && t.options && (t.options.ref || t.options.refPath);

        if (!o && r && null != r.$__) {
          var s = r.$__fullPath(t.path);
          o = (r.ownerDocument ? r.ownerDocument() : r).populated(s) || r.populated(t.path);
        }

        if (o) {
          if (null == e) return !0;
          if (!n.isBuffer(e) && "Binary" !== e._bsontype && d.isObject(e)) return !0;
        }
       ...
       */
      m.prototype.castForQueryWrapper = function (t) {
        return this.$$context = t.context, "$conditional" in t ? this.castForQuery(t.$conditional, t.val) : t.$skipQueryCastForUpdate || t.$applySetters ? this._castForQuery(t.val) : this.castForQuery(t.val);
      }, m.prototype.castForQuery = function (t, e) {
        var r = void 0;
       ...
       * Module exports.
       */
      t.exports = e = m, e.CastError = _, e.ValidatorError = v;
    ...
    var n = r(1),
      ...
      Object.assign(this, n.clone(e));
    },
        o = r(10);

    Object.defineProperty(i.prototype, "type", o), Object.defineProperty(i.prototype, "validate", o), Object.defineProperty(i.prototype, "cast", o), Object.defineProperty(i.prototype, "required", o), Object.defineProperty(i.prototype, "default", o), Object.defineProperty(i.prototype, "ref", o), Object.defineProperty(i.prototype, "select", o), Object.defineProperty(i.prototype, "index", o), Object.defineProperty(i.prototype, "unique", o), Object.defineProperty(i.prototype, "immutable", o), Object.defineProperty(i.prototype, "sparse", o), Object.defineProperty(i.prototype, "text", o), t.exports = i;
  }, function (t, e, r) {
    "use strict";
    ...
    function s(t, e, r, s, a) {
      var u = o.inspect(e);
      (u = u.replace(/^'/, '"').replace(/'$/, '"')).startsWith('"') || (u = '"' + u + '"'), "string" == typeof i(a, "options.cast", null) && (this.messageFormat = a.options.cast), this.stringValue = u, this.kind = t, this.value = e, this.path = r, this.reason = s, n.call(this, this.formatMessage()), this.name = "CastError", Error.captureStackTrace ? Error.captureStackTrace(this) : this.stack = new Error().stack;
    }
    /*!
     ...
     * ignore
     */
    s.prototype.setModel = function (t) {
      this.model = t, this.message = this.formatMessage(t);
    },
    /*!
     * ignore
     */
    ...
    (function (e) {
      ...
      t.exports = {
        normalizedFunctionString: function normalizedFunctionString(t) {
    ...
    (function (e) {
      ...
      var o = r(64),
        ...
        return function (t, e) {
          ...
          key: "map",
          value: function value() {
            var t = i(r.prototype.__proto__ || Object.getPrototypeOf(r.prototype), "map", this).apply(this, arguments);
            return t[_] = null, t[y] = null, t[d] = null, t;
          }
        }, {
          key: "_cast",
          value: function value(t, r) {
            if (null == this[_]) return t;
            var n = this[_].casterConstructor;
            if ((n.$isMongooseDocumentArray ? t && t.isMongooseDocumentArray : t instanceof n) || t && t.constructor && t.constructor.baseCasterConstructor === n) return t[v] && t.__parentArray || (t[v] = this[d], t.__parentArray = this), t.$setIndex(r), t;
            if (void 0 === t || null === t) return null;
            if ((e.isBuffer(t) || t instanceof a || !h.isObject(t)) && (t = {
              _id: t
              ...
              var i = c(n, t[n.schema.options.discriminatorKey]);
              i && (n = i);
            }
          ...
          value: function value(t) {
            ...
            for (var i = 0, o = this.length; i < o; i++) {
              if (this[i] && null !== (n = this[i].get("_id")) && void 0 !== n) if (n instanceof s) {
                if (r || (r = String(t)), r == n._id) return this[i];
              } else if (t instanceof a || n instanceof a) {
                if (e == n) return this[i];
              } else if (h.deepEqual(t, n)) return this[i];
            }
          ...
          key: "slice",
          value: function value() {
            var t = i(r.prototype.__proto__ || Object.getPrototypeOf(r.prototype), "slice", this).apply(this, arguments);
            return t[d] = this[d], t[y] = this[y], t;
          }
        }, {
          key: "push",
          value: function value() {
            var t = i(r.prototype.__proto__ || Object.getPrototypeOf(r.prototype), "push", this).apply(this, arguments);
            return b(this), t;
          }
        }, {
          key: "pull",
          value: function value() {
            var t = i(r.prototype.__proto__ || Object.getPrototypeOf(r.prototype), "pull", this).apply(this, arguments);
            return b(this), t;
          }
        }, {
          key: "shift",
          value: function value() {
            var t = i(r.prototype.__proto__ || Object.getPrototypeOf(r.prototype), "shift", this).apply(this, arguments);
            return b(this), t;
          }
        }, {
          key: "splice",
          value: function value() {
            var t = i(r.prototype.__proto__ || Object.getPrototypeOf(r.prototype), "splice", this).apply(this, arguments);
            return b(this), t;
          }
        }, {
          key: "inspect",
          ...
          key: "create",
          value: function value(t) {
            var e = this[_].casterConstructor;
            if (t && e.discriminators && e.schema && e.schema.options && e.schema.options.discriminatorKey) if ("string" == typeof t[e.schema.options.discriminatorKey] && e.discriminators[t[e.schema.options.discriminatorKey]]) e = e.discriminators[t[e.schema.options.discriminatorKey]];else {
              var r = c(e, t[e.schema.options.discriminatorKey]);
              r && (e = r);
            }
            return new e(t, this);
          }
      ...
      function b(t) {
        ...
        if (e && null != e.$__.populated) {
          ...
          try {
            ...
            }, u = r[Symbol.iterator](); !(n = (s = u.next()).done); n = !0) {
              a();
            }
          } catch (t) {
            i = !0, o = t;
      ...
      t.exports = function (t, e, r) {
        var n = new g();
        if (n[p] = {}, n[_] = void 0, Array.isArray(t) && (t instanceof g && t[y] === e && t[d] === r && (n[p] = Object.assign({}, t[p])), t.forEach(function (t) {
          m.call(n, t);
        })), n[y] = e, r && r instanceof s) for (n[d] = r, n[_] = r.schema.path(e); null != n && null != n[_] && n[_].$isMongooseArray && !n[_].$isMongooseDocumentArray;) {
          n[_] = n[_].casterConstructor;
        }
        return n;
      };
    }).call(this, r(2).Buffer);
    ...
    function f(t, e, r, n) {
      ...
      if (void 0 === (s = t._events) ? (s = t._events = Object.create(null), t._eventsCount = 0) : (void 0 !== s.newListener && (t.emit("newListener", e, r.listener ? r.listener : r), s = t._events), a = s[e]), void 0 === a) a = s[e] = r, ++t._eventsCount;else if ("function" == typeof a ? a = s[e] = n ? [r, a] : [a, r] : n ? a.unshift(r) : a.push(r), (o = l(t)) > 0 && a.length > o && !a.warned) {
        a.warned = !0;
        ...
        u.name = "MaxListenersExceededWarning", u.emitter = t, u.type = e, u.count = a.length, function (t) {
    ...
    (function (e) {
      ...
      p.AssertionError = function (t) {
        this.name = "AssertionError", this.actual = t.actual, this.expected = t.expected, this.operator = t.operator, t.message ? (this.message = t.message, this.generatedMessage = !1) : (this.message = function (t) {
          return _(v(t.actual), 128) + " " + t.operator + " " + _(v(t.expected), 128);
    ...
    n.prototype.toInt = function () {
      ...
      for (r = this; r.greaterThanOrEqual(t);) {
        ...
        for (var o = Math.ceil(Math.log(e) / Math.LN2), s = o <= 48 ? 1 : Math.pow(2, o - 48), a = n.fromNumber(e), u = a.multiply(t); u.isNegative() || u.greaterThan(r);) {
          e -= s, u = (a = n.fromNumber(e)).multiply(t);
        }
    ...
    e.Array = r(63), e.Buffer = r(67), e.Document = e.Embedded = r(24), e.DocumentArray = r(16), e.Decimal128 = r(22), e.ObjectId = r(14), e.Map = r(69), e.Subdocument = r(71);
  }, function (t, e, r) {
    "use strict";
    /*!
     * Module dependencies.
    ...
    var n = r(56)(),
        ...
        o = r(27),
        s = r(44),
        a = r(20).internalToObjectOptions,
        u = r(5),
        c = r(1),
        l = r(3),
    ...
    for (var d in p.prototype = Object.create(n.prototype), p.prototype.constructor = p, i.prototype) {
      p[d] = i.prototype[d];
    }

    p.prototype.toBSON = function () {
      return this.toObject(a);
    },
    /*!
     * ignore
     */
    p.prototype.$setIndex = function (t) {
      if (this.__index = t, null != u(this, "$__.validationError", null)) {
        var e = Object.keys(this.$__.validationError.errors),
            r = !0,
            n = !1,
            i = void 0;
        ...
        try {
          for (var o, s = e[Symbol.iterator](); !(r = (o = s.next()).done); r = !0) {
            var a = o.value;
            this.invalidate(a, this.$__.validationError.errors[a]);
          }
        } catch (t) {
          n = !0, i = t;
        } finally {
    ...
    }, p.prototype.markModified = function (t) {
      this.$__.activePaths.modify(t), this.__parentArray && (this.isNew ? this.__parentArray._markModified() : this.__parentArray._markModified(this, t));
    },
    /*!
     * ignore
     */
     ...
     * no-op for hooks
     */
    p.prototype.$__remove = function (t) {
      return t(null, this);
    }, p.prototype.remove = function (t, e) {
      if ("function" != typeof t || e || (e = t, t = void 0), !this.__parentArray || t && t.noop) return e && e(null), this;
      var r = void 0;

      if (!this.willRemove) {
        if (!(r = this._doc._id)) throw new Error("For your own good, Mongoose does not know how to remove an EmbeddedDocument that has no _id");
    ...
    /*!
      * Avoid Node deprecation warning DEP0079
      */
    p.prototype[l.inspect.custom] = p.prototype.inspect), p.prototype.invalidate = function (t, e, r) {
      if (n.prototype.invalidate.call(this, t, e, r), !this[f] || null == this.__index) {
        if (e[h] || e instanceof o) return !0;
        throw e;
      }

      var i = this.__index,
          s = [this.__parentArray.$path(), i, t].join(".");
      return this[f].invalidate(s, e, r), !0;
    }, p.prototype.$markValid = function (t) {
      if (this[f]) {
        var e = this.__index;
    ...
    p.prototype.$ignore = function (t) {
      ...
      if (!this.$__.fullPath) {
        ...
        for (var r = []; e[f] || e.$parent;) {
          e[f] ? r.unshift(e.__parentArray.$path()) : r.unshift(e.$basePath), e = e[f] || e.$parent;
        }
    ...
    (function (e) {
      ...
      o.prototype.put = function (t) {
        ...
        var e = null;
        if (e = "string" == typeof t ? t.charCodeAt(0) : null != t.length ? t[0] : t, this.buffer.length > this.position) this.buffer[this.position++] = e;else if (void 0 !== n && n.isBuffer(this.buffer)) {
        ...
        if (e = "number" == typeof e ? e : this.position, this.buffer.length < e + t.length) {
          var r = null;
          if (void 0 !== n && n.isBuffer(this.buffer)) r = i.allocBuffer(this.buffer.length + t.length), this.buffer.copy(r, 0, 0, this.buffer.length);else if ("[object Uint8Array]" === Object.prototype.toString.call(this.buffer)) {
            r = new Uint8Array(new ArrayBuffer(this.buffer.length + t.length));

            for (var o = 0; o < this.position; o++) {
              r[o] = this.buffer[o];
            }
          }
          this.buffer = r;
        ...
        if (void 0 !== n && n.isBuffer(t) && n.isBuffer(this.buffer)) t.copy(this.buffer, e, 0, t.length), this.position = e + t.length > this.position ? e + t.length : this.position;else if (void 0 !== n && "string" == typeof t && n.isBuffer(this.buffer)) this.buffer.write(t, e, "binary"), this.position = e + t.length > this.position ? e + t.length : this.position;else if ("[object Uint8Array]" === Object.prototype.toString.call(t) || "[object Array]" === Object.prototype.toString.call(t) && "string" != typeof t) {
        ...
        for (var r = "undefined" != typeof Uint8Array ? new Uint8Array(new ArrayBuffer(e)) : new Array(e), n = 0; n < e; n++) {
          r[n] = this.buffer[t++];
        }
        ...
        if (t) {
          ...
          for (var e = "[object Uint8Array]" === Object.prototype.toString.call(this.buffer) ? new Uint8Array(new ArrayBuffer(this.position)) : new Array(this.position), r = 0; r < this.position; r++) {
            e[r] = this.buffer[r];
          }
      ...
      var s = 0,
          a = function a(t) {
        for (var e = "undefined" != typeof Uint8Array ? new Uint8Array(new ArrayBuffer(t.length)) : new Array(t.length), r = 0; r < t.length; r++) {
          e[r] = t.charCodeAt(r);
        }
    ...
    function o(t) {
      this.errors = {}, this._message = "", n.call(this, this._message), t && "model" === t.constructor.name ? this._message = t.constructor.modelName + " validation failed" : this._message = "Validation failed", this.name = "ValidationError", Error.captureStackTrace ? Error.captureStackTrace(this) : this.stack = new Error().stack, t && (t.errors = this.errors);
    }
    /*!
     * Inherits from MongooseError.
     */
    ...
    function s(t) {
      for (var e = Object.keys(t.errors || {}), r = e.length, n = [], i = void 0, o = 0; o < r; ++o) {
        i = e[o], t !== t.errors[i] && n.push(i + ": " + t.errors[i].message);
      }
    ...
    o.prototype = Object.create(n.prototype), o.prototype.constructor = n, o.prototype.toString = function () {
     ...
     * add message
     */
    o.prototype.addError = function (t, e) {
      this.errors[t] = e, this.message = this._message + ": " + s(this);
    }, t.exports = o;
  }, function (t, e, r) {
    "use strict";
    /*!
    ...
    function i(t, e, r) {
      e = e || "Field `" + t + "` is not in schema and strict mode is set to throw.", n.call(this, e), this.name = "StrictModeError", this.isImmutableError = !!r, Error.captureStackTrace ? Error.captureStackTrace(this) : this.stack = new Error().stack, this.path = t;
    }
    /*!
     * Inherits from MongooseError.
     */
    ...
    function s(t, e) {
      if (e && e["default"]) {
        var r = e["default"];
        Array.isArray(r) && 0 === r.length ? e["default"] = Array : !e.shared && o.isObject(r) && 0 === Object.keys(r).length && (e["default"] = function () {
          return {};
        });
      }
     ...
     */
    s.prototype = Object.create(n.prototype), s.prototype.constructor = s, s.get = n.get, s.prototype.cast = function (t) {
      return t;
    ...
    (function (e, n) {
      ...
      c.prototype.toHexString = function () {
        ...
        for (var e = 0; e < this.id.length; e++) {
          t += l[this.id.charCodeAt(e)];
        }
      ...
      c.createFromHexString = function (t) {
        ...
        for (var e = new p(12), r = 0, n = 0; n < 24;) {
          e[r++] = h[t.charCodeAt(n++)] << 4 | h[t.charCodeAt(n++)];
        }
    ...
    var n = r(21),
      ...
      for (i = 0; i <= 3; i++) {
        r = (r = r.shiftLeft(32)).add(new n(t.parts[i], 0)), t.parts[i] = r.div(e).low_, r = r.modulo(e);
      }
    ...
    y.fromString = function (t) {
      ...
      if ("+" !== t[P] && "-" !== t[P] || (r = "-" === t[P++]), !p(t[P]) && "." !== t[P]) {
        if ("i" === t[P] || "I" === t[P]) return new y(h.toBuffer(r ? c : l));
        if ("N" === t[P]) return new y(h.toBuffer(u));
      }

      for (; p(t[P]) || "." === t[P];) {
        if ("." !== t[P]) S < 34 && ("0" !== t[P] || _) && (_ || (w = m), _ = !0, O[E++] = parseInt(t[P], 10), S += 1), _ && (g += 1), d && (b += 1), m += 1, P += 1;else {
      ...
      if ("e" === t[P] || "E" === t[P]) {
        var D = t.substr(++P).match(f);
        if (!D || !D[2]) return new y(h.toBuffer(u));
        j = parseInt(D[0], 10), P += D[0].length;
      }

      if (t[P]) return new y(h.toBuffer(u));

      if (A = 0, S) {
        if ($ = S - 1, v = g, 0 !== j && 1 !== v) for (; "0" === t[w + v - 1];) {
          v -= 1;
        }
      } else A = 0, $ = 0, O[0] = 0, g = 1, S = 1, v = 0;
      ...
      if ($ - A + 1 < v && "0" !== t[v]) {
        ...
        var F = parseInt(t[w + $ + 1], 10),
            I = 0;
        if (F >= 5 && (I = 1, 5 === F)) for (I = O[$] % 2 == 1, x = w + $ + 2; x < R; x++) {
          if (parseInt(t[x], 10)) {
            I = 1;
            break;
          }
        }
        if (I) for (var L = $; L >= 0 && ++O[L] > 9; L--) {
          if (O[L] = 0, 0 === L) {
      ...
      if (N = n.fromNumber(0), k = n.fromNumber(0), 0 === v) N = n.fromNumber(0), k = n.fromNumber(0);else if ($ - A < 17) for (L = A, k = n.fromNumber(O[L++]), N = new n(0, 0); L <= $; L++) {
        k = (k = k.multiply(n.fromNumber(10))).add(n.fromNumber(O[L]));
      } else {
        for (L = A, N = n.fromNumber(O[L++]); L <= $ - 17; L++) {
          N = (N = N.multiply(n.fromNumber(10))).add(n.fromNumber(O[L]));
        }

        for (k = n.fromNumber(O[L++]); L <= $; L++) {
          k = (k = k.multiply(n.fromNumber(10))).add(n.fromNumber(O[L]));
        }
      }
      ...
      U.low = U.low.add(k), function (t, e) {
        var r = t.high_ >>> 0,
            n = e.high_ >>> 0;
        return r < n || r === n && t.low_ >>> 0 < e.low_ >>> 0;
      }(U.low, k) && (U.high = U.high.add(n.fromNumber(1))), e = j + a;
      var V = {
        low: n.fromNumber(0),
        high: n.fromNumber(0)
      };
      ...
      return P = 0, q[P++] = 255 & V.low.low_, q[P++] = V.low.low_ >> 8 & 255, q[P++] = V.low.low_ >> 16 & 255, q[P++] = V.low.low_ >> 24 & 255, q[P++] = 255 & V.low.high_, q[P++] = V.low.high_ >> 8 & 255, q[P++] = V.low.high_ >> 16 & 255, q[P++] = V.low.high_ >> 24 & 255, q[P++] = 255 & V.high.low_, q[P++] = V.high.low_ >> 8 & 255, q[P++] = V.high.low_ >> 16 & 255, q[P++] = V.high.low_ >> 24 & 255, q[P++] = 255 & V.high.high_, q[P++] = V.high.high_ >> 8 & 255, q[P++] = V.high.high_ >> 16 & 255, q[P++] = V.high.high_ >> 24 & 255, new y(q);
    };

    a = 6176, y.prototype.toString = function () {
      for (var t, e, r, i, o, s, u = 0, c = new Array(36), l = 0; l < c.length; l++) {
        c[l] = 0;
      }
      ...
      if (i = w[v++] | w[v++] << 8 | w[v++] << 16 | w[v++] << 24, r = w[v++] | w[v++] << 8 | w[v++] << 16 | w[v++] << 24, e = w[v++] | w[v++] << 8 | w[v++] << 16 | w[v++] << 24, t = w[v++] | w[v++] << 8 | w[v++] << 16 | w[v++] << 24, v = 0, {
        low: new n(i, r),
        high: new n(e, t)
      ...
      if (f = s - a, g.parts[0] = (16383 & t) + ((15 & p) << 14), g.parts[1] = e, g.parts[2] = r, g.parts[3] = i, 0 === g.parts[0] && 0 === g.parts[1] && 0 === g.parts[2] && 0 === g.parts[3]) m = !0;else for (_ = 3; _ >= 0; _--) {
        var O = 0,
            S = d(g);
        if (g = S.quotient, O = S.rem.low_) for (y = 8; y >= 0; y--) {
          c[9 * _ + y] = O % 10, O = Math.floor(O / 10);
        }
      }
      if (m) u = 1, c[v] = 0;else for (u = 36, l = 0; !c[v];) {
        l++, u -= 1, v += 1;
      }

      if ((h = u - 1 + f) >= 34 || h <= -7 || f > 0) {
        for (b.push(c[v++]), (u -= 1) && b.push("."), l = 0; l < u; l++) {
          b.push(c[v++]);
        }

        b.push("E"), h > 0 ? b.push("+" + h) : b.push(h);
      } else if (f >= 0) for (l = 0; l < u; l++) {
        b.push(c[v++]);
      } else {
        var E = u + f;
        if (E > 0) for (l = 0; l < E; l++) {
          b.push(c[v++]);
        } else b.push("0");
    ...
    */
    ...
    (function (n) {
      ...
      var s = r(18).EventEmitter,
          ...
          d = r(128),
          y = r(130),
          _ = r(0).arrayParentSymbol,
          v = r(5),
          m = r(131),
          g = r(74),
          b = r(132),
          w = r(43),
          O = r(17).get().ReadPreference,
          S = r(48),
          E = r(3),
          A = r(1),
          $ = r(133),
          j = void 0,
          x = r(134).middlewareFunctions,
          N = r(75).middlewareFunctions,
          k = x.concat(N).reduce(function (t, e) {
        return t.add(e);
      }, new Set()),
          P = 0;
      ...
      function T(t, e) {
        ...
        if (this.obj = t, this.paths = {}, this.aliases = {}, this.subpaths = {}, this.virtuals = {}, this.singleNestedPaths = {}, this.nested = {}, this.inherits = {}, this.callQueue = [], this._indexes = [], this.methods = {}, this.methodOptions = {}, this.statics = {}, this.tree = {}, this.query = {}, this.childSchemas = [], this.plugins = [], this.$id = ++P, this.s = {
          hooks: new a()
        ...
        var c = t && t._id && A.isObject(t._id);
       ...
       * ignore
       */
      Object.defineProperty(T.prototype, "$schemaType", {
        configurable: !1,
        enumerable: !1,
        writable: !0
      }), Object.defineProperty(T.prototype, "childSchemas", {
        configurable: !1,
        enumerable: !0,
        writable: !0
      }), T.prototype.obj, T.prototype.paths, T.prototype.tree, T.prototype.clone = function () {
        var t = this,
            e = new T({}, this._userProvidedOptions);
        ...
        function (t) {
          ...
          try {
            for (var o, s = Object.keys(t.paths)[Symbol.iterator](); !(r = (o = s.next()).done); r = !0) {
              var a = o.value,
                  u = t.paths[a];
              (u.$isMongooseDocumentArray || u.$isSingleNested) && e.push({
                schema: u.schema,
                model: u.caster
              });
            }
        ...
        var r = new T({}, e || this.options);
        if (!Array.isArray(t)) throw new u('Schema#pick() only accepts an array argument, got "' + (void 0 === t ? "undefined" : i(t)) + '"');
        var n = !0,
            s = !1,
            a = void 0;

        try {
          for (var c, l = t[Symbol.iterator](); !(n = (c = l.next()).done); n = !0) {
            var f = c.value;
            if (this.nested[f]) r.add(o({}, f, v(this.tree, f)));else {
              var h = this.path(f);
              if (null == h) throw new u("Path `" + f + "` is not in the schema");
              r.add(o({}, f, h));
            }
          }
        } catch (t) {
        ...
        return r;
      }, T.prototype.defaultOptions = function (t) {
        t && !1 === t.safe && (t.safe = {
          w: 0
        }), t && t.safe && 0 === t.safe.w && (t.versionKey = !1), this._userProvidedOptions = null == t ? {} : A.clone(t);
        var e = v(this, "base.options", {});
        return (t = A.options({
        ...
        }, A.clone(t))).read && (t.read = O(t.read)), t;
      }, T.prototype.add = function (t, e) {
        if (t instanceof T) return b(this, t), this;
        ...
        for (var r = Object.keys(t), n = 0; n < r.length; ++n) {
          ...
          if ("_id" !== i || !1 !== t[i]) if (t[i] instanceof h) this.virtual(t[i]);else {
            if (Array.isArray(t[i]) && 1 === t[i].length && null == t[i][0]) throw new TypeError("Invalid value for schema Array path `" + o + '`, got value "' + t[i][0] + '"');
            if (A.isPOJO(t[i]) || t[i] instanceof l) {
              if (Object.keys(t[i]).length < 1) e && (this.nested[e.substr(0, e.length - 1)] = !0), this.path(o, t[i]);else if (!t[i][this.options.typeKey] || "type" === this.options.typeKey && t[i].type.type) this.nested[o] = !0, this.add(t[i], o + ".");else if (!this.options.typePojoToMixed && A.isPOJO(t[i][this.options.typeKey])) {
                e && (this.nested[e.substr(0, e.length - 1)] = !0);
                var s = Object.assign({}, t[i], {
                  type: new T(t[i][this.options.typeKey])
                });
                this.path(e + i, s);
        ...
        return function (t, e) {
          ...
          try {
            for (var o, s = e[Symbol.iterator](); !(r = (o = s.next()).done); r = !0) {
              var a = o.value,
                  u = v(t.paths[a], "options");

              if (null != u) {
                var c = t.paths[a].path,
                    l = u.alias;

                if (l) {
                  if ("string" != typeof l) throw new Error("Invalid value for alias option on " + c + ", got " + l);
                  t.aliases[l] = c, t.virtual(l).get(function (t) {
                    return function () {
      ...
      }, T.reserved = Object.create(null), T.prototype.reserved = T.reserved;
      var B = T.reserved;
      B.prototype = B.emit = B.on = B.once = B.listeners = B.removeListener = B.collection = B.db = B.errors = B.init = B.isModified = B.isNew = B.get = B.modelName = B.save = B.schema = B.toObject = B.validate = B.remove = B.populated = 1;
      /*!
      ...
      function M(t, e) {
        ...
        try {
          for (var o, s = Object.keys(t.paths)[Symbol.iterator](); !(r = (o = s.next()).done); r = !0) {
            var a = o.value;
            if (a.includes(".$*")) if (new RegExp("^" + a.replace(/\.\$\*/g, "\\.[^.]+") + "$").test(e)) return t.paths[a];
          }
        } catch (t) {
          n = !0, i = t;
        } finally {
      ...
      function R(t, e) {
        ...
        for (var o = r.length - 1, s = 1; s < r.length; ++s) {
          ...
          if (s === o && n && !/\D/.test(a)) {
            n = n.$isMongooseDocumentArray ? n.$embeddedSchemaType : n instanceof j.Array ? n.caster : void 0;
            break;
          }
          ...
          } else n instanceof j.Array && s !== o && (n = n.caster);
        }
      ...
      C.increment = "`increment` should not be used as a schema path name unless you have disabled versioning.", T.prototype.path = function (t, e) {
        var r = D(t);
        ...
        if (void 0 === e) {
          var n = function (t, e, r) {
            ...
            if (t.singleNestedPaths.hasOwnProperty(r)) return t.singleNestedPaths[r];
            return null;
          }(this, t, r);
          ...
          return null != o ? o : null != (n = this.hasMixedParent(r)) ? n : /\.\d+\.?.*$/.test(t) ? function (t, e) {
            return R(t, e), t.subpaths[e];
          }(this, t) : void 0;
        }

        if (B[t]) throw new Error("`" + t + "` may not be used as a schema pathname");
        C[t] && console.log("WARN: " + C[t]), "object" === (void 0 === e ? "undefined" : i(e)) && A.hasUserDefinedProperty(e, "ref") && $(e.ref, t);
        var s = t.split(/\./),
            a = s.pop(),
            u = this.tree;
        s.forEach(function (e, r) {
          if (u[e] || (u[e] = {}), "object" !== i(u[e])) {
            var n = "Cannot set nested path `" + t + "`. Parent path `" + s.slice(0, r).concat([e]).join(".") + "` already set to type " + u[e].name + ".";
            throw new Error(n);
          }

          u = u[e];
        }), u[a] = A.clone(e), this.paths[t] = this.interpretAsType(t, e, this.options);
        var l = this.paths[t];
        ...
        if (l.$isSchemaMap) {
          ...
          if (A.hasUserDefinedProperty(e, "of")) h = A.isPOJO(e.of) && Object.keys(e.of).length > 0 && !A.hasUserDefinedProperty(e.of, this.options.typeKey) ? new T(e.of) : e.of;
          this.paths[f] = this.interpretAsType(f, h, this.options), l.$__schemaType = this.paths[f];
        }

        if (l.$isSingleNested) {
          for (var p in l.schema.paths) {
            this.singleNestedPaths[t + "." + p] = l.schema.paths[p];
          }

          for (var d in l.schema.singleNestedPaths) {
            this.singleNestedPaths[t + "." + d] = l.schema.singleNestedPaths[d];
          }

          for (var y in l.schema.subpaths) {
            this.singleNestedPaths[t + "." + y] = l.schema.subpaths[y];
          }

          Object.defineProperty(l.schema, "base", {
            configurable: !0,
            enumerable: !1,
            writable: !1,
            value: this.base
          }), l.caster.base = this.base, this.childSchemas.push({
            schema: l.schema,
            model: l.caster
          });
        } else l.$isMongooseDocumentArray && (Object.defineProperty(l.schema, "base", {
          configurable: !0,
          enumerable: !1,
          writable: !1,
          value: this.base
        }), l.casterConstructor.base = this.base, this.childSchemas.push({
          schema: l.schema,
          model: l.casterConstructor
        }));

        if (l.$isMongooseArray && l.caster instanceof c) {
          for (var _ = t, v = l, m = []; v.$isMongooseArray;) {
            _ += ".$", (v = v.$isMongooseDocumentArray ? v.$embeddedSchemaType.clone() : v.caster.clone()).path = _, m.push(v);
          }
        ...
        if (l.$isMongooseDocumentArray) {
          var j = !0,
              x = !1,
              N = void 0;

          try {
            for (var k, P = Object.keys(l.schema.paths)[Symbol.iterator](); !(j = (k = P.next()).done); j = !0) {
              var F = k.value;
              this.subpaths[t + "." + F] = l.schema.paths[F], l.schema.paths[F].$isUnderneathDocArray = !0;
            }
          } catch (t) {
            x = !0, N = t;
          } finally {
          ...
          try {
            for (var V, q = Object.keys(l.schema.subpaths)[Symbol.iterator](); !(I = (V = q.next()).done); I = !0) {
              var W = V.value;
              this.subpaths[t + "." + W] = l.schema.subpaths[W], l.schema.subpaths[W].$isUnderneathDocArray = !0;
            }
          } catch (t) {
            L = !0, U = t;
          } finally {
          ...
          try {
            for (var K, Q = Object.keys(l.schema.singleNestedPaths)[Symbol.iterator](); !(H = (K = Q.next()).done); H = !0) {
              var J = K.value;
              this.subpaths[t + "." + J] = l.schema.singleNestedPaths[J], l.schema.singleNestedPaths[J].$isUnderneathDocArray = !0;
            }
          } catch (t) {
            Y = !0, z = t;
          } finally {
        ...
        writable: !0,
        value: null
      }), T.prototype.interpretAsType = function (t, e, r) {
        if (e instanceof c) return e;
        var o = null != this.base ? this.base.Schema.Types : T.Types;

        if (!(A.isPOJO(e) || e instanceof l) && "Object" !== A.getFunctionName(e.constructor)) {
          var s = e;
          (e = {})[r.typeKey] = s;
        }

        var a = !e[r.typeKey] || "type" === r.typeKey && e.type.type ? {} : e[r.typeKey],
            u = void 0;
        if (A.isPOJO(a) || "mixed" === a) return new o.Mixed(t, e);

        if (Array.isArray(a) || Array === a || "array" === a) {
          var f = Array === a || "array" === a ? e.cast : a[0];
          if (f && f.instanceOfSchema) return new o.DocumentArray(t, f, e);
          if (f && f[r.typeKey] && f[r.typeKey].instanceOfSchema) return new o.DocumentArray(t, f[r.typeKey], e, f);
          if (Array.isArray(f)) return new o.Array(t, this.interpretAsType(t, f, r), e);
          if ("string" == typeof f) f = o[f.charAt(0).toUpperCase() + f.substring(1)];else if (f && (!f[r.typeKey] || "type" === r.typeKey && f.type.type) && A.isPOJO(f)) {
            if (Object.keys(f).length) {
              var h = {
                minimize: r.minimize
              };
              r.typeKey && (h.typeKey = r.typeKey), r.hasOwnProperty("strict") && (h.strict = r.strict);
              var p = new T(f, h);
              return p.$implicitlyCreated = !0, new o.DocumentArray(t, p, e);
            }

            return new o.Array(t, o.Mixed, e);
          }
          if (f && (u = "string" == typeof (a = !f[r.typeKey] || "type" === r.typeKey && f.type.type ? f : f[r.typeKey]) ? a : a.schemaName || A.getFunctionName(a), !o.hasOwnProperty(u))) throw new TypeError("Invalid schema configuration: `" + u + "` is not a valid type within the array `" + t + "`.See http://bit.ly/mongoose-schematypes for a list of valid schema types.");
          return new o.Array(t, f || o.Mixed, e, r);
        }

        if (a && a.instanceOfSchema) return new o.Embedded(a, t, e);
        if ((u = n.isBuffer(a) ? "Buffer" : "function" == typeof a || "object" === (void 0 === a ? "undefined" : i(a)) ? a.schemaName || A.getFunctionName(a) : null == a ? "" + a : a.toString()) && (u = u.charAt(0).toUpperCase() + u.substring(1)), "ObjectID" === u && (u = "ObjectId"), null == o[u]) throw new TypeError("Invalid schema configuration: `" + u + "` is not a valid type at path `" + t + "`. See http://bit.ly/mongoose-schematypes for a list of valid schema types.");
        return new o[u](t, e);
      }, T.prototype.eachPath = function (t) {
        for (var e = Object.keys(this.paths), r = e.length, n = 0; n < r; ++n) {
          t(e[n], this.paths[e[n]]);
        }

        return this;
      }, T.prototype.requiredPaths = function (t) {
      ...
      }, T.prototype.indexedPaths = function () {
        return this._indexedpaths ? this._indexedpaths : (this._indexedpaths = this.indexes(), this._indexedpaths);
      }, T.prototype.pathType = function (t) {
        var e = D(t);
        return this.paths.hasOwnProperty(t) ? "real" : this.virtuals.hasOwnProperty(t) ? "virtual" : this.nested.hasOwnProperty(t) ? "nested" : this.subpaths.hasOwnProperty(e) ? "real" : this.singleNestedPaths.hasOwnProperty(e) ? "real" : null != M(this, t) ? "real" : /\.\d+\.|\.\d+$/.test(t) ? R(this, t) : "adhocOrUndefined";
      }, T.prototype.hasMixedParent = function (t) {
        var e = t.split(/\./g);
        t = "";

        for (var r = 0; r < e.length; ++r) {
          if ((t = r > 0 ? t + "." + e[r] : e[r]) in this.paths && this.paths[t] instanceof j.Mixed) return this.paths[t];
        }

        return null;
      }, T.prototype.setupTimestamp = function (t) {
        ...
        if (t || e) {
          ...
          this.$timestamps = {
            createdAt: r,
            updatedAt: n
          }, n && !this.paths[n] && (i[n] = Date), r && !this.paths[r] && (i[r] = Date), this.add(i), this.pre("save", function (t) {
            var e = v(this, "$__.saveOptions.timestamps");
            if (!1 === e) return t();
            var i = null != e && !1 === e.updatedAt,
                o = null != e && !1 === e.createdAt,
                s = (this.ownerDocument ? this.ownerDocument() : this).constructor.base.now(),
                a = this._id && this._id.auto;

            if (!o && r && !this.get(r) && this.isSelected(r) && this.set(r, a ? this._id.getTimestamp() : s), !i && n && (this.isNew || this.isModified())) {
              var u = s;
              this.isNew && (null != r ? u = this.$__getValue(r) : a && (u = this._id.getTimestamp())), this.set(n, u);
            }

            t();
          }), this.methods.initializeTimestamps = function () {
            return r && !this.get(r) && this.set(r, new Date()), n && !this.get(n) && this.set(n, new Date()), this;
          }, s[S.builtInMiddleware] = !0;
          var o = {
            query: !0,
            model: !1
          };
          this.pre("findOneAndUpdate", o, s), this.pre("replaceOne", o, s), this.pre("update", o, s), this.pre("updateOne", o, s), this.pre("updateMany", o, s);
        }

        function s(t) {
          var e = this.model.base.now();
          y(e, r, n, this.getUpdate(), this.options, this.schema), d(e, this.getUpdate(), this.model.schema), t();
        }
      }, T.prototype.queue = function (t, e) {
        ...
        if (t instanceof RegExp) {
          ...
          try {
            for (var o, s = k[Symbol.iterator](); !(r = (o = s.next()).done); r = !0) {
              var a = o.value;
              t.test(a) && this.pre.apply(this, [a].concat(e));
            }
          } catch (t) {
            n = !0, i = t;
          } finally {
        ...
        if (Array.isArray(t)) {
          ...
          try {
            for (var h, p = t[Symbol.iterator](); !(c = (h = p.next()).done); c = !0) {
              var d = h.value;
              this.pre.apply(this, [d].concat(u));
            }
          } catch (t) {
            l = !0, f = t;
          } finally {
        ...
        if (t instanceof RegExp) {
          ...
          try {
            for (var o, s = k[Symbol.iterator](); !(r = (o = s.next()).done); r = !0) {
              var a = o.value;
              t.test(a) && this.post.apply(this, [a].concat(e));
            }
          } catch (t) {
            n = !0, i = t;
          } finally {
        ...
        if (Array.isArray(t)) {
          ...
          try {
            for (var h, p = t[Symbol.iterator](); !(c = (h = p.next()).done); c = !0) {
              var d = h.value;
              this.post.apply(this, [d].concat(u));
            }
          } catch (t) {
            l = !0, f = t;
          } finally {
        ...
        if ("function" != typeof t) throw new Error('First param to `schema.plugin()` must be a function, got "' + (void 0 === t ? "undefined" : i(t)) + '"');
        if (e && e.deduplicate) for (var r = 0; r < this.plugins.length; ++r) {
          if (this.plugins[r].fn === t) return this;
        }
        return this.plugins.push({
          fn: t,
          opts: e
        }), t(this, e), this;
      }, T.prototype.method = function (t, e, r) {
        ...
        return this;
      }, T.prototype["static"] = function (t, e) {
        ...
        switch (t) {
          case "read":
            this.options[t] = O(e, r), this._userProvidedOptions[t] = this.options[t];
            break;

          case "safe":
            F(this.options, e), this._userProvidedOptions[t] = this.options[t];
            break;
      ...
      var F = E.deprecate(function (t, e) {
        t.safe = !1 === e ? {
          w: 0
        } : e;
      ...
      function L(t, e) {
        for (var r = e.split("."), n = r.pop(), i = t.tree, o = 0; o < r.length; ++o) {
          i = i[r[o]];
        }
      ...
      Object.defineProperty(T, "indexTypes", {
        get: function get() {
          return I;
        },
        set: function set() {
      ...
      }), T.prototype.indexes = function () {
        return m(this);
      }, T.prototype.virtual = function (t, e) {
        var r = this;
        if (t instanceof h) return this.virtual(t.path, t.options);

        if (e = new f(e), A.hasUserDefinedProperty(e, ["ref", "refPath"])) {
          ...
          this.pre("init", function (r) {
            if (w.has(t, r)) {
              var n = w.get(t, r);
              this.$$populatedVirtuals || (this.$$populatedVirtuals = {}), e.justOne || e.count ? this.$$populatedVirtuals[t] = Array.isArray(n) ? n[0] : n : this.$$populatedVirtuals[t] = Array.isArray(n) ? n : null == n ? [] : [n], w.unset(t, r);
            }
          });
          var n = this.virtual(t);
          return n.options = e, n.get(function () {
            if (this.$$populatedVirtuals || (this.$$populatedVirtuals = {}), this.$$populatedVirtuals.hasOwnProperty(t)) return this.$$populatedVirtuals[t];
          }).set(function (r) {
        ...
        o[t] = s.reduce(function (r, n, i) {
          return r[n] || (r[n] = i === s.length - 1 ? new h(e, t) : {}), r[n];
        }, this.tree);

        for (var a = s[0], u = 0; u < s.length - 1; ++u) {
          if (null != this.paths[a] && this.paths[a].$isMongooseDocumentArray) if ("break" === function () {
            var t = s.slice(u + 1).join(".");
            return r.paths[a].schema.virtual(t).get(function (e, r, n) {
              var i = n.__parentArray[_],
                  o = a + "." + n.__index + "." + t;
              return i.get(o);
            }), "break";
          }()) break;
        ...
        return o[t];
      }, T.prototype.virtualpath = function (t) {
        ...
        return "string" == typeof t && (t = [t]), Array.isArray(t) && t.forEach(function (t) {
          if (null != this.path(t) || this.nested[t]) {
            if (this.nested[t]) {
              var e = Object.keys(this.paths).concat(Object.keys(this.nested)),
                  r = !0,
                  n = !1,
                  i = void 0;
              ...
              try {
                for (var o, s = e[Symbol.iterator](); !(r = (o = s.next()).done); r = !0) {
                  var a = o.value;
                  a.startsWith(t + ".") && (delete this.paths[a], delete this.nested[a], L(this, a));
                }
              } catch (t) {
                n = !0, i = t;
              } finally {
        ...
        return t === Object.prototype || t === Function.prototype || t.prototype.hasOwnProperty("$isMongooseModelPrototype") ? this : (this.loadClass(Object.getPrototypeOf(t)), e || Object.getOwnPropertyNames(t).forEach(function (e) {
          if (!e.match(/^(length|name|prototype)$/)) {
            var r = Object.getOwnPropertyDescriptor(t, e);
            "function" == typeof r.value && this["static"](e, r.value);
          }
          ...
          if (!r.match(/^(constructor)$/)) {
            ...
            e || "function" == typeof n.value && this.method(r, n.value), "function" == typeof n.get && this.virtual(r).get(n.get), "function" == typeof n.set && this.virtual(r).set(n.set);
          }
        }, this), this);
      },
      /*!
       * ignore
       */
      T.prototype._getSchema = function (t) {
        var e = this.path(t),
            r = [];
        ...
        return function t(e, n) {
          for (var i = e.length + 1, o = void 0, s = void 0; i--;) {
            if (s = e.slice(0, i).join("."), o = n.path(s)) {
              if (r.push(s), o.caster) {
                if (o.caster instanceof j.Mixed) return o.caster.$fullPath = r.join("."), o.caster;

                if (i !== e.length && o.schema) {
                  var a = void 0;
                  return "$" === e[i] || U(e[i]) ? i + 1 === e.length ? o : ((a = t(e.slice(i + 1), o.schema)) && (a.$isUnderneathDocArray = a.$isUnderneathDocArray || !o.schema.$isSingleNested), a) : ((a = t(e.slice(i), o.schema)) && (a.$isUnderneathDocArray = a.$isUnderneathDocArray || !o.schema.$isSingleNested), a);
                }
              }
    ...
    n.prototype.clone = function () {
      var t = new n(this.name, this.options);
      ...
      for (var r = t, n = this.getters.length - 1; n >= 0; n--) {
        r = this.getters[n].call(e, r, this, e);
      }

      return r;
    }, n.prototype.applySetters = function (t, e) {
      for (var r = t, n = this.setters.length - 1; n >= 0; n--) {
        r = this.setters[n].call(e, r, this, e);
      }
    ...
    e.String = r(135), e.Number = r(77), e.Boolean = r(139), e.DocumentArray = r(140), e.Embedded = r(145), e.Array = r(52), e.Buffer = r(147), e.Date = r(149), e.ObjectId = r(152), e.Mixed = r(29), e.Decimal128 = e.Decimal = r(154), e.Map = r(156), e.Oid = e.ObjectId, e.Object = e.Mixed, e.Bool = e.Boolean, e.ObjectID = e.ObjectId;
  }, function (t, e, r) {
    "use strict";
    /*!
     * Module dependencies.
    ...
    function g(t, e, n, i) {
      ...
      if (i && i.typeKey && (o = i.typeKey), this.schemaOptions = i, e) {
        var s = {};
        p.isPOJO(e) && (e[o] ? (delete (s = p.clone(e))[o], e = e[o]) : e = c), e === Object && (e = c);
        var u = "string" == typeof e ? e : p.getFunctionName(e),
            l = r(51),
            f = l.hasOwnProperty(u) ? l[u] : e;
        this.casterConstructor = f, "function" != typeof f || f.$isArraySubdocument || f.$isSchemaMap ? this.caster = f : this.caster = new f(null, s), this.$embeddedSchemaType = this.caster, this.caster instanceof m || (this.caster.path = t);
      }
      ...
      if (null != this.defaultValue && (h = this.defaultValue, d = "function" == typeof h), !("defaultValue" in this) || void 0 !== this.defaultValue) {
        var y = function y() {
          var t = [];
          return d ? t = h.call(this) : null != h && (t = t.concat(h)), t;
        };

        y.$runBeforeSetters = !0, this["default"](y);
      }
    }

    g.schemaName = "Array", g.options = {
      castNonArrays: !0
    },
    /*!
     * Inherits from SchemaType.
     ...
     * ignore
     */
    g._checkRequired = a.prototype.checkRequired, g.checkRequired = a.checkRequired, g.prototype.checkRequired = function (t, e) {
      return a._isRef(this, t, e, !0) ? !!t : ("function" == typeof this.constructor.checkRequired ? this.constructor.checkRequired() : g.checkRequired())(t);
    }, g.prototype["enum"] = function () {
      for (var t = this;;) {
        var e = f(t, "caster.instance");
      ...
      return t.caster["enum"].apply(t.caster, arguments), this;
    }, g.prototype.applyGetters = function (t, e) {
      return this.caster.options && this.caster.options.ref ? t : a.prototype.applyGetters.call(this, t, e);
    }, g.prototype.cast = function (t, e, n) {
      v || (v = r(23).Array);
      var i = void 0,
          o = void 0;
      ...
      if (Array.isArray(t)) {
        if (!t.length && e) {
          ...
          var f = this.path.endsWith(".coordinates") ? this.path.substr(0, this.path.lastIndexOf(".")) : null;
          if (null != f) for (i = 0, o = s.length; i < o; ++i) {
            if ("2dsphere" === s[i][0][f]) return;
          }
        }

        if (t && t.isMongooseArray ? t && t.isMongooseArray && (t = new v(t, this.path, e)) : t = new v(t, this.path, e), null != e && null != e.$__ && e.populated(this.path)) return t;
        if (this.caster && this.casterConstructor !== c) try {
          for (i = 0, o = t.length; i < o; i++) {
            t[i] = this.caster.cast(t[i], e, n);
          }
        } catch (e) {
          throw new u("[" + e.kind + "]", h.inspect(t), this.path, e, this);
        }
        return t;
      }

      if (n || g.options.castNonArrays) return e && n && e.markModified(this.path), this.cast([t], e, n);
      throw new u("Array", h.inspect(t), this.path, null, this);
    },
    /*!
     * Ignore
     */
    g.prototype.discriminator = function (t, e) {
      for (var r = this; r.$isMongooseArray && !r.$isMongooseDocumentArray;) {
        if (null == (r = r.casterConstructor) || "function" == typeof r) throw new o("You can only add an embedded discriminator on a document array, " + this.path + " is a plain array");
      }
    ...
    g.prototype.clone = function () {
      ...
      if (2 === arguments.length) {
        ...
        if (i && o.discriminators && o.schema && o.schema.options && o.schema.options.discriminatorKey) if ("string" == typeof i[o.schema.options.discriminatorKey] && o.discriminators[i[o.schema.options.discriminatorKey]]) o = o.discriminators[i[o.schema.options.discriminatorKey]];else {
          var s = _(o, i[o.schema.options.discriminatorKey]);
        ...
        Array.isArray(i) ? (this.setters.reverse().forEach(function (t) {
          ...
          return p.isObject(t) && t.$elemMatch ? t : u ? t = u.call(c, t) : null != t ? t = new o(t) : t;
        })) : u ? i = u.call(c, i) : null != i && (i = new o(i));
      }

      return i;
    };
    var b = g.prototype.$conditionalHandlers = {};
    b.$all = function (t) {
      return Array.isArray(t) || (t = [t]), t = t.map(function (t) {
        if (p.isObject(t)) {
          var e = {};
          return e[this.path] = t, l(this.casterConstructor.schema, e)[this.path];
        }

        return t;
      }, this), this.castForQuery(t);
    }, b.$options = String, b.$elemMatch = function (t) {
      for (var e = Object.keys(t), r = e.length, n = 0; n < r; ++n) {
        var i = e[n],
            o = t[i];
        i.startsWith("$") && o && (t[i] = this.castForQuery(i, o));
      }

      var s = f(this, "casterConstructor.schema.options.discriminatorKey"),
          a = f(this, "casterConstructor.schema.discriminators", {});
      return null != s && null != t[s] && null != a[t[s]] ? l(a[t[s]], t) : l(this.casterConstructor.schema, t);
    }, b.$geoIntersects = y.cast$geoIntersects, b.$or = b.$and = function (t) {
      if (!Array.isArray(t)) throw new TypeError("conditional $or/$and require array");

      for (var e = [], r = 0; r < t.length; ++r) {
        e.push(l(this.casterConstructor.schema, t[r]));
      }

      return e;
    }, b.$near = b.$nearSphere = y.cast$near, b.$within = b.$geoWithin = y.cast$within, b.$size = b.$minDistance = b.$maxDistance = d, b.$exists = n, b.$type = i, b.$eq = b.$gt = b.$gte = b.$lt = b.$lte = b.$ne = b.$regex = g.prototype.castForQuery, b.$nin = a.prototype.$conditionalHandlers.$nin, b.$in = a.prototype.$conditionalHandlers.$in,
    /*!
     * Module exports.
     */
    t.exports = g;
    ...
    function c(t, e, c, l, f, h) {
      a = a || r(6);
      var p = (l ? l + "." : "") + t;
      l = l || "", e ? Object.defineProperty(c, t, {
        enumerable: !0,
        configurable: !0,
        get: function get() {
          var t = this;

          if (this.$__.getters || (this.$__.getters = {}), !this.$__.getters[p]) {
            var r = Object.create(a.prototype, function (t) {
              var e = {};
              return Object.getOwnPropertyNames(t).forEach(function (r) {
                e[r] = Object.getOwnPropertyDescriptor(t, r), e[r].get ? delete e[r] : e[r].enumerable = -1 === ["isNew", "$__", "errors", "_doc", "$locals"].indexOf(r);
              }), e;
            }(this));
            l || (r.$__.scope = this), r.$__.nestedPath = p, Object.defineProperty(r, "schema", {
              enumerable: !1,
              configurable: !0,
              writable: !1,
              value: c.schema
              ...
              writable: !1,
              value: c.schema
            }), Object.defineProperty(r, "toObject", {
              enumerable: !1,
              configurable: !0,
              writable: !1,
              value: function value() {
                return s.clone(t.get(p, null, {
                  virtuals: i(this, "schema.options.toObject.virtuals", null)
                }));
              }
              ...
              value: function value() {
                return t.get(p, null, {
                  virtuals: i(t, "schema.options.toJSON.virtuals", null)
                });
              }
            }), Object.defineProperty(r, "$__isNested", {
              enumerable: !1,
              configurable: !0,
              writable: !1,
              value: !0
            ...
            Object.defineProperty(r, "$isEmpty", {
              ...
              writable: !1,
              value: function value() {
                return 0 === Object.keys(this.get(p, null, o) || {}).length;
              }
            }), u(e, r, p, h), this.$__.getters[p] = r;
          }

          return this.$__.getters[p];
        },
        set: function set(t) {
          return t instanceof a && (t = t.toObject({
            transform: !1
          })), (this.$__.scope || this).$set(p, t);
        }
      }) : Object.defineProperty(c, t, {
        enumerable: !0,
        configurable: !0,
        get: function get() {
          return this[o].call(this.$__.scope || this, p);
        },
        set: function set(t) {
          return this.$set.call(this.$__.scope || this, p, t);
        }
      });
    }
    /*!
    ...
    (function (e) {
      if (void 0 !== e.Map) t.exports = e.Map, t.exports.Map = e.Map;else {
        var r = function r(t) {
    ...
    (function (t, n) {
      ...
      e.cloneObject = function (t, e) {
        ...
        for (i in t) {
          n = a(t[i], e), o && void 0 === n || (r || (r = !0), s[i] = n);
        }
        ...
        for (var i, o = Object.keys(n), s = o.length; s--;) {
          void 0 === r[i = o[s]] ? r[i] = n[i] : e.isObject(n[i]) ? t(r[i], n[i]) : r[i] = n[i];
        }
      }, e.mergeClone = function t(r, n) {
        for (var i, o = Object.keys(n), s = o.length; s--;) {
          void 0 === r[i = o[s]] ? r[i] = a(n[i]) : e.isObject(n[i]) ? t(r[i], n[i]) : r[i] = a(n[i]);
        }
    ...
    }).call(this, r(60).setImmediate, r(8));
  }, function (t, e, r) {
    "use strict";
    ...
    (function (t) {
      ...
      }, r(105), e.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== t && t.setImmediate || void 0, e.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== t && t.clearImmediate || void 0;
    }).call(this, r(11));
  }, function (t, e, r) {
    "use strict";
    ...
    }).call(this, r(8), r(110)(t), r(11), r(2).Buffer);
  }, function (t, e, r) {
    "use strict";
    /*!
     * Module dependencies.
    ...
    (function (e) {
      ...
      var i = r(6),
        ...
        return function (t, e) {
          ...
          value: function value(t) {
            var r = !1,
                n = void 0;
            return this[d] && (r = this[d].populated(this[y], !0)), r && null !== t && void 0 !== t ? (n = r.options[v], (e.isBuffer(t) || t instanceof a || !f.isObject(t)) && (t = {
              _id: t
            }), t.schema && t.schema.discriminatorMapping && void 0 !== t.schema.discriminatorMapping.key || (t = new n(t)), this[_].caster.applySetters(t, this[d], !0)) : this[_].caster.applySetters(t, this[d], !1);
          }
        }, {
          key: "_mapCast",
          ...
          value: function value(t, e) {
            var r = this[d],
                n = void 0;
            return r && (n = this[y], arguments.length && (n = null != e ? n + "." + this.indexOf(t) + "." + e : n + "." + t), r.markModified(n, arguments.length > 0 ? t : r)), this;
          }
        }, {
          key: "_registerAtomic",
          value: function value(t, e) {
            if ("$set" === t) return this[p] = {
              $set: e
            }, u(this[d], this[y]), this._markModified(), this;
            var r = this[p];

            if ("$pop" === t && !("$pop" in r)) {
              var n = this;
              this[d].once("save", function () {
                n._popped = n._shifted = null;
              });
            }

            if (this[p].$set || Object.keys(r).length && !(t in r)) return this[p] = {
              $set: this
            }, this;
            var i = void 0;
            if ("$pullAll" === t || "$addToSet" === t) r[t] || (r[t] = []), r[t] = r[t].concat(e);else if ("$pullDocs" === t) {
              var s = r.$pull || (r.$pull = {});
              e[0] instanceof o ? (i = s.$or || (s.$or = []), Array.prototype.push.apply(i, e.map(function (t) {
                return t.toObject({
                  transform: !1,
                  virtuals: !1
                });
            ...
            } else "$push" === t ? (r.$push = r.$push || {
              $each: []
            }, null != e && f.hasUserDefinedProperty(e, "$each") ? r.$push = e : r.$push.$each = r.$push.$each.concat(e)) : r[t] = e;
            return this;
          }
        }, {
          key: "addToSet",
          value: function value() {
            ...
            var t = [].map.call(arguments, this._mapCast, this),
                e = [],
                r = "";
            return (t = this[_].applySetters(t, this[d]))[0] instanceof o ? r = "doc" : t[0] instanceof Date && (r = "date"), t.forEach(function (t) {
              var n = void 0,
                  i = +t;
              ...
              n || ([].push.call(this, t), this._registerAtomic("$addToSet", t), this._markModified(), [].push.call(e, t));
            }, this), e;
          }
        }, {
          key: "hasAtomics",
          value: function value() {
            return f.isPOJO(this[p]) ? Object.keys(this[p]).length : 0;
          }
        }, {
          key: "includes",
          value: function value(t, e) {
          ...
          key: "indexOf",
          value: function value(t, e) {
            t instanceof a && (t = t.toString()), e = null == e ? 0 : e;
          ...
          key: "pull",
          value: function value() {
            for (var t = [].map.call(arguments, this._cast, this), e = this[d].get(this[y]), r = e.length, n = void 0; r--;) {
              if ((n = e[r]) instanceof i) t.some(function (t) {
                return n.equals(t);
              }) && [].splice.call(e, r, 1);else ~e.indexOf.call(t, n) && [].splice.call(e, r, 1);
            }

            return t[0] instanceof o ? this._registerAtomic("$pullDocs", t.map(function (t) {
              return t._id || t;
            })) : this._registerAtomic("$pullAll", t), this._markModified(), u(this[d], this[y]) > 0 && this._registerAtomic("$set", this), this;
          }
        }, {
          key: "push",
          value: function value() {
            var t = arguments,
                e = t,
                r = null != t[0] && f.hasUserDefinedProperty(t[0], "$each");
            if (r && (e = t[0], t = t[0].$each), null == this[_]) return m.apply(this, t);
            w(this, t);
            var n = this[d];
            t = [].map.call(t, this._mapCast, this), t = this[_].applySetters(t, n, void 0, void 0, {
            ...
            if (r) {
              if (e.$each = t, c(o, "$push.$each.length", 0) > 0 && o.$push.$position != o.$position) throw new s("Cannot call `Array#push()` multiple times with different `$position`");
              null != e.$position ? ([].splice.apply(this, [e.$position, 0].concat(t)), i = this.length) : i = [].push.apply(this, t);
            } else {
              if (c(o, "$push.$each.length", 0) > 0 && null != o.$push.$position) throw new s("Cannot call `Array#push()` multiple times with different `$position`");
              e = t, i = [].push.apply(this, t);
            }
          ...
          key: "set",
          value: function value(t, e) {
            var r = this._cast(e, t);

            return this[t] = r, this._markModified(t), this;
          }
        }, {
          key: "shift",
          value: function value() {
          ...
          key: "sort",
          value: function value() {
            var t = [].sort.apply(this, arguments);
          ...
          value: function value() {
            ...
            if (w(this, Array.prototype.slice.call(arguments, 2)), arguments.length) {
              var e = void 0;
              if (null == this[_]) e = arguments;else {
                e = [];

                for (var r = 0; r < arguments.length; ++r) {
                  e[r] = r < 2 ? arguments[r] : this._cast(arguments[r], arguments[0] + (r - 2));
                }
              }
              t = [].splice.apply(this, e), this._registerAtomic("$set", this);
            }
          ...
          key: "toObject",
          value: function value(t) {
            return t && t.depopulate ? ((t = f.clone(t))._isNested = !0, this.map(function (e) {
              return e instanceof i ? e.toObject(t) : e;
            })) : this.slice();
          }
        }, {
          key: "unshift",
          value: function value() {
            w(this, arguments);
            var t = [].map.call(arguments, this._cast, this);
            return t = this[_].applySetters(t, this[d]), [].unshift.apply(this, t), this._registerAtomic("$set", this), this._markModified(), this.length;
          }
        }, {
          key: "isMongooseArray",
          get: function get() {
      ...
      function w(t, e) {
        var r = null == t ? null : c(t[_], "caster.options.ref", null);
     ...
     */
    i.prototype.formatMessage = function (t, e) {
    ...
    a.mixin = {
      ...
      write: function write() {
        var t = s.write.apply(this, arguments);
        return t > 0 && this._markModified(), t;
      },
      copy: function copy(t) {
        var e = s.copy.apply(this, arguments);
    ...
    var s = r(29),
      ...
      return function (t, e) {
        ...
        key: "$init",
        value: function value(t, r) {
          h(t), o(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "set", this).call(this, t, r), null != r && r.$isSingleNested && (r.$basePath = this.$__path + "." + t);
        }
      }, {
        key: "$__set",
        value: function value(t, r) {
        ...
        key: "set",
        value: function value(t, r) {
          if (h(t), null == this.$__schemaType) return this.$__deferred = this.$__deferred || [], void this.$__deferred.push({
            key: t,
            value: r
          });
          var n = this.$__path + "." + t,
              i = null != this.$__parent && this.$__parent.$__ ? this.$__parent.populated(n) || this.$__parent.populated(this.$__path) : null;
          if (null != i) null == r.$__ && (r = new i.options[l](r)), r.$__.wasPopulated = !0;else try {
          ...
          o(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "set", this).call(this, t, r), null != r && r.$isSingleNested && (r.$basePath = this.$__path + "." + t), null != this.$__parent && this.$__parent.$__ && this.$__parent.markModified(this.$__path + "." + t);
        }
      }, {
        key: "delete",
        value: function value(t) {
        ...
        value: function value() {
          if (this.$__deferred) {
            for (var t = 0; t < this.$__deferred.length; ++t) {
              this.set(this.$__deferred[t].key, this.$__deferred[t].value);
            }
    ...
    function h(t) {
      ...
      if (c.specialProperties.has(t)) throw new Error('Mongoose maps do not support reserved key name "' + t + '"');
    }

    u.inspect.custom && Object.defineProperty(f.prototype, u.inspect.custom, {
      enumerable: !1,
      writable: !1,
      configurable: !1,
      value: f.prototype.inspect
    }), Object.defineProperty(f.prototype, "$__set", {
      enumerable: !1,
      writable: !0,
      configurable: !1
    }), Object.defineProperty(f.prototype, "$__parent", {
      enumerable: !1,
      writable: !0,
      configurable: !1
    }), Object.defineProperty(f.prototype, "$__path", {
      enumerable: !1,
      writable: !0,
      configurable: !1
    }), Object.defineProperty(f.prototype, "$__schemaType", {
      enumerable: !1,
      writable: !0,
      configurable: !1
    }), Object.defineProperty(f.prototype, "$isMongooseMap", {
      enumerable: !1,
      writable: !1,
      configurable: !1,
      value: !0
    }), Object.defineProperty(f.prototype, "$__deferredCalls", {
      enumerable: !1,
      writable: !1,
      configurable: !1,
      value: !0
    ...
    var n = r(6),
        i = r(44),
        o = r(20).internalToObjectOptions,
        s = r(1),
      ...
      if (a && (this._doc = Object.assign({}, o.priorDoc._doc), delete this._doc[this.schema.options.discriminatorKey], u = Object.keys(o.priorDoc._doc || {}).filter(function (t) {
        ...
        try {
          for (var h, p = u[Symbol.iterator](); !(c = (h = p.next()).done); c = !0) {
            var d = h.value;
            this.$__.activePaths.states.modify[d] || this.$__.activePaths.states["default"][d] || this.$__.$setCalled.has(d) || delete this._doc[d];
          }
        } catch (t) {
          l = !0, f = t;
        } finally {
    ...
    t.exports = u, u.prototype = Object.create(n.prototype), u.prototype.toBSON = function () {
      ...
      var r = this;
      return "function" == typeof t && (e = t, t = {}), (t = t || {}).suppressWarning || console.warn("mongoose: calling `save()` on a subdoc does **not** save the document to MongoDB, it only runs save middleware. Use `subdoc.save({ suppressWarning: true })` to hide this warning if you're sure this behavior is right for your app."), s.promiseOrCallback(e, function (t) {
        r.$__save(t);
      });
    ...
    u.prototype.invalidate = function (t, e, r) {
      if (e !== this.ownerDocument().$__.validationError && n.prototype.invalidate.call(this, t, e, r), this.$parent && this.$basePath) this.$parent.invalidate([this.$basePath, t].join("."), e, r);else if ("cast" === e.kind || "CastError" === e.name) throw e;
    },
    /*!
     * ignore
     */
    u.prototype.$ignore = function (t) {
      n.prototype.$ignore.call(this, t), this.$parent && this.$basePath && this.$parent.$ignore([this.$basePath, t].join("."));
    }, u.prototype.ownerDocument = function () {
      if (this.$__.ownerDocument) return this.$__.ownerDocument;
      var t = this.$parent;
      if (!t) return this;
     ...
     * no-op for hooks
     */
    u.prototype.$__remove = function (t) {
      return t(null, this);
    ...
    function o(t, e, r) {
      ...
      try {
        for (var f, h = Object.keys(e.paths)[Symbol.iterator](); !(u = (f = h.next()).done); u = !0) {
          var p = f.value,
              d = e.paths[p],
              y = null;
          if (d.$isSingleNested) y = d.caster;else {
            if (!d.$isMongooseDocumentArray) continue;
            y = d.Constructor;
          }
          if (!y.$appliedHooks && (o(y, d.schema, r), null != y.discriminators)) for (var _ = Object.keys(y.discriminators), v = 0; v < _.length; ++v) {
            o(y.discriminators[_[v]], y.discriminators[_[v]].schema, r);
          }
        }
      } catch (t) {
        c = !0, l = t;
      ...
      var m = e.s.hooks.filter(function (t) {
        return "updateOne" === t.name || "deleteOne" === t.name ? !!t.document : "remove" !== t.name || null == t.document || !!t.document;
      }).filter(function (t) {
        return !e.methods[t.name] || !t.fn[n.builtInMiddleware];
      });
      t._middleware = m, a.$__save = m.createWrapper("save", a.$__save, null, s), a.$__originalValidate = a.$__originalValidate || a.$__validate, a.$__validate = m.createWrapper("validate", a.$__originalValidate, null, s), a.$__remove = m.createWrapper("remove", a.$__remove, null, s), a.$__deleteOne = m.createWrapper("deleteOne", a.$__deleteOne, null, s), a.$__init = m.createWrapperSync("init", a.$__init, null, s);
      var g = Object.keys(e.methods),
          b = Object.assign({}, s, {
        checkForPromise: !0
      }),
          w = !0,
      ...
      try {
        for (var E, A = function A() {
          ...
          a[e] = function () {
            ...
            return i.promiseOrCallback(o, function (t) {
              return r["$__" + e].apply(r, s.concat([t]));
            }, t.events);
          }, a["$__" + e] = m.createWrapper(e, r, null, b);
        }, $ = g[Symbol.iterator](); !(w = (E = $.next()).done); w = !0) {
          A();
        }
      } catch (t) {
        O = !0, S = t;
    ...
    (function (e) {
       ...
       * ignore
       */
      h._cast = s, h.cast = function (t) {
        return 0 === arguments.length ? this._cast : (!1 === t && (t = function t(_t2) {
          if ("number" != typeof _t2) throw new Error();
          return _t2;
        }), this._cast = t, this._cast);
      }, h.schemaName = "Number",
      /*!
    ...
    var n = r(30).castArraysOfNumbers,
        i = r(30).castToNumber;
    ...
    t.exports = function (t, e, r, a, u) {
      ...
      var l = t.schema.options.discriminatorKey,
          f = t.schema.path(l);
      if (null != f) o.hasUserDefinedProperty(f.options, "select") || (f.options.select = !0), f.options.$skipDiscriminatorCheck = !0;else {
        var h = {};
        h[l] = {
          "default": void 0,
          select: !0,
      ...
      if ("string" == typeof a && a.length && (p = a), function (e, r) {
        ...
        for (var n = Object.keys(r.paths), i = [], a = 0; a < n.length; ++a) {
          e.nested[n[a]] && i.push(n[a]);
        }
        ...
        e.options = o.clone(r.options), h && (e.options.toJSON = h), d && (e.options.toObject = d), void 0 !== y && (e.options._id = y), e.options.id = _, e.s.hooks = t.schema.s.hooks.merge(e.s.hooks), e.plugins = Array.prototype.slice.call(r.plugins), e.callQueue = r.callQueue.concat(e.callQueue), delete e._requiredpaths;
    ...
    (function (n) {
      ...
      }), e.PromiseProvider = o, e.Error = r(4), e.Schema = r(49), e.Types = r(23), e.VirtualType = r(50), e.SchemaType = r(7), e.utils = r(1), e.Document = i(), e.model = function () {
        return null;
      },
      /*!
       * Module exports.
    ...
    e.Binary = r(90), e.Collection = function () {
      throw new Error("Cannot create a collection from browser library");
    }, e.Decimal128 = r(97), e.ObjectId = r(98), e.ReadPreference = r(99);
  }, function (t, e, r) {
    "use strict";
    /*!
     * Module dependencies.
    ...
    var Long = __webpack_require__(21).Long,
        Double = __webpack_require__(32).Double,
        Timestamp = __webpack_require__(33).Timestamp,
        ObjectID = __webpack_require__(34).ObjectID,
        _Symbol = __webpack_require__(36).Symbol,
        Code = __webpack_require__(37).Code,
        MinKey = __webpack_require__(39).MinKey,
        MaxKey = __webpack_require__(40).MaxKey,
        Decimal128 = __webpack_require__(38),
        Int32 = __webpack_require__(55),
        DBRef = __webpack_require__(41).DBRef,
        BSONRegExp = __webpack_require__(35).BSONRegExp,
        Binary = __webpack_require__(25).Binary,
        utils = __webpack_require__(13),
        deserialize = function deserialize(t, e, r) {
      ...
      for (var v = i ? [] : {}, m = 0;;) {
        ...
        if (r = b + 1, g === BSON.BSON_DATA_STRING) {
        ...
        } else if (g === BSON.BSON_DATA_INT && !1 === d) v[w] = new Int32(e[r++] | e[r++] << 8 | e[r++] << 16 | e[r++] << 24);else if (g === BSON.BSON_DATA_INT) v[w] = e[r++] | e[r++] << 8 | e[r++] << 16 | e[r++] << 24;else if (g === BSON.BSON_DATA_NUMBER && !1 === d) v[w] = new Double(e.readDoubleLE(r)), r += 8;else if (g === BSON.BSON_DATA_NUMBER) v[w] = e.readDoubleLE(r), r += 8;else if (g === BSON.BSON_DATA_DATE) {
          var E = e[r++] | e[r++] << 8 | e[r++] << 16 | e[r++] << 24,
              A = e[r++] | e[r++] << 8 | e[r++] << 16 | e[r++] << 24;
          v[w] = new Date(new Long(E, A).toNumber());
          ...
          v[w] = l ? e.slice(r, r + j) : t(e, $, n, !1), r += j;
          ...
          if (v[w] = t(e, $, x, !0), 0 !== e[(r += j) - 1]) throw new Error("invalid array terminator byte");
          ...
          E = e[r++] | e[r++] << 8 | e[r++] << 16 | e[r++] << 24, A = e[r++] | e[r++] << 8 | e[r++] << 16 | e[r++] << 24;
          var P = new Long(E, A);
          v[w] = p && !0 === d && P.lessThanOrEqual(JS_INT_MAX_LONG) && P.greaterThanOrEqual(JS_INT_MIN_LONG) ? P.toNumber() : P;
          ...
          if (null != e.slice) {
            ...
            v[w] = h && d ? e.slice(r, r + C) : new Binary(e.slice(r, r + C), M);
          } else {
            ...
            v[w] = h && d ? R : new Binary(R, M);
          }

          r += C;
        } else if (g === BSON.BSON_DATA_REGEXP && !1 === f) {
          for (b = r; 0 !== e[b] && b < e.length;) {
            b++;
          }
          ...
          for (F = e.toString("utf8", r, b), b = r = b + 1; 0 !== e[b] && b < e.length;) {
            b++;
          }

          if (b >= e.length) throw new Error("Bad BSON Document: illegal CString");
          I = e.toString("utf8", r, b), r = b + 1, v[w] = new BSONRegExp(F, I);
        ...
        } else if (g === BSON.BSON_DATA_TIMESTAMP) E = e[r++] | e[r++] << 8 | e[r++] << 16 | e[r++] << 24, A = e[r++] | e[r++] << 8 | e[r++] << 16 | e[r++] << 24, v[w] = new Timestamp(E, A);else if (g === BSON.BSON_DATA_MIN_KEY) v[w] = new MinKey();else if (g === BSON.BSON_DATA_MAX_KEY) v[w] = new MaxKey();else if (g === BSON.BSON_DATA_CODE) {
          if ((O = e[r++] | e[r++] << 8 | e[r++] << 16 | e[r++] << 24) <= 0 || O > e.length - r || 0 !== e[r + O - 1]) throw new Error("bad string length in bson");
          ...
          o ? (s ? (V = a ? u(U) : U, v[w] = isolateEvalWithHash(functionCache, V, U, v)) : v[w] = isolateEval(U), v[w].scope = W) : v[w] = new Code(U, W);
        } else {
    ...
    (function (e) {
      var n = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (t) {
        ...
        return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : _typeof(t);
          ...
          s = r(54),
          a = r(25).Binary,
          u = r(13).normalizedFunctionString,
          c = /\x00/,
        ...
        if (Math.floor(r) === r && r >= C.JS_INT_MIN && r <= C.JS_INT_MAX) {
          ...
          } else if (r >= C.JS_INT_MIN && r <= C.JS_INT_MAX) t[n++] = C.BSON_DATA_NUMBER, n += a = s ? t.write(e, n, "ascii") : t.write(e, n, "utf8"), t[n++] = 0, i(t, r, n, "little", 52, 8), n += 8;else {
        ...
        return null === r ? t[n++] = C.BSON_DATA_NULL : "MinKey" === r._bsontype ? t[n++] = C.BSON_DATA_MIN_KEY : t[n++] = C.BSON_DATA_MAX_KEY, n += i ? t.write(e, n, "ascii") : t.write(e, n, "utf8"), t[n++] = 0, n;
          ...
          w = function w(t, e, r, n, i) {
        if (t[n++] = C.BSON_DATA_OID, n += i ? t.write(e, n, "ascii") : t.write(e, n, "utf8"), t[n++] = 0, "string" == typeof r.id) t.write(r.id, n, "binary");else {
          if (!r.id || !r.id.copy) throw new Error("object [" + JSON.stringify(r) + "] is not a valid ObjectId");
          r.id.copy(t, n, 0, 12);
        }
        return n + 12;
      },
          O = function O(t, e, r, n, i) {
        ...
        return t[n++] = 255 & o, t[n++] = o >> 8 & 255, t[n++] = o >> 16 & 255, t[n++] = o >> 24 & 255, t[n++] = C.BSON_BINARY_SUBTYPE_DEFAULT, r.copy(t, n, 0, o), n += o;
          ...
          S = function S(t, e, r, n, i, o, s, a, u, c) {
        ...
        return t[n] = 255 & c, t[n + 1] = c >> 8 & 255, t[n + 2] = c >> 16 & 255, t[n + 3] = c >> 24 & 255, n = n + 4 + c - 1, t[n++] = 0, n;
          ...
          N = function N(t, e, r, i, o, s, a, u, c) {
        if (r.scope && "object" === n(r.scope)) {
          ...
          var _ = t.write(h, i + 4, "utf8") + 1;

          t[i] = 255 & _, t[i + 1] = _ >> 8 & 255, t[i + 2] = _ >> 16 & 255, t[i + 3] = _ >> 24 & 255, i = i + 4 + _ - 1, t[i++] = 0;
        }

        return i;
      },
          k = function k(t, e, r, n, i) {
        t[n++] = C.BSON_DATA_BINARY, n += i ? t.write(e, n, "ascii") : t.write(e, n, "utf8"), t[n++] = 0;
        var o = r.value(!0),
            s = r.position;
        ...
        return t[u++] = 255 & c, t[u++] = c >> 8 & 255, t[u++] = c >> 16 & 255, t[u++] = c >> 24 & 255, a;
          ...
          B = function B(t, r, i, o, a, u, _B, C) {
        o = o || 0, (C = C || []).push(r);
        var D = o + 4;
        if (Array.isArray(r)) for (var M = 0; M < r.length; M++) {
          var R = "" + M,
              F = r[M];
          ...
          "string" === I ? D = p(t, R, F, D, !0) : "number" === I ? D = d(t, R, F, D, !0) : "boolean" === I ? D = _(t, R, F, D, !0) : F instanceof Date || f(F) ? D = v(t, R, F, D, !0) : void 0 === F ? D = y(t, R, 0, D, !0) : null === F ? D = y(t, R, 0, D, !0) : "ObjectID" === F._bsontype || "ObjectId" === F._bsontype ? D = w(t, R, F, D, !0) : e.isBuffer(F) ? D = O(t, R, F, D, !0) : F instanceof RegExp || h(F) ? D = m(t, R, F, D, !0) : "object" === I && null == F._bsontype ? D = S(t, R, F, D, i, a, u, _B, !0, C) : "object" === I && "Decimal128" === F._bsontype ? D = E(t, R, F, D, !0) : "Long" === F._bsontype || "Timestamp" === F._bsontype ? D = A(t, R, F, D, !0) : "Double" === F._bsontype ? D = j(t, R, F, D, !0) : "function" == typeof F && u ? D = x(t, R, F, D, 0, 0, u) : "Code" === F._bsontype ? D = N(t, R, F, D, i, a, u, _B, !0) : "Binary" === F._bsontype ? D = k(t, R, F, D, !0) : "Symbol" === F._bsontype ? D = P(t, R, F, D, !0) : "DBRef" === F._bsontype ? D = T(t, R, F, D, a, u, !0) : "BSONRegExp" === F._bsontype ? D = g(t, R, F, D, !0) : "Int32" === F._bsontype ? D = $(t, R, F, D, !0) : "MinKey" !== F._bsontype && "MaxKey" !== F._bsontype || (D = b(t, R, F, D, !0));
          ...
          if (!(U = V.done)) {
            ...
            "string" === I ? D = p(t, R, F, D) : "number" === I ? D = d(t, R, F, D) : "boolean" === I ? D = _(t, R, F, D) : F instanceof Date || f(F) ? D = v(t, R, F, D) : null === F || void 0 === F && !1 === _B ? D = y(t, R, 0, D) : "ObjectID" === F._bsontype || "ObjectId" === F._bsontype ? D = w(t, R, F, D) : e.isBuffer(F) ? D = O(t, R, F, D) : F instanceof RegExp || h(F) ? D = m(t, R, F, D) : "object" === I && null == F._bsontype ? D = S(t, R, F, D, i, a, u, _B, !1, C) : "object" === I && "Decimal128" === F._bsontype ? D = E(t, R, F, D) : "Long" === F._bsontype || "Timestamp" === F._bsontype ? D = A(t, R, F, D) : "Double" === F._bsontype ? D = j(t, R, F, D) : "Code" === F._bsontype ? D = N(t, R, F, D, i, a, u, _B) : "function" == typeof F && u ? D = x(t, R, F, D, 0, 0, u) : "Binary" === F._bsontype ? D = k(t, R, F, D) : "Symbol" === F._bsontype ? D = P(t, R, F, D) : "DBRef" === F._bsontype ? D = T(t, R, F, D, a, u) : "BSONRegExp" === F._bsontype ? D = g(t, R, F, D) : "Int32" === F._bsontype ? D = $(t, R, F, D) : "MinKey" !== F._bsontype && "MaxKey" !== F._bsontype || (D = b(t, R, F, D));
          }
        } else {
          if (r.toBSON) {
          ...
          for (R in r) {
            ...
            "string" === I ? D = p(t, R, F, D) : "number" === I ? D = d(t, R, F, D) : "boolean" === I ? D = _(t, R, F, D) : F instanceof Date || f(F) ? D = v(t, R, F, D) : void 0 === F ? !1 === _B && (D = y(t, R, 0, D)) : null === F ? D = y(t, R, 0, D) : "ObjectID" === F._bsontype || "ObjectId" === F._bsontype ? D = w(t, R, F, D) : e.isBuffer(F) ? D = O(t, R, F, D) : F instanceof RegExp || h(F) ? D = m(t, R, F, D) : "object" === I && null == F._bsontype ? D = S(t, R, F, D, i, a, u, _B, !1, C) : "object" === I && "Decimal128" === F._bsontype ? D = E(t, R, F, D) : "Long" === F._bsontype || "Timestamp" === F._bsontype ? D = A(t, R, F, D) : "Double" === F._bsontype ? D = j(t, R, F, D) : "Code" === F._bsontype ? D = N(t, R, F, D, i, a, u, _B) : "function" == typeof F && u ? D = x(t, R, F, D, 0, 0, u) : "Binary" === F._bsontype ? D = k(t, R, F, D) : "Symbol" === F._bsontype ? D = P(t, R, F, D) : "DBRef" === F._bsontype ? D = T(t, R, F, D, a, u) : "BSONRegExp" === F._bsontype ? D = g(t, R, F, D) : "Int32" === F._bsontype ? D = $(t, R, F, D) : "MinKey" !== F._bsontype && "MaxKey" !== F._bsontype || (D = b(t, R, F, D));
          }
        }
        C.pop(), t[D++] = 0;
        var q = D - o;
    ...
    (function (e) {
      var n = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (t) {
        ...
        return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : _typeof(t);
          ...
          d = r(41).DBRef,
          y = r(25).Binary,
          _ = r(13).normalizedFunctionString,
          v = function v(t) {
        return "object" === (void 0 === t ? "undefined" : n(t)) && "[object Date]" === Object.prototype.toString.call(t);
      },
          m = function m(t, e, r) {
      ...
      function g(t, r, g, w, O) {
        switch (r && r.toBSON && (r = r.toBSON()), void 0 === r ? "undefined" : n(r)) {
          ...
          case "object":
            ...
            if (r instanceof Date || v(r)) return (null != t ? e.byteLength(t, "utf8") + 1 : 0) + 9;
          ...
          case "function":
            ...
            if (g && null != r.scope && Object.keys(r.scope).length > 0) return (null != t ? e.byteLength(t, "utf8") + 1 : 0) + 1 + 4 + 4 + e.byteLength(_(r), "utf8") + 1 + m(r.scope, g, O);
            if (g) return (null != t ? e.byteLength(t, "utf8") + 1 : 0) + 1 + 4 + e.byteLength(_(r), "utf8") + 1;
        }
    ...
    var n = r(101).ctor("require", "modify", "init", "default", "ignore");
    ...
    i.prototype.clear = function (t) {
      for (var e = Object.keys(this.states[t]), r = e.length, n = void 0; r--;) {
        n = e[r], delete this.states[t][n], delete this.paths[n];
      }
    },
    /*!
    ...
    t.exports = function t(e) {
      !function (t, e) {
        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
      }(this, t), this._docs = {}, null != e && (e = i.clone(e), Object.assign(this, e), "object" === n(e.subPopulate) && (this.populate = e.subPopulate));
    };
  }, function (t, e, r) {
    "use strict";
    /*
    ...
    */
    ...
    "gt gte lt lte ne in nin all regex size maxDistance minDistance".split(" ").forEach(function (t) {
      c.prototype[t] = function () {
        var e, r;
        return 1 === arguments.length ? (this._ensurePath(t), r = arguments[0], e = this._path) : (r = arguments[1], e = arguments[0]), (null === this._conditions[e] || "object" === n(this._conditions[e]) ? this._conditions[e] : this._conditions[e] = {})["$" + t] = r, this;
      };
    }), c.prototype.mod = function () {
      var t, e;
      return 1 === arguments.length ? (this._ensurePath("mod"), t = arguments[0], e = this._path) : 2 !== arguments.length || a.isArray(arguments[1]) ? 3 === arguments.length ? (t = i(arguments, 1), e = arguments[0]) : (t = arguments[1], e = arguments[0]) : (this._ensurePath("mod"), t = i(arguments), e = this._path), (this._conditions[e] || (this._conditions[e] = {})).$mod = t, this;
      ...
      return (this._conditions[t] || (this._conditions[t] = {}))[this._geoComparison || l] = {
        $box: e
      }, this;
    }, c.prototype.polygon = function () {
      var t, e;
      return "string" == typeof arguments[0] ? (e = arguments[0], t = i(arguments, 1)) : (this._ensurePath("polygon"), e = this._path, t = i(arguments)), (this._conditions[e] || (this._conditions[e] = {}))[this._geoComparison || l] = {
        $polygon: t
      }, this;
      ...
      var e,
          r,
          i = this._fields || (this._fields = {}),
          o = void 0 === t ? "undefined" : n(t);

      if (("string" == o || a.isArgumentsObject(t)) && "number" == typeof t.length || Array.isArray(t)) {
        for ("string" == o && (t = t.split(/\s+/)), e = 0, r = t.length; e < r; ++e) {
          var s = t[e];

          if (s) {
            var u = "-" == s[0] ? 0 : 1;
            0 === u && (s = s.substring(1)), i[s] = u;
          }
        }
      ...
      if (this._validate("slice"), 1 === arguments.length) {
        ...
        if ("object" === (void 0 === r ? "undefined" : n(r)) && !Array.isArray(r)) {
          for (var o = Object.keys(r), s = o.length, a = 0; a < s; ++a) {
            this.slice(o[a], r[o[a]]);
          }
      ...
      } else 2 === arguments.length ? "number" == typeof arguments[0] ? (this._ensurePath("slice"), t = this._path, e = i(arguments)) : (t = arguments[0], e = arguments[1]) : 3 === arguments.length && (t = arguments[0], e = i(arguments, 1));
      ...
      if (1 === arguments.length && "string" == o) {
        for (r = (t = t.split(/\s+/)).length, e = 0; e < r; ++e) {
          if (i = t[e]) {
            var s = "-" == i[0] ? -1 : 1;
            -1 === s && (i = i.substring(1)), h(this.options, i, s);
          }
        }
      ...
      if ("undefined" != typeof Map && t instanceof Map) return function (t, e) {
        ...
        e.forEach(function (e, r) {
          ...
          if (!(n = f[n])) throw new TypeError("Invalid sort value: < " + r + ": " + e + " >");
          t.sort.set(r, n);
        });
      }
      /*!
    ...
    function h(t, e, r) {
      ...
      if (r && r.$meta) (n = t.sort || (t.sort = {}))[e] = {
        ...
        if (!(i = f[i])) throw new TypeError("Invalid sort value: { " + e + ": " + r + " }");
        n[e] = i;
      }
    }
    ...
    function p(t, e, r) {
      ...
      if (!(n = f[n])) throw new TypeError("Invalid sort value: [ " + e + ", " + r + " ]");
      t.sort.push([e, n]);
    }
    /*!
    ...
    ["limit", "skip", "maxScan", "batchSize", "comment"].forEach(function (t) {
      ...
      return "object" === (void 0 === t ? "undefined" : n(t)) ? (void 0 !== t.j && (this.options.j = t.j), void 0 !== t.w && (this.options.w = t.w), void 0 !== t.wtimeout && (this.options.wtimeout = t.wtimeout)) : this.options.w = "m" === t ? "majority" : t, this;
      ...
      var i = this._conditions,
          o = this._optionsForExec();

      return u("distinct", this._collection.collectionName, i, o), r = this._wrapCallback("distinct", r, {
        conditions: i,
        options: o
      }), this._collection.distinct(this._distinct, i, o, a.tick(r)), this;
    }, c.prototype.update = function (t, e, r, i) {
      var o;
      ...
      switch (arguments.length) {
        ...
        case 2:
          "function" == typeof e && (i = e, e = t, t = void 0);
          break;
      ...
      return d(this, "update", t, e, r, o, i);
    }, c.prototype.updateMany = function (t, e, r, i) {
      var o;
      ...
      return d(this, "updateMany", t, e, r, o, i);
    }, c.prototype.updateOne = function (t, e, r, i) {
      var o;
      ...
      return d(this, "updateOne", t, e, r, o, i);
    }, c.prototype.replaceOne = function (t, e, r, i) {
      var o;
      ...
      e || (n.safe = !1);
      var i = this._conditions;
      return u("remove", this._collection.collectionName, i, n), e = this._wrapCallback("remove", e, {
        conditions: i,
        options: n
      }), this._collection.remove(i, n, a.tick(e)), this;
      ...
      var i = this._conditions;
      return u("deleteOne", this._collection.collectionName, i, n), e = this._wrapCallback("deleteOne", e, {
        conditions: i,
        options: n
      }), this._collection.deleteOne(i, n, a.tick(e)), this;
      ...
      return u("deleteOne", this._collection.collectionName, i, n), e = this._wrapCallback("deleteOne", e, {
        conditions: i,
        options: n
      }), this._collection.deleteMany(i, n, a.tick(e)), this;
      ...
      return c.canMerge(t) && this.merge(t), e && this._mergeUpdate(e), r && this.setOptions(r), n ? this._findAndModify("update", n) : this;
    }, c.prototype.findOneAndRemove = c.prototype.findOneAndDelete = function (t, e, r) {
      return this.op = "findOneAndRemove", this._validate(), "function" == typeof e ? (r = e, e = void 0) : "function" == typeof t && (r = t, t = void 0), c.canMerge(t) && this.merge(t), e && this.setOptions(e), r ? this._findAndModify("remove", r) : this;
    }, c.prototype._findAndModify = function (t, e) {
      o.equal("function", void 0 === e ? "undefined" : n(e));

      var r,
          i = this._optionsForExec();

      if ("remove" == t) i.remove = !0;else if ("new" in i || (i["new"] = !0), "upsert" in i || (i.upsert = !1), !(r = this._updateForExec())) {
        if (!i.upsert) return this.findOne(e);
        r = {
          $set: {}
        };
      }
      null != this._fieldsForExec() && (this.$useProjection ? i.projection = this._fieldsForExec() : i.fields = this._fieldsForExec());
      var s = this._conditions;
      return u("findAndModify", this._collection.collectionName, s, r, i), e = this._wrapCallback("findAndModify", e, {
        conditions: s,
        doc: r,
        options: i
      }), this._collection.findAndModify(s, r, i, a.tick(e)), this;
      ...
      o.ok(this.op, "Missing query type: (find, update, etc)"), "update" != this.op && "remove" != this.op || e || (e = !0);
      var r = this;
    ...
    }, c.prototype.stream = function (t) {
      if ("find" != this.op) throw new Error("stream() is only available for find");

      var e = this._conditions,
          r = this._optionsForExec();

      return this.$useProjection ? r.projection = this._fieldsForExec() : r.fields = this._fieldsForExec(), u("stream", this._collection.collectionName, e, r, t), this._collection.findStream(e, r, t);
      ...
      for (var e = 0; e < t.length; ++e) {
        ...
        if (this._fields[r] && "object" === n(this._fields[r]) && this._fields[r].$meta) return !1;
      }
      ...
      for (var t = a.clone(this._update), e = a.keys(t), r = e.length, n = {}; r--;) {
        var i = e[r];
        this.options.overwrite ? n[i] = t[i] : "$" !== i[0] ? (n.$set || (t.$set ? n.$set = t.$set : n.$set = {}), n.$set[i] = t[i], e.splice(r, 1), ~e.indexOf("$set") || e.push("$set")) : "$set" === i && n.$set || (n[i] = t[i]);
      }

      return this._compiledUpdate = n, n;
     ...
     * Permissions
     */
    c.permissions = r(109), c._isPermitted = function (t, e) {
     ...
     * Exports.
     */
    c.utils = a, c.env = r(62), c.Collection = r(111), c.BaseCollection = r(26), c.Promise = r(113), t.exports = c;
  }, function (t, e, r) {
    "use strict";
    ...
    (function (n) {
      ...
      (e = t.exports = r(107)).log = function () {
    ...
    (e = t.exports = n.debug = n["default"] = n).coerce = function (t) {
      ...
      return !1;
    }, e.humanize = r(108), e.instances = [], e.names = [], e.skips = [], e.formatters = {};
  }, function (t, e, r) {
    "use strict";
    ...
    t.exports = n.isNode ? r(112) : (n.isMongo, r(26));
  }, function (t, e, r) {
    "use strict";
    ...
    r(59).inherits(i, n), i.prototype.find = function (t, e, r) {
      ...
      !function (r) {
        ...
        return function t(e, r, n) {
            ...
            e.exports = function (e, n) {
              ...
              e.longStackTraces = function () {
                ...
                if (!X.longStackTraces && Y()) {
                  ...
                  X.longStackTraces = !0, S = function S() {
                    if (c.haveItemsQueued() && !X.longStackTraces) throw new Error("cannot enable long stack traces after promises have been created\n\n    See http://goo.gl/MqrFmX\n");
              ...
              var j = {
                ...
                try {
                  r = E(t, j[t].apply(null, arguments));
                } catch (t) {
                  c.throwLater(t), r = !0;
                }
              ...
              e.config = function (t) {
                ...
                if ("cancellation" in t && t.cancellation && !X.cancellation) {
                  ...
                  e.prototype._clearCancellationData = C, e.prototype._propagateFrom = D, e.prototype._onCancel = T, e.prototype._setOnCancel = B, e.prototype._attachCancellationCallback = P, e.prototype._execute = k, M = D, X.cancellation = !0;
                }
              ...
              function L(t, r, n) {
                if (X.warnings) {
                  var i,
                      o = new l(t);
                  if (r) n._attachExtraTrace(o);else if (X.longStackTraces && (i = e._peekContext())) i.attachExtraTrace(o);else {
                    var s = V(o);
                    o.stack = s.message + "\n" + s.stack.join("\n");
                  }
                  x("warning", o) || q(o, "", !0);
              ...
              f.inherits(J, Error), n.CapturedTrace = J, J.prototype.uncycle = function () {
                ...
                if (!t.__stackCleaned__) {
                  ...
                  for (var e = V(t), r = e.message, n = [e.stack], i = this; void 0 !== i;) {
                    n.push(U(i.stack.split("\n"))), i = i._parent;
                  }
              ...
              var G = function () {
                var t = /^\s*at\s*/,
                    e = function e(t, _e) {
                  return "string" == typeof t ? t : void 0 !== _e.name && void 0 !== _e.message ? _e.toString() : H(_e);
                };

                if ("number" == typeof Error.stackTraceLimit && "function" == typeof Error.captureStackTrace) {
                  Error.stackTraceLimit += 6, _ = t, v = e;
                  var r = Error.captureStackTrace;
                  return z = function z(t) {
                    return p.test(t);
                  }, function (t, e) {
              ...
              "undefined" != typeof console && void 0 !== console.warn && (s = function s(t) {
                console.warn(t);
              }, f.isNode && r.stderr.isTTY ? s = function s(t, e) {
                var r = e ? "[33m" : "[31m";
                console.warn(r + t + "[0m\n");
              } : f.isNode || "string" != typeof new Error().stack || (s = function s(t, e) {
              ...
              return w && e.longStackTraces(), {
                ...
                setBounds: function setBounds(t, e) {
                  if (Y()) {
                    ...
                    s < 0 || a < 0 || !r || !n || r !== n || s >= a || (z = function z(t) {
          ...
          12: [function (t, e, r) {
            ...
            for (var y = "join pop push shift unshift slice filter forEach some every map indexOf lastIndexOf reduce reduceRight sort reverse".split(" "), _ = 0; _ < y.length; ++_) {
              "function" == typeof Array.prototype[y[_]] && (d.prototype[y[_]] = Array.prototype[y[_]]);
            }
              ...
              c.inherits(p, r), p.prototype._asyncInit = function () {
                ...
                if (r < 0) {
                  ...
                  if (_ instanceof e) {
                    ...
                    if (0 == (50397184 & v)) return u >= 1 && this._inFlight++, n[r] = _, _._proxy(this, -1 * (r + 1)), !1;
          ...
          22: [function (t, e, n) {
            e.exports = function () {
              ...
              var _ = function _() {},
                  ...
                  m = {},
                  g = t("./thenables")(N, _),
                  b = t("./promise_array")(N, _, g, o, s),
                  w = t("./context")(N),
                  O = w.create,
                  S = t("./debuggability")(N, w),
                  E = (S.CapturedTrace, t("./finally")(N, g, m)),
                  A = t("./catch_filter")(m),
                  $ = t("./nodeback"),
                  j = c.errorObj,
                  x = c.tryCatch;
              ...
              return N.prototype.toString = function () {
                ...
                var e = g(t);
                return e instanceof N || ((e = new N(_))._captureStackTrace(), e._setFulfilled(), e._rejectionHandler0 = t), e;
                ...
                if (0 != (50397184 & l)) {
                  ...
                  0 != (33554432 & l) ? (d = u._rejectionHandler0, p = t) : 0 != (16777216 & l) ? (d = u._fulfillmentHandler0, p = e, u._unsetRejectionIsUnhandled()) : (v = u._settlePromiseLateCancellationObserver, d = new y("late cancellation observer"), u._attachExtraTrace(d), p = e), h.invoke(v, u, {
                ...
                if (0 == (65536 & i)) {
                  var o;
                  n._pushContext(), e === v ? r && "number" == typeof r.length ? o = x(t).apply(this._boundValue(), r) : (o = j).e = new d("cannot .spread() a non-array: " + c.classString(r)) : o = x(t).call(e, r);
              ...
              }, c.notEnumerableProp(N, "_makeSelfResolutionError", n), t("./method")(N, _, g, o, S), t("./bind")(N, _, g, S), t("./cancel")(N, b, o, S), t("./direct_resolve")(N), t("./synchronous_inspection")(N), t("./join")(N, b, g, _, h, a), N.Promise = N, N.version = "3.5.1", t("./map.js")(N, b, o, g, _, S), t("./call_get.js")(N), t("./using.js")(N, o, g, O, _, S), t("./timers.js")(N, _, S), t("./generators.js")(N, o, _, g, s, S), t("./nodeify.js")(N), t("./promisify.js")(N, _), t("./props.js")(N, b, g, o), t("./race.js")(N, _, g, o), t("./reduce.js")(N, b, o, g, _, S), t("./settle.js")(N, b, S), t("./some.js")(N, b, o), t("./filter.js")(N, _), t("./each.js")(N, _), t("./any.js")(N), c.toFastProperties(N), c.toFastProperties(N.prototype), T({
                a: 1
              }), T({
                b: 2
              }), T({
                c: 3
              }), T(1), T(function () {}), T(void 0), T(!1), T(new N(_)), S.setBounds(f.firstLineError, c.lastLineError), N;
            };
          }, {
            "./any.js": 1,
            "./async": 2,
          ...
          24: [function (t, e, r) {
            e.exports = function (e, r) {
              ...
              function v(t, e, r, n) {
                for (var o = i.inheritedDataKeys(t), s = [], a = 0; a < o.length; ++a) {
                  var u = o[a],
                      c = t[u],
                      f = n === p || p(u, c, t);
                  "function" != typeof c || y(c) || _(t, u, e) || !n(u, c, t, f) || s.push(u, c);
                }
              ...
              function b(t, e, r, o, s) {
                for (var a = new RegExp(m(e) + "$"), u = v(t, e, a, r), c = 0, l = u.length; c < l; c += 2) {
                  var f = u[c],
                      h = u[c + 1],
                      p = f + e;
                  if (o === g) t[p] = g(f, n, f, h, e, s);else {
                    var d = o(h, function () {
          ...
          35: [function (t, e, r) {
            e.exports = function (e, r, n, i, o, s) {
              ...
              y.prototype.data = function () {
              ...
              }, c(_, y), _.prototype.doDispose = function (t, e) {
                ...
                for (var c = new m(t), h = 0; h < t; ++h) {
                  ...
                  if (y.isDisposer(p)) {
                    ...
                    var g = n(p);
                    g instanceof e && (p = g._then(v, null, null, {
                      resources: c,
                      index: h
                    }, void 0));
                  }
    ...
    }).call(this, r(8), r(11), r(60).setImmediate);
  }, function (t, e, r) {
    "use strict";
    ...
    e.get = function (t, r, n, i) {
      ...
      if (null != n) {
        ...
        for (var h, p = u || /\$/.test(t) && !1 !== u, d = n, y = (f = 0, l.length - 1); f < y; ++f) {
          if ("$" != (h = l[f])) {
            if (Array.isArray(d) && !/^\d+$/.test(h)) {
              ...
              if (!p && Array.isArray(r)) for (var v = 0; v < d.length && v < r.length; ++v) {
                e.set(_, r[v], d[v], s || c, a, p);
              } else for (v = 0; v < d.length; ++v) {
                e.set(_, r, d[v], s || c, a, p);
              }
              return;
            }
        ...
        if (h = l[y], s && d[s] && (d = d[s]), Array.isArray(d) && !/^\d+$/.test(h)) {
          ...
          }(d, r, h, c, s, a);else for (v = 0; v < d.length; ++v) {
            item = d[v], item && (c ? c(item, h, a(r)) : (item[s] && (item = item[s]), item[h] = a(r)));
          }
    ...
    function i(t) {
      n.call(this, "Cannot overwrite `" + t + "` model once compiled."), this.name = "OverwriteModelError", Error.captureStackTrace ? Error.captureStackTrace(this) : this.stack = new Error().stack;
    }
    /*!
     * Inherits from MongooseError.
     */
    ...
    function i(t) {
      ...
      n.call(this, e), this.name = "MissingSchemaError", Error.captureStackTrace ? Error.captureStackTrace(this) : this.stack = new Error().stack;
    }
    /*!
     * Inherits from MongooseError.
     */
    ...
    function i(t) {
      ...
      n.call(this, e), this.name = "DivergentArrayError", Error.captureStackTrace ? Error.captureStackTrace(this) : this.stack = new Error().stack;
    }
    /*!
     * Inherits from MongooseError.
     */
    ...
    (function (e) {
      ...
      n.prototype.execPre = function (t, r, n, i) {
        ...
        var y = function t() {
          if (!(f >= l)) {
            ...
            if (n.isAsync) {
              ...
              for (var y = arguments.length >= 2 ? arguments : [null].concat(d), v = 1; v < y.length; ++v) {
                o.push(y[v]);
              }
        ...
        for (var n = o(this._pres, t, []), i = n.length, s = 0; s < i; ++s) {
          n[s].fn.apply(e, r || []);
        }
        ...
        !function t() {
          for (var e = l[h].fn, i = 0, o = n.length, d = [], y = 0; y < o; ++y) {
            i += n[y] && n[y]._kareemIgnore ? 0 : 1, n[y] && n[y]._kareemIgnore || d.push(n[y]);
          }
          ...
          if (p) {
            ...
            if (e.length === i + 1) s(e, r, d.concat([v]), v);else {
              var m = void 0,
                  g = void 0;
        ...
        for (var n = o(this._posts, t, []), i = n.length, s = 0; s < i; ++s) {
          n[s].fn.apply(e, r || []);
        }
        ...
        this.execPre(t, r, n, function (c) {
          if (c) {
            for (var l = o.numCallbackParams || 0, f = o.contextParameter ? [r] : [], h = f.length; h < l; ++h) {
              f.push(null);
            }
          ...
          var p = "function" == typeof s ? n.length - 1 : n.length,
              d = e.length,
              y = e.apply(r, n.slice(0, p).concat(_));
        ...
        try {
          ...
          }, c = n[Symbol.iterator](); !(i = (a = c.next()).done); i = !0) {
            u();
          }
        } catch (t) {
          o = !0, s = t;
        ...
        try {
          for (var d, y = function y() {
            ...
            r._posts.set(n, i);
          }, _ = l[Symbol.iterator](); !(f = (d = _.next()).done); f = !0) {
            y();
          }
        } catch (t) {
          h = !0, p = t;
        ...
        try {
          ...
          }, c = t._pres.keys()[Symbol.iterator](); !(n = (a = c.next()).done); n = !0) {
            u();
          }
        } catch (t) {
          i = !0, s = t;
        ...
        try {
          ...
          }, y = t._posts.keys()[Symbol.iterator](); !(l = (p = y.next()).done); l = !0) {
            d();
          }
        } catch (t) {
          f = !0, h = t;
    ...
    Object.defineProperty(i.prototype, "ref", n), Object.defineProperty(i.prototype, "refPath", n), Object.defineProperty(i.prototype, "localField", n), Object.defineProperty(i.prototype, "foreignField", n), Object.defineProperty(i.prototype, "justOne", n), Object.defineProperty(i.prototype, "count", n), Object.defineProperty(i.prototype, "match", n), Object.defineProperty(i.prototype, "options", n), t.exports = i;
  }, function (t, e, r) {
    "use strict";
    ...
    function o(t, e, r) {
      ...
      if (n) for (var o = t.length, s = i(n, "createdAt"), a = i(n, "updatedAt"), u = 0; u < o; ++u) {
        null != a && (t[u][a] = r), null != s && (t[u][s] = r);
      }
    }
    ...
    function (t, e, r) {
      ...
      if (a.length && a[0].startsWith("$")) {
            ...
            for (var m, g = d[Symbol.iterator](); !(y = (m = g.next()).done); y = !0) {
              ...
              if (h = r.path(b)) {
                for (var w = null, O = b.split("."), S = O.length - 1; S > 0; --S) {
                  var E = r.path(O.slice(0, S).join("."));

                  if (null != E && (E.$isMongooseDocumentArray || E.$isSingleNested)) {
                    w = E;
                    break;
                  }
                }

                if (Array.isArray(e.$set[u]) && h.$isMongooseDocumentArray) o(e.$set[u], h, t);else if (e.$set[u] && h.$isSingleNested) s(e.$set[u], h, t);else if (null != w) {
                  ...
                  var A = u.substr(w.path.length + 1);
                  ...
                  var $ = A.indexOf(".");
                  A = -1 !== $ ? A.substr(0, $) : A, e.$set[w.path + "." + A + "." + l] = t;
        ...
        try {
          for (var P, T = j[Symbol.iterator](); !(x = (P = T.next()).done); x = !0) {
            u = P.value;
            var B = n(u);
    ...
    t.exports = function (t) {
      ...
      return function t(a, u, c) {
        if (!r.has(a)) {
          ...
          for (var l = Object.keys(a.paths), f = l.length, h = 0; h < f; ++h) {
            var p = l[h],
                d = a.paths[p];

            if (null == c || !c.paths[p]) {
              if (d.$isMongooseDocumentArray || d.$isSingleNested) {
                if (!0 !== n(d, "options.excludeIndexes") && !0 !== n(d, "schemaOptions.excludeIndexes") && !0 !== n(d, "schema.options.excludeIndexes") && t(d.schema, u + p + "."), null != d.schema.discriminators) {
                  var y = d.schema.discriminators,
                      _ = Object.keys(y),
                      v = !0,
                      m = !1,
                      g = void 0;
                  ...
                  try {
                    for (var b, w = _[Symbol.iterator](); !(v = (b = w.next()).done); v = !0) {
                      t(y[b.value], u + p + ".", d.schema);
                    }
                  } catch (t) {
                    m = !0, g = t;
                  } finally {
              ...
              var O = d._index || d.caster && d.caster._index;

              if (!1 !== O && null !== O && void 0 !== O) {
                var S = {},
                    E = i.isObject(O),
                    A = E ? O : {},
                    $ = "string" == typeof O ? O : !!E && O.type;
                $ && -1 !== o.indexOf($) ? S[u + p] = $ : A.text ? (S[u + p] = "text", delete A.text) : S[u + p] = 1, delete A.type, "background" in A || (A.background = !0);
                var j = A && A.name;
                "string" == typeof j && s.has(j) ? Object.assign(s.get(j), S) : (e.push([S, A]), s.set(j, S));
              }
            }
          }
    ...
    t.exports = function (t, e) {
      for (var r in t.add(e.tree || {}), t.callQueue = t.callQueue.concat(e.callQueue), t.method(e.methods), t["static"](e.statics), e.query) {
        t.query[r] = e.query[r];
      }

      for (var n in e.virtuals) {
        t.virtuals[n] = e.virtuals[n].clone();
      }
    ...
    function n(t, e) {
      var r = {
        ...
        return "updateOne" === t.name || "deleteOne" === t.name ? null == t.query || !!t.query : "remove" === t.name ? !!t.query : "validate" !== t.name || !!t.query;
      });
    ...
    (function (e) {
       ...
       * Inherits from SchemaType.
       */
      f.prototype = Object.create(n.prototype), f.prototype.constructor = f, Object.defineProperty(f.prototype, "OptionsConstructor", {
        configurable: !1,
        enumerable: !1,
        writable: !1,
        value: o
      ...
      f._cast = s, f.cast = function (t) {
        return 0 === arguments.length ? this._cast : (!1 === t && (t = function t(_t3) {
          if (null != _t3 && "string" != typeof _t3) throw new Error();
          return _t3;
        }), this._cast = t, this._cast);
      }, f.get = n.get,
      /*!
      ...
      f._checkRequired = function (t) {
        ...
        for (var r = 0; r < t.length; r++) {
          void 0 !== t[r] && this.enumValues.push(this.cast(t[r]));
        }
    ...
    t.exports = function (t) {
      return n.ok(!isNaN(t)), null == t ? t : "" === t ? null : ("string" != typeof t && "boolean" != typeof t || (t = Number(t)), n.ok(!isNaN(t)), t instanceof Number ? t.valueOf() : "number" == typeof t ? t : Array.isArray(t) || "function" != typeof t.valueOf ? t.toString && !Array.isArray(t) && t.toString() == Number(t) ? Number(t) : void n.ok(!1) : Number(t.valueOf()));
    };
  }, function (t, e, r) {
    "use strict";
    /*!
     ...
     * ignore
     */
    a._cast = o, a.cast = function (t) {
      return 0 === arguments.length ? this._cast : (!1 === t && (t = function t(_t4) {
        if (null != _t4 && "boolean" != typeof _t4) throw new Error();
        return _t4;
      }), this._cast = t, this._cast);
    },
    /*!
    ...
    function b(t, e, n) {
      function i() {
        m.apply(this, arguments), this.$session(this.ownerDocument().$session());
      }

      m || (m = r(24));
      var s = null != n ? n.prototype : m.prototype;

      for (var a in i.prototype = Object.create(s), i.prototype.$__setSchema(t), i.schema = t, i.prototype.constructor = i, i.$isArraySubdocument = !0, i.events = new o(), t.methods) {
        i.prototype[a] = t.methods[a];
      }
    ...
    function w(t, e, r) {
      if (r && e) {
        for (var n = t.path + ".", i = Object.keys(e), o = i.length, s = {}, a = void 0, u = void 0, c = void 0; o--;) {
          if ((u = i[o]).startsWith(n)) {
            if ("$" === (c = u.substring(n.length))) continue;
            c.startsWith("$.") && (c = c.substr(2)), a || (a = !0), s[c] = e[u];
          }
        }
     ...
     */
    g.prototype = Object.create(n.prototype), g.prototype.constructor = g, g.prototype.OptionsConstructor = s, g.prototype.discriminator = function (t, e, r) {
      "function" == typeof t && (t = p.getFunctionName(t));
      var n = b(e = c(this.casterConstructor, t, e, r), null, this.casterConstructor);
      n.baseCasterConstructor = this.casterConstructor;
      ...
      return this.casterConstructor.discriminators[t] = n, this.casterConstructor.discriminators[t];
    }, g.prototype.doValidate = function (t, e, n, i) {
      v || (v = r(16));
      var o = this;

      try {
        a.prototype.doValidate.call(this, t, function (r) {
          if (r) return r.$isArrayValidatorError = !0, e(r);
          var s = t && t.length,
              a = void 0;
          if (!s) return e();
          if (i && i.updateValidator) return e();
          t.isMongooseDocumentArray || (t = new v(t, o.path, n));

          function c(t) {
            null != t && ((a = t) instanceof u || (a.$isArrayValidatorError = !0)), --s || e(a);
          }

          for (var l = 0, f = s; l < f; ++l) {
            var h = t[l];

            if (null != h) {
              if (!(h instanceof m)) {
                var p = d(o.casterConstructor, t[l]);
                h = t[l] = new p(h, t, void 0, void 0, l);
              }
        ...
        return t.$isArrayValidatorError = !0, e(t);
      }
    }, g.prototype.doValidateSync = function (t, e) {
      var r = a.prototype.doValidateSync.call(this, t, e);
      if (null != r) return r.$isArrayValidatorError = !0, r;
      var n = t && t.length,
          i = null;
      ...
      if (n) {
        for (var o = 0, s = n; o < s; ++o) {
          ...
          if (u) {
            if (!(u instanceof m)) {
              var c = d(this.casterConstructor, t[o]);
              u = t[o] = new c(u, t, void 0, void 0, o);
            }

            var l = u.validateSync();
            l && null == i && (i = l);
          }
        }
    ...
    g.prototype.getDefault = function (t) {
      ...
      if (null == e) return e;
      v || (v = r(16)), Array.isArray(e) || (e = [e]), e = new v(e, this.path, t);
      ...
      t && t.isMongooseDocumentArray || s && s.skipDocumentArrayCast ? t && t.isMongooseDocumentArray && (t = new v(t, this.path, e)) : t = new v(t, this.path, e);

      for (var l = t.length, f = 0; f < l; ++f) {
        if (t[f]) {
          var b = d(this.casterConstructor, t[f]);
          if (!t[f].$__ || t[f] instanceof b && t[f][_] === e || (t[f] = t[f].toObject({
            transform: !1,
            virtuals: t[f].schema === b.schema
          })), t[f] instanceof m) null == t[f].__index && t[f].$setIndex(f);else if (null != t[f]) if (n) e ? a || (a = w(this, e.$__.selected, n)) : a = !0, u = new b(null, t, !0, a, f), t[f] = u.init(t[f]);else if (o && "function" == typeof o.id && (u = o.id(t[f]._id)), o && u && p.deepEqual(u.toObject(c), t[f])) u.set(t[f]), t[f] = u;else try {
    ...
    function f(t, e, r) {
      if (Array.isArray(t)) t.forEach(function (n, i) {
        if (Array.isArray(n) || c.isObject(n)) return f(n, e, r);
        ...
        var o = n[i],
            s = t[o];
        Array.isArray(s) || c.isObject(s) ? (f(s, e, r), t[o] = s) : t[o] = e.castForQuery({
          val: s,
          context: r
        });
      }
    ...
    t.exports = function t(e, r, h, p) {
      if (Array.isArray(r)) throw new Error("Query filter must be an object, got an array ", u.inspect(r));
      ...
      for (h = h || {}; y--;) {
        if (w = r[g = d[y]], "$or" === g || "$nor" === g || "$and" === g) for (var O = w.length; O--;) {
          w[O] = t(e, w[O], h, p);
        } else {
          if ("$where" === g) {
            if ("string" !== (b = void 0 === w ? "undefined" : n(w)) && "function" !== b) throw new Error("Must have a string or function for $where");
            "function" === b && (r[g] = w.toString());
            continue;
          }

          if ("$elemMatch" === g) w = t(e, w, h, p);else if ("$text" === g) w = s(w, g);else {
            if (!e) continue;
            if (!(v = e.path(g))) for (var S = g.split("."), E = S.length; E--;) {
              var A = S.slice(0, E).join("."),
                  $ = S.slice(E).join("."),
                  j = e.path(A),
                  x = a(j, "schema.options.discriminatorKey");

              if (null != j && null != a(j, "schema.discriminators") && null != x && $ !== x) {
                var N = a(r, A + "." + x);
                null != N && (v = j.schema.discriminators[N].path($));
              }
            }

            if (v) {
              if (null == w) continue;
              if ("Object" === w.constructor.name) {
                if (Object.keys(w).some(function (t) {
                  return t.startsWith("$") && "$id" !== t && "$ref" !== t;
                })) for (var k = Object.keys(w), P = void 0, T = k.length; T--;) {
                  if (m = w[P = k[T]], "$not" === P) {
                    if (m && v && !v.caster) {
                      if ((_ = Object.keys(m)).length && _[0].startsWith("$")) for (var B in m) {
                        m[B] = v.castForQueryWrapper({
                          $conditional: B,
                          val: m[B],
                          context: p
                        });
                      } else w[P] = v.castForQueryWrapper({
                        $conditional: P,
                        val: m,
                        context: p
                      });
                    ...
                    t(v.caster ? v.caster.schema : e, m, h, p);
                  } else w[P] = v.castForQueryWrapper({
                    $conditional: P,
                    val: m,
                    context: p
                  });
                } else r[g] = v.castForQueryWrapper({
                  val: w,
                  context: p
                });
              } else if (Array.isArray(w) && -1 === ["Buffer", "Array"].indexOf(v.instance)) {
                for (var C = [], D = 0; D < w.length; D++) {
                  C.push(v.castForQueryWrapper({
                    val: w[D],
                    context: p
                  }));
                }
              ...
              for (var M = g.split("."), R = M.length, F = void 0, I = void 0, L = void 0; R-- && (F = M.slice(0, R).join("."), !(v = e.path(F)));) {
                ;
              }

              if (v) {
                v.caster && v.caster.schema ? ((L = {})[I = M.slice(R).join(".")] = w, r[g] = t(v.caster.schema, L, h, p)[I]) : r[g] = w;
                continue;
              }
              ...
              if (c.isObject(w)) {
                ...
                if (w.$near ? U = "$near" : w.$nearSphere ? U = "$nearSphere" : w.$within ? U = "$within" : w.$geoIntersects ? U = "$geoIntersects" : w.$geoWithin && (U = "$geoWithin"), U) {
                  var V = new o.Number("__QueryCasting__"),
                      q = w[U];

                  if (null != w.$maxDistance && (w.$maxDistance = V.castForQueryWrapper({
                    val: w.$maxDistance,
                    context: p
                  })), null != w.$minDistance && (w.$minDistance = V.castForQueryWrapper({
                    val: w.$minDistance,
                    context: p
                  })), "$within" === U) {
                    var W = q.$center || q.$centerSphere || q.$box || q.$polygon;
                    if (!W) throw new Error("Bad $within parameter: " + JSON.stringify(w));
                    q = W;
                  } else if ("$near" === U && "string" == typeof q.type && Array.isArray(q.coordinates)) q = q.coordinates;else if (("$near" === U || "$nearSphere" === U || "$geoIntersects" === U) && q.$geometry && "string" == typeof q.$geometry.type && Array.isArray(q.$geometry.coordinates)) null != q.$maxDistance && (q.$maxDistance = V.castForQueryWrapper({
                    val: q.$maxDistance,
                    context: p
                  })), null != q.$minDistance && (q.$minDistance = V.castForQueryWrapper({
                    val: q.$minDistance,
                    context: p
                  })), c.isMongooseObject(q.$geometry) && (q.$geometry = q.$geometry.toObject({
                    transform: !1,
                    virtuals: !1
                  })), q = q.$geometry.coordinates;else if ("$geoWithin" === U) if (q.$geometry) {
                    c.isMongooseObject(q.$geometry) && (q.$geometry = q.$geometry.toObject({
                      virtuals: !1
                    }));
                    var H = q.$geometry.type;
                    if (-1 === l.indexOf(H)) throw new Error('Invalid geoJSON type for $geoWithin "' + H + '", must be "Polygon" or "MultiPolygon"');
                    q = q.$geometry.coordinates;
                  } else q = q.$box || q.$polygon || q.$center || q.$centerSphere, c.isMongooseObject(q) && (q = q.toObject({
                    virtuals: !1
                  }));
              ...
              if (e.nested[g]) continue;

              if (h.upsert && h.strict) {
                if ("throw" === h.strict) throw new i(g);
                throw new i(g, 'Path "' + g + '" is not in schema, strict mode is `true`, and upsert is `true`.');
              }

              if ("throw" === h.strictQuery) throw new i(g, 'Path "' + g + "\" is not in schema and strictQuery is 'throw'.");
              h.strictQuery && delete r[g];
            }
          }
        }
      }
    ...
    var n = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (t) {
      ...
      return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : _typeof(t);
        ...
        d = r(82),
        y = r(81),
        _ = r(20).internalToObjectOptions,
        v = void 0;
    ...
    function g(t, e) {
      ...
      var n = function n(t, e, r) {
        var n = this;
        this.$parent = r, v.apply(this, arguments), this.$session(this.ownerDocument().$session()), r && (r.on("save", function () {
          n.emit("save", n), n.constructor.emit("save", n);
        }), r.on("isNew", function (t) {
          n.isNew = t, n.emit("isNew", t), n.constructor.emit("isNew", t);
        }));
      },
          i = null != e ? e.prototype : v.prototype;

      for (var s in (n.prototype = Object.create(i)).$__setSchema(t), n.prototype.constructor = n, n.schema = t, n.$isSingleNested = !0, n.events = new o(), n.prototype.toBSON = function () {
        return this.toObject(_);
      }, t.methods) {
        n.prototype[s] = t.methods[s];
      }

      for (var a in t.statics) {
        n[a] = t.statics[a];
      }
    ...
    t.exports = m, m.prototype = Object.create(u.prototype), m.prototype.constructor = m, m.prototype.OptionsConstructor = a, m.prototype.$conditionalHandlers.$geoWithin = function (t) {
      return {
    ...
    (function (e) {
      ...
      p._checkRequired = function (t) {
        return !(!t || !t.length);
      }, p.checkRequired = s.checkRequired, p.prototype.checkRequired = function (t, e) {
    ...
    c._cast = s, c.cast = function (t) {
      return 0 === arguments.length ? this._cast : (!1 === t && (t = function t(_t5) {
        if (null != _t5 && !(_t5 instanceof Date)) throw new Error();
        return _t5;
      }), this._cast = t, this._cast);
    }, c.prototype.expires = function (t) {
      return this._index && "Object" === this._index.constructor.name || (this._index = {}), this._index.expires = t, a.expires(this._index), this;
    },
    /*!
     * ignore
     */
    ...
    (function (e) {
       ...
       * Inherits from SchemaType.
       */
      f.prototype = Object.create(i.prototype), f.prototype.constructor = f, f.prototype.OptionsConstructor = n, f.get = i.get, f.prototype.auto = function (t) {
        return t && (this["default"](p), this.set(d)), this;
      },
      /*!
       * ignore
       */
      ...
      f._cast = o, f.cast = function (t) {
        return 0 === arguments.length ? this._cast : (!1 === t && (t = function t(_t6) {
          if (!(_t6 instanceof s)) throw new Error();
          return _t6;
        }), this._cast = t, this._cast);
    ...
    (function (e) {
       ...
       * ignore
       */
      l._cast = s, l.cast = function (t) {
        return 0 === arguments.length ? this._cast : (!1 === t && (t = function t(_t7) {
          if (null != _t7 && !(_t7 instanceof o)) throw new Error();
          return _t7;
        }), this._cast = t, this._cast);
      },
      /*!
    ...
    (function (e) {
          ...
          value: function value(t, r, n) {
            ...
            if (n) {
              ...
              if (t instanceof e.Map) {
                ...
                try {
                  for (var y, _ = Object.keys(t)[Symbol.iterator](); !(h = (y = _.next()).done); h = !0) {
                    var v = y.value;
                    o.$init(v, o.$__schemaType.cast(t[v], r, !0));
                  }
                } catch (t) {
                  p = !0, d = t;
                } finally {
      ...
      a.prototype.OptionsConstructor = o, t.exports = a;
    }).call(this, r(11));
  }, function (t, e, r) {
    "use strict";
    ...
    (function (t) {
      ...
      function a(e) {
        return e && "object" === (void 0 === e ? "undefined" : n(e)) && !(e instanceof Date) && !(e instanceof o) && (!Array.isArray(e) || e.length > 0) && !(e instanceof t) && !(e instanceof i);
      }
      ...
      function e(r, n, i, o) {
        var u = void 0;
        u = r && s.isMongooseObject(r) && !t.isBuffer(r) ? Object.keys(r.toObject({
          transform: !1,
          virtuals: !1
        })) : Object.keys(r || {});
        var c = u.length;
          ...
          if (!d || "Mixed" !== d.instance) {
            ...
            if (y) {
              ...
              try {
                for (var O, S = m[Symbol.iterator](); !(g = (O = S.next()).done); g = !0) {
                  var E = O.value;
                  E.startsWith(n + h + ".") && !l.hasOwnProperty(E) && (l[E] = void 0);
                }
              } catch (t) {
                b = !0, w = t;
              } finally {
      ...
      , e.modifiedPaths = function e(r, n, i) {
        ...
        for (var c = 0; c < u; ++c) {
          var l = o[c],
              f = r[l];
          i[n + l] = !0, s.isMongooseObject(f) && !t.isBuffer(f) && (f = f.toObject({
            transform: !1,
            virtuals: !1
          })), a(f) && e(f, n + l, i);
        }
    ...
    t.exports = function (t) {
      !t.paths.id && !t.options.noVirtualId && t.options.id && t.virtual("id").get(n);
    };
  }, function (t, e, r) {
    "use strict";
    ...
    t.exports = function (t) {
      var e = Object.keys(t),
          r = e.length,
          i = null;
      if (1 === r && "_id" === e[0]) i = !!t[e[r]];else for (; r--;) {
        if ("_id" !== e[r] && n(t[e[r]])) {
          i = !t[e[r]];
          break;
        }
    ...
    function f(t, e, r, i, u) {
      if (!(this instanceof f)) return new f(t, e, r, i, u);
      if (l.isObject(e) && !e.instanceOfSchema && (e = new s(e)), e = this.schema || e, !this.schema && e.options._id && void 0 === (t = t || {})._id && (t._id = new a()), !e) throw new o.MissingSchemaError();
     ...
     */
    f.$emitter = new i(), l.each(["on", "once", "emit", "listeners", "removeListener", "setMaxListeners", "removeAllListeners", "addListener"], function (t) {
      f[t] = function () {
        return f.$emitter[t].apply(f.$emitter, arguments);
      };
    }),
    /*!
     * Module exports.
