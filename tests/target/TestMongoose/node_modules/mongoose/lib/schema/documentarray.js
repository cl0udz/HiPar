...
var SchemaDocumentArrayOptions = require('../options/SchemaDocumentArrayOptions');
...
DocumentArrayPath.prototype.cast = function (value, doc, init, prev, options) {
  ...
  for (var i = 0; i < len; ++i) {
    ...
    var Constructor = getConstructor(this.casterConstructor, value[i]); // Check if the document has a different schema (re gh-3701)
