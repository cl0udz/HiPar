...
var SchemaArrayOptions = require('../options/SchemaArrayOptions');
...
SchemaArray.prototype["enum"] = function () {
  ...
  while (true) {
    var instance = get(arr, 'caster.instance');
...
SchemaArray.prototype.cast = function (value, doc, init) {
  ...
  if (Array.isArray(value)) {
    if (!value.length && doc) {
      ...
      var arrayGeojsonPath = this.path.endsWith('.coordinates') ? this.path.substr(0, this.path.lastIndexOf('.')) : null;
    ...
    var isPopulated = doc != null && doc.$__ != null && doc.populated(this.path);
