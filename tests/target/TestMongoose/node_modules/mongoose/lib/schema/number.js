...
var SchemaNumberOptions = require('../options/SchemaNumberOptions');
...
SchemaNumber.prototype.cast = function (value, doc, init) {
  if (SchemaType._isRef(this, value, doc, init)) {
    ...
    var ret = new pop.options[populateModelSymbol](value);
  ...
  value;
  var castNumber = typeof this.constructor.cast === 'function' ? this.constructor.cast() : SchemaNumber.cast();
