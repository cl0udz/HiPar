...
var Buffer = require('safe-buffer').Buffer; // Yes this is weird. See https://github.com/feross/safe-buffer/pull/23


var proto = Buffer.from('').constructor.prototype;
/**
...
MongooseBuffer.mixin = {
  ...
  write: function write() {
    var written = proto.write.apply(this, arguments);
  ...
  copy: function copy(target) {
    var ret = proto.copy.apply(this, arguments);
...
'writeUInt16LE writeUInt16BE writeUInt32LE writeUInt32BE ' + 'writeInt16LE writeInt16BE writeInt32LE writeInt32BE ' + 'writeFloatLE writeFloatBE writeDoubleLE writeDoubleBE').split(' ').forEach(function (method) {
  ...
  MongooseBuffer.mixin[method] = function () {
    var ret = proto[method].apply(this, arguments);
