...
NativeConnection.prototype.useDb = function (name, options) {
  ...
  function wireup() {
    ...
    newConn.onOpen(); // setup the events appropriately
...
function listen(conn) {
  ...
  conn.db.on('close', function (force) {
    if (conn._closeCalled) return; // the driver never emits an `open` event. auto_reconnect still
...
NativeConnection.prototype.doClose = function (force, fn) {
  this.client.close(force, function (err, res) {
