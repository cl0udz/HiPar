...
Document.prototype.$__buildDoc = function (obj, fields, skipId, exclude, hasIncludedChildren) {
  var doc = {};
  var paths = Object.keys(this.schema.paths). // Don't build up any paths that are underneath a map, we don't know
...
Document.prototype.$__init = function (doc, opts) {
  ...
  if (doc._id != null && opts.populated && opts.populated.length) {
    ...
    for (var _i3 = 0; _i3 < opts.populated.length; ++_i3) {
      var item = opts.populated[_i3];
...
Document.prototype.$session = function $session(session) {
  ...
  if (!this.ownerDocument) {
    ...
    try {
      for (var _iterator2 = subdocs[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
Document.prototype.$set = function $set(path, val, type, options) {
  ...
  function _handleIndex(i) {
    ...
    if (_typeof(path[key]) === 'object' && !utils.isNativeObject(path[key]) && !utils.isMongooseType(path[key]) && path[key] != null && pathtype !== 'virtual' && pathtype !== 'real' && !(this.$__path(pathName) instanceof MixedSchema) && !(this.schema.paths[pathName] && this.schema.paths[pathName].options && this.schema.paths[pathName].options.ref)) {
  ...
  if (pathType === 'nested' && val) {
    if (_typeof(val) === 'object' && val != null) {
      ...
      var _keys2 = Object.keys(val);

      this.$__setValue(path, {});

      for (var _i6 = 0, _keys3 = _keys2; _i6 < _keys3.length; _i6++) {
        var _key = _keys3[_i6];
        this.$set(path + '.' + _key, val[_key], constructing);
      }
  ...
  try {
    ...
    if (schema.$isMongooseDocumentArray && Array.isArray(val) && val.length > 0 && val[0] != null && val[0].$__ != null && val[0].$__.populated != null) {
      ...
      var _loop = function _loop() {
        var populatedPath = _populatedPaths[_i8];
      ...
      for (var _i8 = 0, _populatedPaths = populatedPaths; _i8 < _populatedPaths.length; _i8++) {
        _loop();
      }
    ...
    if (!didPopulate && this.$__.populated) {
      ...
      if (Array.isArray(val) && this.$__.populated[path]) {
        for (var _i9 = 0; _i9 < val.length; ++_i9) {
          if (val[_i9] instanceof Document) {
            val[_i9] = val[_i9]._id;
          }
        }
      }
...
Document.prototype.get = function (path, type, options) {
  ...
  for (var _i10 = 0, l = pieces.length; _i10 < l; _i10++) {
    if (obj && obj._doc) {
      obj = obj._doc;
    }
    ...
    if (obj == null) {
      ...
      obj = obj.get(pieces[_i10]);
    } else if (_i10 === l - 1) {
      obj = utils.getValue(pieces[_i10], obj);
    } else {
      obj = obj[pieces[_i10]];
    }
  }
...
function _isEmpty(v) {
  ...
  for (var _i11 = 0, _Object$keys = Object.keys(v); _i11 < _Object$keys.length; _i11++) {
    ...
    if (cur != null && _typeof(cur) === 'object') {
      ...
      if (Array.isArray(cur)) {
        ...
        for (var _i12 = 0; _i12 < len; ++_i12) {
          if (list.indexOf(path + '.' + _i12) === -1) {
            list.push(path + '.' + _i12);

            if (cur[_i12] != null && cur[_i12].$__) {
              var modified = cur[_i12].modifiedPaths();
              ...
              try {
                for (var _iterator4 = modified[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                  var childPath = _step4.value;
                  list.push(path + '.' + _i12 + '.' + childPath);
                }
              } catch (err) {
...
Document.prototype.isSelected = function isSelected(path) {
  if (this.$__.selected) {
    ...
    var _i13 = paths.length;
    var inclusive = null;
    var cur;

    if (_i13 === 1 && paths[0] === '_id') {
...
Document.prototype.isDirectSelected = function isDirectSelected(path) {
  if (this.$__.selected) {
    ...
    var paths = Object.keys(this.$__.selected);
    var _i14 = paths.length;
    var inclusive = null;
    var cur;

    if (_i14 === 1 && paths[0] === '_id') {
      // only _id was selected.
      return this.$__.selected._id === 0;
    }
...
Document.prototype.validate = function (pathsToValidate, options, callback) {
  ...
  return utils.promiseOrCallback(callback, function (cb) {
    ...
    _this5.$__validate(pathsToValidate, options, function (error) {
      _this5.$__.validating = null;
      cb(error);
    });
...
function _getPathsToValidate(doc) {
  ...
  try {
    for (var _iterator5 = subdocs[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
      var subdoc = _step5.value;
  ...
  try {
    for (var _iterator7 = paths[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
      ...
      if (doc.schema.nested[pathToCheck]) {
        ...
        var flat = flatten(_v, pathToCheck, flattenOptions, doc.schema);
  ...
  try {
    for (var _iterator8 = paths[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
      var _path = _step8.value;

      // Single nested paths (paths embedded under single nested subdocs) will
      // be validated on their own when we call `validate()` on the subdoc itself.
      // Re: gh-8468
      if (doc.schema.singleNestedPaths.hasOwnProperty(_path)) {
        paths["delete"](_path);
        continue;
      }
      ...
      try {
        for (var _iterator10 = _val.keys()[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
...
Document.prototype.$__validate = function (pathsToValidate, options, callback) {
  ...
  var _complete = function _complete() {
    var validationError = _this6.$__.validationError;
    _this6.$__.validationError = undefined;
    ...
    if (shouldValidateModifiedOnly && validationError != null) {
      ...
      for (var _i15 = 0, _errors = errors; _i15 < _errors.length; _i15++) {
        var errPath = _errors[_i15];

        if (!_this6.isModified(errPath)) {
    ...
    _this6.$__.cachedRequired = {};

    _this6.emit('validate', _this);

    _this6.constructor.emit('validate', _this);

    if (validationError) {
      for (var key in validationError.errors) {
        // Make sure cast errors persist
        if (!_this6[documentArrayParent] && validationError.errors[key] instanceof MongooseError.CastError) {
          _this6.invalidate(key, validationError.errors[key]);
        }
      }
  ...
  for (var _i16 = 0; _i16 < numPaths; ++_i16) {
    validatePath(paths[_i16]);
  }
};
/**
...
Document.prototype.validateSync = function (pathsToValidate, options) {
  ...
  if (pathsToValidate && pathsToValidate.length) {
    ...
    for (var _i17 = 0; _i17 < paths.length; ++_i17) {
      if (pathsToValidate.indexOf(paths[_i17]) !== -1) {
        tmp.push(paths[_i17]);
      }
    }
...
Document.prototype.$__setSchema = function (schema) {
  ...
  for (var _i18 = 0, _Object$keys2 = Object.keys(schema.virtuals); _i18 < _Object$keys2.length; _i18++) {
...
function applyQueue(doc) {
  ...
  for (var _i19 = 0; _i19 < q.length; ++_i19) {
    pair = q[_i19];
...
Document.prototype.$toObject = function (options, json) {
  ...
  var schemaOptions = get(this, 'schema.options', {}); // merge base default options with Schema's set default options if available.
...
Document.prototype.populate = function populate() {
  ...
  if (args.length) {
    ...
    for (var _i20 = 0; _i20 < res.length; ++_i20) {
      pop[res[_i20].path] = res[_i20];
    }
  }
...
Document.prototype.populated = function (path, val, options) {
  ...
  for (var _i21 = 0; _i21 < pieces.length - 1; ++_i21) {
    var subpath = pieces.slice(0, _i21 + 1).join('.');
    var subdoc = this.get(subpath);

    if (subdoc != null && subdoc.$__ != null && this.populated(subpath)) {
      var rest = pieces.slice(_i21 + 1).join('.');
...
Document.prototype.depopulate = function (path) {
  ...
  if (arguments.length === 0) {
    // Depopulate all
    for (var _i22 = 0; _i22 < virtualKeys.length; _i22++) {
      delete this.$$populatedVirtuals[virtualKeys[_i22]];
      delete this._doc[virtualKeys[_i22]];
      delete populated[virtualKeys[_i22]];
    }

    var keys = Object.keys(populated);

    for (var _i23 = 0; _i23 < keys.length; _i23++) {
      populatedIds = this.populated(keys[_i23]);

      if (!populatedIds) {
        continue;
      }

      delete populated[keys[_i23]];
      this.$set(keys[_i23], populatedIds);
    }

    return this;
  }

  for (var _i24 = 0; _i24 < path.length; _i24++) {
    populatedIds = this.populated(path[_i24]);
    delete populated[path[_i24]];

    if (virtualKeys.indexOf(path[_i24]) !== -1) {
      delete this.$$populatedVirtuals[path[_i24]];
      delete this._doc[path[_i24]];
    } else if (populatedIds) {
      this.$set(path[_i24], populatedIds);
    }
  }
