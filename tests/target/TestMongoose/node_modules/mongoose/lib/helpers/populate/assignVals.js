...
module.exports = function assignVals(o) {
  ...
  var userOptions = get(o, 'allOptions.options.options'); // `o.options` contains options explicitly listed in `populateOptions`, like
  // `match` and `limit`.
  ...
  for (var i = 0; i < docs.length; ++i) {
    var existingVal = utils.getValue(o.path, docs[i]);
    ...
    if (count) {
      ...
      valueToSet = Array.isArray(rawIds[i]) ? sift(o.match[i], rawIds[i]) : sift(o.match[i], [rawIds[i]])[0];
    } else {
      valueToSet = rawIds[i];
    ...
    if (o.isVirtual && isDoc) {
      docs[i].populated(o.path, o.justOne ? originalIds[0] : originalIds, o.allOptions); // If virtual populate and doc is already init-ed, need to walk through
