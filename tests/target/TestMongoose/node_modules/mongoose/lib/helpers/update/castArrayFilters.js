...
module.exports = function castArrayFilters(query) {
  ...
  var updatedPathsByFilter = Object.keys(updatedPaths).reduce(function (cur, path) {
  ...
  try {
    for (var _iterator2 = arrayFilters[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      ...
      var firstKey = Object.keys(filter)[0];
      ...
      var filterPath = dot === -1 ? updatedPathsByFilter[firstKey] + '.0' : updatedPathsByFilter[firstKey.substr(0, dot)] + '.0' + firstKey.substr(dot);

      if (filterPath == null) {
        throw new Error("Filter path not found for ".concat(firstKey));
      ...
      if (_typeof(filter[firstKey]) === 'object') {
