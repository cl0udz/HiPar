...
module.exports = function (query, schema, castedDoc, options, callback) {
  ...
  for (i = 0; i < numArrayUpdates; ++i) {
    (function (i) {
      ...
      if (schemaPath && schemaPath.$isMongooseDocumentArray) {
        ...
        for (var _j = 0; _j < arrayAtomicUpdates[arrayUpdates[i]].length; ++_j) {
          (function (j) {
            validatorsToExecute.push(function (callback) {
  ...
  function _done(callback) {
    if (validationErrors.length) {
      ...
      for (var _i2 = 0; _i2 < validationErrors.length; ++_i2) {
        err.addError(validationErrors[_i2].path, validationErrors[_i2]);
      }
