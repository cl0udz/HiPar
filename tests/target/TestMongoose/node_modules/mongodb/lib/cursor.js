...
function (_CoreCursor) {
  ...
  function Cursor(topology, ns, cmd, options) {
    ...
    _this3 = _possibleConstructorReturn(this, _getPrototypeOf(Cursor).call(this, topology, ns, cmd, options));
    ...
    if (_this3.options.noCursorTimeout === true) {
      _this3.addCursorFlag('noCursorTimeout', true);
    } // Get the batchSize


    var batchSize = 1000;

    if (_this3.cmd.cursor && _this3.cmd.cursor.batchSize) {
      batchSize = _this3.cmd.cursor.batchSize;
    ...
    _this3.setCursorBatchSize(batchSize);
  ...
  _createClass(Cursor, [{
    ...
    value: function forEach(iterator, callback) {
      var _this = this; // Rewind cursor state
