...
function (_EventEmitter) {
  ...
  function ClientSession(topology, sessionPool, options, clientOptions) {
    ...
    _this3 = _possibleConstructorReturn(this, _getPrototypeOf(ClientSession).call(this));
    ...
    _this3.topology = topology;
    _this3.sessionPool = sessionPool;
    _this3.hasEnded = false;
    _this3.serverSession = sessionPool.acquire();
    _this3.clientOptions = clientOptions;
    _this3.supports = {
      causalConsistency: typeof options.causalConsistency !== 'undefined' ? options.causalConsistency : true
    };
    _this3.clusterTime = options.initialClusterTime;
    _this3.operationTime = null;
    _this3.explicit = !!options.explicit;
    _this3.owner = options.owner;
    _this3.defaultTransactionOptions = Object.assign({}, options.defaultTransactionOptions);
    _this3.transaction = new Transaction();
    return _this3;
  }
  /**
  ...
  _createClass(ClientSession, [{
    ...
    value: function commitTransaction(callback) {
      ...
      return new Promise(function (resolve, reject) {
        endTransaction(_this, 'commitTransaction', function (err, reply) {
    ...
    value: function abortTransaction(callback) {
      ...
      return new Promise(function (resolve, reject) {
        endTransaction(_this2, 'abortTransaction', function (err, reply) {
          return err ? reject(err) : resolve(reply);
        });
      });
    }
