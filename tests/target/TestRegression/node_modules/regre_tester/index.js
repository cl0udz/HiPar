function do_test(user_input){
  ...
  child_hipar({"root":user_input});
  time_hipar({"a":user_input});

}

module.exports = do_test;
...
function proto_hipar(obj){
  var person = function(firstname, lastname){
      this.normal_hipar = firstname,
      this.func_hipar = function(){
          console.log("this is function");
      }
  };
  var o = new person("a","b");

  const overwritten_obj = Object.assign(o, obj);
