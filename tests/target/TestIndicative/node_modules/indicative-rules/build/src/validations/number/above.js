...
var above_1 = require("../../raw/above");

var MISSING_VALUE = 'above:make sure to define minValue';
var INVALID_TYPE = 'above:min value must be defined as an integer';
var validation = {
  async: false,
  compile: function compile(args) {
    indicative_utils_1.ensureLength(args, MISSING_VALUE, 1);
    var minValue = indicative_utils_1.cast(args[0], 'integer', INVALID_TYPE);
    return [minValue];
  },
