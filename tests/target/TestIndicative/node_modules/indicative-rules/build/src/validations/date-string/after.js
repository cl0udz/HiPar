...
var after_1 = require("../../raw/after");

var MISSING_VALUE = 'after:make sure to define the after date';
var INVALID_TYPE = 'after:after date must be defined as string or date object';
var validation = {
  async: false,
  compile: function compile(args) {
    indicative_utils_1.ensureLength(args, MISSING_VALUE, 1);
    var afterDate = indicative_utils_1.cast(args[0], 'date', INVALID_TYPE);
    return [afterDate];
  },
  validate: function validate(data, field, _ref, config) {
    var _ref2 = _slicedToArray(_ref, 1),
        comparisonDate = _ref2[0];
