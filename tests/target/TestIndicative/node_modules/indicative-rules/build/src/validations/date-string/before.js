...
var before_1 = require("../../raw/before");

var MISSING_VALUE = 'before:make sure to define the before date';
var INVALID_TYPE = 'before:before date must be defined as string or date object';
var validation = {
  async: false,
  compile: function compile(args) {
    indicative_utils_1.ensureLength(args, MISSING_VALUE, 1);
    var beforeDate = indicative_utils_1.cast(args[0], 'date', INVALID_TYPE);
    return [beforeDate];
  },
