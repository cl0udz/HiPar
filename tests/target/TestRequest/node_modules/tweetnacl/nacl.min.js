...
!function (r) {
  ...
  function c(r, t, i, a, f) {
    ...
    for (u = 0; u < 4; u++) {
      l[5 * u] = e(a, 4 * u), l[1 + u] = e(i, 4 * u), l[6 + u] = e(t, 4 * u), l[11 + u] = e(i, 16 + 4 * u);
    }
    ...
    if (f) {
      ...
      for (u = 0; u < 4; u++) {
        l[5 * u] = l[5 * u] - e(a, 4 * u) | 0, l[6 + u] = l[6 + u] - e(t, 4 * u) | 0;
      }
  ...
  function l(r, n, e, t, o, i, a) {
    ...
    if (o > 0) for (w(y, c, a, Br), u = 0; u < o; u++) {
      r[n + u] = (e ? e[t + u] : 0) ^ y[u];
    }
    return 0;
  }
  ...
  function g(r, n, e, t, o, i, a) {
    var f = new Uint8Array(32);
    return y(f, i, a, Br), l(r, n, e, t, o, i.subarray(16), f);
  }
  ...
  function b(r, n, e, t, o, i) {
    ...
    for (y[3] &= 15, y[4] &= 252, y[7] &= 15, y[8] &= 252, y[11] &= 15, y[12] &= 252, y[15] &= 15; o > 0;) {
      ...
      for (s[u] = 1, t += u, o -= u, v(l, s), f = 0; f < 17; f++) {
        for (w[f] = 0, u = 0; u < 17; u++) {
          w[f] = w[f] + l[u] * (u <= f ? y[f - u] : 320 * y[f + 17 - u] | 0) | 0 | 0;
        }
      }
    ...
    for (v(l, Sr), a = 0 | -(l[16] >>> 7), u = 0; u < 17; u++) {
      l[u] ^= a & (h[u] ^ l[u]);
    }
  ...
  function p(r, n, e, t, o, i) {
    ...
    return b(a, 0, e, t, o, i), f(r, n, a, 0);
  }
  ...
  function _(r, n, e, t, o) {
    ...
    for (g(r, 0, n, 0, e, t, o), b(r, 16, r, 32, e - 32, r), i = 0; i < 16; i++) {
      r[i] = 0;
    }
  ...
  function A(r, n, e, t, o) {
    var i,
        a = new Uint8Array(32);
    if (e < 32) return -1;
    if (h(a, 0, 32, t, o), 0 !== p(n, 16, n, 32, e - 32, a)) return -1;

    for (g(r, 0, n, 0, e, t, o), i = 0; i < 32; i++) {
      r[i] = 0;
    }
  ...
  function x(r, n) {
    ...
    for (E(a), E(a), E(a), t = 0; t < 2; t++) {
      for (i[0] = a[0] - 65517, e = 1; e < 15; e++) {
        i[e] = a[e] - 65535 - (i[e - 1] >> 16 & 1), i[e - 1] &= 65535;
      }

      i[15] = a[15] - 32767 - (i[14] >> 16 & 1), o = i[15] >> 16 & 1, i[14] &= 65535, d(a, i, 1 - o);
    }
  ...
  function R(r, n, e) {
    ...
    for (i[31] = 127 & n[31] | 64, i[0] &= 248, S(a, e), o = 0; o < 16; o++) {
      u[o] = a[o], w[o] = f[o] = c[o] = 0;
    }

    for (f[0] = w[0] = 1, o = 254; o >= 0; --o) {
      t = i[o >>> 3] >>> (7 & o) & 1, d(f, u, t), d(c, w, t), K(y, f, c), T(f, f, c), K(c, u, w), T(u, u, w), L(w, y), L(l, f), Y(f, c, f), Y(c, u, y), K(y, f, c), T(f, f, c), L(u, f), T(c, w, l), Y(f, c, Ar), K(f, f, w), Y(c, c, f), Y(f, w, l), Y(w, u, a), L(u, y), d(f, u, t), d(c, w, t);
    }

    for (o = 0; o < 16; o++) {
      a[o + 16] = f[o], a[o + 32] = c[o], a[o + 48] = u[o], a[o + 64] = w[o];
    }

    var s = a.subarray(32),
        h = a.subarray(16);
    return k(s, s), Y(h, h, s), x(r, h), 0;
  }
  ...
  function O(r, n) {
    return gr(n, 32), P(r, n);
  }

  function F(r, n, e) {
    var t = new Uint8Array(32);
    return R(t, e, n), y(r, vr, t, Br);
  }

  function N(r, n, e, t, o, i) {
    var a = new Uint8Array(32);
    return F(a, o, i), Kr(r, n, e, t, a);
  }

  function C(r, n, e, t, o, i) {
    var a = new Uint8Array(32);
    return F(a, o, i), Tr(r, n, e, t, a);
  }
  ...
  function M() {
    ...
    for (e = 0; e < arguments.length; e++) {
      r = arguments[e].lo, n = arguments[e].hi, t += r & f, o += r >>> 16, i += n & f, a += n >>> 16;
    }

    return o += t >>> 16, i += o >>> 16, a += i >>> 16, new sr(i & f | a << 16, t & f | o << 16);
  }
  ...
  function V(r) {
    return Z(j(r, 28), j(r, 34), j(r, 39));
  }

  function X(r) {
    return Z(j(r, 14), j(r, 18), j(r, 41));
  }

  function D(r) {
    return Z(j(r, 1), j(r, 8), G(r, 7));
  }

  function H(r) {
    return Z(j(r, 19), j(r, 61), G(r, 6));
  }
  ...
  function J(r, n, e) {
    ...
    for (var l = 0; e >= 128;) {
      ...
      for (a = 0; a < 80; a++) {
        ...
        for (o = M(w[7], X(w[4]), q(w[4], w[5], w[6]), Yr[a], y[a % 16]), c[7] = M(o, V(w[0]), I(w[0], w[1], w[2])), c[3] = M(c[3], o), f = 0; f < 8; f++) {
          w[(f + 1) % 8] = c[f];
        }

        if (a % 16 === 15) for (f = 0; f < 16; f++) {
          y[f] = M(y[f], y[(f + 9) % 16], D(y[(f + 1) % 16]), H(y[(f + 14) % 16]));
        }
      }

      for (a = 0; a < 8; a++) {
        w[a] = M(w[a], u[a]), u[a] = w[a];
      }
  ...
  function Q(r, n, e) {
    ...
    for (a[e] = 128, e = 256 - 128 * (e < 112 ? 1 : 0), a[e - 9] = 0, i(a, e - 8, new sr(f / 536870912 | 0, f << 3)), J(o, a, e), t = 0; t < 64; t++) {
      r[t] = o[t];
    }
  ...
  function W(r, n) {
    var e = hr(),
        ...
        c = hr(),
        w = hr();
    T(e, r[1], r[0]), T(w, n[1], n[0]), Y(e, e, w), K(t, r[0], r[1]), K(w, n[0], n[1]), Y(t, t, w), Y(o, r[3], n[3]), Y(o, o, Er), Y(i, r[2], n[2]), K(i, i, i), T(a, t, e), T(f, i, o), K(u, i, o), K(c, t, e), Y(r[0], a, f), Y(r[1], c, u), Y(r[2], u, f), Y(r[3], a, c);
  }
  ...
  function rr(r, n) {
    var e = hr(),
        t = hr(),
        o = hr();
    k(o, n[2]), Y(e, n[0], o), Y(t, n[1], o), x(r, t), r[31] ^= B(e) << 7;
  }
  ...
  function er(r, n) {
    var e = [hr(), hr(), hr(), hr()];
    U(e[0], dr), U(e[1], xr), U(e[2], _r), Y(e[3], dr, xr), nr(r, e, n);
  }
  ...
  function tr(r, n, e) {
    ...
    for (e || gr(n, 32), Q(o, n, 32), o[0] &= 248, o[31] &= 127, o[31] |= 64, er(i, o), rr(r, i), t = 0; t < 32; t++) {
      n[t + 32] = r[t];
    }
  ...
  function ar(r, n, e, t) {
    var o,
        ...
        w = [hr(), hr(), hr(), hr()];
    Q(a, t, 32), a[0] &= 248, a[31] &= 127, a[31] |= 64;
    var y = e + 64;
    ...
    for (Q(f, r, e + 64), ir(f), o = 0; o < 64; o++) {
      c[o] = 0;
    }
  ...
  function fr(r, n) {
    var e = hr(),
        ...
        f = hr(),
        u = hr();
    return U(r[2], _r), S(r[1], n), L(o, r[1]), Y(i, o, Ur), T(o, o, r[2]), K(i, r[2], i), L(a, i), L(f, a), Y(u, f, a), Y(e, u, o), Y(e, e, i), z(e, e), Y(e, e, o), Y(e, e, i), Y(e, e, i), Y(r[0], e, i), L(t, r[0]), Y(t, t, i), m(t, o) && Y(r[0], r[0], mr), L(t, r[0]), Y(t, t, i), m(t, o) ? -1 : (B(r[0]) === n[31] >> 7 && T(r[0], pr, r[0]), Y(r[3], r[0], r[1]), 0);
  }
  ...
  function ur(r, n, e, t) {
    ...
    if (Q(f, r, e), ir(f), nr(c, w, f), er(w, n.subarray(32)), W(c, w), rr(a, c), e -= 64, u(n, 0, a, 0)) {
      for (o = 0; o < e; o++) {
        r[o] = 0;
      }
  ...
  function wr(r, n) {
    if (r.length !== Cr) throw new Error("bad public key size");
  ...
  function yr() {
    ...
    for (n = 0; n < arguments.length; n++) {
      if ("[object Uint8Array]" !== (r = Object.prototype.toString.call(arguments[n]))) throw new TypeError("unexpected type " + r + ", use Uint8Array");
    }
  }
  ...
  var pr = hr(),
      ...
      dr = hr([54554, 36645, 11616, 51542, 42930, 38181, 51040, 26924, 56412, 64982, 57905, 49316, 21502, 52590, 14035, 8553]),
      xr = hr([26200, 26214, 26214, 26214, 26214, 26214, 26214, 26214, 26214, 26214, 26214, 26214, 26214, 26214, 26214, 26214]),
  ...
  r.lowlevel = {
    ...
    crypto_secretbox_BOXZEROBYTES: Or,
    crypto_scalarmult_BYTES: Fr,
    crypto_scalarmult_SCALARBYTES: Nr,
    crypto_box_PUBLICKEYBYTES: Cr,
    crypto_box_SECRETKEYBYTES: Mr,
    crypto_box_BEFORENMBYTES: Gr,
    crypto_box_NONCEBYTES: Zr,
    crypto_box_ZEROBYTES: jr,
    crypto_box_BOXZEROBYTES: qr,
    crypto_sign_BYTES: Ir,
    crypto_sign_PUBLICKEYBYTES: Vr,
    crypto_sign_SECRETKEYBYTES: Xr,
    ...
    return _(o, t, t.length, n, e), o.subarray(Or);
  }, r.secretbox.open = function (r, n, e) {
    yr(r, n, e), cr(e, n);

    for (var t = new Uint8Array(Or + r.length), o = new Uint8Array(t.length), i = 0; i < r.length; i++) {
      t[i + Or] = r[i];
    }

    return !(t.length < 32) && 0 === A(o, t, t.length, n, e) && o.subarray(Pr);
  }, r.secretbox.keyLength = zr, r.secretbox.nonceLength = Rr, r.secretbox.overheadLength = Or, r.scalarMult = function (r, n) {
    if (yr(r, n), r.length !== Nr) throw new Error("bad n size");
    if (n.length !== Fr) throw new Error("bad p size");
    var e = new Uint8Array(Fr);
    return R(e, r, n), e;
  }, r.scalarMult.base = function (r) {
    if (yr(r), r.length !== Nr) throw new Error("bad n size");
    var n = new Uint8Array(Fr);
    return P(n, r), n;
  }, r.scalarMult.scalarLength = Nr, r.scalarMult.groupElementLength = Fr, r.box = function (n, e, t, o) {
  ...
  }, r.box.publicKeyLength = Cr, r.box.secretKeyLength = Mr, r.box.sharedKeyLength = Gr, r.box.nonceLength = Zr, r.box.overheadLength = r.secretbox.overheadLength, r.sign = function (r, n) {
    if (yr(r, n), n.length !== Xr) throw new Error("bad secret key size");
    var e = new Uint8Array(Ir + r.length);
    return ar(e, r, r.length, n), e;
    ...
    if (yr(r, n), n.length !== Vr) throw new Error("bad public key size");
    ...
    for (var t = r.sign(n, e), o = new Uint8Array(Ir), i = 0; i < o.length; i++) {
      o[i] = t[i];
    }

    return o;
  }, r.sign.detached.verify = function (r, n, e) {
    if (yr(r, n, e), n.length !== Ir) throw new Error("bad signature size");
    if (e.length !== Vr) throw new Error("bad public key size");
    var t,
        o = new Uint8Array(Ir + r.length),
    ...
    if (yr(r), r.length !== Xr) throw new Error("bad secret key size");

    for (var n = new Uint8Array(Vr), e = 0; e < n.length; e++) {
      n[e] = r[32 + e];
    }
    ...
    if (yr(r), r.length !== Dr) throw new Error("bad seed size");

    for (var n = new Uint8Array(Vr), e = new Uint8Array(Xr), t = 0; t < 32; t++) {
      e[t] = r[t];
    }
  ...
  }, r.sign.publicKeyLength = Vr, r.sign.secretKeyLength = Xr, r.sign.seedLength = Dr, r.sign.signatureLength = Ir, r.hash = function (r) {
    yr(r);
    var n = new Uint8Array(Hr);
    return Q(n, r, r.length), n;
  }, r.hash.hashLength = Hr, r.verify = function (r, n) {
    return yr(r, n), 0 !== r.length && 0 !== n.length && r.length === n.length && 0 === a(r, 0, n, 0, r.length);
    ...
    } else "undefined" != typeof require && (n = require("crypto"), n && n.randomBytes && r.setPRNG(function (r, e) {
      var t,
          o = n.randomBytes(e);
