...
(function () {
  ...
  wordwrap = function wordwrap(a, b) {
  ...
  getPreText = function getPreText(option, arg$, maxWidth) {
  ...
  setHelpStyleDefaults = function setHelpStyleDefaults(helpStyle) {
  ...
  generateHelpForOption = function generateHelpForOption(getOption, arg$) {
  ...
  generateHelp = function generateHelp(arg$) {
