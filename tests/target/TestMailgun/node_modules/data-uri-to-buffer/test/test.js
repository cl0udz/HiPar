...
describe('data-uri-to-buffer', function () {
  ...
  it('should decode plain-text Data URIs', function () {
    var html = '<!DOCTYPE html>' + '<html lang="en">' + '<head><title>Embedded Window</title></head>' + '<body><h1>42</h1></body>' + '</html>'; // Escape the HTML for URL formatting
  ...
  it('should decode "base64" Data URIs with newlines', function () {
    ...
    assert.equal('iVBORw0KGgoAAAANSUhEUgAAAAUA' + 'AAAFCAYAAACNbyblAAAAHElEQVQI12P4//8/w38GIAXDIBKE0DHxgljNBAAO' + '9TXL0Y4OHwAAAABJRU5ErkJggg==', buf.toString('base64'));
  });
