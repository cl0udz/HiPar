...
(function () {
  ...
  function g(n) {
    return typeof n == "function" ? n : null == n ? X : (_typeof(n) == "object" ? d : r)(n);
  }
  ...
  function H(n) {
    return null != n && _typeof(n) == "object";
  }
  ...
  o.assignIn = Bn, o.before = G, o.bind = En, o.chain = function (n) {
    ...
    chain: false
  }), o.VERSION = "4.17.15", mn("pop join replace reverse split push shift sort splice unshift".split(" "), function (n) {
