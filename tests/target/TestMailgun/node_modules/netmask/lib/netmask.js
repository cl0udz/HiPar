...
(function () {
  ...
  long2ip = function long2ip(_long) {
    var a, b, c, d;
    a = (_long & 0xff << 24) >>> 24;
    b = (_long & 0xff << 16) >>> 16;
    c = (_long & 0xff << 8) >>> 8;
  ...
  ip2long = function ip2long(ip) {
    ...
    for (i = j = 0, len = b.length; j < len; i = ++j) {
      ...
      if (isNaN(parseInt(_byte, 10))) {
        throw new Error("Invalid byte: " + _byte);
      }
  ...
  Netmask = function () {
    ...
    Netmask.prototype.forEach = function (fn) {
      var index, j, k, len, _long2, range, ref, ref1, results, results1;
      ...
      for (index = k = 0, len = range.length; k < len; index = ++k) {
        _long2 = range[index];
        results1.push(fn(long2ip(_long2), _long2, index));
      }
