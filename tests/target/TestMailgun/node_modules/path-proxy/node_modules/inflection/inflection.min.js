...
(function (a, b) {
  ...
  var d = ["equipment", "information", "rice", "money", "species", "series", "fish", "sheep", "moose", "deer", "news"];
  ...
  var j = new RegExp("(_ids|_id)$", "g");
  var f = new RegExp("_", "g");
  var i = new RegExp("[ _]", "g");
  var e = new RegExp("([A-Z])", "g");
  var h = new RegExp("^_");
  var b = {
    _apply_rules: function _apply_rules(p, o, n, m) {
      if (m) {
        p = m;
      } else {
        var q = b.indexOf(n, p.toLowerCase()) > -1;
    ...
    indexOf: function indexOf(k, q, p, l) {
      if (!p) {
        p = -1;
      }
    ...
    pluralize: function pluralize(l, k) {
      return b._apply_rules(l, g, d, k);
    },
    singularize: function singularize(l, k) {
      return b._apply_rules(l, a, d, k);
    },
    ...
    underscore: function underscore(n, o) {
      ...
      for (; m < l; m++) {
        k[m] = k[m].replace(e, "_$1");
        k[m] = k[m].replace(h, "");
      }

      return k.join("/").toLowerCase();
    },
    humanize: function humanize(l, k) {
      l = l.toLowerCase();
      l = l.replace(j, "");
      l = l.replace(f, " ");
    ...
    capitalize: function capitalize(k) {
      k = k.toLowerCase();
      return k.substring(0, 1).toUpperCase() + k.substring(1);
    },
    dasherize: function dasherize(k) {
      return k.replace(i, "-");
    },
    ...
    demodulize: function demodulize(l) {
      var k = l.split("::");
      return k[k.length - 1];
    },
    tableize: function tableize(k) {
      k = b.underscore(k);
      k = b.pluralize(k);
      return k;
    },
    classify: function classify(k) {
      k = b.camelize(k);
      k = b.singularize(k);
      return k;
    },
    foreign_key: function foreign_key(l, k) {
      l = b.demodulize(l);
      l = b.underscore(l) + (k ? "" : "_") + "id";
      return l;
    },
    ...
    transform: function transform(n, k) {
      var m = 0;
      var l = k.length;
