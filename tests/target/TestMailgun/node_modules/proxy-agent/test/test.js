...
describe('ProxyAgent', function () {
  ...
  var httpsServer, httpsPort; // proxy servers
  ...
  it('should export a "function"', function () {
    assert.equal('function', _typeof(ProxyAgent));
  });
  describe('constructor', function () {
    it('should throw a TypeError if no "protocol" is given', function () {
      assert["throws"](function () {
        ...
        return 'TypeError' === e.name && /must specify a "protocol"/.test(e.message) && /\bhttp\b/.test(e.message) && /\bhttps\b/.test(e.message) && /\bsocks\b/.test(e.message);
      });
    });
    it('should throw a TypeError for unsupported proxy protocols', function () {
      assert["throws"](function () {
        ...
        return 'TypeError' === e.name && /unsupported proxy protocol/.test(e.message);
      });
    });
  });
