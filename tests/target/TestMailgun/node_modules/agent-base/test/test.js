...
describe('Agent', function () {
  ...
  describe('options', function () {
    ...
    it('should be mixed in with HTTP request options', function (done) {
      ...
      agent.callback = function (req, opts, fn) {
        ...
        assert.equal('a', opts.b); // `host` and `port` are special-cases, and should always be
  ...
  describe('artificial "streams"', function () {
    it('should send a GET request', function (done) {
      var stream = new events.EventEmitter(); // needed for the `http` module to call .write() on the stream
...
describe('"http" module', function () {
  var server;
  var port; // setup test HTTP server
  ...
  it('should support the "timeout" option', function (done) {
    ...
    this.timeout(1000);
    this.slow(800);
    var agent = new Agent(function (req, opts, fn) {// this function will time out
    }, {
      timeout: 100
    });
...
describe('"https" module', function () {
  var server;
  var port; // setup test HTTPS server
  ...
  it('should work with a String URL', function (done) {
    ...
    var req = https.get(endpoint); // it's gonna error out since `rejectUnauthorized` is not being passed in
  ...
  it('should not re-patch https.request', function () {
