...
describe('hooks', function () {
  before(function () {
    Date.prototype.getDay = function () {
      return 6;
    }; // Setting local weekday as SAT(6)


    Date.prototype.getUTCDay = function () {
      return 5;
    }; // Setting UTC weekday as FRI(5)
  ...
  describe('weekdayRange(wd1, wd2, gmt)', function () {
    var tests = [["MON", "FRI", false], ["MON", "FRI", "GMT", true], ["SAT", true], ["SAT", "GMT", false], ["FRI", "MON", true], ["SAT", "MON", "GMT", false], ["SOME", "RANDOM", false], ["RANDOM", false], ["RANDOM", "VALUE", "IST", false]];
