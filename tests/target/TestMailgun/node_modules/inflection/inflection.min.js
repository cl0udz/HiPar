...
(function (a, b) {
  ...
  var c = ["and", "or", "nor", "a", "an", "the", "so", "but", "to", "of", "at", "by", "from", "into", "on", "onto", "off", "out", "in", "over", "with", "for"];
  var k = new RegExp("(_ids|_id)$", "g");
  var f = new RegExp("_", "g");
  var j = new RegExp("[ _]", "g");
  var e = new RegExp("([A-Z])", "g");
  var h = new RegExp("^_");
  var b = {
    _apply_rules: function _apply_rules(q, p, o, n) {
      if (n) {
        q = n;
      } else {
        var r = b.indexOf(o, q.toLowerCase()) > -1;
    ...
    indexOf: function indexOf(l, r, q, m) {
      if (!q) {
        q = -1;
      }
    ...
    pluralize: function pluralize(m, l) {
      return b._apply_rules(m, g, d, l);
    },
    singularize: function singularize(m, l) {
      return b._apply_rules(m, a, d, l);
    },
    inflect: function inflect(o, n, m, l) {
      n = parseInt(n, 10);
      ...
      if (n === 0 || n > 1) {
        return b._apply_rules(o, g, d, l);
      } else {
        return b._apply_rules(o, a, d, m);
      }
    },
    camelize: function camelize(t, o) {
      var v = t.split("/");
      var r = 0;
      var q = v.length;
      var u, m, p, n, s;
      ...
      for (; r < q; r++) {
        ...
        for (; p < n; p++) {
          ...
          s = u[p].charAt(0);
          s = o && r === 0 && p === 0 ? s.toLowerCase() : s.toUpperCase();
          u[p] = s + u[p].substring(1);
        }
    ...
    underscore: function underscore(o, p) {
      if (p && o === o.toUpperCase()) {
        return o;
      }
      ...
      for (; n < m; n++) {
        l[n] = l[n].replace(e, "_$1");
        l[n] = l[n].replace(h, "");
      }

      return l.join("/").toLowerCase();
    },
    humanize: function humanize(m, l) {
      m = m.toLowerCase();
      m = m.replace(k, "");
      m = m.replace(f, " ");
    ...
    capitalize: function capitalize(l) {
      l = l.toLowerCase();
      return l.substring(0, 1).toUpperCase() + l.substring(1);
    },
    dasherize: function dasherize(l) {
      return l.replace(j, "-");
    },
    titleize: function titleize(s) {
      s = s.toLowerCase().replace(f, " ");
      var q = s.split(" ");
      var p = 0;
      var o = q.length;
      var r, n, m;
      ...
      for (; p < o; p++) {
        ...
        for (; n < m; n++) {
          if (b.indexOf(c, r[n].toLowerCase()) < 0) {
            r[n] = b.capitalize(r[n]);
          }
        }
    ...
    demodulize: function demodulize(m) {
      var l = m.split("::");
      return l[l.length - 1];
    },
    tableize: function tableize(l) {
      l = b.underscore(l);
      l = b.pluralize(l);
      return l;
    },
    classify: function classify(l) {
      l = b.camelize(l);
      l = b.singularize(l);
      return l;
    },
    foreign_key: function foreign_key(m, l) {
      m = b.demodulize(m);
      m = b.underscore(m) + (l ? "" : "_") + "id";
      return m;
    },
    ordinalize: function ordinalize(s) {
      var q = s.split(" ");
      var o = 0;
      var n = q.length;

      for (; o < n; o++) {
        var m = parseInt(q[o], 10);

        if (!isNaN(m)) {
          var r = q[o].substring(q[o].length - 2);
          var p = q[o].substring(q[o].length - 1);
          var l = "th";
    ...
    transform: function transform(o, l) {
      var n = 0;
      var m = l.length;
