...
!function (a) {
  if ("object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module) module.exports = a();else if ("function" == typeof define && define.amd) define([], a);else {
    ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).psl = a();
  }
}(function () {
  return function s(m, t, u) {
    function r(o, a) {
      if (!t[o]) {
        ...
        m[o][0].call(n.exports, function (a) {
          return r(m[o][1][a] || a);
        }, n, n.exports, s, m, t, u);
      }
    ...
    for (var p = "function" == typeof require && require, a = 0; a < u.length; a++) {
      r(u[a]);
    }
    ...
    2: [function (a, o, r) {
      ...
      k.rules = a("./data/rules.json").map(function (a) {
        ...
        return k.rules.reduce(function (a, o) {
          return -1 === o.punySuffix && (o.punySuffix = p.toASCII(o.suffix)), k.endsWith(i, "." + o.punySuffix) || i === o.punySuffix ? o : a;
        }, null);
      }, r.errorCodes = {
        ...
        function s() {
          return /xn--/.test(o) && (e.domain && (e.domain = p.toASCII(e.domain)), e.subdomain && (e.subdomain = p.toASCII(e.subdomain))), e;
        }

        var m = k.findRule(o);
        if (!m) return n.length < 2 ? e : (e.tld = n.pop(), e.sld = n.pop(), e.domain = [e.sld, e.tld].join("."), n.length && (e.subdomain = n.pop()), s());
        e.listed = !0;
        var t = m.suffix.split("."),
            u = n.slice(0, n.length - t.length);
        return m.exception && u.push(t.shift()), e.tld = t.join("."), u.length ? (m.wildcard && (t.unshift(u.pop()), e.tld = t.join(".")), u.length && (e.sld = u.pop(), e.domain = [e.sld, e.tld].join("."), u.length && (e.subdomain = u.join("."))), s()) : s();
      }, r.get = function (a) {
    ...
    3: [function (a, T, D) {
      (function (S) {
        !function (a) {
          var o = "object" == _typeof(D) && D && !D.nodeType && D,
              i = "object" == _typeof(T) && T && !T.nodeType && T,
              e = "object" == _typeof(S) && S;
          ...
          function g(a, o) {
            var i = a.split("@"),
                e = "";
            return 1 < i.length && (e = i[0] + "@", a = i[1]), e + l((a = a.replace(p, ".")).split("."), o).join(".");
          }

          function O(a) {
            for (var o, i, e = [], n = 0, s = a.length; n < s;) {
              55296 <= (o = a.charCodeAt(n++)) && o <= 56319 && n < s ? 56320 == (64512 & (i = a.charCodeAt(n++))) ? e.push(((1023 & o) << 10) + (1023 & i) + 65536) : (e.push(o), n--) : e.push(o);
            }
          ...
          function _(a) {
            return l(a, function (a) {
              var o = "";
              return 65535 < a && (o += q((a -= 65536) >>> 10 & 1023 | 55296), a = 56320 | 1023 & a), o += q(a);
            }).join("");
          }
          ...
          function I(a, o, i) {
            ...
            for (a = i ? x(a / t) : a >> 1, a += x(a / o); c * f >> 1 < a; e += b) {
              a = x(a / c);
            }
          ...
          function h(a) {
            ...
            for ((i = a.lastIndexOf(z)) < 0 && (i = 0), e = 0; e < i; ++e) {
              128 <= a.charCodeAt(e) && A("not-basic"), c.push(a.charCodeAt(e));
            }

            for (n = 0 < i ? i + 1 : 0; n < l;) {
              for (s = g, m = 1, t = b; l <= n && A("invalid-input"), k = a.charCodeAt(n++), (b <= (u = k - 48 < 10 ? k - 22 : k - 65 < 26 ? k - 65 : k - 97 < 26 ? k - 97 : b) || u > x((d - g) / m)) && A("overflow"), g += u * m, !(u < (r = t <= j ? y : j + f <= t ? f : t - j)); t += b) {
                m > x(d / (p = b - r)) && A("overflow"), m *= p;
              }

              j = I(g - s, o = c.length + 1, 0 == s), x(g / o) > d - h && A("overflow"), h += x(g / o), g %= o, c.splice(g++, 0, h);
            }
          ...
          function j(a) {
            ...
            for (e = n = j.length, n && j.push(z); e < c;) {
              ...
              for (t - o > x((d - i) / (l = e + 1)) && A("overflow"), i += (t - o) * l, o = t, m = 0; m < c; ++m) {
                if ((k = a[m]) < o && ++i > d && A("overflow"), k == o) {
                  for (u = i, r = b; !(u < (p = r <= s ? y : s + f <= r ? f : r - s)); r += b) {
                    h = u - p, g = b - p, j.push(q(L(p + h % g, 0))), u = x(h / g);
                  }

                  j.push(q(L(u, 0))), s = I(i, l, e == n), i = 0, ++e;
                }
              }
          ...
          if (n = {
            ...
            if (T.exports == o) i.exports = n;else for (s in n) {
