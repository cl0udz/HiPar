...
macros.create.string = function (msg) {
  return {
    ...
    "should create an error with the correct message": function shouldCreateAnErrorWithTheCorrectMessage(err) {
...
macros.create.object = function (obj) {
  return {
    ...
    "should create an error with the specified properties": function shouldCreateAnErrorWithTheSpecifiedProperties(err) {
      assert.instanceOf(err, Error);
...
macros.create.err = function (inst) {
  return {
    ...
    "should return the error unmodified": function shouldReturnTheErrorUnmodified(err) {
...
macros.create.registered = function (type, proto, obj) {
  return {
    ...
    "should create an error of the correct type": function shouldCreateAnErrorOfTheCorrectType(err) {
