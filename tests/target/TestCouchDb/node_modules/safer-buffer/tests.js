...
test('Is not a function', function (t) {
  [index, safer, dangerous].forEach(function (impl) {
    t.equal(_typeof(impl), 'object');
    t.equal(_typeof(impl.Buffer), 'object');
  });
  [buffer].forEach(function (impl) {
    t.equal(_typeof(impl), 'object');
    t.equal(_typeof(impl.Buffer), 'function');
  });
  t.end();
});
test('Constructor throws', function (t) {
  [index, safer, dangerous].forEach(function (impl) {
    ...
    t["throws"](function () {
      return new impl.Buffer(0);
    });
    t["throws"](function () {
      return new impl.Buffer('a');
    });
    t["throws"](function () {
      return new impl.Buffer('a', 'utf-8');
    });
  });
  t.end();
});
test('Safe methods exist', function (t) {
  [index, safer, dangerous].forEach(function (impl) {
    t.equal(_typeof(impl.Buffer.alloc), 'function', 'alloc');
    t.equal(_typeof(impl.Buffer.from), 'function', 'from');
  });
  t.end();
});
test('Unsafe methods exist only in Dangerous', function (t) {
  [index, safer].forEach(function (impl) {
    t.equal(_typeof(impl.Buffer.allocUnsafe), 'undefined');
    t.equal(_typeof(impl.Buffer.allocUnsafeSlow), 'undefined');
  });
  [dangerous].forEach(function (impl) {
    t.equal(_typeof(impl.Buffer.allocUnsafe), 'function');
    t.equal(_typeof(impl.Buffer.allocUnsafeSlow), 'function');
  });
  t.end();
});
test('Generic methods/properties are defined and equal', function (t) {
  ['poolSize', 'isBuffer', 'concat', 'byteLength'].forEach(function (method) {
    [index, safer, dangerous].forEach(function (impl) {
      ...
      t.notEqual(_typeof(impl.Buffer[method]), 'undefined', method);
    });
  });
  t.end();
});
test('Built-in buffer static methods/properties are inherited', function (t) {
  Object.keys(buffer).forEach(function (method) {
    ...
    [index, safer, dangerous].forEach(function (impl) {
      ...
      t.notEqual(_typeof(impl[method]), 'undefined', method);
    });
  });
  t.end();
});
...
test('.prototype property of Buffer is inherited', function (t) {
  [index, safer, dangerous].forEach(function (impl) {
    ...
    t.notEqual(_typeof(impl.Buffer.prototype), 'undefined', 'prototype');
  });
  t.end();
});
...
test('Buffers have appropriate lengths (2)', function (t) {
  ...
  var ok = true;
  [safer.Buffer.alloc, dangerous.Buffer.allocUnsafe, dangerous.Buffer.allocUnsafeSlow].forEach(function (method) {
    for (var i = 0; i < 1e2; i++) {
