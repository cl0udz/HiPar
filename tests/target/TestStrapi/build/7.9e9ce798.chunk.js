...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[7], {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _Label = _interopRequireDefault(__webpack_require__(2173));

    var _MenuDropdown = _interopRequireDefault(__webpack_require__(2174));

    var _DropdownButton = _interopRequireDefault(__webpack_require__(2175));

    var _DragWrapper = _interopRequireDefault(__webpack_require__(2176));

    var _Toggle = _interopRequireDefault(__webpack_require__(2177));

    var _reducer = _interopRequireWildcard(__webpack_require__(2178));

    var _forms = _interopRequireDefault(__webpack_require__(2179));

    var ListSettingsView = function ListSettingsView(_ref) {
      var deleteLayout = _ref.deleteLayout,
          slug = _ref.slug;
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.prev = 0;
                    _context.next = 3;
                    return (0, _strapiHelperPlugin.request)((0, _getRequestUrl["default"])("content-types/".concat(slug)), {
                      method: 'GET',
                      signal: signal
                    });
      ...
      var getListDisplayedFields = function getListDisplayedFields() {
        return (0, _lodash.get)(modifiedData, ['layouts', 'list'], []);
      };

      var getListRemainingFields = function getListRemainingFields() {
        var metadatas = (0, _lodash.get)(modifiedData, ['metadatas'], {});
        var attributes = getAttributes;
        return Object.keys(metadatas).filter(function (key) {
          var type = (0, _lodash.get)(attributes, [key, 'type'], '');
      ...
      var handleChangeEditLabel = function handleChangeEditLabel(_ref5) {
          ...
          return _regenerator["default"].wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  _context2.prev = 0;
                  body = (0, _lodash.cloneDeep)(modifiedData);
                  delete body.schema;
                  delete body.uid;
                  _context2.next = 6;
                  return (0, _strapiHelperPlugin.request)((0, _getRequestUrl["default"])("content-types/".concat(slug)), {
      ...
      var renderForm = function renderForm() {
        ...
        })), (0, _lodash.get)(getAttributes, [labelToEdit, 'type'], 'text') !== 'media' && _react["default"].createElement("div", {
          className: "col-6",
          style: {
            marginBottom: 4
          }
      ...
      return _react["default"].createElement(_LayoutDndProvider["default"], {
        ...
        name: getName
      }, _react["default"].createElement(_DragWrapper["default"], null, _react["default"].createElement("div", {
        className: "row"
      }, _react["default"].createElement("div", {
        className: "col-12"
      ...
      }, getListDisplayedFields().map(function (item, index) {
        ...
        return _react["default"].createElement(_Label["default"], {
          ...
          onRemove: function onRemove(e) {
            ...
            if (getListDisplayedFields().length === 1) {
              strapi.notification.info("".concat(_pluginId["default"], ".notification.info.minimumFields"));
            } else {
              dispatch({
                type: 'REMOVE_FIELD',
                index: index
        ...
        disabled: getListRemainingFields().length === 0
      }), _react["default"].createElement(_MenuDropdown["default"], null, getListRemainingFields().map(function (item) {
        ...
        type: (0, _lodash.get)(getAttributes, [labelToEdit, 'type'], 'text')
      }));
    };
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Label = function Label(_ref) {
      ...
      drag(drop(ref));
      return _react["default"].createElement(_DraggedField["default"], {
        count: count,
        ref: ref,
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var MenuDropdown = (0, _styledComponents["default"])(_reactstrap.DropdownMenu)(_templateObject());
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var DropdownButton = (0, _styledComponents["default"])(_reactstrap.ButtonDropdown)(_templateObject());
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var DragWrapper = _styledComponents["default"].div(_templateObject());

    var _default = DragWrapper;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Toggle = (0, _styledComponents["default"])(_reactstrap.DropdownToggle)(_templateObject(), beforeStyle, openedStyle, beforeStyle);
    var _default = Toggle;
    exports["default"] = _default;
    /***/
  },
        ...
        case 'REMOVE_FIELD':
          {
            ...
            var firstAttrType = state.getIn(['modifiedData', 'schema', 'attributes', firstAttr, 'type']);
