...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[0], {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _getRequestUrl = _interopRequireDefault(__webpack_require__(1836));

    var _FieldsReorder = _interopRequireDefault(__webpack_require__(1935));

    var _FormTitle = _interopRequireDefault(__webpack_require__(1945));

    var _LayoutTitle = _interopRequireDefault(__webpack_require__(1946));

    var _PopupForm = _interopRequireDefault(__webpack_require__(1839));

    var _SettingsViewWrapper = _interopRequireDefault(__webpack_require__(1840));

    var _SortableList = _interopRequireDefault(__webpack_require__(1947));

    var _layout = __webpack_require__(1874);

    var _LayoutDndProvider = _interopRequireDefault(__webpack_require__(638));

    var _getInputProps = _interopRequireDefault(__webpack_require__(1949));

    var _getComponents = _interopRequireDefault(__webpack_require__(1846));

    var _reducer = _interopRequireWildcard(__webpack_require__(1950));

    var EditSettingsView = function EditSettingsView(_ref) {
      var currentEnvironment = _ref.currentEnvironment,
          deleteLayout = _ref.deleteLayout,
          deleteLayouts = _ref.deleteLayouts,
          componentsAndModelsMainPossibleMainFields = _ref.componentsAndModelsMainPossibleMainFields,
          push = _ref.history.push,
          plugins = _ref.plugins,
          slug = _ref.slug;

      var _useParams = (0, _reactRouterDom.useParams)(),
          componentSlug = _useParams.componentSlug,
      ...
      var fieldsReorderClassName = type === 'content-types' ? 'col-8' : 'col-12';
      ...
      var getAttributes = (0, _react.useMemo)(function () {
        return (0, _lodash.get)(modifiedData, ['schema', 'attributes'], {});
      }, [modifiedData]);
      var getName = (0, _react.useMemo)(function () {
        return (0, _lodash.get)(modifiedData, ['schema', 'info', 'name'], '');
      }, [modifiedData]);
      var getEditLayout = (0, _react.useCallback)(function () {
        return (0, _lodash.get)(modifiedData, ['layouts', 'edit'], []);
      }, [modifiedData]);

      var getForm = function getForm() {
        return Object.keys((0, _lodash.get)(modifiedData, ['metadatas', metaToEdit, 'edit'], {})).filter(function (meta) {
          return meta !== 'visible';
        });
      };

      var getRelationsLayout = (0, _react.useCallback)(function () {
        return (0, _lodash.get)(modifiedData, ['layouts', 'editRelations'], []);
      }, [modifiedData]);

      var getEditRelationsRemaingFields = function getEditRelationsRemaingFields() {
        var attributes = getAttributes;
        var displayedFields = getRelationsLayout();
        return Object.keys(attributes).filter(function (attr) {
          return (0, _lodash.get)(attributes, [attr, 'type'], '') === 'relation';
        }).filter(function (attr) {
          return displayedFields.indexOf(attr) === -1;
        });
      };

      var getEditRemainingFields = function getEditRemainingFields() {
        var attributes = getAttributes;
        var metadatas = (0, _lodash.get)(modifiedData, ['metadatas'], {});
        var displayedFields = getEditLayout().reduce(function (acc, curr) {
          return [].concat((0, _toConsumableArray2["default"])(acc), (0, _toConsumableArray2["default"])(curr.rowContent));
        }, []);
        return Object.keys(attributes).filter(function (attr) {
          return (0, _lodash.get)(attributes, [attr, 'type'], '') !== 'relation';
        }).filter(function (attr) {
          return (0, _lodash.get)(metadatas, [attr, 'edit', 'visible'], false) === true;
        }).filter(function (attr) {
      ...
      var getSelectedItemSelectOptions = (0, _react.useCallback)(function (formType) {
        ...
        var key = (0, _lodash.get)(modifiedData, ['schema', 'attributes', metaToEdit, targetKey], '');
        return (0, _lodash.get)(componentsAndModelsMainPossibleMainFields, [key], []);
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.prev = 0;
                    _context.next = 3;
                    return (0, _strapiHelperPlugin.request)((0, _getRequestUrl["default"])("".concat(type, "/").concat(slug || componentSlug)), {
                      method: 'GET',
                      signal: signal
                    });
      ...
      var handleChangeMeta = function handleChangeMeta(_ref5) {
          ...
          return _regenerator["default"].wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  _context2.prev = 0;
                  body = (0, _lodash.cloneDeep)(modifiedData); // We need to send the unformated edit layout
      ...
      var renderForm = function renderForm() {
        return getForm().map(function (meta, index) {
          var formType = (0, _lodash.get)(getAttributes, [metaToEdit, 'type']);
          ...
          return _react["default"].createElement("div", {
            ...
            return _react["default"].createElement(_reactIntl.FormattedMessage, {
              id: (0, _lodash.get)((0, _getInputProps["default"])(meta), 'label.id', 'app.utils.defaultMessage')
            }, function (label) {
              return _react["default"].createElement(_custom.Inputs, {
                autoFocus: index === 0,
                description: meta === 'mainField' ? description : '',
                label: label,
                name: meta,
                type: (0, _getInputProps["default"])(meta).type,
      ...
      return _react["default"].createElement(_LayoutDndProvider["default"], {
      ...
      }, _react["default"].createElement(_SettingsViewWrapper["default"], {
        inputs: [{
          label: {
        ...
        className: "row"
      }, _react["default"].createElement(_LayoutTitle["default"], {
      ...
      }, _react["default"].createElement("div", null, _react["default"].createElement(_FormTitle["default"], {
      ...
      }, (0, _getComponents["default"])('editSettingsView', 'left.links', plugins, currentEnvironment, slug, push, {
        componentSlug: componentSlug,
        type: type,
        modifiedData: modifiedData
      })))), type !== 'components' && _react["default"].createElement(_LayoutTitle["default"], {
        className: "col-4"
      }, _react["default"].createElement(_FormTitle["default"], {
        title: "".concat(_pluginId["default"], ".containers.SettingPage.relations"),
        description: "".concat(_pluginId["default"], ".containers.SettingPage.editSettings.description")
      })), _react["default"].createElement(_FieldsReorder["default"], {
        className: fieldsReorderClassName
      }), type !== 'components' && _react["default"].createElement(_SortableList["default"], {
      ...
      }))), _react["default"].createElement(_PopupForm["default"], {
        ...
        type: (0, _lodash.get)(getAttributes, [metaToEdit, 'type'], '')
      }));
    };

    EditSettingsView.defaultProps = {
      deleteAllLayouts: function deleteAllLayouts() {},
      slug: null
    };
    EditSettingsView.propTypes = {
      ...
      deleteLayout: _propTypes["default"].func.isRequired,
      deleteLayouts: _propTypes["default"].func,
      componentsAndModelsMainPossibleMainFields: _propTypes["default"].object.isRequired,
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var getRequestUrl = function getRequestUrl(path) {
      return "/".concat(_pluginId["default"], "/").concat(path);
    };
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var PopupForm = function PopupForm(_ref) {
      var headerId = _ref.headerId,
          ...
          subHeaderContent = _ref.subHeaderContent,
          type = _ref.type;

      var getAttrType = function getAttrType() {
        if (type === 'timestamp') {
          return 'date';
        }
      ...
      return _react["default"].createElement(_strapiHelperPlugin.Modal, {
        isOpen: isOpen,
        onClosed: onClosed,
        onToggle: onToggle
      }, _react["default"].createElement(_strapiHelperPlugin.HeaderModal, null, _react["default"].createElement("section", null, _react["default"].createElement(_strapiHelperPlugin.HeaderModalTitle, {
        style: {
          textTransform: 'none'
        }
      }, _react["default"].createElement(_core.AttributeIcon, {
        type: getAttrType(),
        style: {
        ...
        id: headerId
      }))), _react["default"].createElement("section", null, _react["default"].createElement(_strapiHelperPlugin.HeaderModalTitle, null, _react["default"].createElement("span", null, (0, _lodash.upperFirst)(subHeaderContent)), _react["default"].createElement("hr", null)))), _react["default"].createElement("form", {
        onSubmit: onSubmit
      }, _react["default"].createElement(_strapiHelperPlugin.ModalForm, null, _react["default"].createElement(_strapiHelperPlugin.ModalBody, null, renderForm())), _react["default"].createElement(_strapiHelperPlugin.ModalFooter, null, _react["default"].createElement("section", null, _react["default"].createElement(_core.Button, {
        onClick: onToggle,
        color: "cancel"
      }, _react["default"].createElement(_reactIntl.FormattedMessage, {
    ...
    PopupForm.propTypes = {
      headerId: _propTypes["default"].string.isRequired,
      isOpen: _propTypes["default"].bool,
      onClosed: _propTypes["default"].func,
      onSubmit: _propTypes["default"].func,
      onToggle: _propTypes["default"].func,
      renderForm: _propTypes["default"].func,
      subHeaderContent: _propTypes["default"].string,
      type: _propTypes["default"].string
    };
    var _default = PopupForm;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _Block = _interopRequireDefault(__webpack_require__(1841));

    var _Container = _interopRequireDefault(__webpack_require__(1815));

    var _SectionTitle = _interopRequireDefault(__webpack_require__(1843));

    var _Separator = _interopRequireDefault(__webpack_require__(1845));

    var SettingsViewWrapper = function SettingsViewWrapper(_ref) {
      var children = _ref.children,
          goBack = _ref.history.goBack,
          getListDisplayedFields = _ref.getListDisplayedFields,
          inputs = _ref.inputs,
      ...
      var getPluginHeaderActions = function getPluginHeaderActions() {
        return [{
          ...
          title: formatMessage({
            id: "".concat(_pluginId["default"], ".popUpWarning.button.cancel")
          }),
          type: 'button',
          disabled: (0, _lodash.isEqual)(modifiedData, initialData) ? true : false,
          style: {
            fontWeight: 600,
            paddingLeft: 15,
            paddingRight: 15
      ...
      var getSelectOptions = function getSelectOptions(input) {
        if (input.name === 'settings.defaultSortBy') {
          return ['id'].concat((0, _toConsumableArray2["default"])(getListDisplayedFields().filter(function (name) {
            return (0, _lodash.get)(getAttributes, [name, 'type'], '') !== 'media' && name !== 'id' && (0, _lodash.get)(getAttributes, [name, 'type'], '') !== 'richtext';
          })));
        }
        ...
        if (input.name === 'settings.mainField') {
          ...
          var options = Object.keys(attributes).filter(function (attr) {
            ...
            return !['json', 'text', 'relation', 'component', 'boolean', 'date', 'media', 'richtext'].includes(type) && !!type;
          });
          return options;
        }
      ...
      if (isLoading) {
        return _react["default"].createElement(_strapiHelperPlugin.LoadingIndicatorPage, null);
      }

      return _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement(_strapiHelperPlugin.BackHeader, {
        onClick: goBack
      }), _react["default"].createElement(_Container["default"], {
        className: "container-fluid"
      }, _react["default"].createElement("form", {
        onSubmit: handleSubmit
      }, _react["default"].createElement(_custom.Header, headerProps), _react["default"].createElement("div", {
        className: "row",
        style: {
          paddingTop: '3px'
        }
        ...
        return _react["default"].createElement(_reactIntl.FormattedMessage, {
          ...
          return _react["default"].createElement("div", {
            ...
            return _react["default"].createElement(_custom.Inputs, (0, _extends2["default"])({}, input, {
      ...
      }))), _react["default"].createElement(_SectionTitle["default"], null), children)), _react["default"].createElement(_strapiHelperPlugin.PopUpWarning, {
        ...
        content: {
          title: "".concat(_pluginId["default"], ".popUpWarning.title"),
          message: "".concat(_pluginId["default"], ".popUpWarning.warning.updateAllSettings"),
          cancel: "".concat(_pluginId["default"], ".popUpWarning.button.cancel"),
          confirm: "".concat(_pluginId["default"], ".popUpWarning.button.confirm")
        },
        popUpWarningType: "danger",
    ...
    SettingsViewWrapper.defaultProps = {
      getListDisplayedFields: function getListDisplayedFields() {
        return [];
      },
      inputs: [],
      initialData: {},
      ...
      onConfirmSubmit: function () {
        var _onConfirmSubmit = (0, _asyncToGenerator2["default"])(
        /*#__PURE__*/
        _regenerator["default"].mark(function _callee2() {
          return _regenerator["default"].wrap(function _callee2$(_context2) {
            while (1) {
    ...
    SettingsViewWrapper.propTypes = {
      ...
      getListDisplayedFields: _propTypes["default"].func,
      history: _propTypes["default"].shape({
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _components = __webpack_require__(1842);
    /**
    *
    * Block
    */
    ...
    var Block = function Block(_ref) {
      ...
      return _react["default"].createElement("div", {
        className: "col-md-12"
      }, _react["default"].createElement(_components.Wrapper, {
        style: style
      }, _react["default"].createElement(_components.Sub, null, !!title && _react["default"].createElement("p", null, _react["default"].createElement(_reactIntl.FormattedMessage, {
        id: title
    ...
    var _default = (0, _react.memo)(Block);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    exports.Sub = exports.Wrapper = void 0;
    ...
    var Sub = _styledComponents["default"].div(_templateObject2());
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _Title = _interopRequireDefault(__webpack_require__(1844));

    var SectionTitle = function SectionTitle(_ref) {
      var isSettings = _ref.isSettings;
      var suffix = isSettings ? 'settings' : 'view';
      var msgId = "".concat(_pluginId["default"], ".containers.SettingPage.").concat(suffix);
      return _react["default"].createElement("div", {
        style: {
          marginBottom: '18px'
        }
        ...
        return _react["default"].createElement(_Title["default"], null, msg);
      }));
    };

    SectionTitle.propTypes = {
      isSettings: _propTypes["default"].bool
    };
    SectionTitle.defaultProps = {
      isSettings: false
    };

    var _default = (0, _react.memo)(SectionTitle);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Separator = _styledComponents["default"].div(_templateObject());
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _getTrad = _interopRequireDefault(__webpack_require__(1936));

    var _components = __webpack_require__(1937);

    function Add(_ref) {
      var data = _ref.data,
          isRelation = _ref.isRelation,
          _onClick = _ref.onClick,
          pStyle = _ref.pStyle,
          style = _ref.style;
      ...
      return _react["default"].createElement(_components.Wrapper, {
        isOpen: isOpen,
        notAllowed: data.length === 0,
        style: style
      }, _react["default"].createElement(_reactstrap.ButtonDropdown, {
        isOpen: isOpen,
      ...
      }, _react["default"].createElement(_reactstrap.DropdownToggle, null, _react["default"].createElement(_reactIntl.FormattedMessage, {
        id: (0, _getTrad["default"])("containers.SettingPage.".concat(isRelation ? 'add.relational-field' : 'add.field'))
      }, function (msg) {
        return _react["default"].createElement("p", {
          style: pStyle
        }, _react["default"].createElement(_icons.Plus, {
          fill: "#007eff",
          height: "11px",
          width: "11px"
        }), msg);
      })), _react["default"].createElement(_reactstrap.DropdownMenu, null, data.map(function (item) {
    ...
    Add.propTypes = {
      ...
      isRelation: _propTypes["default"].bool,
      onClick: _propTypes["default"].func,
      pStyle: _propTypes["default"].object,
      style: _propTypes["default"].object
    };

    var _default = (0, _react.memo)(Add);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _Carret = _interopRequireDefault(__webpack_require__(1940));

    var _DraggedField = _interopRequireDefault(__webpack_require__(640));

    var _DynamicZoneWrapper = _interopRequireDefault(__webpack_require__(1941));

    var _PreviewCarret = _interopRequireDefault(__webpack_require__(643));

    var _Wrapper = _interopRequireDefault(__webpack_require__(1942));

    var _DynamicComponent = _interopRequireDefault(__webpack_require__(1943));

    var DraggedFieldWithPreview = (0, _react.forwardRef)(function (_ref, refs) {
      var goTo = _ref.goTo,
          componentUid = _ref.componentUid,
      ...
      var getCompoInfos = function getCompoInfos(uid) {
        return (0, _lodash.get)(componentLayouts, [uid, 'schema', 'info'], {
          name: '',
          icon: ''
        });
      };
      ...
      return _react["default"].createElement("div", {
        ...
        style: style
      }, dragStart && isFullSize && _react["default"].createElement(_PreviewCarret["default"], {
        style: {
          marginRight: '-10px'
        }
      }), _react["default"].createElement(_react["default"].Fragment, null, showLeftCarret && _react["default"].createElement(_Carret["default"], null), _react["default"].createElement("div", {
        className: "sub",
        style: {
          width: width,
          opacity: opacity
        }
      }, _react["default"].createElement(_DraggedField["default"], {
        goTo: goTo,
        ...
        return _react["default"].createElement("div", {
          ...
          var fieldType = (0, _lodash.get)(componentData, ['schema', 'attributes', field.name, 'type'], '');
      ...
      }), type === 'dynamiczone' && _react["default"].createElement(_DynamicZoneWrapper["default"], null, dynamicZoneComponents.map(function (compo) {
        var _getCompoInfos = getCompoInfos(compo),
            name = _getCompoInfos.name,
            icon = _getCompoInfos.icon;

        return _react["default"].createElement(_DynamicComponent["default"], {
          key: compo,
          componentUid: compo,
          friendlyName: name,
          icon: icon,
      ...
      })))), showRightCarret && _react["default"].createElement(_Carret["default"], {
        right: true
      }))));
    });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    exports.unformatLayout = exports.getRowSize = exports.getInputSize = exports.getFieldType = exports.formatLayout = exports.createLayout = void 0;
    ...
    var getInputSize = function getInputSize(type) {
      switch (type) {
        case 'boolean':
        case 'date':
        case 'integer':
    ...
    var getFieldType = function getFieldType(state, name) {
      return state.getIn(['modifiedData', 'schema', 'attributes', name, 'type']);
    };
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _useLayoutDnd2 = _interopRequireDefault(__webpack_require__(635));

    var _AddDropdown = _interopRequireDefault(__webpack_require__(1872));

    var _SortWrapper = _interopRequireDefault(__webpack_require__(1828));

    var _components = __webpack_require__(1938);

    var _Item = _interopRequireDefault(__webpack_require__(1939));
    ...
    var FieldsReorder = function FieldsReorder(_ref) {
      ...
      return _react["default"].createElement("div", {
        className: className
      }, _react["default"].createElement(_SortWrapper["default"], {
        style: {
          marginTop: 7,
          paddingTop: 11,
          paddingLeft: 5,
      ...
      }, _react["default"].createElement(_AddDropdown["default"], {
        data: buttonData,
        onClick: onAddData,
        style: {
          width: '100%',
    ...
    var _default = (0, _react.memo)(FieldsReorder);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var getTrad = function getTrad(id) {
      return "".concat(_pluginId["default"], ".").concat(id);
    };

    var _default = getTrad;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Wrapper = _styledComponents["default"].div(_templateObject(), function (_ref) {
      ...
      var notAllowed = _ref2.notAllowed;
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _DraggedFieldWithPreview = _interopRequireDefault(__webpack_require__(1873));
    ...
    var Item = function Item(_ref) {
      ...
      return _react["default"].createElement(_DraggedFieldWithPreview["default"], {
        goTo: goTo,
        componentUid: componentUid,
        componentLayouts: componentLayouts,
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Carret = _styledComponents["default"].div(_templateObject(), function (_ref) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Wrapper = _styledComponents["default"].div(_templateObject(), function (_ref) {
      var withLongerHeight = _ref.withLongerHeight;
      return withLongerHeight ? '102px' : '30px';
    });
    ...
    Wrapper.propTypes = {
      withLongerHeight: _propTypes["default"].bool
    };
    var _default = Wrapper;
    exports["default"] = _default;
    /***/
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _Tooltip = _interopRequireDefault(__webpack_require__(1944));
    ...
    var DynamicComponent = function DynamicComponent(_ref) {
      ...
      return _react["default"].createElement(_DynamicComponentCard["default"], {
        ...
        isOver: state,
        onClick: function onClick() {
          push("/plugins/".concat(_pluginId["default"], "/ctm-configurations/edit-settings/components/").concat(componentUid, "/"));
        },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Tooltip = _styledComponents["default"].div(_templateObject(), function (_ref) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var FormTitle = function FormTitle(_ref) {
      var description = _ref.description,
          title = _ref.title;
      return _react["default"].createElement(_react["default"].Fragment, null, !!title && _react["default"].createElement(_reactIntl.FormattedMessage, {
        id: title
      }), !!description && _react["default"].createElement(_reactIntl.FormattedMessage, {
        id: description
      }, function (msg) {
    ...
    var _default = (0, _react.memo)(FormTitle);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var LayoutTitle = _styledComponents["default"].div(_templateObject());

    var _default = LayoutTitle;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _Item = _interopRequireDefault(__webpack_require__(1948));
    ...
    var SortableList = function SortableList(_ref) {
      ...
      var _useLayoutDnd = (0, _useLayoutDnd2["default"])(),
          relationsLayout = _useLayoutDnd.relationsLayout;
    ...
    SortableList.propTypes = {
      ...
      buttonData: _propTypes["default"].array,
      moveItem: _propTypes["default"].func.isRequired,
      removeItem: _propTypes["default"].func.isRequired
    };

    var _default = (0, _react.memo)(SortableList);
    ...
    var reducer = function reducer(state, action) {
      ...
      switch (action.type) {
        ...
        case 'GET_DATA_SUCCEEDED':
          {
            var data = (0, _lodash.cloneDeep)(action.data);
            (0, _lodash.set)(data, ['layouts', 'edit'], (0, _layout.formatLayout)((0, _layout.createLayout)(data.layouts.edit)));
            return state.update('componentLayouts', function () {
              return (0, _immutable.fromJS)(action.componentLayouts);
        ...
        case 'ON_ADD_DATA':
          {
            var size = (0, _layout.getInputSize)(state.getIn(['modifiedData', 'schema', 'attributes', action.name, 'type']));
