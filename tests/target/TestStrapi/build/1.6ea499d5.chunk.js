...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[1], {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var convertAttrObjToArray = function convertAttrObjToArray(attributes) {
      return Object.keys(attributes).map(function (key, index) {
        return _objectSpread({}, attributes[key], {
          name: key,
          index: index
        });
      });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _pluginId = _interopRequireDefault(__webpack_require__(94));

    var _useListView2 = _interopRequireDefault(__webpack_require__(1919));

    var _useDataManager2 = _interopRequireDefault(__webpack_require__(84));

    var _DynamicZoneList = _interopRequireDefault(__webpack_require__(1920));

    var _ComponentList = _interopRequireDefault(__webpack_require__(1869));

    var _ListButton = __webpack_require__(1871);

    var _List = _interopRequireDefault(__webpack_require__(1925));
    /**
    *
    * List
    *
    */
    ...
    function List(_ref) {
      ...
      var onClickAddField = function onClickAddField() {
        var headerDisplayName = mainTypeName;
        ...
        openModalAddField(editTarget, targetUid, headerDisplayName, firstLoopComponentUid ? mainTypeName : null, secondLoopComponentName ? firstLoopComponentName : null, secondLoopComponentUid ? firstLoopComponentUid : null);
      };

      var addButtonProps = {
        icon: !isSub ? _react["default"].createElement(_icons.Plus, {
          fill: "#007eff",
          width: "11px",
          height: "11px"
        }) : false,
        ...
        label: isInDevelopmentMode ? formatMessage({
          id: !isSub ? "".concat(_pluginId["default"], ".form.button.add.field.to.").concat(editTarget) : "".concat(_pluginId["default"], ".form.button.add.field.to.component")
        }) : null,
      ...
      return _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement(_List["default"], {
        className: className,
        isFromDynamicZone: isFromDynamicZone
      }, _react["default"].createElement("table", null, _react["default"].createElement("tbody", null, items.map(function (item) {
        var type = item.type;
        var CustomRow = customRowComponent;
        return _react["default"].createElement(_react["default"].Fragment, {
          key: item.name
        }, _react["default"].createElement(CustomRow, (0, _extends2["default"])({}, item, {
          targetUid: targetUid // NEW props
          ,
        ...
        })), type === 'component' && _react["default"].createElement(_ComponentList["default"], (0, _extends2["default"])({}, item, {
          ...
          firstLoopComponentName: firstLoopComponentName,
          firstLoopComponentUid: firstLoopComponentUid
        })), type === 'dynamiczone' && _react["default"].createElement(_DynamicZoneList["default"], (0, _extends2["default"])({}, item, {
          customRowComponent: customRowComponent,
          addComponent: addComponentToDZ,
          targetUid: targetUid,
          mainTypeName: mainTypeName
        })));
      }))), isMain && isInDevelopmentMode && _react["default"].createElement(_ListButton.ListButton, addButtonProps), !isMain && _react["default"].createElement(_ListButton.ListButton, addButtonProps)), isSub && _react["default"].createElement("div", {
        className: "plus-icon",
        onClick: onClickAddField
      }, isInDevelopmentMode && _react["default"].createElement(_icons.Plus, {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _List = _interopRequireDefault(__webpack_require__(1868));

    var _useDataManager2 = _interopRequireDefault(__webpack_require__(84));

    var _convertAttrObjToArray = _interopRequireDefault(__webpack_require__(1867));

    var _Td = _interopRequireDefault(__webpack_require__(1870));
    /**
    *
    * ComponentList
    *
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Td = _styledComponents["default"].td(_templateObject(), function (_ref) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    exports.ListHeaderButton = exports.ListButton = void 0;
    ...
    var ListHeaderButton = (0, _styledComponents["default"])(_core.Button)(_templateObject());
    exports.ListHeaderButton = ListHeaderButton;
    var ListButton = (0, _styledComponents["default"])(_core.Button)(_templateObject2());
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _getTrad = _interopRequireDefault(__webpack_require__(66));

    var _Curve = _interopRequireDefault(__webpack_require__(1917));

    var _UpperFirst = _interopRequireDefault(__webpack_require__(172));

    var _Wrapper = _interopRequireDefault(__webpack_require__(1918));
    ...
    function ListRow(_ref) {
      ...
      var handleClick = function handleClick() {
        if (configurable !== false) {
          ...
          attrType, headerDisplayName, firstLoopComponentUid ? mainTypeName : null, secondLoopComponentName ? firstLoopComponentName : null, secondLoopComponentUid ? firstLoopComponentUid : null);
        }
      };
      ...
      return _react["default"].createElement(_Wrapper["default"], {
      ...
      }, _react["default"].createElement("td", null, _react["default"].createElement(_core.AttributeIcon, {
        key: src,
        type: src
      ...
      }, _react["default"].createElement("p", null, name)), _react["default"].createElement("td", null, target ? _react["default"].createElement("div", null, _react["default"].createElement(_reactIntl.FormattedMessage, {
        id: "".concat(_pluginId["default"], ".modelPage.attribute.relationWith")
        ...
        }, _react["default"].createElement(_UpperFirst["default"], {
      ...
      }), "\xA0", repeatable && _react["default"].createElement(_reactIntl.FormattedMessage, {
        id: (0, _getTrad["default"])('component.repeatable')
      }))), _react["default"].createElement("td", {
        className: "button-container"
      }, isInDevelopmentMode && _react["default"].createElement(_react["default"].Fragment, null, configurable ? _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement("button", {
        type: "button",
        onClick: handleClick
    ...
    var _default = (0, _react.memo)(ListRow);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Wrapper = _styledComponents["default"].tr(_templateObject(), function (_ref) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _ListViewContext = _interopRequireDefault(__webpack_require__(1866));
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _ComponentButton = _interopRequireDefault(__webpack_require__(1921));

    var _ComponentCard = _interopRequireDefault(__webpack_require__(1922));
    ...
    */
    ...
    function DynamicZoneList(_ref) {
      ...
      return _react["default"].createElement("tr", {
        ...
        tabs: true
      }, isInDevelopmentMode && _react["default"].createElement("li", null, _react["default"].createElement(_ComponentButton["default"], {
        onClick: handleClickAdd
      }, _react["default"].createElement("div", null, _react["default"].createElement(_icons.Plus, {
        style: {
          height: 15,
          width: 15
        }
      })), _react["default"].createElement("p", null, _react["default"].createElement(_reactIntl.FormattedMessage, {
        id: (0, _getTrad["default"])('button.component.add')
      })))), components.map(function (component, index) {
        return _react["default"].createElement("li", {
          key: component
        }, _react["default"].createElement(_ComponentCard["default"], {
          dzName: name,
          index: index,
          component: component,
        ...
        return _react["default"].createElement(_reactstrap.TabPane, {
          tabId: "".concat(index),
          key: component
        }, _react["default"].createElement("table", null, _react["default"].createElement("tbody", null, _react["default"].createElement(_ComponentList["default"], (0, _extends2["default"])({}, props, {
          isFromDynamicZone: true,
          mainTypeName: mainTypeName,
          targetUid: targetUid,
          key: component
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var ComponentButton = _styledComponents["default"].button(_templateObject());
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _Wrapper = _interopRequireDefault(__webpack_require__(1923));

    var _Close = _interopRequireDefault(__webpack_require__(1924));
    /**
    *
    * ComponentCard
    *
    */
    ...
    function ComponentCard(_ref) {
      ...
      return _react["default"].createElement(_Wrapper["default"], {
        ...
        icon: icon
      })), _react["default"].createElement("p", null, name), _react["default"].createElement("div", {
        className: "close-btn",
        onClick: function onClick(e) {
          e.stopPropagation();
          removeComponentFromDynamicZone(dzName, index);
        }
      }, isInDevelopmentMode && _react["default"].createElement(_Close["default"], {
        width: "7px",
        height: "7px"
      })));
    }
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Close = (0, _styledComponents["default"])(_icons.Remove)(_templateObject());
    var _default = Close;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Wrapper = (0, _styledComponents["default"])(_styles.List)(_templateObject(), function (_ref) {
      var isFromDynamicZone = _ref.isFromDynamicZone;
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _Title = _interopRequireDefault(__webpack_require__(1927));

    var _Wrapper = _interopRequireDefault(__webpack_require__(1928));
    ...
    function ListHeader(_ref) {
      ...
      return _react["default"].createElement(_Wrapper["default"], null, _react["default"].createElement("div", {
        ...
        return _react["default"].createElement(_ListButton.ListHeaderButton, (0, _extends2["default"])({
          key: label,
          onClick: onClick,
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Title = _styledComponents["default"].p(_templateObject(), _strapiHelperPlugin.colors.blueTxt);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _CustomLink = _interopRequireDefault(__webpack_require__(1930));

    var _useDataManager2 = _interopRequireDefault(__webpack_require__(84));

    var _makeSearch = _interopRequireDefault(__webpack_require__(353));

    var _Wrapper = _interopRequireDefault(__webpack_require__(1933));
    /**
    *
    * LeftMenu
    *
    */
    ...
    var displayNotificationCTNotSaved = function displayNotificationCTNotSaved() {
      strapi.notification.info("".concat(_pluginId["default"], ".notification.info.creating.notSaved"));
    };
    ...
    function LeftMenu(_ref) {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  eventName = type === 'contentType' ? 'willCreateContentType' : 'willCreateComponent';
                  emitEvent(eventName);
                  _context.next = 5;
                  return wait();
                ...
                case 5:
                  push({
                    search: "modalType=".concat(type, "&actionType=create&settingType=base&forTarget=").concat(type)
                  });
                  _context.next = 9;
                  break;
      ...
      return _react["default"].createElement(_Wrapper["default"], {
        ...
        return _react["default"].createElement(_strapiHelperPlugin.LeftMenuList, (0, _extends2["default"])({}, list, {
          key: list.name
        }));
      }));
    }
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _P = _interopRequireDefault(__webpack_require__(1931));

    var _StyledCustomLink = _interopRequireDefault(__webpack_require__(1932));

    var CustomLink = function CustomLink(_ref) {
      var disabled = _ref.disabled,
          id = _ref.id,
          onClick = _ref.onClick;
      return _react["default"].createElement(_StyledCustomLink["default"], {
        disabled: disabled
      }, _react["default"].createElement("button", {
        onClick: onClick,
        role: "button",
        disabled: disabled
      }, _react["default"].createElement(_P["default"], null, _react["default"].createElement(_icons.Plus, {
        fill: "#007EFF",
        width: "11px",
        height: "11px"
      }), id && _react["default"].createElement(_reactIntl.FormattedMessage, {
        id: id
      }))));
    };
    ...
    var _default = (0, _react.memo)(CustomLink);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var P = _styledComponents["default"].p(_templateObject(), _strapiHelperPlugin.colors.blue);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var StyledCustomLink = _styledComponents["default"].div(_templateObject(), function (_ref) {
      var disabled = _ref.disabled;
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Wrapper = _styledComponents["default"].div(_templateObject(), _strapiHelperPlugin.sizes.header.height, _strapiHelperPlugin.colors.leftMenu.mediumGrey);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Wrapper = (0, _styledComponents["default"])(_strapiHelperPlugin.ViewContainer)(_templateObject());
    var _default = Wrapper;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _ListRow = _interopRequireDefault(__webpack_require__(1916));
    ...
    var _ListHeader = _interopRequireDefault(__webpack_require__(1926));

    var _LeftMenu = _interopRequireDefault(__webpack_require__(1929));

    var _Wrapper = _interopRequireDefault(__webpack_require__(1934));
    ...
    var ListView = function ListView() {
      ...
      var handleClickOpenModalAddField =
      /*#__PURE__*/
      function () {
        var _ref = (0, _asyncToGenerator2["default"])(
        /*#__PURE__*/
        _regenerator["default"].mark(function _callee(forTarget, targetUid, headerDisplayName) {
          var headerDisplayCategory,
          ...
          return _regenerator["default"].wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  headerDisplayCategory = _args.length > 3 && _args[3] !== undefined ? _args[3] : null;
                  headerDisplaySubCategory = _args.length > 4 && _args[4] !== undefined ? _args[4] : null;
                  subTargetUid = _args.length > 5 && _args[5] !== undefined ? _args[5] : null;
                  searchObj = {
                ...
                case 6:
                  push({
                    search: (0, _makeSearch["default"])(searchObj, true)
                  });
        ...
        return function handleClickOpenModalAddField(_x, _x2, _x3) {
          return _ref.apply(this, arguments);
        };
      }();

      var handleClickAddComponentToDZ =
      /*#__PURE__*/
      function () {
        var _ref2 = (0, _asyncToGenerator2["default"])(
        /*#__PURE__*/
        _regenerator["default"].mark(function _callee2(dzName) {
          var search;
        ...
        return function handleClickAddComponentToDZ(_x4) {
          return _ref2.apply(this, arguments);
        };
      }();

      var handleClickEditField =
      /*#__PURE__*/
      function () {
        var _ref3 = (0, _asyncToGenerator2["default"])(
        /*#__PURE__*/
        _regenerator["default"].mark(function _callee3(forTarget, targetUid, attributeName, type, headerDisplayName) {
          var headerDisplayCategory,
              headerDisplaySubCategory,
              subTargetUid,
              attributeType,
          ...
          return _regenerator["default"].wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  headerDisplayCategory = _args3.length > 5 && _args3[5] !== undefined ? _args3[5] : null;
                  headerDisplaySubCategory = _args3.length > 6 && _args3[6] !== undefined ? _args3[6] : null;
                  subTargetUid = _args3.length > 7 && _args3[7] !== undefined ? _args3[7] : null;
                  _context3.t0 = type;
                  _context3.next = _context3.t0 === 'integer' ? 6 : _context3.t0 === 'biginteger' ? 6 : _context3.t0 === 'decimal' ? 6 : _context3.t0 === 'float' ? 6 : _context3.t0 === 'string' ? 8 : _context3.t0 === 'text' ? 8 : _context3.t0 === '' ? 10 : 12;
                  break;
        ...
        return function handleClickEditField(_x5, _x6, _x7, _x8, _x9) {
      ...
      var getDescription = function getDescription() {
        ...
        return description ? description : formatMessage({
      ...
      var goToCMSettingsPage = function goToCMSettingsPage() {
        var endPoint = isInContentTypeView ? "/plugins/content-manager/".concat(targetUid, "/ctm-configurations/edit-settings/content-types") : "/plugins/content-manager/ctm-configurations/edit-settings/components/".concat(targetUid, "/");
        push(endPoint);
      };

      var configureButtonProps = {
        icon: _react["default"].createElement(_strapiHelperPlugin.LayoutIcon, {
          className: "colored",
          fill: "#007eff"
        }),
        color: 'secondary',
        label: formatMessage({
          id: "".concat(_pluginId["default"], ".form.button.configure-view")
        }),
      ...
      var listActions = isInDevelopmentMode ? [_objectSpread({}, configureButtonProps), _objectSpread({}, addButtonProps)] : [configureButtonProps];

      var handleClickOnTrashIcon = function handleClickOnTrashIcon() {};

      var CustomRow = function CustomRow(props) {
        var name = props.name;
        return _react["default"].createElement(_ListRow["default"], (0, _extends2["default"])({}, props, {
          attributeName: name,
          name: name,
      ...
      return _react["default"].createElement(_ListViewContext["default"].Provider, {
        value: {
          openModalAddField: handleClickOpenModalAddField
        }
      }, _react["default"].createElement(_Wrapper["default"], null, _react["default"].createElement(_strapiHelperPlugin.BackHeader, {
        onClick: goBack
      }), _react["default"].createElement(_reactRouterDom.Prompt, {
        ...
        className: "row"
      }, _react["default"].createElement(_LeftMenu["default"], {
        wait: wait
      }), _react["default"].createElement("div", {
      ...
      }, _react["default"].createElement(_custom.Header, headerProps), _react["default"].createElement(_strapiHelperPlugin.ListWrapper, {
        style: {
          marginBottom: 80
        }
        ...
        customRowComponent: function customRowComponent(props) {
          return _react["default"].createElement(CustomRow, props);
        },
