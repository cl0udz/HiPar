...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[5], {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _taggedTemplateLiteral2 = _interopRequireDefault(__webpack_require__(7));
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _EditViewDataManager = _interopRequireDefault(__webpack_require__(1875));

    var useDataManager = function useDataManager() {
      return (0, _react.useContext)(_EditViewDataManager["default"]);
    };

    var _default = useDataManager;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _EditView = _interopRequireDefault(__webpack_require__(1876));

    var useEditView = function useEditView() {
      return (0, _react.useContext)(_EditView["default"]);
    };

    var _default = useEditView;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _pluginId = _interopRequireDefault(__webpack_require__(103));

    var _useDataManager2 = _interopRequireDefault(__webpack_require__(1816));

    var _useEditView2 = _interopRequireDefault(__webpack_require__(1829));

    var _ComponentInitializer = _interopRequireDefault(__webpack_require__(1953));

    var _NonRepeatableComponent = _interopRequireDefault(__webpack_require__(1955));

    var _RepeatableComponent = _interopRequireDefault(__webpack_require__(2104));

    var _ComponentIcon = _interopRequireDefault(__webpack_require__(2111));

    var _Label = _interopRequireDefault(__webpack_require__(2112));

    var _ResetComponent = _interopRequireDefault(__webpack_require__(2113));

    var _Wrapper = _interopRequireDefault(__webpack_require__(2114));
    ...
    var FieldComponent = function FieldComponent(_ref) {
      ...
      var _useDataManager = (0, _useDataManager2["default"])(),
          ...
          removeComponentFromField = _useDataManager.removeComponentFromField;

      var _useEditView = (0, _useEditView2["default"])(),
          allLayoutData = _useEditView.allLayoutData;
      ...
      var showResetComponent = !isRepeatable && isInitialized && !isFromDynamicZone;
      var currentComponentSchema = (0, _lodash.get)(allLayoutData, ['components', componentUid], {});
      var displayedFields = (0, _lodash.get)(currentComponentSchema, ['layouts', 'edit'], []);
      return _react["default"].createElement(_Wrapper["default"], {
        className: "col-12",
        isFromDynamicZone: isFromDynamicZone
      }, isFromDynamicZone && _react["default"].createElement(_ComponentIcon["default"], {
        ...
        icon: icon,
        title: componentFriendlyName
      })), _react["default"].createElement("p", null, componentFriendlyName))), _react["default"].createElement(_Label["default"], null, label, "\xA0", isRepeatable && "(".concat(componentValueLength, ")")), showResetComponent && _react["default"].createElement(_ResetComponent["default"], {
      ...
      }), _react["default"].createElement("div", null)), !isRepeatable && !isInitialized && _react["default"].createElement(_ComponentInitializer["default"], {
        componentUid: componentUid,
        name: name
      }), !isRepeatable && isInitialized && _react["default"].createElement(_NonRepeatableComponent["default"], {
        fields: displayedFields,
        isFromDynamicZone: isFromDynamicZone,
        name: name,
        schema: currentComponentSchema
      }), isRepeatable && _react["default"].createElement(_RepeatableComponent["default"], {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _Wrapper = _interopRequireDefault(__webpack_require__(1838));

    var DynamicComponentCard = function DynamicComponentCard(_ref) {
      ...
      }, _react["default"].createElement("span", null, friendlyName)), children);
    };
    ...
    var _default = DynamicComponentCard;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _toConsumableArray2 = _interopRequireDefault(__webpack_require__(54));
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _InputJSONWithErrors = _interopRequireDefault(__webpack_require__(1956));

    var _InputFileWithErrors = _interopRequireDefault(__webpack_require__(1970));

    var _SelectWrapper = _interopRequireDefault(__webpack_require__(1879));

    var _WysiwygWithErrors = _interopRequireDefault(__webpack_require__(1977));

    var getInputType = function getInputType() {
      var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';

      switch ((0, _lodash.toLower)(type)) {
        case 'boolean':
          return 'bool';
    ...
    function Inputs(_ref) {
      ...
      var _useDataManager = (0, _useDataManager2["default"])(),
          didCheckErrors = _useDataManager.didCheckErrors,
          formErrors = _useDataManager.formErrors,
          modifiedData = _useDataManager.modifiedData,
          onChange = _useDataManager.onChange;

      var attribute = (0, _react.useMemo)(function () {
        return (0, _lodash.get)(layout, ['schema', 'attributes', name], {});
      }, [layout, name]);
      var metadatas = (0, _react.useMemo)(function () {
        return (0, _lodash.get)(layout, ['metadatas', name, 'edit'], {});
      }, [layout, name]);
      var disabled = (0, _react.useMemo)(function () {
        return !(0, _lodash.get)(metadatas, 'editable', true);
      }, [metadatas]);
      var type = (0, _react.useMemo)(function () {
        return (0, _lodash.get)(attribute, 'type', null);
      }, [attribute]);
      var validations = (0, _lodash.omit)(attribute, ['type', 'model', 'via', 'collection', 'default', 'plugin', 'enum']);
      var description = metadatas.description,
          visible = metadatas.visible;
      var value = (0, _lodash.get)(modifiedData, keys, null);

      if (visible === false) {
        return null;
      }

      var temporaryErrorIdUntilBuffetjsSupportsFormattedMessage = 'app.utils.defaultMessage';
      var errorId = (0, _lodash.get)(formErrors, [keys, 'id'], temporaryErrorIdUntilBuffetjsSupportsFormattedMessage);

      if (type === 'relation') {
        return _react["default"].createElement("div", {
          className: "col-6",
          key: keys
        }, _react["default"].createElement(_SelectWrapper["default"], (0, _extends2["default"])({}, metadatas, {
          name: keys,
          plugin: attribute.plugin,
          relationType: attribute.relationType,
          targetModel: attribute.targetModel,
          value: (0, _lodash.get)(modifiedData, keys)
        })));
      }

      var inputValue = value; // Fix for input file multipe
      ...
      var options = (0, _lodash.get)(attribute, 'enum', []).map(function (v) {
        return _react["default"].createElement("option", {
          key: v,
          value: v
        }, v);
      });
      var isRequired = (0, _lodash.get)(validations, ['required'], false);
      var enumOptions = [_react["default"].createElement(_reactIntl.FormattedMessage, {
      ...
      return _react["default"].createElement(_reactIntl.FormattedMessage, {
        ...
        return _react["default"].createElement(_custom.Inputs, (0, _extends2["default"])({}, metadatas, {
          autoFocus: autoFocus,
          didCheckErrors: didCheckErrors,
          disabled: disabled,
          error: (0, _lodash.isEmpty)(error) || errorId === temporaryErrorIdUntilBuffetjsSupportsFormattedMessage ? null : error,
          inputDescription: description,
          description: description,
          customInputs: {
            media: _InputFileWithErrors["default"],
            json: _InputJSONWithErrors["default"],
            wysiwyg: _WysiwygWithErrors["default"]
          },
          multiple: (0, _lodash.get)(attribute, 'multiple', false),
          name: keys,
          onBlur: onBlur,
          onChange: onChange,
          options: enumOptions,
    ...
    var _default = (0, _react.memo)(Inputs);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var WysiwygContext = (0, _react.createContext)();
    var _default = WysiwygContext;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    exports.DEFAULT_INDENTATION = exports.CONTROLS = exports.SELECT_OPTIONS = void 0;
    var SELECT_OPTIONS = [{
    ...
    exports.DEFAULT_INDENTATION = DEFAULT_INDENTATION;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var EditViewDataManagerContext = (0, _react.createContext)();
    var _default = EditViewDataManagerContext;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var EditViewContext = (0, _react.createContext)();
    var _default = EditViewContext;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var NonRepeatableWrapper = _styledComponents["default"].div(_templateObject(), function (_ref) {
    ...
    var _default = NonRepeatableWrapper;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Button = _styledComponents["default"].button(_templateObject(), beforeStyle, afterStyle);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _regenerator = _interopRequireDefault(__webpack_require__(55));

    var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(145));
    ...
    var _strapiHelperPlugin = __webpack_require__(11);
    ...
    var _SelectOne = _interopRequireDefault(__webpack_require__(1973));

    var _SelectMany = _interopRequireDefault(__webpack_require__(1974));

    var _components = __webpack_require__(1976);
    ...
    function SelectWrapper(_ref) {
      ...
      var _useDataManager = (0, _useDataManager2["default"])(),
          _addRelation = _useDataManager.addRelation,
          modifiedData = _useDataManager.modifiedData,
          moveRelation = _useDataManager.moveRelation,
          _onChange = _useDataManager.onChange,
          onRemoveRelation = _useDataManager.onRemoveRelation;

      var _useEditView = (0, _useEditView2["default"])(),
          isDraggingComponent = _useEditView.isDraggingComponent;
      ...
      _regenerator["default"].mark(function _callee() {
        var params, requestUrl, data, formattedData;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                params = (0, _lodash.cloneDeep)(state);
                requestUrl = "/".concat(_pluginId["default"], "/explorer/").concat(targetModel);

                if ((0, _lodash.isEmpty)(params._q)) {
                  delete params._q;
                }
      ...
      var onInputChange = function onInputChange(inputValue, _ref3) {
      ...
      var onMenuScrollToBottom = function onMenuScrollToBottom() {
        setState(function (prevState) {
          return _objectSpread({}, prevState, {
      ...
      var nextSearch = "".concat(pathname).concat(search);
      var to = "/plugins/".concat(_pluginId["default"], "/").concat(targetModel, "/").concat(value ? value.id : null, "?redirectUrl=").concat(nextSearch);
      var link = value === null || value === undefined || ['role', 'permission'].includes(targetModel) ? null : _react["default"].createElement(_reactRouterDom.Link, {
        to: to
      }, _react["default"].createElement(_reactIntl.FormattedMessage, {
      ...
      return _react["default"].createElement(_components.Wrapper, {
        className: "form-group"
      }, _react["default"].createElement(_components.Nav, null, _react["default"].createElement("div", null, _react["default"].createElement("label", {
        htmlFor: name
      }, label, !isSingle && _react["default"].createElement("span", {
        style: {
          fontWeight: 400,
          fontSize: 12
        }
      }, "\xA0(", associationsLength, ")")), isSingle && link), !(0, _lodash.isEmpty)(description) && _react["default"].createElement("p", {
        className: "description"
      }, description)), _react["default"].createElement(Component, {
        addRelation: function addRelation(value) {
          _addRelation({
            target: {
              name: name,
              value: value
        ...
        placeholder: (0, _lodash.isEmpty)(placeholder) ? _react["default"].createElement(_reactIntl.FormattedMessage, {
    ...
    SelectWrapper.propTypes = {
      ...
      mainField: _propTypes["default"].string.isRequired,
      name: _propTypes["default"].string.isRequired,
    ...
    var _default = (0, _react.memo)(SelectWrapper);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _draftJs = __webpack_require__(1831);
    ...
    */
    ...
    function (_React$Component) {
      (0, _inherits2["default"])(WysiwygEditor, _React$Component);

      function WysiwygEditor() {
        (0, _classCallCheck2["default"])(this, WysiwygEditor);
        return (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(WysiwygEditor).apply(this, arguments));
      }

      (0, _createClass2["default"])(WysiwygEditor, [{
        key: "render",
        value: function render() {
          return _react["default"].createElement(_draftJs.Editor, (0, _extends2["default"])({}, this.props, {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _Container = _interopRequireDefault(__webpack_require__(1815));

    var _DynamicZone = _interopRequireDefault(__webpack_require__(1952));

    var _FormWrapper = _interopRequireDefault(__webpack_require__(2122));

    var _FieldComponent = _interopRequireDefault(__webpack_require__(1830));

    var _Inputs = _interopRequireDefault(__webpack_require__(1847));

    var _SelectWrapper = _interopRequireDefault(__webpack_require__(1879));

    var _EditViewDataManagerProvider = _interopRequireDefault(__webpack_require__(2123));

    var _EditViewProvider = _interopRequireDefault(__webpack_require__(2131));

    var _Header = _interopRequireDefault(__webpack_require__(2132));

    var _createAttributesLayout = _interopRequireDefault(__webpack_require__(2133));

    var _components = __webpack_require__(2134);

    var _getComponents = _interopRequireDefault(__webpack_require__(1846));

    var _init = _interopRequireDefault(__webpack_require__(2135));

    var _reducer = _interopRequireWildcard(__webpack_require__(2136));

    var EditView = function EditView(_ref) {
      var components = _ref.components,
          currentEnvironment = _ref.currentEnvironment,
          layouts = _ref.layouts,
          plugins = _ref.plugins,
          slug = _ref.slug;
      var formatLayoutRef = (0, _react.useRef)();
      formatLayoutRef.current = _createAttributesLayout["default"]; // Retrieve push to programmatically navigate between views

      var _useHistory = (0, _reactRouterDom.useHistory)(),
          push = _useHistory.push; // Retrieve the search


      var _useLocation = (0, _reactRouterDom.useLocation)(),
          search = _useLocation.search; // eslint-disable-next-line react-hooks/exhaustive-deps
      ...
      var allLayoutData = (0, _react.useMemo)(function () {
        return (0, _lodash.get)(layouts, [slug], {});
      }, [layouts, slug]);
      var currentContentTypeLayoutData = (0, _react.useMemo)(function () {
        return (0, _lodash.get)(allLayoutData, ['contentType'], {});
      }, [allLayoutData]);
      var currentContentTypeLayout = (0, _react.useMemo)(function () {
        return (0, _lodash.get)(currentContentTypeLayoutData, ['layouts', 'edit'], []);
      }, [currentContentTypeLayoutData]);
      var currentContentTypeLayoutRelations = (0, _react.useMemo)(function () {
        return (0, _lodash.get)(currentContentTypeLayoutData, ['layouts', 'editRelations'], []);
      }, [currentContentTypeLayoutData]);
      var currentContentTypeSchema = (0, _react.useMemo)(function () {
        return (0, _lodash.get)(currentContentTypeLayoutData, ['schema'], {});
      }, [currentContentTypeLayoutData]);
      var getFieldMetas = (0, _react.useCallback)(function (fieldName) {
        return (0, _lodash.get)(currentContentTypeLayoutData, ['metadatas', fieldName, 'edit'], {});
      }, [currentContentTypeLayoutData]);
      var getField = (0, _react.useCallback)(function (fieldName) {
        return (0, _lodash.get)(currentContentTypeSchema, ['attributes', fieldName], {});
      }, [currentContentTypeSchema]);
      var getFieldType = (0, _react.useCallback)(function (fieldName) {
        return (0, _lodash.get)(getField(fieldName), ['type'], '');
      }, [getField]);
      var getFieldComponentUid = (0, _react.useCallback)(function (fieldName) {
        return (0, _lodash.get)(getField(fieldName), ['component'], '');
      }, [getField]); // Check if a block is a dynamic zone
      ...
      var isDynamicZone = (0, _react.useCallback)(function (block) {
        return block.every(function (subBlock) {
          return subBlock.every(function (obj) {
            return getFieldType(obj.name) === 'dynamiczone';
          });
        });
      }, [getFieldType]);
      (0, _react.useEffect)(function () {
        ...
        dispatch({
          ...
          formattedContentTypeLayout: formatLayoutRef.current(currentContentTypeLayout, currentContentTypeSchema.attributes)
        });
      }, [currentContentTypeLayout, currentContentTypeSchema.attributes]);

      var _reducerState$toJS = reducerState.toJS(),
          formattedContentTypeLayout = _reducerState$toJS.formattedContentTypeLayout,
          isDraggingComponent = _reducerState$toJS.isDraggingComponent; // We can't use the getQueryParameters helper here because the search
      // can contain 'redirectUrl' several times since we can navigate between documents


      var redirectURL = search.split('redirectUrl=').filter(function (_, index) {
        return index !== 0;
      }).join('');

      var redirectToPreviousPage = function redirectToPreviousPage() {
        return push(redirectURL);
      };

      return _react["default"].createElement(_EditViewProvider["default"], {
        allLayoutData: allLayoutData,
        components: components,
        layout: currentContentTypeLayoutData,
        isDraggingComponent: isDraggingComponent,
        setIsDraggingComponent: function setIsDraggingComponent() {
          dispatch({
            type: 'SET_IS_DRAGGING_COMPONENT'
          });
        },
        unsetIsDraggingComponent: function unsetIsDraggingComponent() {
          dispatch({
            type: 'UNSET_IS_DRAGGING_COMPONENT'
          });
        }
      }, _react["default"].createElement(_EditViewDataManagerProvider["default"], {
        allLayoutData: allLayoutData,
        redirectToPreviousPage: redirectToPreviousPage,
        slug: slug
      }, _react["default"].createElement(_strapiHelperPlugin.BackHeader, {
        onClick: function onClick() {
        ...
        if (isDynamicZone(block)) {
          var name = block[0][0].name;

          var _getField = getField(name),
              max = _getField.max,
              min = _getField.min;

          return _react["default"].createElement(_DynamicZone["default"], {
            key: blockIndex,
            name: name,
            max: max,
            min: min
        ...
        return _react["default"].createElement(_FormWrapper["default"], {
          key: blockIndex
        }, block.map(function (fieldsBlock, fieldsBlockIndex) {
          return _react["default"].createElement("div", {
            className: "row",
            key: fieldsBlockIndex
          }, fieldsBlock.map(function (_ref2, fieldIndex) {
            var name = _ref2.name,
                size = _ref2.size;
            var isComponent = getFieldType(name) === 'component';

            if (isComponent) {
              var componentUid = getFieldComponentUid(name);
              var isRepeatable = (0, _lodash.get)(getField(name), 'repeatable', false);

              var _getField2 = getField(name),
                  _max = _getField2.max,
                  _min = _getField2.min;

              var label = (0, _lodash.get)(getFieldMetas(name), 'label', componentUid);
              return _react["default"].createElement(_FieldComponent["default"], {
                key: componentUid,
                componentUid: componentUid,
      ...
      }, currentContentTypeLayoutRelations.length > 0 && _react["default"].createElement(_components.SubWrapper, {
        style: {
          padding: '0 20px 1px',
          marginBottom: '25px'
        }
      ...
      }, currentContentTypeLayoutRelations.map(function (relationName) {
        var relation = (0, _lodash.get)(currentContentTypeLayoutData, ['schema', 'attributes', relationName], {});
        var relationMetas = (0, _lodash.get)(currentContentTypeLayoutData, ['metadatas', relationName, 'edit'], {});
        return _react["default"].createElement(_SelectWrapper["default"], (0, _extends2["default"])({}, relation, relationMetas, {
          key: relationName,
          name: relationName,
          relationsType: relation.relationType
        }));
      }))), _react["default"].createElement(_components.LinkWrapper, null, _react["default"].createElement("ul", null, _react["default"].createElement(_strapiHelperPlugin.LiLink, {
        message: {
          id: 'app.links.configure-view'
        },
        icon: "layout",
        key: "".concat(_pluginId["default"], ".link"),
      ...
      }), (0, _getComponents["default"])('editView', 'right.links', plugins, currentEnvironment, slug))))))));
    };
    ...
    var _default = (0, _react.memo)(EditView);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _DynamicComponentCard = _interopRequireDefault(__webpack_require__(1837));

    var _FieldComponent = _interopRequireDefault(__webpack_require__(1830));

    var _Button = _interopRequireDefault(__webpack_require__(2115));

    var _ComponentsPicker = _interopRequireDefault(__webpack_require__(2116));

    var _ComponentWrapper = _interopRequireDefault(__webpack_require__(2117));

    var _DynamicZoneWrapper = _interopRequireDefault(__webpack_require__(2118));

    var _Label = _interopRequireDefault(__webpack_require__(2119));

    var _RoundCTA = _interopRequireDefault(__webpack_require__(2120));

    var _Wrapper = _interopRequireDefault(__webpack_require__(2121));
    ...
    var DynamicZone = function DynamicZone(_ref) {
      ...
      var _useEditView = (0, _useEditView2["default"])(),
          components = _useEditView.components;

      var getDynamicDisplayedComponents = (0, _react.useCallback)(function () {
        return (0, _lodash.get)(modifiedData, [name], []).map(function (data) {
          return data.__component;
        });
      }, [modifiedData, name]);

      var getDynamicComponentSchemaData = function getDynamicComponentSchemaData(componentUid) {
        var component = components.find(function (compo) {
          return compo.uid === componentUid;
        });
        var schema = component.schema;
        return schema;
      };

      var getDynamicComponentInfos = function getDynamicComponentInfos(componentUid) {
        var _getDynamicComponentS = getDynamicComponentSchemaData(componentUid),
            _getDynamicComponentS2 = _getDynamicComponentS.info,
            icon = _getDynamicComponentS2.icon,
            name = _getDynamicComponentS2.name;
      ...
      var dynamicZoneErrors = Object.keys(formErrors).filter(function (key) {
        return key === name;
      }).map(function (key) {
        return formErrors[key];
      });
      var dynamicZoneAvailableComponents = (0, _lodash.get)(layout, ['schema', 'attributes', name, 'components'], []);
      var metas = (0, _lodash.get)(layout, ['metadatas', name, 'edit'], {});
      var dynamicDisplayedComponentsLength = getDynamicDisplayedComponents().length;
      ...
      return _react["default"].createElement(_DynamicZoneWrapper["default"], null, getDynamicDisplayedComponents().length > 0 && _react["default"].createElement(_Label["default"], null, _react["default"].createElement("p", null, metas.label), _react["default"].createElement("p", null, metas.description)), _react["default"].createElement(_ComponentWrapper["default"], null, getDynamicDisplayedComponents().map(function (componentUid, index) {
        var showDownIcon = dynamicDisplayedComponentsLength > 0 && index < dynamicDisplayedComponentsLength - 1;
        var showUpIcon = dynamicDisplayedComponentsLength > 0 && index > 0;
        return _react["default"].createElement("div", {
          key: index
        }, _react["default"].createElement("div", {
          className: "arrow-icons"
        }, showDownIcon && _react["default"].createElement(_RoundCTA["default"], {
          className: "arrow-btn arrow-down",
          onClick: function onClick() {
            return moveComponentDown(name, index);
          }
        }, _react["default"].createElement(_icons.Arrow, null)), showUpIcon && _react["default"].createElement(_RoundCTA["default"], {
          className: "arrow-btn arrow-up",
          onClick: function onClick() {
            return moveComponentUp(name, index);
          }
        }, _react["default"].createElement(_icons.Arrow, null))), _react["default"].createElement(_RoundCTA["default"], {
          onClick: function onClick() {
            return removeComponentFromDynamicZone(name, index);
          }
        }, _react["default"].createElement(_reactFontawesome.FontAwesomeIcon, {
          icon: 'trash'
        })), _react["default"].createElement(_FieldComponent["default"], {
          componentUid: componentUid,
      ...
      })), _react["default"].createElement(_Wrapper["default"], null, _react["default"].createElement(_Button["default"], {
        type: "button",
        hasError: hasError,
      ...
      }), hasRequiredError && !isOpen && !hasMaxError && _react["default"].createElement("div", {
        className: "error-label"
      }, "Component is required"), hasMaxError && !isOpen && _react["default"].createElement("div", {
        className: "error-label"
      }, _react["default"].createElement(_reactIntl.FormattedMessage, {
        id: "components.Input.error.validation.max"
      })), hasMinError && !isOpen && _react["default"].createElement("div", {
        className: "error-label"
      }, _react["default"].createElement(_reactIntl.FormattedMessage, {
      ...
      })), _react["default"].createElement(_ComponentsPicker["default"], {
        isOpen: isOpen
      ...
      }, dynamicZoneAvailableComponents.map(function (componentUid) {
        var _getDynamicComponentI = getDynamicComponentInfos(componentUid),
            icon = _getDynamicComponentI.icon,
            friendlyName = _getDynamicComponentI.name;

        return _react["default"].createElement(_DynamicComponentCard["default"], {
          key: componentUid,
          componentUid: componentUid,
          ...
          onClick: function onClick() {
            setIsOpen(false);
            var shouldCheckErrors = hasError;
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _NonRepeatableWrapper = _interopRequireDefault(__webpack_require__(1877));

    var _PlusButton = _interopRequireDefault(__webpack_require__(1878));

    var _P = _interopRequireDefault(__webpack_require__(1954));
    ...
    var ComponentInitializer = function ComponentInitializer(_ref) {
      ...
      var _useDataManager = (0, _useDataManager2["default"])(),
          addNonRepeatableComponentToField = _useDataManager.addNonRepeatableComponentToField;

      return _react["default"].createElement(_NonRepeatableWrapper["default"], {
        isEmpty: true
      }, _react["default"].createElement(_PlusButton["default"], {
        onClick: function onClick() {
          return addNonRepeatableComponentToField(name, componentUid);
        },
        type: "button"
      }), _react["default"].createElement(_reactIntl.FormattedMessage, {
        id: "".concat(_pluginId["default"], ".components.empty-repeatable")
      }, function (msg) {
        return _react["default"].createElement(_P["default"], {
          style: {
            paddingTop: 78
          }
        }, msg);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var NonRepeatableComponent = function NonRepeatableComponent(_ref) {
      ...
      var getField = function getField(fieldName) {
        return (0, _lodash.get)(schema, ['schema', 'attributes', fieldName], {});
      };

      var getMeta = function getMeta(fieldName) {
        return (0, _lodash.get)(schema, ['metadatas', fieldName, 'edit'], {});
      };
      ...
      return _react["default"].createElement(_NonRepeatableWrapper["default"], {
        ...
        return _react["default"].createElement("div", {
          ...
          var currentField = getField(field.name);
          var isComponent = (0, _lodash.get)(currentField, 'type', '') === 'component';
          var keys = "".concat(name, ".").concat(field.name);

          if (isComponent) {
            var componentUid = currentField.component;
            var metas = getMeta(field.name);
            return _react["default"].createElement(_FieldComponent["default"], {
              key: field.name,
              componentUid: componentUid,
          ...
          return _react["default"].createElement("div", {
            key: field.name,
            className: "col-".concat(field.size)
          }, _react["default"].createElement(_Inputs["default"], {
            keys: keys,
            layout: schema,
            name: field.name,
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _getPrototypeOf3 = _interopRequireDefault(__webpack_require__(16));
    ...
    var _classnames = _interopRequireDefault(__webpack_require__(22));

    var _styles = __webpack_require__(23);

    var _core = __webpack_require__(77);

    var _InputJSON = _interopRequireDefault(__webpack_require__(1957));

    var _Wrapper = _interopRequireDefault(__webpack_require__(1969));
    /**
    *
    * InputJSONWithErrors
    *
    */
    ...
    var InputJSONWithErrors =
    /*#__PURE__*/
    function (_React$Component) {
      (0, _inherits2["default"])(InputJSONWithErrors, _React$Component);

      function InputJSONWithErrors() {
        var _getPrototypeOf2;

        var _this;

        (0, _classCallCheck2["default"])(this, InputJSONWithErrors);

        for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }

        _this = (0, _possibleConstructorReturn2["default"])(this, (_getPrototypeOf2 = (0, _getPrototypeOf3["default"])(InputJSONWithErrors)).call.apply(_getPrototypeOf2, [this].concat(args)));
      ...
      (0, _createClass2["default"])(InputJSONWithErrors, [{
        key: "render",
        value: function render() {
          var _this2 = this;
          ...
          var _this$props = this.props,
              ...
              deactivateErrorHighlight = _this$props.deactivateErrorHighlight,
              disabled = _this$props.disabled,
              inputError = _this$props.error,
              inputClassName = _this$props.inputClassName,
              inputDescription = _this$props.inputDescription,
              inputStyle = _this$props.inputStyle,
              label = _this$props.label,
              name = _this$props.name,
              onBlur = _this$props.onBlur,
              placeholder = _this$props.placeholder,
              resetProps = _this$props.resetProps,
              tabIndex = _this$props.tabIndex,
              validations = _this$props.validations,
              value = _this$props.value,
              rest = (0, _objectWithoutProperties2["default"])(_this$props, ["autoFocus", "className", "deactivateErrorHighlight", "disabled", "error", "inputClassName", "inputDescription", "inputStyle", "label", "name", "onBlur", "placeholder", "resetProps", "tabIndex", "validations", "value"]);
          var handleBlur = (0, _lodash.isFunction)(onBlur) ? onBlur : this.handleBlur;
          return _react["default"].createElement(_core.Error, {
            ...
            var canCheck = _ref.canCheck,
                onBlur = _ref.onBlur,
                error = _ref.error,
                dispatch = _ref.dispatch;
            var hasError = error && error !== null;
            return _react["default"].createElement(_Wrapper["default"], {
              className: "".concat((0, _classnames["default"])(!(0, _lodash.isEmpty)(className) && className), " ").concat(hasError ? 'bordered' : '')
            }, _react["default"].createElement(_styles.Label, {
              htmlFor: name
            }, label), _react["default"].createElement(_InputJSON["default"], (0, _extends2["default"])({}, rest, {
              autoFocus: autoFocus,
              ...
              tabIndex: tabIndex,
              value: value
            })), !hasError && inputDescription && _react["default"].createElement(_styles.Description, null, inputDescription), hasError && _react["default"].createElement(_styles.ErrorMessage, null, error));
          });
        }
      }]);
      return InputJSONWithErrors;
    }(_react["default"].Component);
    ...
    InputJSONWithErrors.propTypes = {
      ...
      didCheckErrors: _propTypes["default"].bool,
      ...
      name: _propTypes["default"].string.isRequired,
      onBlur: _propTypes["default"].oneOfType([_propTypes["default"].bool, _propTypes["default"].func]),
      onChange: _propTypes["default"].func.isRequired,
      placeholder: _propTypes["default"].string,
      resetProps: _propTypes["default"].bool,
      tabIndex: _propTypes["default"].string,
      validations: _propTypes["default"].object,
      value: _propTypes["default"].oneOfType([_propTypes["default"].array, _propTypes["default"].object, _propTypes["default"].bool, _propTypes["default"].string, _propTypes["default"].number])
    };
    var _default = InputJSONWithErrors;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _codemirror = _interopRequireDefault(__webpack_require__(1820));
    ...
    var _jsonlint = _interopRequireDefault(__webpack_require__(1967));

    var _components = _interopRequireDefault(__webpack_require__(1968));
    /**
    *
    * InputJSON
    *
    */
    ...
    function (_React$Component) {
      ...
      function InputJSON(props) {
        ...
        _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(InputJSON).call(this, props));
        (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "setInitValue", function () {
          ...
          try {
            ...
            return _this.codeMirror.setValue(stringify(value, null, 2));
          } catch (err) {
        ...
        (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleChange", function () {
          var hasInitValue = _this.state.hasInitValue;
          var _this$props2 = _this.props,
              name = _this$props2.name,
              onChange = _this$props2.onChange;

          var value = _this.codeMirror.getValue();
          ...
          _this.timer = setTimeout(function () {
            return _this.testJSON(_this.codeMirror.getValue());
          }, WAIT);
        });
      ...
      (0, _createClass2["default"])(InputJSON, [{
        ...
        value: function componentDidUpdate(prevProps) {
          if ((0, _lodash.isEmpty)(prevProps.value) && !(0, _lodash.isEmpty)(this.props.value) && !this.state.hasInitValue) {
            this.setInitValue();
          }
        }
      }, {
        ...
        value: function render() {
          if (this.state.error) {
            return _react["default"].createElement("div", null, "error json");
          }

          return _react["default"].createElement(_components["default"], null, _react["default"].createElement("textarea", {
            ref: this.editor,
            autoComplete: "off",
            id: this.props.name,
            defaultValue: ""
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _InputFile = _interopRequireDefault(__webpack_require__(1971));

    var _Container = _interopRequireDefault(__webpack_require__(1972));
    /**
    *
    * InputFileWithErrors
    */
    ...
    function InputFileWithErrors(_ref) {
      var className = _ref.className,
          inputError = _ref.error,
          inputDescription = _ref.inputDescription,
          label = _ref.label,
      ...
      var _useState = (0, _react.useState)(null),
          _useState2 = (0, _slicedToArray2["default"])(_useState, 2),
          fileLabel = _useState2[0],
          setFilelabel = _useState2[1];

      (0, _react.useEffect)(function () {
        if ((0, _lodash.isArray)(value) && value.length > 0) {
          setFilelabel(1);
        }
      }, [value]);
      ...
      return _react["default"].createElement(_core.Error, {
        ...
        return _react["default"].createElement(_Container["default"], {
          ...
          htmlFor: "".concat(name, "NotNeeded")
        }, label, multiple && fileLabel && _react["default"].createElement("span", {
          className: "labelNumber"
        }, "\xA0(", fileLabel, "/", value.length, ")")), _react["default"].createElement(_InputFile["default"], (0, _extends2["default"])({}, props, {
          error: hasError,
          onChange: onChange,
          value: value,
          setLabel: setLabel,
    ...
    InputFileWithErrors.propTypes = {
      ...
      validations: _propTypes["default"].object,
      value: _propTypes["default"].oneOfType([_propTypes["default"].string, _propTypes["default"].object, _propTypes["default"].array])
    };

    var _default = (0, _react.memo)(InputFileWithErrors);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    function InputFile(_ref) {
      ...
      return _react["default"].createElement(_strapiHelperPlugin.InputFile, {
        multiple: multiple,
        error: error,
        name: name,
        onChange: function onChange(e) {
    ...
    var _default = (0, _react.memo)(InputFile);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _reactSelect = _interopRequireDefault(__webpack_require__(199));

    function SelectOne(_ref) {
      var mainField = _ref.mainField,
          name = _ref.name,
      ...
      return _react["default"].createElement(_reactSelect["default"], {
        ...
        onMenuScrollToBottom: onMenuScrollToBottom,
        placeholder: placeholder,
        value: (0, _lodash.isNull)(value) ? null : {
          label: (0, _lodash.get)(value, [mainField], ''),
          value: value
        }
      });
    }
    ...
    var _default = (0, _react.memo)(SelectOne);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _reactDnd = __webpack_require__(352);

    var _reactSelect = _interopRequireWildcard(__webpack_require__(199));

    var _ItemTypes = _interopRequireDefault(__webpack_require__(634));

    var _components = __webpack_require__(639);

    var _ListItem = _interopRequireDefault(__webpack_require__(1975));
    ...
    function SelectMany(_ref) {
      ...
      return _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement(_reactSelect["default"], {
        isDisabled: isDisabled,
        id: name,
        ...
        placeholder: placeholder,
        value: []
      }), _react["default"].createElement(_components.ListWrapper, {
        ref: drop
      }, !(0, _lodash.isEmpty)(value) && _react["default"].createElement("ul", null, value.map(function (data, index) {
        return _react["default"].createElement(_ListItem["default"], {
          ...
          onRemove: function onRemove() {
            return _onRemove("".concat(name, ".").concat(index));
          },
          targetModel: targetModel
        });
      })), !(0, _lodash.isEmpty)(value) && value.length > 4 && _react["default"].createElement(_components.ListShadow, null)));
    }
    ...
    SelectMany.propTypes = {
      ...
      name: _propTypes["default"].string.isRequired,
      nextSearch: _propTypes["default"].string.isRequired,
      isLoading: _propTypes["default"].bool.isRequired,
      onInputChange: _propTypes["default"].func.isRequired,
      onMenuClose: _propTypes["default"].func.isRequired,
      onMenuScrollToBottom: _propTypes["default"].func.isRequired,
    ...
    var _default = (0, _react.memo)(SelectMany);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _reactDndHtml5Backend = __webpack_require__(636);
    ...
    var _Relation = _interopRequireDefault(__webpack_require__(644));
    ...
    function ListItem(_ref) {
      var data = _ref.data,
          ...
          targetModel = _ref.targetModel;
      var to = "/plugins/".concat(_pluginId["default"], "/").concat(targetModel, "/").concat(data.id, "?redirectUrl=").concat(nextSearch);
      ...
      return _react["default"].createElement(_components.Li, {
      ...
      }, _react["default"].createElement(_Relation["default"], {
        mainField: mainField,
        onRemove: onRemove,
        data: data,
        to: to
    ...
    ListItem.propTypes = {
      ...
      nextSearch: _propTypes["default"].string,
      onRemove: _propTypes["default"].func,
      targetModel: _propTypes["default"].string
    };

    var _default = (0, _react.memo)(ListItem);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    exports.Wrapper = exports.Nav = void 0;
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _Wysiwyg = _interopRequireDefault(__webpack_require__(1978));

    var _Wrapper = _interopRequireDefault(__webpack_require__(2103));
    /**
    *
    * WysiwygWithErrors
    *
    */
    ...
    var WysiwygWithErrors =
    /*#__PURE__*/
    function (_React$Component) {
      (0, _inherits2["default"])(WysiwygWithErrors, _React$Component);

      function WysiwygWithErrors() {
        (0, _classCallCheck2["default"])(this, WysiwygWithErrors);
        return (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(WysiwygWithErrors).apply(this, arguments));
      }

      (0, _createClass2["default"])(WysiwygWithErrors, [{
        key: "render",
        value: function render() {
          var _this$props = this.props,
              autoFocus = _this$props.autoFocus,
              ...
              validations = _this$props.validations,
              value = _this$props.value,
              rest = (0, _objectWithoutProperties2["default"])(_this$props, ["autoFocus", "className", "deactivateErrorHighlight", "disabled", "error", "inputClassName", "inputDescription", "inputStyle", "label", "name", "onBlur", "onChange", "placeholder", "resetProps", "style", "tabIndex", "validations", "value"]);
          return _react["default"].createElement(_core.Error, {
            inputError: inputError,
            name: name,
            type: "text",
            ...
            return _react["default"].createElement(_Wrapper["default"], {
              ...
              htmlFor: name
            }, label), _react["default"].createElement(_Wysiwyg["default"], (0, _extends2["default"])({}, rest, {
              autoFocus: autoFocus,
              className: inputClassName,
              disabled: disabled,
              deactivateErrorHighlight: deactivateErrorHighlight,
    ...
    var _default = WysiwygWithErrors;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _WysiwygProvider = _interopRequireDefault(__webpack_require__(2066));

    var _WysiwygInlineControls = _interopRequireDefault(__webpack_require__(2067));

    var _WysiwygDropUpload = _interopRequireDefault(__webpack_require__(2081));

    var _WysiwygBottomControls = _interopRequireDefault(__webpack_require__(2083));

    var _WysiwygEditor = _interopRequireDefault(__webpack_require__(1906));

    var _customSelect = _interopRequireDefault(__webpack_require__(2085));

    var _previewControl = _interopRequireDefault(__webpack_require__(2088));

    var _previewWysiwyg = _interopRequireDefault(__webpack_require__(2090));

    var _toggleMode = _interopRequireDefault(__webpack_require__(2098));

    var _constants = __webpack_require__(1862);

    var _helpers = __webpack_require__(2100);

    var _utils = __webpack_require__(2101);

    var _EditorWrapper = _interopRequireDefault(__webpack_require__(2102));
    /**
    *
    * Wysiwyg
    *
    */
    ...
    function (_React$Component) {
      ...
      function Wysiwyg(_props) {
        ...
        _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(Wysiwyg).call(this, _props));
        ...
        (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "addContent", function (content, style) {
          ...
          var newEditorState = _draftJs.EditorState.push(_this.getEditorState(), textWithEntity, 'insert-character'); // Update the parent reducer
        ...
        (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "getSelectedText", function () {
          var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0, _helpers.getOffSets)(_this.getSelection()),
              start = _ref.start,
              end = _ref.end;
        ...
        (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleChangeSelect", function (_ref2) {
          var target = _ref2.target;
        ...
        (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleDragEnter", function (e) {
          e.preventDefault();
          e.stopPropagation();

          if (!_this.state.isDraging) {
            _this.setState({
              isDraging: true
            });
          }
        });
        (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleDragLeave", function () {
          return _this.setState({
            isDraging: false
          });
        });
        (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleDragOver", function (e) {
          e.preventDefault();
          e.stopPropagation();
        });
        ...
        (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handlePastedFiles", function (files) {
          return _this.uploadFile(files);
        });
        ...
        (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "uploadFile", function (files) {
          ...
          var nextBlocks = (0, _utils.getNextBlocksList)(newEditorState, _this.getSelection().getStartKey()); // Loop to update each block after the inserted li

          nextBlocks.map(function (block, index) {
            // Update the current block
            var nextBlockText = index === 0 ? "![Uploading ".concat(files[0].name, "]()") : nextBlocks.get(index - 1).getText();
            var newBlock = (0, _utils.createNewBlock)(nextBlockText, 'unstyled', block.getKey()); // Update the contentState

            var newContentState = _this.createNewContentStateFromBlock(newBlock, newEditorState.getCurrentContent());

            newEditorState = _draftJs.EditorState.push(newEditorState, newContentState);
          });
          var offset = "![Uploading ".concat(files[0].name, "]()").length;
          var updatedSelection = (0, _utils.updateSelection)(_this.getSelection(), nextBlocks, offset);
          ...
          return (0, _strapiHelperPlugin.request)('/upload', {
            method: 'POST',
            headers: headers,
            body: formData
          }, false, false).then(function (response) {
            var nextBlockKey = newEditorState.getCurrentContent().getKeyAfter(newEditorState.getSelection().getStartKey());
            var content = "![text](".concat(response[0].url, ")");

            var newContentState = _this.createNewContentStateFromBlock((0, _utils.createNewBlock)(content, 'unstyled', nextBlockKey));
            ...
            _this.setState({
              editorState: _draftJs.EditorState.undo(_this.getEditorState())
            });
          })["finally"](function () {
            _this.setState({
              isDraging: false
        ...
        (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "renderDrop", function () {
          return _react["default"].createElement(_WysiwygDropUpload["default"], {
      ...
      (0, _createClass2["default"])(Wysiwyg, [{
        ...
        */
        ...
        value: function render() {
          ...
          return _react["default"].createElement(_WysiwygProvider["default"], {
          ...
          }, _react["default"].createElement(_EditorWrapper["default"], {
            ...
            style: editorStyle
          }, this.state.isDraging && this.renderDrop(), _react["default"].createElement("div", {
            className: "controlsContainer"
          }, _react["default"].createElement(_customSelect["default"], null), _constants.CONTROLS.map(function (value, key) {
            return _react["default"].createElement(_WysiwygInlineControls["default"], {
              key: key,
              buttons: value,
          ...
          }), !isFullscreen ? _react["default"].createElement(_toggleMode["default"], {
          ...
          })), isPreviewMode ? _react["default"].createElement(_previewWysiwyg["default"], {
            data: this.props.value
          }) : _react["default"].createElement("div", {
            className: (0, _classnames["default"])('editor', isFullscreen && 'editorFullScreen'),
            onClick: this.focus
          }, _react["default"].createElement(_WysiwygEditor["default"], {
            ...
            tabIndex: "-1"
          })), !isFullscreen && _react["default"].createElement(_WysiwygBottomControls["default"], {
            isPreviewMode: isPreviewMode,
            onClick: this.toggleFullScreen,
            onChange: this.handleDrop
          })), isFullscreen && _react["default"].createElement("div", {
          ...
          }, _react["default"].createElement(_previewControl["default"], {
            onClick: this.toggleFullScreen,
            characters: this.getCharactersNumber()
          }), _react["default"].createElement(_previewWysiwyg["default"], {
            data: this.props.value
          }))));
        }
      }]);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _Wysiwyg = _interopRequireDefault(__webpack_require__(1861));

    function WysiwygProvider(_ref) {
      var children = _ref.children,
          rest = (0, _objectWithoutProperties2["default"])(_ref, ["children"]);
      return _react["default"].createElement(_Wysiwyg["default"].Provider, {
        value: rest
      }, children);
    }
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _Button = _interopRequireDefault(__webpack_require__(2068));

    var _Wrapper = _interopRequireDefault(__webpack_require__(2080));
    /**
    *
    ...
    */
    ...
    var WysiwygInlineControls = function WysiwygInlineControls(_ref) {
      ...
      return _react["default"].createElement(_Wrapper["default"], null, buttons.map(function (type) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _Bold = _interopRequireDefault(__webpack_require__(2069));

    var _Code = _interopRequireDefault(__webpack_require__(2070));

    var _Media = _interopRequireDefault(__webpack_require__(2071));

    var _Italic = _interopRequireDefault(__webpack_require__(2072));

    var _Link = _interopRequireDefault(__webpack_require__(2073));

    var _Ol = _interopRequireDefault(__webpack_require__(2074));

    var _Quote = _interopRequireDefault(__webpack_require__(2075));

    var _Striked = _interopRequireDefault(__webpack_require__(2076));

    var _Ul = _interopRequireDefault(__webpack_require__(2077));

    var _Underline = _interopRequireDefault(__webpack_require__(2078));

    var _StyledButton = _interopRequireDefault(__webpack_require__(2079));
    ...
    var Button = function Button(_ref) {
      ...
      return _react["default"].createElement(_StyledButton["default"], {
        ...
        onClick: handleClick,
        type: type
      }, icons[type] && _react["default"].createElement(Icon, null), !hideLabel && label);
    };
    ...
    Button.propTypes = {
      ...
      className: _propTypes["default"].string,
      disabled: _propTypes["default"].bool,
      handler: _propTypes["default"].string.isRequired,
      handlers: _propTypes["default"].object.isRequired,
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Media = function Media() {
      return _react["default"].createElement("svg", {
        ...
        d: "M9 4.286a1.286 1.286 0 1 0 0-2.572 1.286 1.286 0 0 0 0 2.572z"
      }), _react["default"].createElement("path", {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Striked = function Striked() {
      return _react["default"].createElement("svg", {
        ...
        x: "1",
        y: "11"
      }, "abc")), _react["default"].createElement("path", {
        d: "M.5 6.5h18",
        stroke: "#2C3039",
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Ul = function Ul() {
      return _react["default"].createElement("svg", {
        ...
        fill: "#333740",
        d: "M5 0h8v1H5zM5 2h8v1H5zM5 4h8v1H5zM5 6h8v1H5z"
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _styledComponents = _interopRequireWildcard(__webpack_require__(4));
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _Label = _interopRequireDefault(__webpack_require__(2082));
    /**
    *
    * WysiwygDropUpload
    *
    */
    ...
    var WysiwygDropUpload = function WysiwygDropUpload(props) {
      return _react["default"].createElement(_Label["default"], props, _react["default"].createElement("input", {
        onChange: function onChange() {},
        type: "file",
        tabIndex: "-1"
      }));
    ...
    var _default = WysiwygDropUpload;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _components = __webpack_require__(2084);
    /**
    *
    ...
    */
    ...
    var WysiwygBottomControls = function WysiwygBottomControls(_ref) {
      var isPreviewMode = _ref.isPreviewMode,
          onChange = _ref.onChange,
          onClick = _ref.onClick;

      var browse = _react["default"].createElement(_reactIntl.FormattedMessage, {
        id: "components.WysiwygBottomControls.uploadFiles.browse"
      }, function (message) {
        return _react["default"].createElement(_components.Span, null, message);
      });

      return _react["default"].createElement(_components.Wrapper, null, _react["default"].createElement("div", null, _react["default"].createElement("label", {
        className: "dropLabel",
        onClick: function onClick(e) {
          if (isPreviewMode) {
            e.preventDefault();
    ...
    var _default = WysiwygBottomControls;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    exports.Wrapper = exports.Span = void 0;
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _useWysiwyg2 = _interopRequireDefault(__webpack_require__(2086));

    var _constants = __webpack_require__(1862);

    var _SelectWrapper = _interopRequireDefault(__webpack_require__(2087));
    /**
    *
    *
    * CustomSelect
    ...
    */
    ...
    var CustomSelect = function CustomSelect() {
      var _useWysiwyg = (0, _useWysiwyg2["default"])(),
          isPreviewMode = _useWysiwyg.isPreviewMode,
          headerValue = _useWysiwyg.headerValue,
          isFullscreen = _useWysiwyg.isFullscreen,
          handleChangeSelect = _useWysiwyg.handleChangeSelect;

      return _react["default"].createElement(_SelectWrapper["default"], {
        isFullscreen: isFullscreen
      }, _react["default"].createElement(_strapiHelperPlugin.InputSelect, {
        disabled: isPreviewMode,
        name: "headerSelect",
        onChange: handleChangeSelect,
        value: headerValue,
        selectOptions: _constants.SELECT_OPTIONS
      }));
    };
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var useWysiwyg = function useWysiwyg() {
      return (0, _react.useContext)(_Wysiwyg["default"]);
    };

    var _default = useWysiwyg;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var SelectWrapper = _styledComponents["default"].div(_templateObject(), function (_ref) {
      var isFullScreen = _ref.isFullScreen;
      return isFullScreen ? '161px' : '115px';
    }, function (_ref2) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _PreviewControlWrapper = _interopRequireDefault(__webpack_require__(2089));
    /**
    *
    *
    * PreviewControl
    ...
    */
    ...
    var PreviewControl = function PreviewControl(_ref) {
      var onClick = _ref.onClick;
      return _react["default"].createElement(_PreviewControlWrapper["default"], {
        onClick: onClick
      }, _react["default"].createElement("div", null), _react["default"].createElement("div", {
        className: "wysiwygCollapse"
      }, _react["default"].createElement(_reactIntl.FormattedMessage, {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var PreviewControlWrapper = _styledComponents["default"].div(_templateObject());

    var _default = PreviewControlWrapper;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _converter = _interopRequireDefault(__webpack_require__(2091));

    var _strategies = __webpack_require__(2093);

    var _PreviewWysiwygWrapper = _interopRequireDefault(__webpack_require__(2094));

    var _image = _interopRequireDefault(__webpack_require__(2095));

    var _link = _interopRequireDefault(__webpack_require__(2096));

    var _video = _interopRequireDefault(__webpack_require__(2097));
    /**
    *
    * PreviewWysiwyg
    *
    */
    ...
    var decorator = new _draftJs.CompositeDecorator([{
      strategy: _strategies.findLinkEntities,
      component: _link["default"]
    }, {
      strategy: _strategies.findImageEntities,
      component: _image["default"]
    }, {
      strategy: _strategies.findVideoEntities,
      component: _video["default"]
    }, {
      strategy: _strategies.findAtomicEntities,
      component: _link["default"]
    }]);

    var getBlockSpecForElement = function getBlockSpecForElement(aElement) {
      return {
        contentType: 'link',
        aHref: aElement.href,
    ...
    var elementToBlockSpecElement = function elementToBlockSpecElement(element) {
      return wrapBlockSpec(getBlockSpecForElement(element));
    };
    ...
    var aReplacer = function aReplacer(aElement) {
      return replaceElement(aElement, elementToBlockSpecElement(aElement));
    };

    var createContentBlock = function createContentBlock() {
      var blockData = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      ...
      var blockSpec = {
        ...
        key: key !== null && key !== undefined ? key : (0, _draftJs.genKey)()
      };
      ...
      if (inlineStyles || entityData) {
        ...
        var charData = _draftJs.CharacterMetadata.applyEntity(_draftJs.CharacterMetadata.create({
          style: style,
          entityKey: entityKey
        }), entityKey);
    ...
    function (_React$PureComponent) {
      (0, _inherits2["default"])(PreviewWysiwyg, _React$PureComponent);

      function PreviewWysiwyg() {
        var _getPrototypeOf2;

        var _this;

        (0, _classCallCheck2["default"])(this, PreviewWysiwyg);

        for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }

        _this = (0, _possibleConstructorReturn2["default"])(this, (_getPrototypeOf2 = (0, _getPrototypeOf3["default"])(PreviewWysiwyg)).call.apply(_getPrototypeOf2, [this].concat(args)));
        (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "state", {
          editorState: _draftJs.EditorState.createEmpty(),
          isMounted: false
        });
        (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "previewHTML", function (rawContent) {
          var initHtml = (0, _lodash.isEmpty)(rawContent) ? '<p></p>' : rawContent;
          var html = new DOMParser().parseFromString(_converter["default"].makeHtml(initHtml), 'text/html');
          (0, _lodash.toArray)(html.getElementsByTagName('a')) // Retrieve all the links <a> tags
          .filter(function (value) {
            return value.getElementsByTagName('img').length > 0;
          }) // Filter by checking if they have any <img> children
          ...
          var blocksFromHTML = (0, _draftJs.convertFromHTML)(html.body.innerHTML);

          if (blocksFromHTML.contentBlocks) {
            blocksFromHTML = blocksFromHTML.contentBlocks.reduce(function (acc, block) {
              if (block.getType() === 'blockquote') {
                try {
                  var _JSON$parse = JSON.parse(block.getText()),
                      aHref = _JSON$parse.aHref,
                      aInnerHTML = _JSON$parse.aInnerHTML;
                  ...
                  var entityData = {
                    ...
                    data: {
                      aHref: aHref,
                      aInnerHTML: aInnerHTML
                    }
                  };
                  var blockSpec = Object.assign({
                    type: 'atomic',
                    text: ' ',
                    key: block.getKey()
                  }, {
                  ...
                  var atomicBlock = createContentBlock(blockSpec); // Create an atomic block so we can identify it easily
            ...
            var contentState = _draftJs.ContentState.createFromBlockArray(blocksFromHTML);
      ...
      (0, _createClass2["default"])(PreviewWysiwyg, [{
        key: "componentDidMount",
        value: function componentDidMount() {
        ...
        value: function UNSAFE_componentWillUpdate(nextProps, nextState) {
          ...
          if (nextProps.data !== this.props.data) {
            new Promise(function (resolve) {
              setTimeout(function () {
                if (nextProps.data === _this2.props.data && nextState.isMounted) {
                  ...
                  _this2.previewHTML(nextProps.data);
                }
        ...
        value: function render() {
          ...
          return _react["default"].createElement(_PreviewWysiwygWrapper["default"], {
      ...
      return PreviewWysiwyg;
    }(_react["default"].PureComponent);

    (0, _defineProperty2["default"])(PreviewWysiwyg, "contextType", _Wysiwyg["default"]);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _showdown = _interopRequireDefault(__webpack_require__(2092));
    ...
    var converter = new _showdown["default"].Converter(converterOptions);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    exports.findAtomicEntities = findAtomicEntities;
    exports.findLinkEntities = findLinkEntities;
    exports.findImageEntities = findImageEntities;
    exports.findVideoEntities = findVideoEntities;
    ...
    var isVideoType = function isVideoType(fileName) {
      return /\.(mp4|mpg|mpeg|mov|avi)$/i.test(fileName);
    };
    /***/
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var PreviewWysiwygWrapper = _styledComponents["default"].div(_templateObject(), function (_ref) {
      var isFullscreen = _ref.isFullscreen;
    ...
    var _default = PreviewWysiwygWrapper;
    exports["default"] = _default;
    /***/
  },
    ...
    */
    ...
    var Image = function Image(props) {
      var _props$contentState$g = props.contentState.getEntity(props.entityKey).getData(),
          alt = _props$contentState$g.alt,
          height = _props$contentState$g.height,
          src = _props$contentState$g.src,
          width = _props$contentState$g.width;
    ...
    */
    ...
    var Link = function Link(props) {
      var _props$contentState$g = props.contentState.getEntity(props.entityKey).getData(),
          ...
          aHref = _props$contentState$g.aHref,
          aInnerHTML = _props$contentState$g.aInnerHTML;

      var content = aInnerHTML;

      if ((0, _lodash.includes)(aInnerHTML, '<img', 'src=')) {
        var src = aInnerHTML.split('src="')[1].split('" ')[0];
        var width = (0, _lodash.includes)(aInnerHTML, 'width=') ? aInnerHTML.split('width="')[1].split('" ')[0] : '';
        var height = (0, _lodash.includes)(aInnerHTML, 'height=') ? aInnerHTML.split('height="')[1].split('" ')[0] : '';
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _ToggleModeWrapper = _interopRequireDefault(__webpack_require__(2099));
    /**
    *
    *
    * ToggleMode
    */
    ...
    var ToggleMode = function ToggleMode(props) {
      var label = props.isPreviewMode ? 'components.Wysiwyg.ToggleMode.markdown' : 'components.Wysiwyg.ToggleMode.preview';
      return _react["default"].createElement(_ToggleModeWrapper["default"], null, _react["default"].createElement(_reactIntl.FormattedMessage, {
        id: label
      }, function (msg) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var ToggleModeWrapper = _styledComponents["default"].div(_templateObject());

    var _default = ToggleModeWrapper;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var EditorWrapper = _styledComponents["default"].div(_templateObject(), function (_ref) {
      var isFullscreen = _ref.isFullscreen;
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _AddFieldButton = _interopRequireDefault(__webpack_require__(2105));

    var _DraggedItem = _interopRequireDefault(__webpack_require__(2106));

    var _EmptyComponent = _interopRequireDefault(__webpack_require__(2108));

    var _init = _interopRequireDefault(__webpack_require__(2109));

    var _reducer = _interopRequireWildcard(__webpack_require__(2110));
    ...
    var RepeatableComponent = function RepeatableComponent(_ref) {
      ...
      var _useDataManager = (0, _useDataManager2["default"])(),
          addRepeatableComponentToField = _useDataManager.addRepeatableComponentToField,
          formErrors = _useDataManager.formErrors;
      ...
      var _useReducer = (0, _react.useReducer)(_reducer["default"], _reducer.initialState, function () {
        return (0, _init["default"])(_reducer.initialState, componentValue);
      }),
          _useReducer2 = (0, _slicedToArray2["default"])(_useReducer, 2),
      ...
      var _state$toJS = state.toJS(),
          collapses = _state$toJS.collapses;

      var toggleCollapses = function toggleCollapses(index) {
        dispatch({
      ...
      var hasMinError = (0, _lodash.get)(errorsArray, [0], '').includes('min') && !collapses.some(function (obj) {
        return obj.isOpen === true;
      });
      return _react["default"].createElement("div", null, componentValueLength === 0 && _react["default"].createElement(_EmptyComponent["default"], {
        hasMinError: hasMinError
      }, _react["default"].createElement(_reactIntl.FormattedMessage, {
        id: "".concat(_pluginId["default"], ".components.empty-repeatable")
      }, function (msg) {
        return _react["default"].createElement("p", null, msg);
      })), _react["default"].createElement("div", {
        ref: drop
      }, componentValueLength > 0 && componentValue.map(function (data, index) {
        var componentFieldName = "".concat(name, ".").concat(index);
        var doesPreviousFieldContainErrorsAndIsOpen = componentErrorKeys.includes("".concat(name, ".").concat(index - 1)) && index !== 0 && collapses[index - 1].isOpen === false;
        var hasErrors = componentErrorKeys.includes(componentFieldName);
        return _react["default"].createElement(_DraggedItem["default"], {
          fields: fields,
          ...
          removeCollapse: function removeCollapse() {
            dispatch({
              type: 'REMOVE_COLLAPSE',
              index: index
            });
          },
          moveCollapse: function moveCollapse(dragIndex, hoverIndex) {
            dispatch({
              type: 'MOVE_COLLAPSE',
              dragIndex: dragIndex,
      ...
      })), _react["default"].createElement(_AddFieldButton["default"], {
        hasMinError: hasMinError,
        withBorderRadius: false,
        doesPreviousFieldContainErrorsAndIsClosed: componentValueLength > 0 && componentErrorKeys.includes("".concat(name, ".").concat(componentValueLength - 1)) && collapses[componentValueLength - 1].isOpen === false,
        type: "button",
        onClick: function onClick() {
      ...
      })), hasMinError && _react["default"].createElement(_styles.ErrorMessage, null, _react["default"].createElement(_reactIntl.FormattedMessage, {
    ...
    var _default = RepeatableComponent;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Button = _styledComponents["default"].button(_templateObject(), function (_ref) {
      var doesPreviousFieldContainErrorsAndIsClosed = _ref.doesPreviousFieldContainErrorsAndIsClosed;
      return doesPreviousFieldContainErrorsAndIsClosed ? '#FFA784' : 'rgba(227, 233, 243, 0.75)';
    }, function (_ref2) {
      ...
      var hasMinError = _ref3.hasMinError;
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _reactstrap = __webpack_require__(113);
    ...
    var _Banner = _interopRequireDefault(__webpack_require__(642));

    var _FormWrapper = _interopRequireDefault(__webpack_require__(2107)); // Issues:
    ...
    var DraggedItem = function DraggedItem(_ref) {
      var componentFieldName = _ref.componentFieldName,
          ...
          isOpen = _ref.isOpen,
          moveCollapse = _ref.moveCollapse,
          onClickToggle = _ref.onClickToggle,
          removeCollapse = _ref.removeCollapse,
          schema = _ref.schema,
      ...
      var _useEditView = (0, _useEditView2["default"])(),
          setIsDraggingComponent = _useEditView.setIsDraggingComponent,
          unsetIsDraggingComponent = _useEditView.unsetIsDraggingComponent;

      var mainField = (0, _lodash.get)(schema, ['settings', 'mainField'], 'id');
      var displayedValue = (0, _lodash.get)(modifiedData, [].concat((0, _toConsumableArray2["default"])(componentFieldName.split('.')), [mainField]), null);
      ...
      }, _react["default"].createElement(_FormWrapper["default"], {
        hasErrors: hasErrors,
        isOpen: isOpen
      }, fields.map(function (fieldRow, key) {
        return _react["default"].createElement("div", {
          ...
          var currentField = getField(field.name);
          var isComponent = (0, _lodash.get)(currentField, 'type', '') === 'component';
          var keys = "".concat(componentFieldName, ".").concat(field.name);
    ...
    DraggedItem.defaultProps = {
      ...
      isFirst: false,
      isOpen: false,
      moveCollapse: function moveCollapse() {},
    ...
    DraggedItem.propTypes = {
      ...
      moveCollapse: _propTypes["default"].func,
      onClickToggle: _propTypes["default"].func.isRequired,
      removeCollapse: _propTypes["default"].func.isRequired,
      schema: _propTypes["default"].object.isRequired,
      toggleCollapses: _propTypes["default"].func
    };
    var _default = DraggedItem;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var FormWrapper = _styledComponents["default"].div(_templateObject(), function (_ref) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var EmptyComponent = _styledComponents["default"].div(_templateObject(), function (_ref) {
      var hasMinError = _ref.hasMinError;
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _lodash = __webpack_require__(9); // Initialize all the fields of the component is the isOpen key to false
    // The key will be used to control the open close state of the banner


    function init(initialState, componentValue) {
      return initialState.update('collapses', function (list) {
        if ((0, _lodash.isArray)(componentValue)) {
          return (0, _immutable.fromJS)(componentValue.map(function (_, i) {
            return {
              isOpen: false,
              _temp__id: i
            };
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var getMax = function getMax(arr) {
      ...
      return Math.max.apply(Math, arr.toJS().map(function (o) {
        return o._temp__id;
      }));
    };
    ...
    var reducer = function reducer(state, action) {
      switch (action.type) {
        case 'ADD_NEW_FIELD':
          return state.update('collapses', function (list) {
            return list.map(function (obj) {
              return obj.update('isOpen', function () {
                return false;
              });
            }).push((0, _immutable.fromJS)({
              isOpen: true,
              _temp__id: getMax(list) + 1
            }));
          });

        case 'MOVE_COLLAPSE':
          return state.updateIn(['collapses'], function (list) {
            var oldList = list;
            var newList = list["delete"](action.dragIndex).insert(action.hoverIndex, state.getIn(['collapses', action.dragIndex])); // Fix for
            // https://github.com/react-dnd/react-dnd/issues/1368
            // https://github.com/frontend-collective/react-sortable-tree/issues/490

            if (oldList.size !== newList.size) {
              strapi.notification.error("An error occured while reordering your component's field, please try again");
              return oldList;
            }
          ...
          return state.update('collapses', function (list) {
            return list.map(function (obj, index) {
              if (index === action.index) {
                return obj.update('isOpen', function (v) {
                  return !v;
                });
              }
        ...
        case 'REMOVE_COLLAPSE':
          return state.removeIn(['collapses', action.index]).update('collapses', function (list) {
            return list.map(function (obj) {
              return obj.set('isOpen', false);
            });
          }).update('collapses', function (list) {
            if (action.shouldAddEmptyField) {
              return list.push((0, _immutable.fromJS)({
                isOpen: true
              }));
            }
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var ComponentIcon = _styledComponents["default"].div(_templateObject());
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var ResetComponent = _styledComponents["default"].div(_templateObject());

    var _default = ResetComponent;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Button = (0, _styledComponents["default"])(_PlusButton["default"])(_templateObject(), function (_ref) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var ComponentsPicker = _styledComponents["default"].div(_templateObject(), function (_ref) {
      var isOpen = _ref.isOpen;
      return isOpen && (0, _styledComponents.css)(_templateObject2());
    });

    var _default = ComponentsPicker;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var DynamicZoneWrapper = _styledComponents["default"].div(_templateObject());

    var _default = DynamicZoneWrapper;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Label = _styledComponents["default"].div(_templateObject());
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var RoundCTA = _styledComponents["default"].div(_templateObject());

    var _default = RoundCTA;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var _schema = _interopRequireDefault(__webpack_require__(2124));

    var _createDefaultForm = _interopRequireDefault(__webpack_require__(2125));

    var _getFilesToUpload = _interopRequireDefault(__webpack_require__(2126));

    var _cleanData = _interopRequireDefault(__webpack_require__(2127));

    var _getYupInnerErrors = _interopRequireDefault(__webpack_require__(2128));

    var _init = _interopRequireDefault(__webpack_require__(2129));

    var _reducer = _interopRequireWildcard(__webpack_require__(2130));

    var getRequestUrl = function getRequestUrl(path) {
      return "/".concat(_pluginId["default"], "/explorer/").concat(path);
    };
    ...
    var EditViewDataManagerProvider = function EditViewDataManagerProvider(_ref) {
      ...
      var _useParams = (0, _reactRouterDom.useParams)(),
          id = _useParams.id; // Retrieve the search
      ...
      var _reducerState$toJS = reducerState.toJS(),
          ...
          shouldShowLoadingState = _reducerState$toJS.shouldShowLoadingState,
      ...
      (0, _react.useEffect)(function () {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.prev = 0;
                    _context.next = 3;
                    return (0, _strapiHelperPlugin.request)(getRequestUrl("".concat(slug, "/").concat(id)), {
                      method: 'GET',
                      signal: signal
                    });
                  ...
                  case 7:
                    ...
                    if (_context.t0.code !== 20) {
                      strapi.notification.error("".concat(_pluginId["default"], ".error.record.fetch"));
                    }
        ...
        var componentsDataStructure = Object.keys(allLayoutData.components).reduce(function (acc, current) {
          acc[current] = (0, _createDefaultForm["default"])((0, _lodash.get)(allLayoutData, ['components', current, 'schema', 'attributes'], {}), allLayoutData.components);
          return acc;
        }, {});
        var contentTypeDataStructure = (0, _createDefaultForm["default"])(currentContentTypeLayout.schema.attributes, allLayoutData.components); // Force state to be cleared when navigation from one entry to another
      ...
      var addComponentToDynamicZone = function addComponentToDynamicZone(keys, componentUid) {
      ...
      var addNonRepeatableComponentToField = function addNonRepeatableComponentToField(keys, componentUid) {
        dispatch({
      ...
      var addRelation = function addRelation(_ref3) {
      ...
      var addRepeatableComponentToField = function addRepeatableComponentToField(keys, componentUid) {
        var shouldCheckErrors = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
        dispatch({
          ...
          return _regenerator["default"].wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  dataToSet = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : {};
                  schema = (0, _schema["default"])(currentContentTypeLayout, {
                  ...
                  _context2.prev = 5;
                  _context2.next = 8;
                  return schema.validate(updatedData, {
                    abortEarly: false
                  });
                ...
                case 10:
                  ...
                  errors = (0, _getYupInnerErrors["default"])(_context2.t0);
      ...
      function () {
        ...
        _regenerator["default"].mark(function _callee3(e) {
          var schema, filesToUpload, cleanedData, formData, headers, method, endPoint, error, errors;
          return _regenerator["default"].wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  e.preventDefault(); // Create yup schema
                ...
                case 5:
                  ...
                  cleanedData = (0, _cleanData["default"])((0, _lodash.cloneDeep)(modifiedData), currentContentTypeLayout, allLayoutData.components);
                  formData = new FormData();
                  formData.append('data', JSON.stringify(cleanedData));
                  Object.keys(filesToUpload).forEach(function (key) {
                    var files = filesToUpload[key];
                  ...
                  endPoint = isCreatingEntry ? slug : "".concat(slug, "/").concat(id);
                  emitEvent(isCreatingEntry ? 'willCreateEntry' : 'willEditEntry');
                  _context3.prev = 14;
                  _context3.next = 17;
                  return (0, _strapiHelperPlugin.request)(getRequestUrl(endPoint), {
                    method: method,
                    headers: headers,
                    body: formData,
                    signal: signal
                ...
                case 22:
                  ...
                  error = (0, _lodash.get)(_context3.t0, ['response', 'payload', 'message', '0', 'messages', '0', 'id'], 'SERVER ERROR');
                ...
                case 31:
                  ...
                  errors = (0, _getYupInnerErrors["default"])(_context3.t1);
                  console.error({
                    err: _context3.t1,
                    errors: errors
                  });
      ...
      var moveComponentDown = function moveComponentDown(dynamicZoneName, currentIndex) {
      ...
      var moveComponentUp = function moveComponentUp(dynamicZoneName, currentIndex) {
        emitEvent('changeComponentsOrder');
        dispatch({
      ...
      var moveComponentField = function moveComponentField(pathToComponent, dragIndex, hoverIndex) {
        dispatch({
      ...
      var moveRelation = function moveRelation(dragIndex, overIndex, name) {
        dispatch({
          type: 'MOVE_FIELD',
          dragIndex: dragIndex,
          overIndex: overIndex,
      ...
      var onRemoveRelation = function onRemoveRelation(keys) {
        dispatch({
      ...
      var shouldCheckDZErrors = function shouldCheckDZErrors(dzName) {
      ...
      var removeComponentFromDynamicZone = function removeComponentFromDynamicZone(dynamicZoneName, index) {
      ...
      var removeComponentFromField = function removeComponentFromField(keys, componentUid) {
        dispatch({
      ...
      var removeRepeatableField = function removeRepeatableField(keys, componentUid) {
        dispatch({
      ...
      var setIsSubmitting = function setIsSubmitting() {
      ...
      var showLoader = !isCreatingEntry && isLoading;
      return _react["default"].createElement(_EditViewDataManager["default"].Provider, {
        value: {
      ...
      }, showLoader ? _react["default"].createElement(_strapiHelperPlugin.LoadingIndicatorPage, null) : _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement(_reactRouterDom.Prompt, {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var yup = _interopRequireWildcard(__webpack_require__(253));
    ...
    var getAttributes = function getAttributes(data) {
      return (0, _lodash.get)(data, ['schema', 'attributes'], {});
    };
    ...
    var createYupSchema = function createYupSchema(model, _ref) {
      ...
      return yup.object().shape(Object.keys(attributes).reduce(function (acc, current) {
        ...
        if (attribute.type !== 'relation' && attribute.type !== 'component' && attribute.type !== 'dynamiczone') {
          var formatted = createYupSchemaAttribute(attribute.type, attribute);
        ...
        if (attribute.type === 'component') {
          ...
          if (attribute.repeatable === true) {
            var min = attribute.min,
                max = attribute.max;
            var componentSchema = attribute.required === true ? yup.array().of(componentFieldSchema).defined() : yup.array().of(componentFieldSchema).nullable();

            if (min) {
              componentSchema = yup.lazy(function (array) {
                if (attribute.required) {
                  return yup.array().of(componentFieldSchema).defined().min(min, _strapiHelperPlugin.translatedErrors.min);
                }

                var schema = yup.array().of(componentFieldSchema).nullable();

                if (array && !(0, _lodash.isEmpty)(array)) {
                  schema = schema.min(min, _strapiHelperPlugin.translatedErrors.min);
                }
            ...
            if (max) {
              componentSchema = componentSchema.max(max, _strapiHelperPlugin.translatedErrors.max);
            }

            acc[current] = componentSchema;
            return acc;
          } else {
            var _componentSchema = yup.lazy(function (obj) {
              if (obj !== undefined) {
                return attribute.required === true ? componentFieldSchema.defined() : componentFieldSchema.nullable();
              }
        ...
        if (attribute.type === 'dynamiczone') {
          ...
          if (attribute.required) {
            ...
            if (_min) {
              dynamicZoneSchema = dynamicZoneSchema.min(_min, _strapiHelperPlugin.translatedErrors.min).required(_strapiHelperPlugin.translatedErrors.required);
            }
          } else {
            if (_min) {
    ...
    var createYupSchemaAttribute = function createYupSchemaAttribute(type, validations) {
      var schema = yup.mixed();

      if (['string', 'text', 'richtext', 'email', 'password', 'enumeration'].includes(type)) {
        schema = yup.string();
      }
      ...
      Object.keys(validations).forEach(function (validation) {
        ...
        if (!!validationValue || !(0, _lodash.isBoolean)(validationValue) && Number.isInteger(Math.floor(validationValue)) || validationValue === 0) {
          switch (validation) {
            ...
            case 'regex':
              schema = schema.matches(validationValue, _strapiHelperPlugin.translatedErrors.regex);
              break;
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var createDefaultForm = function createDefaultForm(attributes, allComponentsSchema) {
      return Object.keys(attributes).reduce(function (acc, current) {
        ...
        if (type === 'component') {
          var currentComponentSchema = (0, _lodash.get)(allComponentsSchema, [component, 'schema', 'attributes'], {});
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var getFilesToUpload = function getFilesToUpload(data) {
      var prefix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      return Object.keys(data).reduce(function (acc, current) {
        var currentData = data[current];
        var path = prefix ? "".concat(prefix, ".").concat(current) : current;
        ...
        var hasFiles = function hasFiles(data) {
          return data.some(function (file) {
            return file instanceof File;
          });
        };

        var hasFile = function hasFile(data) {
          return (0, _lodash.get)(data, 0, null) instanceof File;
        };

        if ((0, _lodash.isArray)(currentData) && hasFiles(currentData)) {
          acc[path] = filterFiles(currentData);
        }

        if ((0, _lodash.isObject)(currentData) && !(0, _lodash.isArray)(currentData) && hasFile(currentData)) {
          var currentFile = (0, _lodash.get)(currentData, 0);
          acc[path] = [currentFile];
        }

        if ((0, _lodash.isArray)(currentData) && !hasFiles(currentData)) {
          return _objectSpread({}, acc, {}, getFilesToUpload(currentData, path));
        }
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var cleanData = function cleanData(retrievedData, currentSchema, componentsSchema) {
      ...
      var recursiveCleanData = function recursiveCleanData(data, schema) {
        return Object.keys(data).reduce(function (acc, current) {
          var attrType = getType(schema.schema, current);
          var value = (0, _lodash.get)(data, current);
          var component = getOtherInfos(schema.schema, [current, 'component']);
          var isRepeatable = getOtherInfos(schema.schema, [current, 'repeatable']);
          var cleanedData;
          ...
          switch (attrType) {
            ...
            case 'media':
              if (getOtherInfos(schema.schema, [current, 'multiple']) === true) {
                cleanedData = value ? helperCleanData(value.filter(function (file) {
                  return !(file instanceof File);
                }), 'id') : null;
              } else {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var getYupInnerErrors = function getYupInnerErrors(error) {
      return (0, _lodash.get)(error, 'inner', []).reduce(function (acc, curr) {
    ...
    var _default = getYupInnerErrors;
    exports["default"] = _default;
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var reducer = function reducer(state, action) {
      switch (action.type) {
        ...
        case 'IS_SUBMITTING':
          return state.update('shouldShowLoadingState', function () {
            return action.value;
          });
        ...
        case 'ON_CHANGE':
          {
            ...
            var _action$keys = (0, _slicedToArray2["default"])(action.keys, 1),
                nonRepeatableComponentKey = _action$keys[0];

            if (action.keys.length === 2 && state.getIn(['modifiedData', nonRepeatableComponentKey]) === null) {
              newState = state.updateIn(['modifiedData', nonRepeatableComponentKey], function () {
        ...
        case 'REMOVE_REPEATABLE_FIELD':
          {
            ...
            return state.deleteIn(_componentPathToRemove);
          }
  ...
  function _(module, exports, __webpack_require__) {
    ...
    function EditViewProvider(_ref) {
      var children = _ref.children,
          rest = (0, _objectWithoutProperties2["default"])(_ref, ["children"]);
      return _react["default"].createElement(_EditView["default"].Provider, {
        value: rest
      }, children);
    }
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var Header = function Header() {
      ...
      var _useState3 = (0, _react.useState)(false),
          _useState4 = (0, _slicedToArray2["default"])(_useState3, 2),
          showWarningDelete = _useState4[0],
          setWarningDelete = _useState4[1];
      ...
      var _useDataManager = (0, _useDataManager2["default"])(),
          deleteSuccess = _useDataManager.deleteSuccess,
          initialData = _useDataManager.initialData,
          layout = _useDataManager.layout,
          redirectToPreviousPage = _useDataManager.redirectToPreviousPage,
          resetData = _useDataManager.resetData,
          setIsSubmitting = _useDataManager.setIsSubmitting,
          slug = _useDataManager.slug;

      var currentContentTypeMainField = (0, _lodash.get)(layout, ['settings', 'mainField'], 'id');
      var isCreatingEntry = id === 'create';
      var headerTitle = isCreatingEntry ? formatMessage({
        id: "".concat(_pluginId["default"], ".containers.Edit.pluginHeader.title.new")
      ...
      var getHeaderActions = function getHeaderActions() {
        var headerActions = [{
          ...
          color: 'cancel',
          title: formatMessage({
            id: "".concat(_pluginId["default"], ".containers.Edit.reset")
          }),
          type: 'button',
          style: {
            paddingLeft: 15,
          ...
          return _regenerator["default"].wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 6:
                  strapi.notification.success("".concat(_pluginId["default"], ".success.record.delete"));
                  deleteSuccess();
      ...
      return _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement(_custom.Header, headerProps), _react["default"].createElement(_strapiHelperPlugin.PopUpWarning, {
        isOpen: showWarningCancel,
        toggleModal: toggleWarningCancel,
        content: {
          title: "".concat(_pluginId["default"], ".popUpWarning.title"),
          message: "".concat(_pluginId["default"], ".popUpWarning.warning.cancelAllSettings"),
          cancel: "".concat(_pluginId["default"], ".popUpWarning.button.cancel"),
          confirm: "".concat(_pluginId["default"], ".popUpWarning.button.confirm")
        },
        popUpWarningType: "danger",
        onConfirm: handleConfirmReset
      }), _react["default"].createElement(_strapiHelperPlugin.PopUpWarning, {
        isOpen: showWarningDelete,
        toggleModal: toggleWarningDelete,
        content: {
          title: "".concat(_pluginId["default"], ".popUpWarning.title"),
          message: "".concat(_pluginId["default"], ".popUpWarning.bodyMessage.contentType.delete"),
          cancel: "".concat(_pluginId["default"], ".popUpWarning.button.cancel"),
          confirm: "".concat(_pluginId["default"], ".popUpWarning.button.confirm")
        },
        popUpWarningType: "danger",
  ...
  function _(module, exports, __webpack_require__) {
    ...
    var createAttributesLayout = function createAttributesLayout(currentLayout, attributes) {
      ...
      try {
        for (var _iterator = currentLayout[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var row = _step.value;
  ...
  function _(module, exports, __webpack_require__) {
    ...
    exports.SubWrapper = exports.MainWrapper = exports.LinkWrapper = void 0;
    ...
    var SubWrapper = _styledComponents["default"].div(_templateObject());

    exports.SubWrapper = SubWrapper;
    var MainWrapper = (0, _styledComponents["default"])(SubWrapper)(_templateObject2());
    exports.MainWrapper = MainWrapper;
    var LinkWrapper = (0, _styledComponents["default"])(SubWrapper)(_templateObject3());
    ...
    var reducer = function reducer(state, action) {
      switch (action.type) {
        case 'SET_IS_DRAGGING_COMPONENT':
          return state.update('isDraggingComponent', function () {
            return true;
          });

        case 'SET_LAYOUT_DATA':
          return state.update('formattedContentTypeLayout', function () {
            return (0, _immutable.fromJS)(action.formattedContentTypeLayout);
          });
