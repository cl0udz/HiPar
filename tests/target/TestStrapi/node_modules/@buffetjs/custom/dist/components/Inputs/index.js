...
function Inputs(_ref) {
  var customInputs = _ref.customInputs,
      ...
      value = _ref.value,
      rest = _objectWithoutProperties(_ref, ["customInputs", "description", "error", "id", "label", "name", "onBlur", "onChange", "type", "validations", "value"]);
  ...
  var InputComponent = allInputs[type] || _core.UnknownInput;
  var inputId = id || name;
