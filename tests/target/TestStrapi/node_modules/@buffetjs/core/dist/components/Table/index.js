...
function Table(_ref) {
  ...
  var shouldDisplayEmptyRow = rows.length === 0;
  ...
  }), _react["default"].createElement("tbody", null, withBulkAction && areAllEntriesSelected && _react["default"].createElement(_ActionCollapse["default"], _extends({
    colSpan: colSpan,
    numberOfSelectedEntries: rows.filter(function (row) {
      return row._isChecked === true;
    }).length
  }, bulkActionProps)), shouldDisplayEmptyRow && _react["default"].createElement(_styles.TableRowEmpty, null, _react["default"].createElement("td", {
    colSpan: colSpan
