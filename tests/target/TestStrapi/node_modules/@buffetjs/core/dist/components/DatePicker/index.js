...
var DatePicker = function (_React$PureComponent) {
  ...
  function DatePicker() {
    ...
    _this.handleChange = function (_ref) {
      ...
      _this.timer = setTimeout(function () {
        _this.handleDateChange((0, _moment["default"])(target.value));
      }, _this.props.wait);
    };
    ...
    _this.handleTabClick = function (_ref3) {
  ...
  _createClass(DatePicker, [{
    ...
    value: function render() {
      ...
      var dateValue = date ? (0, _moment["default"])(date).format(displayFormat) : '';
      ...
      return _react["default"].createElement(_styles.DatePicker, {
        className: "".concat(className, " ").concat(visible && 'is-open')
