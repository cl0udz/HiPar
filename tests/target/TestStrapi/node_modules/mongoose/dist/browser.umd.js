 ...
 * ignore
 */
function(t){Object.keys(t.$__.activePaths.states.require).forEach(function(e){var r=t.schema.path(e);null!=r&&"function"==typeof r.originalRequiredValue&&(t.$__.cachedRequired[e]=r.originalRequiredValue.call(t))})}(t);var i=Object.keys(t.$__.activePaths.states.require).filter(function(e){return!(!t.isSelected(e)&&!t.isModified(e))&&(!(e in t.$__.cachedRequired)||t.$__.cachedRequired[e])});for(i=(i=(i=(i=i.concat(Object.keys(t.$__.activePaths.states.init))).concat(Object.keys(t.$__.activePaths.states.modify))).concat(Object.keys(t.$__.activePaths.states.default))).filter(function(e){return!t.schema.singleNestedPaths.hasOwnProperty(e)}),t.ownerDocument||function(){var o=t.$__getAllSubdocs(),s=void 0;r=o.length;var a=t.modifiedPaths();for(e=0;e<r;++e)s=o[e],!t.isModified(s.$basePath,a)||t.isDirectModified(s.$basePath)||t.$isDefault(s.$basePath)||((i=i.filter(function(t){return null!=t&&0!==t.indexOf(s.$basePath+".")})).push(s.$basePath),n[s.$basePath]=!0)}(),r=i.length,e=0;e<r;++e){var o=i[e],s=t.schema.path(o);if(s&&s.$isMongooseArray&&(!s.$isMongooseDocumentArray||O(s,"schemaOptions.required")))a(t.$__getValue(o),i,o)}function a(t,e,r){if(null!=t)for(var n=t.length,i=0;i<n;++i)Array.isArray(t[i])?a(t[i],e,r+"."+i):e.push(r+"."+i)}var u={skipArrays:!0};for(r=i.length,e=0;e<r;++e){var c=i[e];if(t.schema.nested[c]){var l=t.$__getValue(c);B(l)&&(l=l.toObject({transform:!1}));var f=w(l,c,u,t.schema);i=i.concat(Object.keys(f))}}for(r=i.length,e=0;e<r;++e){var h=i[e],p=t.schema.path(h);if(p&&p.$isSchemaMap){var d=t.$__getValue(h);if(null!=d){var y=!0,_=!1,v=void 0;try{for(var m,g=d.keys()[Symbol.iterator]();!(y=(m=g.next()).done);y=!0){var b=m.value;i.push(h+"."+b)}}catch(t){_=!0,v=t}finally{try{!y&&g.return&&g.return()}finally{if(_)throw v}}}}}return[i,n]}
/*!
 * ignore
 */
/*!
