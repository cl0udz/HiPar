 ...
 * ignore
 */
function O(t,e,r){var n=e&&e.minimize,i={},o=void 0;for(var s in t)if(!g.has(s)){var a=w(t[s],e);n&&void 0===a||(o||(o=!0),i[s]=a)}return n&&!r?o&&i:i}function S(t,e){for(var r=[],n=0,i=t.length;n<i;n++)r.push(w(t[n],e,!0));return r}
/*!
 ...
 * `on`, `once`, etc.
 */for(var W in k.each(["on","once","emit","listeners","removeListener","setMaxListeners","removeAllListeners","addListener"],function(t){q.prototype[t]=function(){return this.$__.emitter[t].apply(this.$__.emitter,arguments)}}),q.prototype.constructor=q,s.prototype)q[W]=s.prototype[W];function H(t,e,r,n,i,o,s){for(var a=Object.keys(t.schema.paths),u=a.length,c=0;c<u;++c){var l=void 0,f="",h=a[c];if("_id"!==h||!r)for(var p=t.schema.paths[h],d=h.split("."),y=d.length,_=!1,v=t._doc,m=0;m<y&&null!=v;++m){var g=d[m];if(f+=(f.length?".":"")+g,!0===n){if(f in e)break}else if(!1===n&&e&&!_)if(f in e)_=!0;else if(!i[f])break;if(m===y-1){if(void 0!==v[g])break;if("function"==typeof p.defaultValue){if(!p.defaultValue.$runBeforeSetters&&o)break;if(p.defaultValue.$runBeforeSetters&&!o)break}else if(!o)continue;if(s&&s[f])break;if(e&&null!==n)if(!0===n){if(h in e)continue;void 0!==(l=p.getDefault(t,!1))&&(v[g]=l,t.$__.activePaths.default(h))}else _&&void 0!==(l=p.getDefault(t,!1))&&(v[g]=l,t.$__.activePaths.default(h));else void 0!==(l=p.getDefault(t,!1))&&(v[g]=l,t.$__.activePaths.default(h))}else v=v[g]}}}
/*!
 * ignore
 */
function Y(t){var e=void 0,r=void 0,n={};!
/*!
 * ignore
 */
function(t){Object.keys(t.$__.activePaths.states.require).forEach(function(e){var r=t.schema.path(e);null!=r&&"function"==typeof r.originalRequiredValue&&(t.$__.cachedRequired[e]=r.originalRequiredValue.call(t))})}(t);var i=Object.keys(t.$__.activePaths.states.require).filter(function(e){return!(!t.isSelected(e)&&!t.isModified(e))&&(!(e in t.$__.cachedRequired)||t.$__.cachedRequired[e])});for(i=(i=(i=i.concat(Object.keys(t.$__.activePaths.states.init))).concat(Object.keys(t.$__.activePaths.states.modify))).concat(Object.keys(t.$__.activePaths.states.default)),t.ownerDocument||function(){var o=t.$__getAllSubdocs(),s=void 0;r=o.length;var a=t.modifiedPaths();for(e=0;e<r;++e)s=o[e],!t.isModified(s.$basePath,a)||t.isDirectModified(s.$basePath)||t.$isDefault(s.$basePath)||((i=i.filter(function(t){return null!=t&&0!==t.indexOf(s.$basePath+".")})).push(s.$basePath),n[s.$basePath]=!0)}(),r=i.length,e=0;e<r;++e){var o=i[e],s=t.schema.path(o);if(s&&s.$isMongooseArray&&(!s.$isMongooseDocumentArray||O(s,"schemaOptions.required")))a(t.$__getValue(o),i,o)}function a(t,e,r){if(null!=t)for(var n=t.length,i=0;i<n;++i)Array.isArray(t[i])?a(t[i],e,r+"."+i):e.push(r+"."+i)}var u={skipArrays:!0};for(r=i.length,e=0;e<r;++e){var c=i[e];if(t.schema.nested[c]){var l=t.$__getValue(c);B(l)&&(l=l.toObject({transform:!1}));var f=w(l,c,u,t.schema);i=i.concat(Object.keys(f))}}for(i=i.filter(function(e){return!t.schema.singleNestedPaths.hasOwnProperty(e)}),r=i.length,e=0;e<r;++e){var h=i[e],p=t.schema.path(h);if(p&&p.$isSchemaMap){var d=t.$__getValue(h);if(null!=d){var y=!0,_=!1,v=void 0;try{for(var m,g=d.keys()[Symbol.iterator]();!(y=(m=g.next()).done);y=!0){var b=m.value;i.push(h+"."+b)}}catch(t){_=!0,v=t}finally{try{!y&&g.return&&g.return()}finally{if(_)throw v}}}}}return[i,n]}
/*!
 * ignore
 */
/*!
 ...
 */
function z(t,e,r,n){var i=t.schema,o=Object.keys(i.virtuals),s=o.length,a=s,u=void 0,c=void 0,l=t._doc,f=void 0,h=O(n,"aliases",!0);if(!l)return e;for(r=r||{},s=0;s<a;++s)if(u=o[s],h||!i.aliases.hasOwnProperty(u)){if(c=u,null!=r.path){if(!u.startsWith(r.path+"."))continue;c=u.substr(r.path.length+1)}var p=c.split(".");if(void 0!==(f=T(t.get(u),r))){var d=p.length;l=e;for(var y=0;y<d-1;++y)l[p[y]]=l[p[y]]||{},l=l[p[y]];l[p[d-1]]=f}}return e}
/*!
 * Applies virtuals properties to `json`.
 *
 * @param {Document} self
 ...
 * ignore
 */
m.prototype.clone=function(){var t=Object.assign({},this.options),e=new this.constructor(this.path,t,this.instance);return e.validators=this.validators.slice(),e.requiredValidator=this.requiredValidator,e.getters=this.getters.slice(),e.setters=this.setters.slice(),e},
/*!
 * Module exports.
 */
 ...
 */
P.prototype=Object.create(s.prototype),P.prototype.constructor=P,P.prototype.instanceOfSchema=!0,
/*!
 * ignore
 */
Object.defineProperty(P.prototype,"$schemaType",{configurable:!1,enumerable:!1,writable:!0}),Object.defineProperty(P.prototype,"childSchemas",{configurable:!1,enumerable:!0,writable:!0}),P.prototype.obj,P.prototype.paths,P.prototype.tree,P.prototype.clone=function(){var t=this,e=new P({},this._userProvidedOptions);return e.base=this.base,e.obj=this.obj,e.options=A.clone(this.options),e.callQueue=this.callQueue.map(function(t){return t}),e.methods=A.clone(this.methods),e.methodOptions=A.clone(this.methodOptions),e.statics=A.clone(this.statics),e.query=A.clone(this.query),e.plugins=Array.prototype.slice.call(this.plugins),e._indexes=A.clone(this._indexes),e.s.hooks=this.s.hooks.clone(),e.tree=A.clone(this.tree),e.paths=A.clone(this.paths),e.nested=A.clone(this.nested),e.subpaths=A.clone(this.subpaths),e.singleNestedPaths=A.clone(this.singleNestedPaths),e.childSchemas=
/*!
 * ignore
 */
 ...
 * ignore
 */
function D(t,e){var r=!0,n=!1,i=void 0;try{for(var o,s=Object.keys(t.paths)[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var a=o.value;if(a.includes(".$*"))if(new RegExp("^"+a.replace(/\.\$\*/g,"\\.[^.]+")+"$").test(e))return t.paths[a]}}catch(t){n=!0,i=t}finally{try{!r&&s.return&&s.return()}finally{if(n)throw i}}return null}
/*!
...
/*!
 * ignore
 */C.increment="`increment` should not be used as a schema path name unless you have disabled versioning.",P.prototype.path=function(t,e){var r=
/*!
 * ignore
 */
function(t){return t.replace(/\.\d+\./g,".$.").replace(/\.\d+$/,".$")}(t);if(void 0===e){var n=function(t,e,r){if(t.paths.hasOwnProperty(e))return t.paths[e];if(t.subpaths.hasOwnProperty(r))return t.subpaths[r];if(t.singleNestedPaths.hasOwnProperty(r))return t.singleNestedPaths[r];return null}(this,t,r);if(null!=n)return n;var o=D(this,t);return null!=o?o:null!=(n=this.hasMixedParent(r))?n:/\.\d+\.?.*$/.test(t)?function(t,e){return M(t,e),t.subpaths[e]}(this,t):void 0}if(B[t])throw new Error("`"+t+"` may not be used as a schema pathname");C[t]&&console.log("WARN: "+C[t]),"object"===(void 0===e?"undefined":i(e))&&A.hasUserDefinedProperty(e,"ref")&&$(e.ref,t);var s=t.split(/\./),a=s.pop(),u=this.tree;s.forEach(function(e,r){if(u[e]||(u[e]={}),"object"!==i(u[e])){var n="Cannot set nested path `"+t+"`. Parent path `"+s.slice(0,r).concat([e]).join(".")+"` already set to type "+u[e].name+".";throw new Error(n)}u=u[e]}),u[a]=A.clone(e),this.paths[t]=this.interpretAsType(t,e,this.options);var l=this.paths[t];if(l.$isSchemaMap){var f=t+".$*",h={type:{}};if(A.hasUserDefinedProperty(e,"of"))h=A.isPOJO(e.of)&&Object.keys(e.of).length>0&&!A.hasUserDefinedProperty(e.of,this.options.typeKey)?new P(e.of):e.of;this.paths[f]=this.interpretAsType(f,h,this.options),l.$__schemaType=this.paths[f]}if(l.$isSingleNested){for(var p in l.schema.paths)this.singleNestedPaths[t+"."+p]=l.schema.paths[p];for(var d in l.schema.singleNestedPaths)this.singleNestedPaths[t+"."+d]=l.schema.singleNestedPaths[d];for(var y in l.schema.subpaths)this.singleNestedPaths[t+"."+y]=l.schema.subpaths[y];Object.defineProperty(l.schema,"base",{configurable:!0,enumerable:!1,writable:!1,value:this.base}),l.caster.base=this.base,this.childSchemas.push({schema:l.schema,model:l.caster})}else l.$isMongooseDocumentArray&&(Object.defineProperty(l.schema,"base",{configurable:!0,enumerable:!1,writable:!1,value:this.base}),l.casterConstructor.base=this.base,this.childSchemas.push({schema:l.schema,model:l.casterConstructor}));if(l.$isMongooseArray&&l.caster instanceof c){for(var _=t,v=l,m=[];v.$isMongooseArray;)_+=".$",(v=v.$isMongooseDocumentArray?v.$embeddedSchemaType.clone():v.caster.clone()).path=_,m.push(v);var g=!0,b=!1,w=void 0;try{for(var O,S=m[Symbol.iterator]();!(g=(O=S.next()).done);g=!0){var E=O.value;this.subpaths[E.path]=E}}catch(t){b=!0,w=t}finally{try{!g&&S.return&&S.return()}finally{if(b)throw w}}}if(l.$isMongooseDocumentArray){var j=!0,x=!1,N=void 0;try{for(var k,T=Object.keys(l.schema.paths)[Symbol.iterator]();!(j=(k=T.next()).done);j=!0){var R=k.value;this.subpaths[t+"."+R]=l.schema.paths[R],l.schema.paths[R].$isUnderneathDocArray=!0}}catch(t){x=!0,N=t}finally{try{!j&&T.return&&T.return()}finally{if(x)throw N}}var F=!0,I=!1,L=void 0;try{for(var U,V=Object.keys(l.schema.subpaths)[Symbol.iterator]();!(F=(U=V.next()).done);F=!0){var q=U.value;this.subpaths[t+"."+q]=l.schema.subpaths[q],l.schema.subpaths[q].$isUnderneathDocArray=!0}}catch(t){I=!0,L=t}finally{try{!F&&V.return&&V.return()}finally{if(I)throw L}}var W=!0,H=!1,Y=void 0;try{for(var z,K=Object.keys(l.schema.singleNestedPaths)[Symbol.iterator]();!(W=(z=K.next()).done);W=!0){var Q=z.value;this.subpaths[t+"."+Q]=l.schema.singleNestedPaths[Q],l.schema.singleNestedPaths[Q].$isUnderneathDocArray=!0}}catch(t){H=!0,Y=t}finally{try{!W&&K.return&&K.return()}finally{if(H)throw Y}}}return this},Object.defineProperty(P.prototype,"base",{configurable:!0,enumerable:!1,writable:!0,value:null}),P.prototype.interpretAsType=function(t,e,r){if(e instanceof c)return e;var o=null!=this.base?this.base.Schema.Types:P.Types;if(!(A.isPOJO(e)||e instanceof l)&&"Object"!==A.getFunctionName(e.constructor)){var s=e;(e={})[r.typeKey]=s}var a=!e[r.typeKey]||"type"===r.typeKey&&e.type.type?{}:e[r.typeKey],u=void 0;if(A.isPOJO(a)||"mixed"===a)return new o.Mixed(t,e);if(Array.isArray(a)||Array===a||"array"===a){var f=Array===a||"array"===a?e.cast:a[0];if(f&&f.instanceOfSchema)return new o.DocumentArray(t,f,e);if(f&&f[r.typeKey]&&f[r.typeKey].instanceOfSchema)return new o.DocumentArray(t,f[r.typeKey],e,f);if(Array.isArray(f))return new o.Array(t,this.interpretAsType(t,f,r),e);if("string"==typeof f)f=o[f.charAt(0).toUpperCase()+f.substring(1)];else if(f&&(!f[r.typeKey]||"type"===r.typeKey&&f.type.type)&&A.isPOJO(f)){if(Object.keys(f).length){var h={minimize:r.minimize};r.typeKey&&(h.typeKey=r.typeKey),r.hasOwnProperty("strict")&&(h.strict=r.strict);var p=new P(f,h);return p.$implicitlyCreated=!0,new o.DocumentArray(t,p,e)}return new o.Array(t,o.Mixed,e)}if(f&&(u="string"==typeof(a=!f[r.typeKey]||"type"===r.typeKey&&f.type.type?f:f[r.typeKey])?a:a.schemaName||A.getFunctionName(a),!o.hasOwnProperty(u)))throw new TypeError("Invalid schema configuration: `"+u+"` is not a valid type within the array `"+t+"`.See http://bit.ly/mongoose-schematypes for a list of valid schema types.");return new o.Array(t,f||o.Mixed,e,r)}if(a&&a.instanceOfSchema)return new o.Embedded(a,t,e);if((u=n.isBuffer(a)?"Buffer":"function"==typeof a||"object"===(void 0===a?"undefined":i(a))?a.schemaName||A.getFunctionName(a):null==a?""+a:a.toString())&&(u=u.charAt(0).toUpperCase()+u.substring(1)),"ObjectID"===u&&(u="ObjectId"),null==o[u])throw new TypeError("Invalid schema configuration: `"+u+"` is not a valid type at path `"+t+"`. See http://bit.ly/mongoose-schematypes for a list of valid schema types.");return new o[u](t,e)},P.prototype.eachPath=function(t){for(var e=Object.keys(this.paths),r=e.length,n=0;n<r;++n)t(e[n],this.paths[e[n]]);return this},P.prototype.requiredPaths=function(t){if(this._requiredpaths&&!t)return this._requiredpaths;for(var e=Object.keys(this.paths),r=e.length,n=[];r--;){var i=e[r];this.paths[i].isRequired&&n.push(i)}return this._requiredpaths=n,this._requiredpaths},P.prototype.indexedPaths=function(){return this._indexedpaths?this._indexedpaths:(this._indexedpaths=this.indexes(),this._indexedpaths)},P.prototype.pathType=function(t){var e=t.replace(/\.\d+\./g,".$.").replace(/\.\d+$/,".$");return this.paths.hasOwnProperty(t)?"real":this.virtuals.hasOwnProperty(t)?"virtual":this.nested.hasOwnProperty(t)?"nested":this.subpaths.hasOwnProperty(e)?"real":this.singleNestedPaths.hasOwnProperty(e)?"real":null!=D(this,t)?"real":/\.\d+\.|\.\d+$/.test(t)?M(this,t):"adhocOrUndefined"},P.prototype.hasMixedParent=function(t){var e=t.split(/\./g);t="";for(var r=0;r<e.length;++r)if((t=r>0?t+"."+e[r]:e[r])in this.paths&&this.paths[t]instanceof j.Mixed)return this.paths[t];return null},P.prototype.setupTimestamp=function(t){var e=this.childSchemas.find(function(t){return!!t.schema.options.timestamps});if(t||e){var r=g(t,"createdAt"),n=g(t,"updatedAt"),i={};this.$timestamps={createdAt:r,updatedAt:n},n&&!this.paths[n]&&(i[n]=Date),r&&!this.paths[r]&&(i[r]=Date),this.add(i),this.pre("save",function(t){var e=v(this,"$__.saveOptions.timestamps");if(!1===e)return t();var i=null!=e&&!1===e.updatedAt,o=null!=e&&!1===e.createdAt,s=(this.ownerDocument?this.ownerDocument():this).constructor.base.now(),a=this._id&&this._id.auto;if(!o&&r&&!this.get(r)&&this.isSelected(r)&&this.set(r,a?this._id.getTimestamp():s),!i&&n&&(this.isNew||this.isModified())){var u=s;this.isNew&&(null!=r?u=this.$__getValue(r):a&&(u=this._id.getTimestamp())),this.set(n,u)}t()}),this.methods.initializeTimestamps=function(){return r&&!this.get(r)&&this.set(r,new Date),n&&!this.get(n)&&this.set(n,new Date),this},s[S.builtInMiddleware]=!0;var o={query:!0,model:!1};this.pre("findOneAndUpdate",o,s),this.pre("replaceOne",o,s),this.pre("update",o,s),this.pre("updateOne",o,s),this.pre("updateMany",o,s)}function s(t){var e=this.model.base.now();y(e,r,n,this.getUpdate(),this.options,this.schema),d(e,this.getUpdate(),this.model.schema),t()}},P.prototype.queue=function(t,e){return this.callQueue.push([t,e]),this},P.prototype.pre=function(t){if(t instanceof RegExp){var e=Array.prototype.slice.call(arguments,1),r=!0,n=!1,i=void 0;try{for(var o,s=k[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var a=o.value;t.test(a)&&this.pre.apply(this,[a].concat(e))}}catch(t){n=!0,i=t}finally{try{!r&&s.return&&s.return()}finally{if(n)throw i}}return this}if(Array.isArray(t)){var u=Array.prototype.slice.call(arguments,1),c=!0,l=!1,f=void 0;try{for(var h,p=t[Symbol.iterator]();!(c=(h=p.next()).done);c=!0){var d=h.value;this.pre.apply(this,[d].concat(u))}}catch(t){l=!0,f=t}finally{try{!c&&p.return&&p.return()}finally{if(l)throw f}}return this}return this.s.hooks.pre.apply(this.s.hooks,arguments),this},P.prototype.post=function(t){if(t instanceof RegExp){var e=Array.prototype.slice.call(arguments,1),r=!0,n=!1,i=void 0;try{for(var o,s=k[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var a=o.value;t.test(a)&&this.post.apply(this,[a].concat(e))}}catch(t){n=!0,i=t}finally{try{!r&&s.return&&s.return()}finally{if(n)throw i}}return this}if(Array.isArray(t)){var u=Array.prototype.slice.call(arguments,1),c=!0,l=!1,f=void 0;try{for(var h,p=t[Symbol.iterator]();!(c=(h=p.next()).done);c=!0){var d=h.value;this.post.apply(this,[d].concat(u))}}catch(t){l=!0,f=t}finally{try{!c&&p.return&&p.return()}finally{if(l)throw f}}return this}return this.s.hooks.post.apply(this.s.hooks,arguments),this},P.prototype.plugin=function(t,e){if("function"!=typeof t)throw new Error('First param to `schema.plugin()` must be a function, got "'+(void 0===t?"undefined":i(t))+'"');if(e&&e.deduplicate)for(var r=0;r<this.plugins.length;++r)if(this.plugins[r].fn===t)return this;return this.plugins.push({fn:t,opts:e}),t(this,e),this},P.prototype.method=function(t,e,r){if("string"!=typeof t)for(var n in t)this.methods[n]=t[n],this.methodOptions[n]=A.clone(r);else this.methods[t]=e,this.methodOptions[t]=A.clone(r);return this},P.prototype.static=function(t,e){if("string"!=typeof t)for(var r in t)this.statics[r]=t[r];else this.statics[t]=e;return this},P.prototype.index=function(t,e){return t||(t={}),e||(e={}),e.expires&&A.expires(e),this._indexes.push([t,e]),this},P.prototype.set=function(t,e,r){if(1===arguments.length)return this.options[t];switch(t){case"read":this.options[t]=O(e,r),this._userProvidedOptions[t]=this.options[t];break;case"safe":R(this.options,e),this._userProvidedOptions[t]=this.options[t];break;case"timestamps":this.setupTimestamp(e),this.options[t]=e,this._userProvidedOptions[t]=this.options[t];break;default:this.options[t]=e,this._userProvidedOptions[t]=this.options[t]}return this};
/*!
 * ignore
 */
var R=E.deprecate(function(t,e){t.safe=!1===e?{w:0}:e},"Mongoose: The `safe` option for schemas is deprecated. Use the `writeConcern` option instead: http://bit.ly/mongoose-write-concern");P.prototype.get=function(t){return this.options[t]};var F="2d 2dsphere hashed text".split(" ");
/*!
 * ignore
 */
...
/*!
 * Module dependencies.
 */var n=r(52),i=r(12),o=r(18).EventEmitter,s=r(144),a=r(7),u=r(27),c=r(80),l=r(5),f=r(81),h=r(3),p=r(1),d=r(82),y=r(0).arrayParentSymbol,_=r(0).arrayPathSymbol,v=r(0).documentArrayParent,m=void 0,g=void 0;function b(t,e,r,i){null!=i&&null!=i._id?e=f(e,i):null!=r&&null!=r._id&&(e=f(e,r));var o=w(e,r);o.prototype.$basePath=t,n.call(this,t,o,r),this.schema=e,this.schemaOptions=i||{},this.$isMongooseDocumentArray=!0,this.Constructor=o,o.base=e.base;var s=this.defaultValue;"defaultValue"in this&&void 0===s||this.default(function(){var t=s.call(this);return Array.isArray(t)||(t=[t]),t});var u=this;this.$embeddedSchemaType=new a(t+".$",{required:l(this,"schemaOptions.required",!1)}),this.$embeddedSchemaType.cast=function(t,e,r){return u.cast(t,e,r)[0]},this.$embeddedSchemaType.$isMongooseDocumentArrayElement=!0,this.$embeddedSchemaType.caster=this.Constructor,this.$embeddedSchemaType.schema=this.schema}
/*!
 * Ignore
 */
function w(t,e,n){function i(){g.apply(this,arguments),this.$session(this.ownerDocument().$session())}g||(g=r(24));var s=null!=n?n.prototype:g.prototype;for(var a in i.prototype=Object.create(s),i.prototype.$__setSchema(t),i.schema=t,i.prototype.constructor=i,i.$isArraySubdocument=!0,i.events=new o,t.methods)i.prototype[a]=t.methods[a];for(var u in t.statics)i[u]=t.statics[u];for(var c in o.prototype)i[c]=o.prototype[c];return i.options=e,i}
/*!
 ...
 */
function O(t,e,r){if(r&&e){for(var n=t.path+".",i=Object.keys(e),o=i.length,s={},a=void 0,u=void 0,c=void 0;o--;)if((u=i[o]).startsWith(n)){if("$"===(c=u.substring(n.length)))continue;c.startsWith("$.")&&(c=c.substr(2)),a||(a=!0),s[c]=e[u]}return a&&s||void 0}}
/*!
 * Module exports.
 ...
 */
b.prototype=Object.create(n.prototype),b.prototype.constructor=b,b.prototype.OptionsConstructor=s,b.prototype.discriminator=function(t,e,r){"function"==typeof t&&(t=p.getFunctionName(t));var n=w(e=c(this.casterConstructor,t,e,r),null,this.casterConstructor);n.baseCasterConstructor=this.casterConstructor;try{Object.defineProperty(n,"name",{value:t})}catch(t){}return this.casterConstructor.discriminators[t]=n,this.casterConstructor.discriminators[t]},b.prototype.doValidate=function(t,e,n,i){m||(m=r(16));var o=this;try{a.prototype.doValidate.call(this,t,function(r){if(r)return r.$isArrayValidatorError=!0,e(r);var s=t&&t.length,a=void 0;if(!s)return e();if(i&&i.updateValidator)return e();t.isMongooseDocumentArray||(t=new m(t,o.path,n));function c(t){null!=t&&((a=t)instanceof u||(a.$isArrayValidatorError=!0)),--s||e(a)}for(var l=0,f=s;l<f;++l){var h=t[l];if(null!=h){if(!(h instanceof g)){var p=d(o.casterConstructor,t[l]);h=t[l]=new p(h,t,void 0,void 0,l)}h.$__validate(c)}else--s||e(a)}},n)}catch(t){return t.$isArrayValidatorError=!0,e(t)}},b.prototype.doValidateSync=function(t,e){var r=a.prototype.doValidateSync.call(this,t,e);if(null!=r)return r.$isArrayValidatorError=!0,r;var n=t&&t.length,i=null;if(n){for(var o=0,s=n;o<s;++o){var u=t[o];if(u){if(!(u instanceof g)){var c=d(this.casterConstructor,t[o]);u=t[o]=new c(u,t,void 0,void 0,o)}var l=u.validateSync();l&&null==i&&(i=l)}}return i}},
/*!
 * ignore
 */
b.prototype.getDefault=function(t){var e="function"==typeof this.defaultValue?this.defaultValue.call(t):this.defaultValue;if(null==e)return e;m||(m=r(16)),Array.isArray(e)||(e=[e]);var n=(e=new m(e,this.path,t))[y];e[y]=null;for(var i=0;i<e.length;++i){var o=d(this.casterConstructor,e[i]);e[i]=new o(e[i],e,void 0,void 0,i)}return e[y]=n,e},b.prototype.cast=function(t,e,n,o,s){m||(m=r(16));var a=void 0,u=void 0,c=void 0,l={transform:!1,virtuals:!1};if(!Array.isArray(t)){if(!n&&!b.options.castNonArrays)throw new i("DocumentArray",h.inspect(t),this.path,null,this);return e&&n&&e.markModified(this.path),this.cast([t],e,n,o)}for(t&&t.isMongooseDocumentArray||s&&s.skipDocumentArrayCast?t&&t.isMongooseDocumentArray&&(t=new m(t,this.path,e)):t=new m(t,this.path,e),c=t.length;c--;)if(t[c]){var f=d(this.casterConstructor,t[c]);if(!t[c].$__||t[c]instanceof f&&t[c][v]===e||(t[c]=t[c].toObject({transform:!1,virtuals:t[c].schema===f.schema})),t[c]instanceof g)null==t[c].__index&&t[c].$setIndex(c);else if(null!=t[c])if(n)e?a||(a=O(this,e.$__.selected,n)):a=!0,u=new f(null,t,!0,a,c),t[c]=u.init(t[c]);else if(o&&"function"==typeof o.id&&(u=o.id(t[c]._id)),o&&u&&p.deepEqual(u.toObject(l),t[c]))u.set(t[c]),t[c]=u;else try{u=new f(t[c],t,void 0,void 0,c),t[c]=u}catch(e){var y=h.inspect(t[c]);throw new i("embedded",y,t[_],e,this)}}return t},
/*!
 * ignore
 */
b.prototype.clone=function(){var t=Object.assign({},this.options),e=new this.constructor(this.path,this.schema,t,this.schemaOptions);return e.validators=this.validators.slice(),e.Constructor.discriminators=Object.assign({},this.Constructor.discriminators),e},t.exports=b},function(t,e,r){"use strict";var n=r(9),i=function(t){function e(){return function(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}(this,e),function(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}(this,(e.__proto__||Object.getPrototypeOf(e)).apply(this,arguments))}return function(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}(e,n),e}(),o=r(10);Object.defineProperty(i.prototype,"enum",o),
/*!
 * ignore
 */
t.exports=i},function(t,e,r){"use strict";
