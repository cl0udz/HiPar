...
DuplicatePackageCheckerPlugin.prototype.apply = function (compiler) {
  ...
  compiler.hooks.emit.tapAsync("DuplicatePackageCheckerPlugin", function (compilation, callback) {
    ...
    compilation.modules.forEach(function (module) {
      ...
      if (!isSeen) {
        ...
        var issuer = module.issuer && module.issuer.resource ? cleanPathRelativeToContext(module.issuer.resource) : null;
        entry.issuer = issuer;
    ...
    if (duplicateCount) {
      ...
      sortedDuplicateKeys.map(function (name) {
        ...
        instances = instances.map(function (version) {
          var str = chalk.green.bold(version.version) + " " + chalk.white.bold(version.path);
