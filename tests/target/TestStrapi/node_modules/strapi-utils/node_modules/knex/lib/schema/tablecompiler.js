...
TableCompiler.prototype.getColumnTypes = columns => (0, _lodash.reduce)((0, _lodash.map)(columns, _lodash.first), function (memo, column) {
...
TableCompiler.prototype.columnQueries = function (columns) {
  const queries = (0, _lodash.reduce)((0, _lodash.map)(columns, _lodash.tail), function (memo, column) {
...
TableCompiler.prototype.addColumns = function (columns, prefix) {
  ...
  if (columns.sql.length > 0) {
    const columnSql = (0, _lodash.map)(columns.sql, column => {
...
TableCompiler.prototype.dropColumn = function () {
  ...
  const drops = (0, _lodash.map)((0, _lodash.isArray)(columns) ? columns : [columns], column => {
