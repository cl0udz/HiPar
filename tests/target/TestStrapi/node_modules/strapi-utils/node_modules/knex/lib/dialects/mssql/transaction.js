...
class Transaction_MSSQL extends _transaction.default {
  begin(conn) {
  ...
  savepoint(conn) {
    ...
    return _bluebird.default.resolve().then(() => this.query(conn, `SAVE TRANSACTION ${this.txid}`));
  }
  ...
  rollbackTo(conn, error) {
    ...
    return _bluebird.default.resolve().then(() => this.query(conn, `ROLLBACK TRANSACTION ${this.txid}`, 2, error)).then(() => this._rejecter(error));
