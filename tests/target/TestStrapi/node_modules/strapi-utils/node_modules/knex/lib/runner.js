...
(0, _lodash.assign)(Runner.prototype, {
  ...
  query: _bluebird.default.method(function (obj) {
    ...
    return queryPromise.then(resp => this.client.processResponse(resp, runner)).then(processedResponse => {
      ...
      this.builder.emit('query-response', postProcessedResponse, (0, _lodash.assign)({
        __knexUid: this.connection.__knexUid
      }, obj), this.builder);
      this.client.emit('query-response', postProcessedResponse, (0, _lodash.assign)({
        __knexUid: this.connection.__knexUid
      }, obj), this.builder);
      ...
      this.builder.emit('query-error', error, (0, _lodash.assign)({
        __knexUid: this.connection.__knexUid
      }, obj));
      throw error;
    });
