...
(0, _lodash.assign)(Builder.prototype, {
  ...
  whereRaw(sql, bindings) {
    const raw = sql instanceof _raw.default ? sql : this.client.raw(sql, bindings);
  ...
  _union(clause, args) {
    ...
    if (args.length === 1 || args.length === 2 && (0, _lodash.isBoolean)(wrap)) {
      ...
      callbacks = (0, _lodash.toArray)(args).slice(0, args.length - 1);
