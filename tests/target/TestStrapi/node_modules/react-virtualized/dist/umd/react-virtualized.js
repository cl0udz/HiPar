...
!function(global, factory) {
 ...
 // eslint-disable-line no-new-wrappers
   ...
   */
    ...
    function toVal(mix) {
        var k, y, str = "";
        if (mix) if ("object" == typeof mix) for (k in mix) mix[k] && (y = toVal(mix.push ? mix[k] : k)) && (str && (str += " "), 
        str += y); else "boolean" != typeof mix && (str && (str += " "), str += mix);
        return str;
    }
    function clsx() {
    ...
    var InfiniteLoader = function(_React$PureComponent) {
        ...
        return inherits(InfiniteLoader, _React$PureComponent), createClass(InfiniteLoader, [ {
            ...
            value: function(startIndex, stopIndex) {
                var _ref2, _this3 = this, _props = this.props, isRowLoaded = _props.isRowLoaded, minimumBatchSize = _props.minimumBatchSize, rowCount = _props.rowCount, threshold = _props.threshold, unloadedRanges = function(_ref5) {
                ...
                }), squashedUnloadedRanges = (_ref2 = []).concat.apply(_ref2, function(arr) {
    ...
    var List = function(_React$PureComponent) {
        ...
        return inherits(List, _React$PureComponent), createClass(List, [ {
            ...
            key: "render",
            value: function() {
                var _props = this.props, className = _props.className, noRowsRenderer = _props.noRowsRenderer, scrollToIndex = _props.scrollToIndex, width = _props.width, classNames = clsx("ReactVirtualized__List", className);
    ...
    var Table = function(_React$PureComponent) {
        ...
        return inherits(Table, _React$PureComponent), createClass(Table, [ {
            ...
            value: function(_ref6) {
                ...
                }), className = clsx("ReactVirtualized__Table__row", rowClass), flattenedStyle = _extends({}, style, {
