...
function add(dirtyDate, duration) {
  ...
  var dateWithMonths = (0, _index2.default)((0, _index3.default)(dirtyDate), months + years * 12); // Add days

  var dateWithDays = (0, _index.default)(dateWithMonths, days); // Add days, hours, minutes and seconds
