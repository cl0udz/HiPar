...
function sub(dirtyDate, duration) {
  ...
  var dateWithoutMonths = (0, _index2.default)((0, _index3.default)(dirtyDate), months + years * 12); // Subtract days

  var dateWithoutDays = (0, _index.default)(dateWithoutMonths, days); // Subtract hours, minutes and seconds
