...
var INSTANCE_SERVER = 'area'; //The instance map, key is instanceId, value is serverId

var instances = {}; //All the instance servers
...
exp.getInstance = function (args, cb) {
  //The key of instance
  var instanceId = args.areaId + '_' + args.id; //If the instance exist, return the instance
  ...
  var app = pomelo.app; //Allocate a server id

  var serverId = getServerId(); //rpc invoke
