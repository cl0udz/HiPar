...
pro.doAction = function () {
  ...
  if (res.result === consts.AttackResult.SUCCESS || res.result === consts.AttackResult.KILLED || res.result === consts.AttackResult.MISS || res.result === consts.AttackResult.NOT_COOLDOWN) {
