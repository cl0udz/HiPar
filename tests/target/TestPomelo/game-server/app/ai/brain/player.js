...
var Brain = function Brain(blackboard) {
  ...
  action.addChild(talkToNpc); //composite them together
...
var genAttackAction = function genAttackAction(blackboard) {
...
var genPickAction = function genPickAction(blackboard) {
...
var genNpcAction = function genNpcAction(blackboard) {
