...
var HELLO_WORLD = Buffer.from && Buffer.from !== Uint8Array.from ? Buffer.from('hello world') : new Buffer('hello world');
...
tape('reset writable / readable', function (t) {
  ...
  var toUpperCase = function toUpperCase(data, enc, cb) {
