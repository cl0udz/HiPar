...
exports = module.exports = function directory(root, options) {
  ...
  return function directory(req, res, next) {
    var accept = req.headers.accept || 'text/plain',
        ...
        showUp = path != root && path != root + '/'; // null byte(s)

    if (~path.indexOf('\0')) return utils.badRequest(res); // malicious path

    if (0 != path.indexOf(root)) return utils.forbidden(res); // check if we have a directory
