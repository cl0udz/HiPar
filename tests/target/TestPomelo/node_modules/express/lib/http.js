...
app.init = function (middleware) {
  ...
  this.errorHandlers = [];
  this.set('env', process.env.NODE_ENV || 'development'); // expose objects to each other
  ...
  this.use(function (req, res, next) {
    ...
    req.res = res;
    res.req = req;
    req.next = next; // assign req.query
  ...
  if (middleware) middleware.forEach(self.use.bind(self)); // router
  ...
  this.on('listening', this.registerErrorHandlers.bind(this)); // route manipulation methods
...
app.use = function (route, middleware) {
  ...
  if (middleware.handle && middleware.set) app = middleware; // restore .app property on req and res
  ...
  connect.HTTPServer.prototype.use.call(this, route, middleware); // mounted an app, invoke the hook
...
app.param = function (name, fn) {
  var self = this,
      fns = [].slice.call(arguments, 1); // array
