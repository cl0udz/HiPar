...
/* bignumber.js v9.0.0 https://github.com/MikeMcl/bignumber.js/LICENCE */
...
!function (e) {
  ...
  (r = function e(r) {
    ...
    function B(e, r) {
      ...
      if (null == r) {
        if (e && !0 === e._isBigNumber) return c.s = e.s, void (!e.c || e.e > y ? c.c = c.e = null : e.e < m ? c.c = [c.e = 0] : (c.e = e.e, c.c = e.c.slice()));
        ...
        -1 < (o = l.indexOf(".")) && (l = l.replace(".", "")), 0 < (s = l.search(/e/i)) ? (o < 0 && (o = s), o += +l.slice(s + 1), l = l.substring(0, s)) : o < 0 && (o = l.length);
      } else {
    ...
    function i(e, r, n, t) {
      ...
      if (i = e.c[0], s = e.e, null == r) u = $(e.c), u = 1 == t || 2 == t && (s <= p || d <= s) ? W(u, s) : X(u, s, "0");else if (o = (e = D(new B(e), r, n)).e, f = (u = $(e.c)).length, 1 == t || 2 == t && (r <= o || o <= p)) {
        for (; f < r; u += "0", f++) {
          ;
        }
    ...
    function _(e, r, n) {
      ...
      return (n = t + n * M - 1) > y ? e.c = e.e = null : e.c = n < m ? [e.e = 0] : (e.e = n, r), e;
    }
    ...
    function D(e, r, n, t) {
      ...
      if (a) {
        e: {
          ...
          if (t = t || r < 0 || null != a[l + 1] || (s < 0 ? u : u % h[i - s - 1]), t = n < 4 ? (c || t) && (0 == n || n == (e.s < 0 ? 3 : 2)) : 5 < c || 5 == c && (4 == n || t || 6 == n && (0 < o ? 0 < s ? u / h[i - s] : 0 : a[l - 1]) % 10 & 1 || n == (e.s < 0 ? 8 : 7)), r < 1 || !a[0]) return a.length = 0, t ? (r -= e.e + 1, a[0] = h[(M - r % M) % M], e.e = -r || 0) : a[0] = e.e = 0, e;
    ...
    return B.clone = e, B.ROUND_UP = 0, B.ROUND_DOWN = 1, B.ROUND_CEIL = 2, B.ROUND_FLOOR = 3, B.ROUND_HALF_UP = 4, B.ROUND_HALF_DOWN = 5, B.ROUND_HALF_EVEN = 6, B.ROUND_HALF_CEIL = 7, B.ROUND_HALF_FLOOR = 8, B.EUCLID = 9, B.config = B.set = function (e) {
      ...
      if (null != e) {
        if ("object" != _typeof(e)) throw Error(I + "Object expected: " + e);
        if (e.hasOwnProperty(r = "DECIMAL_PLACES") && (H(n = e[r], 0, q, r), N = n), e.hasOwnProperty(r = "ROUNDING_MODE") && (H(n = e[r], 0, 8, r), O = n), e.hasOwnProperty(r = "EXPONENTIAL_AT") && ((n = e[r]) && n.pop ? (H(n[0], -q, 0, r), H(n[1], 0, q, r), p = n[0], d = n[1]) : (H(n, -q, q, r), p = -(d = n < 0 ? -n : n))), e.hasOwnProperty(r = "RANGE")) if ((n = e[r]) && n.pop) H(n[0], -q, -1, r), H(n[1], 1, q, r), m = n[0], y = n[1];else {
        ...
        if (e.hasOwnProperty(r = "CRYPTO")) {
          ...
          if (n) {
            if ("undefined" == typeof crypto || !crypto || !crypto.getRandomValues && !crypto.randomBytes) throw b = !n, Error(I + "crypto unavailable");
            b = n;
          } else b = n;
        }
        ...
        if (e.hasOwnProperty(r = "MODULO_MODE") && (H(n = e[r], 0, 9, r), o = n), e.hasOwnProperty(r = "POW_PRECISION") && (H(n = e[r], 0, q, r), E = n), e.hasOwnProperty(r = "FORMAT")) {
          if ("object" != _typeof(n = e[r])) throw Error(I + r + " not an object: " + n);
          A = n;
        }
      ...
      if (null == e ? e = N : H(e, 0, q), i = L(e / M), b) if (crypto.getRandomValues) {
        ...
        for (r = crypto.randomBytes(i *= 7); s < i;) {
          9e15 <= (o = 281474976710656 * (31 & r[s]) + 1099511627776 * r[s + 1] + 4294967296 * r[s + 2] + 16777216 * r[s + 3] + (r[s + 4] << 16) + (r[s + 5] << 8) + r[s + 6]) ? crypto.randomBytes(7).copy(r, s) : (f.push(o % 1e14), s += 7);
        }
      ...
      return function (e, r, n, t, i) {
        ...
        if (g < 0 ? --f : (c.c = a, c.e = f, c.s = t, a = (c = v(c, h, p, w, n)).c, l = c.r, f = c.e), g = a[s = f + p + 1], u = n / 2, l = l || s < 0 || null != a[s + 1], l = w < 4 ? (null != g || l) && (0 == w || w == (c.s < 0 ? 3 : 2)) : u < g || g == u && (4 == w || l || 6 == w && 1 & a[s - 1] || w == (c.s < 0 ? 8 : 7)), s < 1 || !a[0]) e = l ? X(o.charAt(1), -p, o.charAt(0)) : o.charAt(0);else {
          if (a.length = s, l) for (--n; ++a[--s] > n;) {
      ...
      function S(e, r, n) {
        ...
        for (e = e.slice(); u--;) {
          f = ((i = l * (o = e[u] % F) + (t = c * o + (s = e[u] / F | 0) * l) % F * F + f) / n | 0) + (t / F | 0) + c * s, e[u] = i % n;
        }
      ...
      function R(e, r, n, t) {
        var i, o;
        if (n != t) o = t < n ? 1 : -1;else for (i = o = 0; i < n; i++) {
          if (e[i] != r[i]) {
            o = e[i] > r[i] ? 1 : -1;
            break;
          }
      ...
      return function (e, r, n, t, i) {
        ...
        for (g = (h = new B(b)).c = [], b = n + (s = e.e - r.e) + 1, i || (i = C, s = j(e.e / M) - j(r.e / M), b = b / M | 0), f = 0; A[f] == (E[f] || 0); f++) {
          ;
        }
        ...
        if (A[f] > (E[f] || 0) && s--, b < 0) g.push(1), u = !0;else {
          ...
          do {
            if (l = 0, (o = R(A, p, O, w)) < 0) {
              if (d = p[0], O != w && (d = d * i + (p[1] || 0)), 1 < (l = U(d / N))) for (i <= l && (l = i - 1), a = (c = S(A, l, i)).length, w = p.length; 1 == R(c, p, a, w);) {
                l--, _(c, O < a ? y : A, a, i), a = c.length, o = 1;
              } else 0 == l && (o = l = 1), a = (c = A.slice()).length;
              if (a < w && (c = [0].concat(c)), _(p, c, w, i), w = p.length, -1 == o) for (; R(A, p, O, w) < 1;) {
    ...
    }(), s = /^(-?)0([xbo])(?=\w[\w.]*$)/i, f = /^([^.]+)\.$/, u = /^\.([^.]+)$/, c = /^-?(Infinity|NaN)$/, g = /^\s*\+(?=[\w.])|^\s+|\s+$/g, h = function h(e, r, n, t) {
      var i,
          o = n ? r : r.replace(g, "");
      ...
      if (null != r && (r = new B(r)), s = 14 < e.e, !c.c || !c.c[0] || 1 == c.c[0] && !c.e && 1 == c.c.length || !e.c || !e.c[0]) return l = new B(Math.pow(+P(c), s ? 2 - V(e) : +P(e))), r ? l.mod(r) : l;

      if (f = e.s < 0, r) {
        if (r.c ? !r.c[0] : !r.s) return new B(NaN);
        (t = !f && c.isInteger() && r.isInteger()) && (c = c.mod(r));
      } else {
        if (9 < e.e && (0 < c.e || c.e < -1 || (0 == c.e ? 1 < c.c[0] || s && 24e7 <= c.c[1] : c.c[0] < 8e13 || s && c.c[0] <= 9999975e7))) return o = c.s < 0 && V(e) ? -0 : 0, -1 < c.e && (o = 1 / o), new B(f ? 1 / o : o);
        E && (o = L(E / M + 2));
      }

      for (u = s ? (n = new B(.5), f && (e.s = 1), V(e)) : (i = Math.abs(+P(e))) % 2, l = new B(w);;) {
        if (u) {
      ...
      if (u = j(u), l = j(l), c = c.slice(), f = u - l) {
        ...
        i.reverse();
      } else for (t = (o = (f = c.length) < (r = a.length)) ? f : r, f = r = 0; r < t; r++) {
        if (c[r] != a[r]) {
          o = c[r] < a[r];
          break;
        }
      ...
      var n,
          t,
          i = this;
      return e = new B(e, r), !i.c || !e.s || e.c && !e.c[0] ? new B(NaN) : !e.c || i.c && !i.c[0] ? new B(i) : (9 == o ? (t = e.s, e.s = 1, n = v(i, e, 0, 3), e.s = t, n.s *= t) : n = v(i, e, 0, o), (e = i.minus(n.times(e))).c[0] || 1 != o || (e.s = i.s), e);
      ...
      var n,
          ...
          v = m.c,
          N = (e = new B(e, r)).c;
      if (!(v && N && v[0] && N[0])) return !m.s || !e.s || v && !v[0] && !N || N && !N[0] && !v ? e.c = e.e = e.s = null : (e.s *= m.s, v && N ? (e.c = [0], e.e = 0) : e.c = e.e = null), e;

      for (t = j(m.e / M) + j(e.e / M), e.s *= m.s, (u = v.length) < (a = N.length) && (p = v, v = N, N = p, i = u, u = a, a = i), i = u + a, p = []; i--; p.push(0)) {
        ;
      }

      for (w = C, d = F, i = a; 0 <= --i;) {
        for (n = 0, h = N[i] % d, g = N[i] / d | 0, o = i + (s = u); i < o;) {
          n = ((l = h * (l = v[--s] % d) + (f = g * l + (c = v[s] / d | 0) * h) % d * d + p[o] + n) / w | 0) + (f / d | 0) + g * c, p[o--] = l % w;
        }
      ...
      for ((i = f.length) - (r = u.length) < 0 && (n = u, u = f, f = n, r = i), i = 0; r;) {
        i = (f[--r] = f[r] + u[r] + i) / C | 0, f[r] = C === f[r] ? 0 : f[r] % C;
      }
      ...
      if ((n = 0 == (f = Math.sqrt(+P(o))) || f == 1 / 0 ? (((r = $(s)).length + u) % 2 == 0 && (r += "0"), f = Math.sqrt(+r), u = j((u + 1) / 2) - (u < 0 || u % 2), new B(r = f == 1 / 0 ? "1e" + u : (r = f.toExponential()).slice(0, r.indexOf("e") + 1) + u)) : new B(f + "")).c[0]) for ((f = (u = n.e) + l) < 3 && (f = 0);;) {
        if (i = n, n = c.times(i.plus(v(o, i, l, 1))), $(i.c).slice(0, f) === (r = $(n.c)).slice(0, f)) {
      ...
      var t;
      if (null == n) null != e && r && "object" == _typeof(r) ? (n = r, r = null) : e && "object" == _typeof(e) ? (n = e, e = r = null) : n = A;else if ("object" != _typeof(n)) throw Error(I + "Argument not an object: " + n);
      ...
      for (r = new B(w), l = n = new B(w), t = u = new B(w), h = $(p), o = r.e = h.length - g.e - 1, r.c[0] = k[(s = o % M) < 0 ? M + s : s], e = !e || 0 < f.comparedTo(r) ? 0 < o ? r : l : f, s = y, y = 1 / 0, f = new B(h), u.c[0] = 0; c = v(f, r, 0, 1), 1 != (i = n.plus(c.times(t))).comparedTo(e);) {
        n = t, t = i, l = u.plus(c.times(i = l)), u = i, r = f.minus(c.times(i = r)), f = i;
      }

      return i = v(e.minus(n), t, 0, 1), u = u.plus(i.times(l)), n = n.plus(i.times(t)), u.s = l.s = g.s, a = v(l, t, o *= 2, O).minus(g).abs().comparedTo(v(u, n, o, O).minus(g).abs()) < 1 ? [l, t] : [u, n], y = s, a;
    }, t.toNumber = function () {
      return +P(this);
      ...
      var r,
          ...
          t = n.s,
          i = n.e;
      return null === i ? t ? (r = "Infinity", t < 0 && (r = "-" + r)) : r = "NaN" : (r = null == e ? i <= p || d <= i ? W($(n.c), i) : X($(n.c), i, "0") : 10 === e ? X($((n = D(new B(n), N + i + 1, O)).c), n.e, "0") : (H(e, 2, S.length, "Base"), a(X($(n.c), i, "0"), 10, e, t, !0)), t < 0 && n.c[0] && (r = "-" + r)), r;
