...
var ChatService = function ChatService(app) {
  this.app = app;
  this.uidMap = {};
  this.nameMap = {};
  this.channelMap = {};
...
var checkDuplicate = function checkDuplicate(service, uid, channelName) {
...
var addRecord = function addRecord(service, uid, name, sid, channelName) {
  var record = {
    uid: uid,
    name: name,
    sid: sid
...
var removeRecord = function removeRecord(service, uid, channelName) {
...
var clearRecords = function clearRecords(service, uid) {
...
var getSidByUid = function getSidByUid(uid, app) {
