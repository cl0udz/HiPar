...
var MobZone = function MobZone(opts) {
  Zone.call(this, opts);
  this.area = opts.area;
...
var genPatrolPath = function genPatrolPath(mob) {
...
var genPoint = function genPoint(map, originX, originY, count) {
  count = count || 0;
...
var checkPoint = function checkPoint(map, ox, oy, dx, dy) {
