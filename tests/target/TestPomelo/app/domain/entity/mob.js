...
var Mob = function Mob(opts) {
  ...
  this.zoneId = opts.zoneId; // override the character hp calculate value
...
Mob.prototype.onPlayerCome = function (entityId) {
  var player = this.area.getEntity(entityId); //Only hit a live person
