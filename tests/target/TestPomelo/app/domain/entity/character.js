...
var Character = function Character(opts) {
  Entity.call(this, opts);
  this.orientation = opts.orientation;
  this.target = null;
  this.attackers = {}; // the entity who hate me
  // I would notify my enemies to forget me when I disapear or die

  this.enemies = {}; // the entity I hate
...
Character.prototype.attack = function (target, skillId) {
  ...
  this.setTarget(target.entityId); // set up the relationship between attacker and attackee
