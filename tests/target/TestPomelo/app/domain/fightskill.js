...
var attack = function attack(attacker, target, skill) {
...
var addBuff = function addBuff(attacker, target, buff) {
...
var FightSkill = function FightSkill(opts) {
...
FightSkill.prototype.judge = function (attacker, target) {
  if (!formula.inRange(attacker, target, this.skillData.distance)) {
    return {
      ...
      distance: this.skillData.distance
    };
  }
  ...
  if (this.mp < this.mp) {
    return {
      result: consts.AttackResult.NO_ENOUGH_MP
    };
  }
...
var AttackSkill = function AttackSkill(opts) {
  FightSkill.call(this, opts);
};

util.inherits(AttackSkill, FightSkill); // Attack
...
var BuffSkill = function BuffSkill(opts) {
  FightSkill.call(this, opts);
  this.buff = opts.buff;
};
...
var AttackBuffSkill = function AttackBuffSkill(opts) {
  FightSkill.call(this, opts);
...
var PassiveSkill = function PassiveSkill(opts) {
  BuffSkill.call(this, opts);
};

util.inherits(PassiveSkill, BuffSkill);

var CommonAttackSkill = function CommonAttackSkill(opts) {
