...
var sync = require('pomelo-sync-plugin'); // var masterhaPlugin = require('pomelo-masterha-plugin');
...
app.configure('production|development', function () {
  ...
  require('./app/util/httpServer'); //var sceneInfo = require('./app/modules/sceneInfo');
...
app.configure('production|development', 'area', function () {
  ...
  app.before(playerFilter()); //Load scene server and instance server
...
app.configure('production|development', 'area|auth|connector|master', function () {
  ...
  app.set('dbclient', dbclient); // app.load(pomelo.sync, {path:__dirname + '/app/dao/mapping', dbclient: dbclient});
...
app.configure('production|development', 'connector', function () {
  ...
  app.set('connectorConfig', {
    ...
    useDict: true,
    useProtobuf: true,
    handshake: function handshake(msg, cb) {
      cb(null, {});
    }
  });
});
...
app.start(); // Uncaught exception handler
