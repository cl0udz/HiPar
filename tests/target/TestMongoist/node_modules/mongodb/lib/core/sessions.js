...
function (_EventEmitter) {
  ...
  function ClientSession(topology, sessionPool, options, clientOptions) {
    ...
    _this4 = _possibleConstructorReturn(this, _getPrototypeOf(ClientSession).call(this));
    ...
    _this4.topology = topology;
    _this4.sessionPool = sessionPool;
    _this4.hasEnded = false;
    _this4.serverSession = sessionPool.acquire();
    _this4.clientOptions = clientOptions;
    _this4.supports = {
      causalConsistency: typeof options.causalConsistency !== 'undefined' ? options.causalConsistency : true
    };
    _this4.clusterTime = options.initialClusterTime;
    _this4.operationTime = null;
    _this4.explicit = !!options.explicit;
    _this4.owner = options.owner;
    _this4.defaultTransactionOptions = Object.assign({}, options.defaultTransactionOptions);
    _this4.transaction = new Transaction();
    return _this4;
  }
  /**
