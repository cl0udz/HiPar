...
function (_AuthProvider) {
  ...
  function ScramSHA(bson, cryptoMethod) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(ScramSHA).call(this, bson));
    _this2.cryptoMethod = cryptoMethod || 'sha1';
    return _this2;
  }
  ...
  _createClass(ScramSHA, [{
    ...
    value: function _authenticateSingleConnection(sendAuthCommand, connection, credentials, callback) {
      var _this = this; // Create a random nonce
      ...
      crypto.randomBytes(24, function (err, buff) {
        ...
        return _this._executeScram(sendAuthCommand, connection, credentials, buff.toString('base64'), callback);
      });
    }
    /**
     * Authenticate
