...
function (_EventEmitter) {
  ...
  function ConnectionPool(options) {
    ...
    _this4 = _possibleConstructorReturn(this, _getPrototypeOf(ConnectionPool).call(this));
    _this = _assertThisInitialized(_this4);
    options = options || {};
    _this4.closed = false;
    _this4.options = resolveOptions(options, {
    ...
    _this4[kLogger] = Logger('ConnectionPool', options);
    _this4[kConnections] = new Denque();
    _this4[kPermits] = _this4.options.maxPoolSize;
    _this4[kMinPoolSizeTimer] = undefined;
    _this4[kGeneration] = 0;
    _this4[kConnectionCounter] = makeCounter(1);
    _this4[kCancellationToken] = new EventEmitter();

    _this4[kCancellationToken].setMaxListeners(Infinity);

    _this4[kWaitQueue] = new Denque();
    process.nextTick(function () {
      _this.emit('connectionPoolCreated', new ConnectionPoolCreatedEvent(_this));

      ensureMinPoolSize(_this);
    });
    return _this4;
  }
