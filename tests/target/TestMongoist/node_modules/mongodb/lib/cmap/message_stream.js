...
function (_Duplex) {
  ...
  function MessageStream(options) {
    ...
    options = options || {};
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(MessageStream).call(this, options));
    _this2.bson = options.bson;
    _this2.maxBsonMessageSize = options.maxBsonMessageSize || kDefaultMaxBsonMessageSize;
    _this2[kBuffer] = new BufferList();
    return _this2;
  }
  ...
  _createClass(MessageStream, [{
    ...
    value: function writeCommand(command, operationDescription) {
      var _this = this; // TODO: agreed compressor should live in `StreamDescription`
      ...
      compress({
        ...
        _this.push(Buffer.concat([msgHeader, compressionDetails, compressedMessage]));
      });
    }
  }]);
