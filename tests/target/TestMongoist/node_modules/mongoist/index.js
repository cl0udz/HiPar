...
function isValidCollectionName(name) {
  return typeof name === 'string' && name && !(name.includes('$') || name.includes('\0') || name.startsWith('system.'));
}

module.exports = function (connectionString, options) {
  var db = new Database(connectionString, options);
  var dbMethods = Object.create(null);
  return new Proxy(db, {
...
module.exports.Bulk = Bulk; // expose bson stuff visible in the shell
...
module.exports.Timestamp = mongodb.Timestamp; // Add support for default ES6 module imports
