...
(function (root, factory) {
  ...
  return function () {
    ...
    var Utils = {
      ...
      resolveTransformObject: function resolveTransformObject(subObj, params, depth) {
        ...
        for (prop in subObj) {
          ...
          } else if (_typeof(subObj[prop]) === "object") {
      ...
      getIn: function getIn(object, path, usingDotNotation) {
        ...
        if (!Array.isArray(path)) {
          throw new Error("path must be a string or array. Found " + _typeof(path));
        }
    ...
    function dotSubScan(root, paths, fun, value, poffset) {
      ...
      if (_typeof(root) === "object" && path in root) {
        element = root[path];
      }
    ...
    var LokiOps = {
      ...
      $type: function $type(a, b) {
        ...
        return _typeof(b) !== "object" ? type === b : doQueryOp(type, b);
      },
      ...
      $size: function $size(a, b) {
        if (Array.isArray(a)) {
          return _typeof(b) !== "object" ? a.length === b : doQueryOp(a.length, b);
        }
      ...
      switch (cloneMethod) {
        ...
        case "shallow-recurse-objects":
          ...
          keys.forEach(function (key) {
            if (_typeof(data[key]) === "object" && data[key].constructor.name === "Object") {
    ...
    function precompileQuery(operator, value) {
      if (operator === "$regex") {
        ...
        for (var key in value) {
          if (key === "$regex" || _typeof(value[key]) === "object") {
    ...
    Resultset.prototype.find = function (query, firstOnly) {
      ...
      if (queryObjectOp === null || _typeof(queryObjectOp) !== "object" || queryObjectOp instanceof Date) {
        operator = "$eq";
        value = queryObjectOp;
      } else if (_typeof(queryObjectOp) === "object") {
      ...
      if (operator === "$regex" || _typeof(value) === "object") {
    ...
    function Collection(name, options) {
      ...
      function getObjectDelta(oldObject, newObject) {
        var propertyNames = newObject !== null && _typeof(newObject) === "object" ? Object.keys(newObject) : null;

        if (propertyNames && propertyNames.length && ["string", "boolean", "number"].indexOf(_typeof(newObject)) < 0) {
          var delta = {};
    ...
    Collection.prototype.checkIndex = function (property, options) {
      ...
      options.randomSamplingFactor = options.randomSamplingFactor || .1;

      if (options.randomSamplingFactor < 0 || options.randomSamplingFactor > 1) {
        options.randomSamplingFactor = .1;
      }
