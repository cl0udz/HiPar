  ...
  return function () {
    ...
    IncrementalIndexedDBAdapter.prototype.saveDatabase = function (dbname, loki, callback) {
      ...
      loki.collections.forEach(function (collection, i) {
        ...
        dirtyChunks.forEach(function (chunkId) {
          var chunkData = that._getChunk(collection, chunkId); // we must stringify, because IDB is asynchronous, and underlying objects are mutable
    ...
    IncrementalIndexedDBAdapter.prototype.loadDatabase = function (dbname, callback) {
      ...
      this._getAllChunks(function (chunks) {
        ...
        var loki;
        var chunkCollections = {}; // console.time('repack')
        ...
        chunks = null; // console.timeEnd('repack')
        ...
        loki = JSON.parse(loki); // console.timeEnd('parse')
        ...
        console.timeEnd("loadDatabase"); // console.log('Loaded Loki database!', loki)
    ...
    IncrementalIndexedDBAdapter.prototype._saveChunks = function (chunks, callback) {
      ...
      console.time("put"); // console.log(chunks)
