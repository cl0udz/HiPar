...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    // Browser globals
    root.lokiAngular = factory(root.angular, // Use thirdParty.loki if available to cover all legacy cases
    root.thirdParty && root.thirdParty.loki ? root.thirdParty.loki : root.loki);
  }
})(void 0, function (angular, lokijs) {
  var module = angular.module('lokijs', []).factory('Loki', Loki).service('Lokiwork', Lokiwork);
  ...
  function Lokiwork(Loki, $q, $injector, $window) {
    ...
    function deleteDocument(dbName, collName, doc) {
      //doc should be in {name:value} format 
      return $q(function (resolve, reject) {
        userDbPreference = dbName;

        _getem('delete_doc', dbName, collName, doc).then(function (data) {
          currentDoc = {};
          resolve(data);
        }, function (data) {
          reject(data);
    ...
    function insertItemInDoc(item) {
      return $q(function (resolve, reject) {
        _getem('insert_item_in_doc', currentDoc.dbName, currentDoc.collName, currentDoc.doc, "", item).then(function (data) {
          resolve(data);
        }, function (data) {
          reject(data);
        });
    ...
    function deleteCurrentDoc() {
      return $q(function (resolve, reject) {
        _getem('delete_current_doc').then(function (data) {
          resolve(data);
        }, function (data) {
          reject(data);
        });
    ...
    function addDocument(dbName, collName, newDoc) {
      return $q(function (resolve, reject) {
        ...
        _getem('create_doc', dbName, collName, "", "", newDoc).then(function (data) {
    ...
    function setCurrentDoc(dbName, collName, docName) {
      return $q(function (resolve, reject) {
        ...
        _getem('set_doc', dbName, collName, docName).then(function (data) {
          currentDoc.dbName = dbName;
          currentDoc.collName = collName;
          currentDoc.doc = data;
          currentDoc.lokiNum = data[0].$loki;
    ...
    function updateCurrentDoc(thekey, thevalue) {
      return $q(function (resolve, reject) {
        if (currentDoc) {
          _getem('update_current_doc', currentDoc.dbName, currentDoc.collName, currentDoc.doc, thekey, thevalue).then(function (data) {
            resolve(data[0]);
          }, function (data) {
            reject(data);
          });
    ...
    function updateDoc(dbName, collName, docName, thekey, thevalue) {
      return $q(function (resolve, reject) {
        ...
        if (currentDoc) {
          _getem('update_doc', dbName, collName, docName, thekey, thevalue).then(function (data) {
            resolve(data[0]);
          }, function (data) {
            reject(data);
          });
    ...
    function getDoc(dbName, collName, docName) {
      return $q(function (resolve, reject) {
        ...
        _getem('get_doc', dbName, collName, docName).then(function (data) {
          currentDoc.dbName = dbName;
          currentDoc.collName = collName;
          currentDoc.doc = data;
          currentDoc.lokiNum = data[0].$loki;
    ...
    function getCollection(dbName, collName) {
      return $q(function (resolve, reject) {
        ...
        _getem('get_collection', dbName, collName).then(function (data) {
    ...
    function removeCollection(dbName, collName) {
      return $q(function (resolve, reject) {
        ...
        _getem('remove_collection', dbName, collName).then(function (data) {
          currentColl = {};
          resolve(data);
        }, function (data) {
          reject(data);
    ...
    function addCollection(collData) {
      return $q(function (resolve, reject) {
        ...
        _getem('add_collection', userDbPreference, '', '', '', collData).then(function (data) {
      ...
      return $q(function (resolve, reject) {
        ...
        function getdata() {
          ...
          if (operation === 'update_doc' || operation === 'insert_item_in_doc') {
            ...
            var coll = db.getCollection(collName); //docName is not simply a docname, this is an object like: {name: 'user settings'}
            ...
            db.loadDatabase(dbName);
            db.removeCollection(collName); //coll = db.getCollection(collName);
      ...
      return $q(function (resolve, reject) {
        for (var x = 0; x >= 0; x++) {
          if ($injector.has('json' + (x + 1))) {
            ...
            if (setting[dbobj.db] === userDbPreference) {
              //userDbPreference is the name
    ...
    function initialiseDbList() {
      return $q(function (resolve, reject) {
        firstFewItemsOfDbList().then(function () {
    ...
    function initialiseAll() {
      return $q(function (resolve, reject) {
        initialiseDbList().then(function () {
          function iterate_me() {
    ...
    function initiateDb(database) {
      return $q(function (resolve, reject) {
        ...
        db = new loki(database[dbobj.db], {
          ...
          //loadHandler, //for some reason this has to be called like this
          autosave: true,
