...
function requireUncached(moduleName) {
  ...
  Object.keys(require.cache).filter(function (file) {
...
var extJSON = null,
    mongodb = null; // BSON types

var Binary, Code, DBRef, Decimal128, Double, Int32, Long, MaxKey, MinKey, ObjectID, BSONRegExp, _Symbol, Timestamp;
...
var environments = [{
  ...
  beforeEach: function beforeEach() {
    ...
    _Symbol = mongodb.Symbol;
    Timestamp = mongodb.Timestamp; // Create a new Buffer
  ...
  environments.forEach(function (env) {
    describe('environment: ' + env.name, function () {
      ...
      it('should correctly deserialize using strict, and non-strict mode', function () {
        ...
        var doc1 = extJSON.parse(extJSON.stringify(test.doc, null, 0), {
          strict: false
        }); // Validate the values
        ...
        assert.equal(19007199250000000.12, doc1.doubleNumberIntFit); // Deserialize the document using strict mode

        doc1 = extJSON.parse(extJSON.stringify(test.doc, null, 0), {
          strict: true
        }); // Validate the values
      ...
      it('should correctly serialize, and deserialize using built-in BSON', function () {
        ...
        var Int32 = extJSON.BSON.Int32; // Create a doc
        ...
        expect(text).to.equal('{"int32":{"$numberInt":"10"}}'); // Deserialize the json in strict and non strict mode

        var doc2 = extJSON.parse(text, {
          strict: true
        });
        expect(doc2.int32._bsontype).to.equal('Int32');
        doc2 = extJSON.parse(text, {
          strict: false
        });
      ...
      it('should correctly serialize bson types when they are values', function () {
        ...
        serialized = extJSON.stringify({
          _id: {
            $nin: [new ObjectID('591801a468f9e7024b6235ea')]
          }
        });
      ...
      it('should correctly parse null values', function () {
        ...
        var parsed = extJSON.parse(input, {
          strict: false
        });
      ...
      it('should allow relaxed parsing', function () {
        ...
        var inputObject = {
          ...
          date: {
            $date: {
              $numberLong: '1452124800000'
            }
          }
        };
        var parsed = extJSON.parse(JSON.stringify(inputObject), {
          relaxed: true
        });
      ...
      it('should allow regexp', function () {
        var parsedRegExp = extJSON.stringify({
          test: /some-regex/i
        }, {
          relaxed: true
        });
        var parsedBSONRegExp = extJSON.stringify({
