...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('bson')) : typeof define === 'function' && define.amd ? define(['bson'], factory) : global['mongodb-extjson'] = factory(global.bson);
})(void 0, function (bson) {
  'use strict';
  ...
  function serializeDocument(doc, options) {
    ...
    if (doc._bsontype && BSONTypes.indexOf(doc._bsontype) !== -1) {
      ...
      if (doc._bsontype === 'Code' && doc.scope) {
        ...
        return bson$1['Code'].toExtendedJSON(tempDoc, options); // we need to separately serialize the embedded OID document
    ...
    for (var name in doc) {
      ...
      if (Array.isArray(val)) {
        ...
        if (val._bsontype === 'Code' && val.scope) {
          ...
          _doc[name] = bson$1['Code'].toExtendedJSON(tempVal, options); // we need to separately serialize the embedded OID document
      ...
      if (val instanceof RegExp) {
        ...
        _doc[name] = bson$1['BSONRegExp'].toExtendedJSON({
          pattern: val.source,
          options: flags
        });
      }
