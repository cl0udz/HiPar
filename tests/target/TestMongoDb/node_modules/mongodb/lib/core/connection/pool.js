...
Pool.prototype.connect = function () {
  ...
  createConnection(this, function (err, conn) {
    ...
    stateTransition(_this, CONNECTED);

    _this.emit('connect', _this, conn); // create min connections
...
Pool.prototype.reset = function (callback) {
  ...
  eachAsync(connections, function (conn, cb) {
    ...
    resetPoolState(_this2); // create an initial connection, and kick off execution again

    createConnection(_this2);
