...
var ExplainOperation =
/*#__PURE__*/
function (_OperationBase) {
  _inherits(ExplainOperation, _OperationBase);

  function ExplainOperation(cursor) {
    var _this;

    _classCallCheck(this, ExplainOperation);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ExplainOperation).call(this));
    _this.cursor = cursor;
    return _this;
  }

  _createClass(ExplainOperation, [{
    key: "execute",
