...
var crypto = require('crypto'); // From https://github.com/Graylog2/graylog2-docs/wiki/GELF
...
Gelfling.prototype.send = function (data, callback) {
  ...
  var udpClient,
      ...
      self = this,
      cbDone = false;
  if (!Array.isArray(data)) return this.encode(this.convert(data), function (err, chunks) {
