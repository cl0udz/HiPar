...
describe('find-root', function () {
  it('recursively looks for package.json', function () {
    ...
    var findRoot = moquire(MODULE, {
      fs: fs
    });
    findRoot('/foo/bar/baz').should.equal('/foo');
    checked.should.deep.equal(['/foo/bar/baz/package.json', '/foo/bar/package.json', '/foo/package.json']);
  });
  it('can take a custom check argument', function () {
    ...
    checked.should.deep.equal(['/foo/bar/baz', '/foo/bar']);
  });
