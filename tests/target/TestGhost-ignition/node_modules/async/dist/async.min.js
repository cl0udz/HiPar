...
!function () {
  ...
  function o(n) {
    return M(n) || "number" == typeof n.length && n.length >= 0 && n.length % 1 === 0;
  }
  ...
  function h(n) {
    var t,
        e,
        r = -1;
    return o(n) ? (t = n.length, function () {
      return r++, t > r ? r : null;
    }) : (e = W(n), t = e.length, function () {
  ...
  function m(n, t) {
    return t = null == t ? n.length - 1 : +t, function () {
      for (var e = Math.max(arguments.length - t, 0), r = Array(e), u = 0; e > u; u++) {
        r[u] = arguments[u + t];
      }
  ...
  function I(t, e, r) {
    function i(t, e, r, u) {
      ...
      return t.started = !0, M(e) || (e = [e]), 0 === e.length && t.idle() ? P.setImmediate(function () {
        t.drain();
      }) : (c(e, function (e) {
        var i = {
          data: e,
    ...
    function o(n, t) {
      return function () {
        ...
        }), n.tasks.length + f === 0 && n.drain(), n.process();
      };
    }
    ...
    var f = 0,
      ...
      process: function process() {
        for (; !s.paused && f < s.concurrency && s.tasks.length;) {
      ...
      resume: function resume() {
        if (s.paused !== !1) {
          ...
          for (var n = Math.min(s.concurrency, s.tasks.length), t = 1; n >= t; t++) {
  ...
  function x(n) {
    return m(function (t, e) {
      t.apply(null, e.concat([m(function (t, e) {
        "object" == (typeof console === "undefined" ? "undefined" : _typeof(console)) && (t ? console.error && console.error(t) : console[n] && c(e, function (t) {
          console[n](t);
        }));
      })]));
    });
  ...
  var q,
      P = {},
      C = "object" == (typeof self === "undefined" ? "undefined" : _typeof(self)) && self.self === self && self || "object" == (typeof global === "undefined" ? "undefined" : _typeof(global)) && global.global === global && global || this;
  null != C && (q = C.async), P.noConflict = function () {
    return C.async = q, P;
  };

  var H = Object.prototype.toString,
      M = Array.isArray || function (n) {
  ...
  "object" == (typeof process === "undefined" ? "undefined" : _typeof(process)) && "function" == typeof process.nextTick ? P.nextTick = process.nextTick : P.nextTick = D, P.setImmediate = B ? D : P.nextTick, P.forEach = P.each = function (n, t, e) {
    return P.eachOf(n, y(t), e);
  }, P.forEachSeries = P.eachSeries = function (n, t, e) {
    return P.eachOfSeries(n, y(t), e);
    ...
    var c = h(t),
        a = c();
    o();
  }, P.forEachOfLimit = P.eachOfLimit = function (n, t, e, r) {
    v(t)(n, e, r);
  }, P.map = d(b), P.mapSeries = k(b), P.mapLimit = g(b), P.inject = P.foldl = P.reduce = function (n, t, e, r) {
    P.eachOfSeries(n, function (n, r, u) {
      e(t, n, function (n, e) {
        t = e, u(n);
      });
    }, function (n) {
  ...
  }, P.foldr = P.reduceRight = function (n, e, r, u) {
    var i = a(n, t).reverse();
    P.reduce(i, e, r, u);
  }, P.transform = function (n, t, e, r) {
    3 === arguments.length && (r = e, e = t, t = M(n) ? [] : {}), P.eachOf(n, function (n, r, u) {
      e(t, n, r, u);
    }, function (n) {
      r(n, t);
    });
    ...
    P.map(n, function (n, e) {
      ...
      return n ? e(n) : void e(null, a(t.sort(r), function (n) {
        return n.value;
      }));
    });
    ...
    function a() {
      h--, c(g.slice(0), function (n) {
        n();
      });
    }

    "function" == typeof arguments[1] && (r = e, e = null), r = i(r || n);
    var f = W(t),
        h = f.length;
    if (!h) return r(null);
    e || (e = h);
    ...
    u(function () {
      ...
      function i() {
        return e > v && l(k, function (n, t) {
          return n && y.hasOwnProperty(t);
        }, !0) && !y.hasOwnProperty(n);
      }

      function c() {
        i() && (v++, o(c), h[h.length - 1](g, y));
      }

      if (!d) {
        for (var f, h = M(t[n]) ? t[n] : [t[n]], g = m(function (t, e) {
          if (v--, e.length <= 1 && (e = e[0]), t) {
            var u = {};
            s(y, function (n, t) {
              u[t] = n;
            }), u[n] = e, d = !0, r(t, u);
          } else y[n] = e, P.setImmediate(a);
        }), k = h.slice(0, h.length - 1), b = k.length; b--;) {
          if (!(f = t[k[b]])) throw new Error("Has nonexistent dependency in " + k.join(", "));
          if (M(f) && p(f, n) >= 0) throw new Error("Has cyclic dependencies");
        }

        i() ? (v++, h[h.length - 1](g, y)) : u(c);
      }
    });
  }, P.retry = function (n, t, e) {
    function r(n, t) {
      if ("number" == typeof t) n.times = parseInt(t, 10) || i;else {
        if ("object" != _typeof(t)) throw new Error("Unsupported argument type for 'times': " + _typeof(t));
    ...
    function r(n) {
      return m(function (t, u) {
        if (t) e.apply(null, [t].concat(u));else {
          var i = n.next();
    ...
    L(P.eachOf, n, t);
  }, P.parallelLimit = function (n, t, e) {
    L(v(t), n, e);
  }, P.series = function (n, t) {
    ...
    return t(0);
  }, P.apply = m(function (n, t) {
    return m(function (e) {
      return n.apply(null, t.concat(e));
    });
  }), P.concat = d(j), P.concatSeries = k(j), P.whilst = function (t, e, r) {
    if (r = r || n, t()) {
      var u = m(function (n, i) {
        n ? r(n) : t.apply(this, i) ? e(u) : r.apply(null, [null].concat(i));
      });
      e(u);
    } else r(null);
    ...
    function i(t, e, i, o) {
      ...
      return t.started = !0, M(e) || (e = [e]), 0 === e.length ? P.setImmediate(function () {
        t.drain();
      }) : void c(e, function (e) {
        var c = {
          data: e,
    ...
    return I(n, 1, t);
  }, P.log = x("log"), P.dir = x("dir"), P.memoize = function (n, e) {
    var r = {},
        u = {},
    ...
    var o = m(function (t) {
      var o = t.pop(),
          c = e.apply(null, t);
      i.call(r, c) ? P.setImmediate(function () {
        o.apply(null, r[c]);
      }) : i.call(u, c) ? u[c].push(o) : (u[c] = [o], n.apply(null, t.concat([m(function (n) {
        r[c] = n;
        var t = u[c];
        delete u[c];
  ...
  }, P.times = A(P.map), P.timesSeries = A(P.mapSeries), P.timesLimit = function (n, t, e, r) {
    return P.mapLimit(f(n), t, e, r);
  }, P.seq = function () {
    var t = arguments;
    return m(function (e) {
      var r = this,
          u = e[e.length - 1];
      "function" == typeof u ? e.pop() : u = n, P.reduce(t, e, function (n, t, e) {
        t.apply(r, n.concat([m(function (n, t) {
          e(n, t);
        })]));
      }, function (n, t) {
  ...
  }, P.applyEach = T(P.eachOf), P.applyEachSeries = T(P.eachOfSeries), P.forever = function (t, e) {
    function r(n) {
    ...
    var i = u(e || n),
        o = z(t);
    r();
  }, P.ensureAsync = z, P.constant = m(function (n) {
    var t = [null].concat(n);
    return function (n) {
    ...
    return m(function (t) {
      ...
      U(e) && "function" == typeof e.then ? e.then(function (n) {
        r(null, n);
      })["catch"](function (n) {
        r(n.message ? n : new Error(n));
      }) : r(null, e);
    });
  }, "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = P : "function" == typeof define && define.amd ? define([], function () {
    return P;
  }) : C.async = P;
}();