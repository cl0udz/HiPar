...
function deepEqual(obj1, obj2) {
  ...
  if (obj1 === null || obj2 === null || _typeof(obj1) != 'object') return obj1 === obj2;
...
function hasKey(obj, key) {
  mod_assert.equal(_typeof(key), 'string');
...
function pluckv(obj, key) {
  if (obj === null || _typeof(obj) !== 'object') return undefined;
...
function doFlattenIter(data, depth, accum, callback) {
  ...
  mod_assert.equal(_typeof(data), 'object');
  mod_assert.equal(_typeof(depth), 'number');
...
function extraProperties(obj, allowed) {
  mod_assert.ok(_typeof(obj) === 'object' && obj !== null, 'obj argument must be a non-null object');
