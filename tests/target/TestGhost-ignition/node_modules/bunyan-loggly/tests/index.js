...
test('Bunyan2Loggly Exists', function (t) {
  ...
  t.equal(_typeof(Bunyan2Loggly), 'function', 'Bunyan2Loggly is a function');
});
test('Bunyan2Loggly throws on bad config', function (t) {
  ...
  t["throws"](function () {
    new Bunyan2Loggly();
  }, exceptionMessage, 'throws on bad config');
  t["throws"](function () {
    new Bunyan2Loggly({});
  }, exceptionMessage, 'throws on bad config');
  t["throws"](function () {
...
test('Bunyan2Loggly throws if write called with non raw stream', function (t) {
  ...
  t["throws"](function () {
    bunyan2Loggly.write();
  }, exceptionMessage, 'throws on bad stream');
  t["throws"](function () {
...
test('Bunyan2Loggly uses logglyCallback if provided', function (t) {
  ...
  mocks['node-loggly-bulk'].createClient = function () {
    return {
      log: function log(data, callback) {
