...
require("core-js/modules/es.regexp.to-string"); // Copyright 2012 Joyent, Inc.  All rights reserved.
...
module.exports = {
  ...
  isSigner: function isSigner(obj) {
    if (_typeof(obj) === 'object' && obj instanceof RequestSigner) return true;
    return false;
  },
