...
module.exports = Any.extend({
  ...
  validate: function validate(value, _ref) {
    ...
    return linked.$_validate(value, state.nest(linked, "link:".concat(ref.display, ":").concat(linked.type)), prefs);
  },
  generate: function generate(schema, value, state, prefs) {
...
internals.assert = function (condition, message, ref, schema, state, prefs) {
  ...
  Assert(false, "\"".concat(Errors.label(schema._flags, state, prefs), "\" contains link reference \"").concat(ref.display, "\" ").concat(message));
};