...
module.exports = Any.extend({
  ...
  rules: {
    has: {
      ...
      validate(value, _ref3, _ref4) {
        ...
        for (var i = 0; i < value.length; ++i) {
          var localState = state.localize([...state.path, i], ancestors, has);
    ...
    items: {
      ...
      validate(value, _ref5) {
        ...
        var inclusions = [...schema.$_terms._inclusions, ...requireds];
        ...
        for (var i = 0; i < il; ++i) {
          ...
          var path = [...state.path, key]; // Sparse
          ...
          for (var j = 0; j < jl; ++j) {
            var localState = state.localize(path, ancestors, requireds[j]);
            localState.snapshot();

            var _res = requireds[j].$_validate(item, localState, prefs);
          ...
          try {
            for (var _iterator2 = inclusions[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              ...
              if (previousCheck !== -1) {
                ...
                var _localState = state.localize(path, ancestors, inclusion);

                _localState.snapshot();

                _res2 = inclusion.$_validate(item, _localState, prefs);
    ...
    unique: {
      ...
      validate(value, _ref10, _ref11, _ref12) {
        ...
        for (var i = 0; i < value.length; ++i) {
          ...
          var records = comparator ? found.custom : found[typeof item];
          ...
          if (records instanceof Map) {
            ...
            while (!(current = entries.next()).done) {
              if (compare(current.value[0], item)) {
                var localState = state.localize([...state.path, i], [value, ...state.ancestors]);
                var context = {
                  pos: i,
                  value: value[i],
            ...
            if ((!ignoreUndefined || item !== undefined) && records[item] !== undefined) {
              ...
              var _localState2 = state.localize([...state.path, i], [value, ...state.ancestors]);

              return error('array.unique', _context, _localState2);
            }
  ...
  rebuild(schema) {
    ...
    try {
      for (var _iterator3 = schema.$_terms.items[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
    ...
    try {
      for (var _iterator4 = schema.$_terms.ordered[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
internals.fillMissedErrors = function (schema, errors, requireds, value, state, prefs) {
  ...
  try {
    for (var _iterator5 = requireds[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
      var required = _step5.value;
...
internals.fillOrderedErrors = function (schema, errors, ordereds, value, state, prefs) {
  ...
  try {
    for (var _iterator6 = ordereds[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
      var ordered = _step6.value;
