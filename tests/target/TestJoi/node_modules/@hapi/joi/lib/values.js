...
function () {
  ...
  _createClass(_class, [{
    ...
    value: function get(value, state, prefs, insensitive) {
      ...
      if (!this._refs.size && _typeof(value) !== 'object') {
        return false;
      } // Objects
      ...
      if (state) {
        ...
        try {
          for (var _iterator2 = this._refs[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            ...
            var items = !ref["in"] || _typeof(resolved) !== 'object' ? [resolved] : Array.isArray(resolved) ? resolved : Object.keys(resolved);
            ...
            try {
              for (var _iterator3 = items[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                ...
                if (_typeof(_item) !== _typeof(value)) {
                  continue;
                }

                if (insensitive && value && typeof value === 'string') {
                  if (_item.toLowerCase() === value.toLowerCase()) {
                    return {
                      value: _item,
                      ref: ref
                    };
    ...
    value: function values(options) {
      if (options && options.display) {
        ...
        for (var _i = 0, _arr = [].concat(_toConsumableArray(this._values), _toConsumableArray(this._refs)); _i < _arr.length; _i++) {
          var item = _arr[_i];
    ...
    value: function concat(source) {
      ...
      var set = new internals.Values([].concat(_toConsumableArray(this._values), _toConsumableArray(source._values)), [].concat(_toConsumableArray(this._refs), _toConsumableArray(source._refs)));
      set._override = this._override;
      return set;
    }
  }, {
    ...
    value: function describe() {
      ...
      try {
        for (var _iterator4 = this._values.values()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          ...
          normalized.push(value && _typeof(value) === 'object' ? {
            value: value
          } : value);
        }
      } catch (err) {
    ...
    key: "merge",
    value: function merge(target, source, remove) {
      ...
      if (source) {
        ...
        for (var _i2 = 0, _arr2 = [].concat(_toConsumableArray(source._values), _toConsumableArray(source._refs)); _i2 < _arr2.length; _i2++) {
          var item = _arr2[_i2];
          target.add(item);
        }
      }
      ...
      if (remove) {
        for (var _i3 = 0, _arr3 = [].concat(_toConsumableArray(remove._values), _toConsumableArray(remove._refs)); _i3 < _arr3.length; _i3++) {
          var _item2 = _arr3[_i3];
          target.remove(_item2);
        }
      }
